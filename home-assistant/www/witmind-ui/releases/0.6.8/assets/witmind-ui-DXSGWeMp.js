...
`;class Mt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._hass=null,this._panel=null,this._narrow=!1,this._started=!1,this._renderQueued=!1,this._forecast=[],this._history=[],this._historyError="",this._liveStates=new Map,this._pendingSwitches=new Map,this._switchErrors=new Map,this._switchTimers=new Map,this._pendingAction="",this._confirmAction="",this._toast=null,this._toastTimer=null,this._clockTimer=null,this._historyTimer=null,this._unsubscribeStates=null,this._unsubscribeForecast=null,this._forecastEntity="",this._energyRange="day",this._energyDayOffset=0,this._energyData=[],this._energyLoading=!1,this._energyError=null,this._energyMonthTotal=null,this._energyRequestId=0,this._energyRefreshTimer=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._themeStorageKey="witmind-showroom-panel-theme",this._theme=this._loadTheme(),this._activeView="home",this.shadowRoot.addEventListener("click",e=>this._handleClick(e)),this.shadowRoot.addEventListener("scroll",e=>this._handleEnergyScroll(e),!0)}set hass(e){var o,n,c,d;const t=this._hass,i=this._config(),a=this._relevantHassChanged(t,e),r=!t||((o=t.states)==null?void 0:o[i.energySensor])!==((n=e==null?void 0:e.states)==null?void 0:n[i.energySensor]),s=!((c=t==null?void 0:t.states)!=null&&c[i.energySensor])&&!!((d=e==null?void 0:e.states)!=null&&d[i.energySensor]);this._hass=e,a&&this._syncStatesFromHass(),this.isConnected&&(this._started?r&&(s?this._loadEnergyStatistics():this._scheduleEnergyRefresh()):(this._started=!0,this._start()),a&&this._updateStatePresentation())}get hass(){return this._hass}set panel(e){const t=this._config().weather;this._panel=e;const i=this._config().weather;this._config().panelKind==="general"&&this._activeView==="home"&&(this._activeView="lights"),this._started&&t!==i&&(this._resetForecastSubscription(),this._subscribeWeather()),this._hass&&(this._syncStatesFromHass(),this._loadEnergyStatistics(),this._updateStatePresentation())}get panel(){return this._panel}set narrow(e){this._narrow=!!e,this.toggleAttribute("narrow",this._narrow)}get narrow(){return this._narrow}connectedCallback(){this._hass&&(this._started||(this._started=!0,this._start()),this._updateStatePresentation(),this._scheduleEnergyRefresh(!0))}disconnectedCallback(){clearInterval(this._clockTimer),clearInterval(this._historyTimer),clearTimeout(this._toastTimer),clearTimeout(this._energyRefreshTimer),this._energyRequestId+=1;for(const e of this._switchTimers.values())clearTimeout(e);this._switchTimers.clear(),this._resetForecastSubscription(),this._unsubscribeStates&&(this._unsubscribeStates(),this._unsubscribeStates=null),this._started=!1}_requestRender(){this._renderQueued||!this._hass||!this.shadowRoot||(this._renderQueued=!0,requestAnimationFrame(()=>{this._renderQueued=!1,this.render()}))}_updateStatePresentation(){var o;if(!((o=this.shadowRoot)!=null&&o.querySelector(".app-shell"))){this._requestRender();return}const e=n=>{var b;const c=n.dataset.entity;if(!c)return;const d=this._state(c),p=this._visibleSwitchState(c),h=p==="on",g=!d||["unknown","unavailable"].includes(d.state),u=this._pendingSwitches.has(c),m=this._switchErrors.get(c),_=m||(u?p==="on"?"Encendiendo…":"Apagando…":g?"No disponible":h?"Encendido":"Apagado");n.classList.toggle("is-on",h),n.classList.toggle("is-pending",u),n.classList.toggle("is-error",!!m),n.disabled=g,n.setAttribute("aria-pressed",String(h));const k=((b=n.querySelector(".device-copy strong"))==null?void 0:b.textContent)||c;n.setAttribute("aria-label",`${k}: ${_}`);const E=n.querySelector(".device-copy small");E&&(E.textContent=_)};this.shadowRoot.querySelectorAll('[data-action="toggle-switch"]').forEach(e),this.shadowRoot.querySelectorAll('[data-action="run-scene"]').forEach(n=>{const c=this._allScenes().find(u=>u.key===n.dataset.sceneKey);if(!c)return;const d=this._sceneStatus(c),p=this._pendingAction===c.key,h=p?"Aplicando...":d.active?"Activo":d.unavailable?"Sin datos":"Inactivo";n.classList.toggle("is-pending",p),n.classList.toggle("is-active",d.active),n.classList.toggle("is-unavailable",d.unavailable),n.disabled=!!(this._pendingAction&&!p),n.setAttribute("aria-pressed",String(d.active));const g=n.querySelector(".scene-state");g&&(g.textContent=h)});const t=this._config(),i=[...t.spots,...t.samples,...t.reflector?[t.reflector]:[]],a=i.filter(n=>this._visibleSwitchState(n.entity)==="on").length,r=this.shadowRoot.querySelector("[data-lights-summary]");r&&(r.textContent=`${a} de ${i.length}`);const s=this.shadowRoot.querySelector("[data-energy-summary]");s&&(s.textContent=this._energyMonthTotal===null?"Sin datos":`${this._formatEnergy(this._energyMonthTotal)} kWh`)}_handleClick(e){const t=e.target.closest("[data-action]");if(!t||!this._hass)return;const i=t.dataset.action;if(i==="toggle-menu"){this._toggleHomeAssistantMenu();return}if(i==="toggle-theme"){this._toggleTheme();return}if(i==="set-view"){const a=t.dataset.view;["home","lights","energy","system"].includes(a)&&(this._activeView=a,this._requestRender());return}if(i==="toggle-switch"){this._toggleSwitch(t.dataset.entity);return}if(i==="run-scene"){this._runScene(t.dataset.sceneKey||t.dataset.entity,t.dataset.label);return}if(i==="open-power-on"){this._pendingAction||(this._confirmAction="on",this._requestRender());return}if(i==="open-power-off"){this._pendingAction||(this._confirmAction="off",this._requestRender());return}if(i==="general-off"){const a=this._config().generalOffScript;a?this._hass.callService("script","turn_on",{entity_id:a}).catch(r=>{this._notify("No se pudo ejecutar Apagar todo Witmind.","error"),console.error("Error ejecutando el apagado general de Witmind:",r)}):this._notify("El apagado general aún no tiene una entidad configurada.","error");return}if(i==="cancel-power-confirm"){const a=e.target.closest("[data-dialog-card]");if(t.classList.contains("dialog-backdrop")&&a)return;this._pendingAction||(this._confirmAction="",this._requestRender());return}if(i==="confirm-power"){this._confirmGeneralPower();return}if(i==="clear-scene"){this._clearScene();return}if(i==="media"){this._mediaAction(t.dataset.service);return}if(i==="energy-range"){this._setEnergyRange(t.dataset.range);return}if(i==="energy-day-prev"){this._shiftEnergyDay(-1);return}if(i==="energy-day-next"){this._shiftEnergyDay(1);return}if(i==="energy-day-today"){this._resetEnergyDay();return}i==="refresh-energy"&&(this._energyLastLoadedAt=0,this._loadEnergyStatistics())}_toggleHomeAssistantMenu(){this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}))}_loadTheme(){try{return localStorage.getItem(this._themeStorageKey)==="light"?"light":"dark"}catch{return"dark"}}_saveTheme(){try{localStorage.setItem(this._themeStorageKey,this._theme)}catch(e){console.warn("No se pudo guardar el tema del showroom:",e)}}_toggleTheme(){this._theme=this._theme==="dark"?"light":"dark",this.setAttribute("data-theme",this._theme),this._saveTheme(),this.dispatchEvent(new CustomEvent("witmind-theme-change",{detail:{theme:this._theme},bubbles:!0,composed:!0})),this._requestRender()}set theme(e){e!=="dark"&&e!=="light"||(this._theme=e,this.setAttribute("data-theme",e),this._saveTheme())}get theme(){return this._theme}_config(){var u;const e=((u=this._panel)==null?void 0:u.config)||{},t=e.panel_kind==="lobby"||e.panel_kind==="general"||e.static_only===!0||e.staticOnly===!0,i=m=>Array.isArray(m)?[...new Set(m.filter(Boolean).map(_=>String(_)))]:[],a=(m,_)=>(Array.isArray(m)&&(m.length||t)?m:_).filter(E=>E==null?void 0:E.entity).map((E,b)=>({entity:String(E.entity),name:E.name||`Dispositivo ${b+1}`,subtitle:E.subtitle||"Iluminación",icon:E.icon||"bulb"})),r=a(e.spots,M.spots),s=a(e.samples||e.muestras,M.samples),o=[...r,...s].map(m=>m.entity),n=i(e.scene_control_entities||e.sceneControlEntities),c=n.length?n:o,d=(m,_,k)=>(Array.isArray(m)&&(m.length||t)?m:_).filter(b=>(b==null?void 0:b.entity)||(b==null?void 0:b.id)||(b==null?void 0:b.key)).map((b,v)=>{const S=b.entity?String(b.entity):"",C=String(b.id||b.key||S||`${k}-${v+1}`),x=_.find(I=>{const De=I.entity?String(I.entity):"",kt=String(I.id||I.key||De||"");return S&&De===S||kt===C}),z=S||(x!=null&&x.entity?String(x.entity):""),N=String(b.id||b.key||(x==null?void 0:x.id)||z||`${k}-${v+1}`),T=z||`${k}:${N}`,A=Array.isArray(b.on_entities)||Array.isArray(b.onEntities),re=Array.isArray(b.off_entities)||Array.isArray(b.offEntities),pe=i(A?b.on_entities||b.onEntities:x==null?void 0:x.onEntities),wt=i(re?b.off_entities||b.offEntities:[]),$t=re?wt.filter(I=>!pe.includes(I)):c.filter(I=>!pe.includes(I));return{key:T,id:N,entity:z,name:b.name||(x==null?void 0:x.name)||`Escena ${v+1}`,subtitle:b.subtitle||(x==null?void 0:x.subtitle)||"Escena del showroom",icon:b.icon||(x==null?void 0:x.icon)||"presentation",directOnly:b.direct_only??b.directOnly??(x==null?void 0:x.directOnly)??!1,onEntities:pe,offEntities:$t}}),p=e.reflector||M.reflector,h=Number(e.history_hours??e.historyHours),g=Number(e.chart_hours??e.chartHours);return{title:e.title||M.title,subtitle:e.subtitle||M.subtitle,siteLabel:e.site_label||e.siteLabel||M.siteLabel,logo:e.logo||M.logo,weather:e.weather||M.weather,mediaPlayer:e.media_player||e.mediaPlayer||M.mediaPlayer,lightCountSensor:e.light_count_sensor||e.lightCountSensor||M.lightCountSensor,energySensor:e.energy_sensor||e.energySensor||M.energySensor,batteryLevel:e.battery_level||e.batteryLevel||M.batteryLevel,powerOnScript:e.power_on_script||e.powerOnScript||M.powerOnScript,powerOffScript:e.power_off_script||e.powerOffScript||M.powerOffScript,historyHours:Number.isFinite(h)&&h>0?Math.min(24,h):M.historyHours,chartHours:Number.isFinite(g)&&g>0?Math.min(72,g):M.chartHours,showForecast:e.show_forecast??e.showForecast??M.showForecast,panelKind:e.panel_kind||e.panelKind||"showroom",staticOnly:e.static_only??e.staticOnly??!1,generalOffScript:e.general_off_script||e.generalOffScript||"",spots:r,samples:s,sceneControlEntities:c,reflector:p!=null&&p.entity?{entity:String(p.entity),name:p.name||M.reflector.name,subtitle:p.subtitle||M.reflector.subtitle,icon:p.icon||M.reflector.icon}:null,scenes:d(e.scenes,M.scenes,"scene"),sampleScenes:d(e.sample_scenes||e.sampleScenes,M.sampleScenes,"sample")}}_allDevices(){const e=this._config();return[...e.spots,...e.samples,...e.reflector?[e.reflector]:[]]}_allScenes(e=this._config()){return[...e.scenes,...e.sampleScenes]}_trackedEntities(){const e=this._config();return new Set([...this._allDevices().map(t=>t.entity),...e.sceneControlEntities,...this._allScenes(e).flatMap(t=>[t.entity,...t.onEntities,...t.offEntities]),e.weather,e.mediaPlayer,e.lightCountSensor,e.energySensor,e.batteryLevel,e.powerOnScript,e.powerOffScript].filter(Boolean))}_relevantHassChanged(e,t){var i,a;if(!e||!t)return!0;for(const r of this._trackedEntities())if(((i=e.states)==null?void 0:i[r])!==((a=t.states)==null?void 0:a[r]))return!0;return!1}async _start(){this._clockTimer=setInterval(()=>this._updateClock(),3e4),await Promise.allSettled([this._fetchCurrentStates(),this._subscribeStateChanges(),this._subscribeWeather(),this._loadEnergyStatistics()])}_syncStatesFromHass(){var e;if((e=this._hass)!=null&&e.states)for(const t of this._trackedEntities()){const i=this._hass.states[t];i&&this._applyLiveState(t,i)}}_applyLiveState(e,t){if(!t){this._liveStates.delete(e);return}this._liveStates.set(e,t);const i=this._pendingSwitches.get(e);if(i&&t.state===i.desired){this._pendingSwitches.delete(e),this._switchErrors.delete(e);const a=this._switchTimers.get(e);a&&clearTimeout(a),this._switchTimers.delete(e)}}async _fetchCurrentStates(){var e;if((e=this._hass)!=null&&e.callWS)try{const t=await this._hass.callWS({type:"get_states"}),i=this._trackedEntities();for(const a of t||[])i.has(a.entity_id)&&this._applyLiveState(a.entity_id,a);this._updateStatePresentation()}catch(t){console.error("No se pudieron sincronizar los estados del showroom:",t)}}async _subscribeStateChanges(){var e;if(!(!((e=this._hass)!=null&&e.connection)||this._unsubscribeStates))try{this._unsubscribeStates=await this._hass.connection.subscribeEvents(t=>{var a;const i=(a=t==null?void 0:t.data)==null?void 0:a.entity_id;!i||!this._trackedEntities().has(i)||(this._applyLiveState(i,t.data.new_state),i===this._config().energySensor&&this._scheduleEnergyRefresh(),this._updateStatePresentation())},"state_changed")}catch(t){console.error("No se pudo suscribir a state_changed:",t)}}_resetForecastSubscription(){this._unsubscribeForecast&&(this._unsubscribeForecast(),this._unsubscribeForecast=null),this._forecastEntity=""}async _subscribeWeather(){var t;const e=this._config();if(!(!((t=this._hass)!=null&&t.connection)||!e.weather)&&!(this._unsubscribeForecast&&this._forecastEntity===e.weather)){this._resetForecastSubscription();try{this._forecastEntity=e.weather,this._unsubscribeForecast=await this._hass.connection.subscribeMessage(i=>{this._forecast=Array.isArray(i==null?void 0:i.forecast)?i.forecast:[],this._requestRender()},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e.weather})}catch(i){this._forecastEntity="",console.error("No se pudo cargar el pronóstico:",i)}}}_energyRefreshInterval(){return this._energyRange==="day"?3e4:this._energyRange==="month"?12e4:3e5}_scheduleEnergyRefresh(e=!1){if(!this._hass||!this.isConnected||(clearTimeout(this._energyRefreshTimer),this._energyRange==="day"&&this._energyDayOffset!==0))return;const t=this._energyRefreshInterval(),i=this._energyLastLoadedAt?Date.now()-this._energyLastLoadedAt:0,a=e?0:this._energyLastLoadedAt?Math.max(1e3,t-i):t;this._energyRefreshTimer=setTimeout(()=>this._loadEnergyStatistics(),a)}_energyRangeDefinition(e=this._energyRange){const t=new Date;let i,a=t,r,s,o,n=!1;if(e==="year")i=new Date(t.getFullYear(),0,1,0,0,0,0),r="month",s=`Año ${t.getFullYear()}`,o="mes";else if(e==="month")i=new Date(t.getFullYear(),t.getMonth(),1,0,0,0,0),r="day",s=t.toLocaleDateString("es-BO",{month:"long",year:"numeric"}),o="día";else{const c=new Date(t.getFullYear(),t.getMonth(),t.getDate(),0,0,0,0);i=new Date(c.getFullYear(),c.getMonth(),c.getDate()+Math.min(0,Number(this._energyDayOffset)||0),0,0,0,0),n=i.getTime()===c.getTime(),a=n?t:new Date(i.getFullYear(),i.getMonth(),i.getDate()+1,0,0,0,0),r="hour",s=i.toLocaleDateString("es-BO",{weekday:"long",day:"numeric",month:"long"}),o="hora"}return{start:i,end:a,period:r,title:s,intervalLabel:o,isToday:n}}_energyValueToKWh(e,t){const i=Number(e);if(!Number.isFinite(i))return null;const a=String(t||"kWh").trim().toLowerCase().replaceAll(" ","");return a==="kwh"?i:a==="wh"?i/1e3:a==="mwh"?i*1e3:null}_deriveEnergyStateDeltas(e,t,i){const a=Number(t instanceof Date?t.getTime():t),r=Number(i instanceof Date?i.getTime():i),s=e.filter(c=>Number.isFinite(Number(c.start))&&Number.isFinite(Number(c.state))).sort((c,d)=>Number(c.start)-Number(d.start)),o=[];let n=null;for(const c of s){const d=Number(c.start),p=Number(c.state);if(d<a){n=p;continue}if(d>=r)break;let h=0;if(Number.isFinite(n)){const g=p-n;h=g>=0?g:Math.max(0,p)}o.push({...c,change:h}),n=p}return o}_aggregateEnergyDayRows(e,t,i){var c;const a=new Date(t.start),r=new Date(t.end),s=t.isToday?new Date(r.getFullYear(),r.getMonth(),r.getDate(),r.getHours(),0,0,0):new Date(a.getFullYear(),a.getMonth(),a.getDate(),23,0,0,0),o=new Map;for(let d=new Date(a);d<=s;d.setHours(d.getHours()+1)){const p=d.getTime();o.set(p,{start:p,end:new Date(d.getFullYear(),d.getMonth(),d.getDate(),d.getHours()+1,0,0,0).getTime(),change:0,samples:0,partial:t.isToday&&p===s.getTime(),live:!1})}let n=null;for(const d of e){const p=new Date(Number(d.start));if(!Number.isFinite(p.getTime()))continue;const h=new Date(p.getFullYear(),p.getMonth(),p.getDate(),p.getHours(),0,0,0).getTime(),g=o.get(h);g&&(g.change+=Math.max(0,Number(d.change)||0),g.samples+=1,Number.isFinite(d.state)&&(!n||Number(d.end||d.start)>Number(n.end||n.start))&&(n=d))}if(t.isToday){const d=this._energyValueToKWh(i==null?void 0:i.state,(c=i==null?void 0:i.attributes)==null?void 0:c.unit_of_measurement),p=n==null?void 0:n.state,h=Number((n==null?void 0:n.end)||(n==null?void 0:n.start)),g=o.get(s.getTime());if(g&&Number.isFinite(d)&&Number.isFinite(p)&&Number.isFinite(h)&&h>=s.getTime()&&r.getTime()-h>=0&&r.getTime()-h<=900*1e3){const u=d-p;Number.isFinite(u)&&u>=0&&(g.change+=u,g.live=u>0)}}return[...o.values()].filter(d=>d.samples>0||d.live)}_calculateCurrentMonthEnergy(e,t,i){var h;const a=new Date(t),r=new Date(a.getFullYear(),a.getMonth(),1,0,0,0,0).getTime(),s=e.filter(g=>Number.isFinite(Number(g.start))&&Number(g.start)>=r).sort((g,u)=>Number(g.start)-Number(u.start));let o=s.reduce((g,u)=>g+Math.max(0,Number(u.change)||0),0),n=null;for(const g of s)Number.isFinite(Number(g.state))&&(!n||Number(g.end||g.start)>Number(n.end||n.start))&&(n=g);const c=this._energyValueToKWh(i==null?void 0:i.state,(h=i==null?void 0:i.attributes)==null?void 0:h.unit_of_measurement),d=Number(n==null?void 0:n.state),p=Number((n==null?void 0:n.end)||(n==null?void 0:n.start));if(Number.isFinite(c)&&Number.isFinite(d)&&Number.isFinite(p)&&p>=r&&p<=a.getTime()&&a.getTime()-p<=7200*1e3){const g=c-d;Number.isFinite(g)&&g>=0&&(o+=g)}return s.length||Number.isFinite(d)?o:null}_aggregateEnergyCalendarRows(e,t,i,a){var p;if(!["month","year"].includes(a))return[];const r=new Map;let s=null;for(const h of e){const g=Number(h.start);if(!Number.isFinite(g))continue;const u=new Date(g),m=a==="month"?new Date(u.getFullYear(),u.getMonth(),u.getDate(),0,0,0,0).getTime():new Date(u.getFullYear(),u.getMonth(),1,0,0,0,0).getTime(),_=r.get(m)||{start:m,change:0,samples:0,partial:!1,live:!1};_.change+=Math.max(0,Number(h.change)||0),_.samples+=1,r.set(m,_),Number.isFinite(Number(h.state))&&(!s||g>Number(s.start))&&(s=h)}const o=this._energyValueToKWh(i==null?void 0:i.state,(p=i==null?void 0:i.attributes)==null?void 0:p.unit_of_measurement),n=Number(s==null?void 0:s.state),c=Number(s==null?void 0:s.start),d=new Date(t.end);if(Number.isFinite(o)&&Number.isFinite(n)&&Number.isFinite(c)&&c<=d.getTime()&&d.getTime()-c<=7200*1e3){const h=o-n;if(Number.isFinite(h)&&h>=0){const g=a==="month"?new Date(d.getFullYear(),d.getMonth(),d.getDate(),0,0,0,0).getTime():new Date(d.getFullYear(),d.getMonth(),1,0,0,0,0).getTime(),u=r.get(g)||{start:g,change:0,samples:0,partial:!1,live:!1};u.change+=h,u.live=h>0,r.set(g,u)}}return[...r.values()].sort((h,g)=>Number(h.start)-Number(g.start))}_energyViewSignature(){return JSON.stringify([this._energyRange,this._energyDayOffset,this._energyMonthTotal,this._energyError||"",this._energyData.map(e=>[Number(e.start),Number(e.change)||0,Number(e.samples)||0,!!e.partial,!!e.live])])}async _loadEnergyStatistics(){var g;if(!((g=this._hass)!=null&&g.connection))return;clearTimeout(this._energyRefreshTimer);const e=this._config(),t=this._state(e.energySensor),i=Number(t==null?void 0:t.state);if(!t){this._energyData=[],this._energyMonthTotal=null,this._energyError=`No existe ${e.energySensor} en Home Assistant.`,this._energyLoading=!1,this._requestRender();return}if(!Number.isFinite(i)){this._energyData=[],this._energyMonthTotal=null,this._energyError=`${e.energySensor} no entrega un valor numérico.`,this._energyLoading=!1,this._requestRender();return}const a=++this._energyRequestId,r=this._energyViewSignature(),s=this._energyData.length>0,o=this._energyRangeDefinition(),n=new Date,c=new Date(n.getFullYear(),n.getMonth(),1,0,0,0,0),d=new Date(o.start.getTime()-3600*1e3),p=this._energyRange==="year"?"hour":"5minute",h=new Date(c.getTime()-3600*1e3);this._energyLoading=!0,this._energyError=null,s||this._requestRender();try{const u=await this._hass.connection.sendMessagePromise({type:"recorder/get_statistics_metadata",statistic_ids:[e.energySensor]});if(a!==this._energyRequestId)return;const _=(Array.isArray(u)?u:[]).find(T=>(T==null?void 0:T.statistic_id)===e.energySensor)||null;if(!_||!_.has_sum)throw new Error("La entidad no dispone de estadísticas acumulables. Verifica device_class: energy y state_class total/total_increasing.");const k=this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:d.toISOString(),end_time:o.end.toISOString(),statistic_ids:[e.energySensor],period:p,units:{energy:"kWh"},types:["state"]}),E=this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:h.toISOString(),end_time:n.toISOString(),statistic_ids:[e.energySensor],period:"hour",units:{energy:"kWh"},types:["state"]}),[b,v]=await Promise.all([k,E]);if(a!==this._energyRequestId)return;const S=T=>(Array.isArray(T==null?void 0:T[e.energySensor])?T[e.energySensor]:[]).map(A=>({start:Number(A.start),end:Number(A.end),change:A.change===void 0||A.change===null?null:Math.max(0,Number(A.change)||0),state:A.state===void 0||A.state===null?null:Number(A.state)})).filter(A=>Number.isFinite(A.start)&&(Number.isFinite(A.state)||Number.isFinite(A.change))),C=S(b),x=this._deriveEnergyStateDeltas(C,o.start,o.end);this._energyData=this._energyRange==="day"?this._aggregateEnergyDayRows(x,o,t):this._aggregateEnergyCalendarRows(x,o,t,this._energyRange);const z=S(v),N=this._deriveEnergyStateDeltas(z,c,n);if(this._energyMonthTotal=this._calculateCurrentMonthEnergy(N,n,t),this._energyRange==="month"&&this._energyData.length)this._energyMonthTotal=this._energyData.reduce((T,A)=>T+Math.max(0,Number(A.change)||0),0);else if(this._energyRange==="year"&&Number.isFinite(this._energyMonthTotal)){const T=new Date(n.getFullYear(),n.getMonth(),1,0,0,0,0).getTime(),A=this._energyData.find(re=>Number(re.start)===T);A&&(A.change=this._energyMonthTotal)}this._energyLastLoadedAt=Date.now(),this._energyError=null}catch(u){if(a!==this._energyRequestId)return;this._energyData=[],this._energyMonthTotal=null,this._energyError=(u==null?void 0:u.message)||"No se pudieron consultar las estadísticas energéticas.",console.error("Error cargando estadísticas de energía del showroom:",u)}finally{if(a===this._energyRequestId){this._energyLoading=!1;const u=r!==this._energyViewSignature();!s||u&&this._activeView==="energy"?this._requestRender():this._updateStatePresentation(),this._scheduleEnergyRefresh()}}}_setEnergyRange(e){!["day","month","year"].includes(e)||e===this._energyRange||(this._energyRange=e,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_shiftEnergyDay(e){if(this._energyRange!=="day")return;const t=Number(e);if(!Number.isFinite(t)||t===0)return;const i=Math.min(0,this._energyDayOffset+t);i!==this._energyDayOffset&&(this._energyDayOffset=i,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_resetEnergyDay(){this._energyRange!=="day"||this._energyDayOffset===0||(this._energyDayOffset=0,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_formatEnergy(e,t=2){const i=Number(e);return Number.isFinite(i)?i.toLocaleString("es-BO",{minimumFractionDigits:t,maximumFractionDigits:t}):"--"}_energyLabel(e,t=this._energyRange){const i=new Date(Number(e));return Number.isFinite(i.getTime())?t==="year"?i.toLocaleDateString("es-BO",{month:"short"}).replace(".",""):t==="month"?String(i.getDate()):i.toLocaleTimeString("es-BO",{hour:"2-digit",minute:"2-digit",hour12:!1}):"--"}_captureEnergyChartScroll(){var i;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("[data-energy-scroll]");if(!e)return;const t=Math.max(0,e.scrollWidth-e.clientWidth);this._energyScrollLeft=e.scrollLeft,this._energyAutoFollow=t<=0||t-e.scrollLeft<=8}_handleEnergyScroll(e){var a,r;const t=(r=(a=e.target)==null?void 0:a.closest)==null?void 0:r.call(a,"[data-energy-scroll]");if(!t)return;const i=Math.max(0,t.scrollWidth-t.clientWidth);this._energyScrollLeft=t.scrollLeft,this._energyAutoFollow=i<=0||i-t.scrollLeft<=8}_restoreEnergyChartScroll(){var i;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("[data-energy-scroll]");if(!e)return;const t=Math.max(0,e.scrollWidth-e.clientWidth);if(this._energyAutoFollow||this._energyScrollLeft===null){e.scrollLeft=t,this._energyScrollLeft=e.scrollLeft;return}e.scrollLeft=Math.max(0,Math.min(this._energyScrollLeft,t))}_energyChart(){const e=this._energyData;if(this._energyLoading&&!e.length)return'<div class="energy-empty"><span class="energy-spinner"></span>Consultando estadísticas de Home Assistant…</div>';if(this._energyError)return`<div class="energy-empty error">${this._icon("status")}<span>${this._escape(this._energyError)}</span></div>`;if(!e.length)return'<div class="energy-empty">No hay estadísticas de consumo disponibles para este período.</div>';const t=280,i=14,a=16,r=22,s=42,o=this._energyRange==="day"?64:this._energyRange==="month"?36:58,n=Math.max(620,e.length*o+i+a),c=t-r-s,d=n-i-a,p=Math.max(...e.map(b=>b.change),.001),h=this._energyRange==="day"?10:e.length>24?4:7,g=Math.max(6,(d-h*Math.max(0,e.length-1))/e.length),u=this._energyRange==="month"?Math.max(1,Math.ceil(e.length/10)):this._energyRange==="day"?2:1,m=[0,.25,.5,.75,1],_=m.map(b=>{const v=r+c*(1-b);return`<line x1="${i}" y1="${v.toFixed(1)}" x2="${n-a}" y2="${v.toFixed(1)}" class="energy-grid-line"/>`}).join(""),k=m.map(b=>{const v=r+c*(1-b),S=this._formatEnergy(p*b,p<1?2:1);return`<span class="energy-y-tick" style="top:${v.toFixed(1)}px">${this._escape(S)}</span>`}).join(""),E=e.map((b,v)=>{const S=i+v*(g+h),C=b.change>0?Math.max(2,b.change/p*c):1,x=r+c-C,z=v%u===0||v===e.length-1,N=this._energyLabel(b.start),T=b.partial?" · en curso":"",A=b.partial?`<text x="${(S+g/2).toFixed(1)}" y="${(r+10).toFixed(1)}" text-anchor="middle" class="energy-current-label">ahora</text>`:"";return`<g class="energy-bar-group ${b.partial?"is-current":""}"><rect x="${S.toFixed(1)}" y="${x.toFixed(1)}" width="${g.toFixed(1)}" height="${C.toFixed(1)}" rx="${Math.min(4,g/2).toFixed(1)}" class="energy-bar ${b.partial?"is-partial":""}"><title>${this._escape(N)} · ${this._formatEnergy(b.change)} kWh${T}</title></rect>${A}${z?`<text x="${(S+g/2).toFixed(1)}" y="${t-14}" text-anchor="middle" class="energy-axis-text">${this._escape(N)}</text>`:""}</g>`}).join("");return`<div class="energy-chart-layout"><div class="energy-y-axis" aria-hidden="true"><span class="energy-y-unit">kWh</span>${k}</div><div class="energy-chart-wrap" data-energy-scroll><svg class="energy-chart" width="${n}" height="${t}" viewBox="0 0 ${n} ${t}" role="img" aria-label="Gráfica de consumo energético estimado en kWh">${_}${E}</svg></div></div>`}async _loadHistory(){var o;const e=this._config();if(!((o=this._hass)!=null&&o.callApi))return;const t=Math.max(e.historyHours,e.chartHours),i=new Date(Date.now()-t*60*60*1e3).toISOString(),a=new Date().toISOString(),r=[e.lightCountSensor,...e.spots.map(n=>n.entity),...e.samples.map(n=>n.entity)].filter(Boolean).join(",");if(!r)return;const s=`history/period/${encodeURIComponent(i)}?filter_entity_id=${encodeURIComponent(r)}&end_time=${encodeURIComponent(a)}&minimal_response&no_attributes`;try{this._history=await this._hass.callApi("GET",s),this._historyError=""}catch(n){this._history=[],this._historyError="No se pudo cargar el historial.",console.error("No se pudo cargar el historial del showroom:",n)}this._requestRender()}_state(e){var t,i;return this._liveStates.get(e)||((i=(t=this._hass)==null?void 0:t.states)==null?void 0:i[e])}_isUnavailable(e){var i;const t=(i=this._state(e))==null?void 0:i.state;return!t||t==="unknown"||t==="unavailable"}_visibleSwitchState(e){var t,i;return((t=this._pendingSwitches.get(e))==null?void 0:t.desired)||((i=this._state(e))==null?void 0:i.state)||"unavailable"}async _toggleSwitch(e){if(!e||!this._hass)return;const t=this._state(e);if(!t||["unknown","unavailable"].includes(t.state)){this._switchErrors.set(e,"No disponible"),this._updateStatePresentation();return}const a=this._visibleSwitchState(e)==="on"?"off":"on",r=a==="on"?"turn_on":"turn_off",s=e.split(".")[0]||"switch";this._pendingSwitches.set(e,{desired:a,startedAt:Date.now()}),this._switchErrors.delete(e),this._updateStatePresentation();try{await this._hass.callService(s,r,{entity_id:e});const o=this._switchTimers.get(e);o&&clearTimeout(o);const n=setTimeout(()=>this._verifySwitchState(e,a),6e3);this._switchTimers.set(e,n)}catch(o){this._pendingSwitches.delete(e),this._switchErrors.set(e,"La acción falló"),this._updateStatePresentation(),console.error(`Error ejecutando ${r} en ${e}:`,o)}}async _verifySwitchState(e,t){var a;await this._fetchCurrentStates();const i=((a=this._state(e))==null?void 0:a.state)===t;this._pendingSwitches.delete(e),this._switchTimers.delete(e),i?this._switchErrors.delete(e):this._switchErrors.set(e,"Sin confirmación"),this._updateStatePresentation()}_sceneStatus(e){const t=[...e.onEntities.map(r=>({entityId:r,desired:"on"})),...e.offEntities.map(r=>({entityId:r,desired:"off"}))];if(!t.length)return{active:!1,unavailable:!1,mismatches:[]};const i=t.some(({entityId:r})=>this._isUnavailable(r)),a=t.filter(({entityId:r,desired:s})=>{var o;return((o=this._state(r))==null?void 0:o.state)!==s});return{active:!i&&a.length===0,unavailable:i,mismatches:a}}_sceneExpectations(e){return[...e.offEntities.map(t=>({entityId:t,desired:"off"})),...e.onEntities.map(t=>({entityId:t,desired:"on"}))]}_markExpectedStates(e){const t=Date.now();for(const{entityId:i,desired:a}of e)this._pendingSwitches.set(i,{desired:a,startedAt:t}),this._switchErrors.delete(i)}_clearExpectedStates(e){for(const{entityId:t}of e){this._pendingSwitches.delete(t);const i=this._switchTimers.get(t);i&&clearTimeout(i),this._switchTimers.delete(t)}}async _setEntitiesState(e,t){const i=[...new Set((e||[]).filter(Boolean))];if(!i.length)return;const a=new Map;for(const s of i){const o=s.split(".")[0];o&&(a.has(o)||a.set(o,[]),a.get(o).push(s))}const r=t==="on"?"turn_on":"turn_off";for(const[s,o]of a)await this._hass.callService(s,r,{entity_id:o})}async _waitForExpectedStates(e,t=7e3){const i=Date.now()+t;let a=e;for(;Date.now()<i;){if(await this._fetchCurrentStates(),a=e.filter(({entityId:r,desired:s})=>{var o;return((o=this._state(r))==null?void 0:o.state)!==s}),!a.length)return{ok:!0,mismatches:[]};await new Promise(r=>setTimeout(r,450))}return{ok:!1,mismatches:a}}async _runScene(e,t){var o;if(!e||this._pendingAction)return;const i=this._config(),a=this._allScenes(i).find(n=>n.key===e||n.entity===e);if(!a){this._notify("La escena no está configurada.","error");return}const r=this._sceneExpectations(a);this._pendingAction=a.key,this._markExpectedStates(r),this._updateStatePresentation();let s=null;try{if(a.entity&&!a.directOnly)try{await this._hass.callService("scene","turn_on",{entity_id:a.entity})}catch(d){s=d,console.warn(`La escena ${a.entity} no respondió; se aplicará el perfil directo.`,d)}await this._setEntitiesState(a.offEntities,"off"),await this._setEntitiesState(a.onEntities,"on");const n=await this._waitForExpectedStates(r);if(!n.ok){const d=n.mismatches.map(p=>p.entityId).join(", ");throw new Error(`No se confirmaron los estados de: ${d}`)}const c=s?`${t||"Modo"} aplicado mediante control directo.`:`${t||"Modo"} activo.`;this._notify(c,"success")}catch(n){for(const{entityId:c,desired:d}of r)((o=this._state(c))==null?void 0:o.state)!==d&&this._switchErrors.set(c,"No confirmó el modo");this._notify("No se pudo aplicar completamente el modo seleccionado.","error"),console.error("Error aplicando modo del showroom:",n)}finally{this._clearExpectedStates(r),this._pendingAction="",await this._fetchCurrentStates(),this._updateStatePresentation()}}async _executeGeneralPower(e,t={}){var c;if(!this._hass||this._pendingAction||!["on","off"].includes(e))return!1;const i=this._config(),a=e==="on"?i.powerOnScript:i.powerOffScript,r=i.sceneControlEntities.map(d=>({entityId:d,desired:e})),s=t.successMessage||(e==="on"?"Iluminación general encendida.":"Iluminación general apagada."),o=t.errorMessage||(e==="on"?"No se pudo encender toda la iluminación.":"No se pudo apagar toda la iluminación.");this._pendingAction=a||`direct-power-${e}`,this._markExpectedStates(r),this._updateStatePresentation();let n=null;try{if(a)try{await this._hass.callService("script","turn_on",{entity_id:a})}catch(p){n=p,console.warn(`El script ${a} no respondió; se aplicará el control directo.`,p)}await this._setEntitiesState(i.sceneControlEntities,e);const d=await this._waitForExpectedStates(r);if(!d.ok){const p=d.mismatches.map(h=>h.entityId).join(", ");throw new Error(`No se confirmaron los estados de: ${p}`)}return this._confirmAction="",this._notify(s,"success"),!0}catch(d){for(const{entityId:p,desired:h}of r)((c=this._state(p))==null?void 0:c.state)!==h&&this._switchErrors.set(p,"Sin confirmación");return this._notify(o,"error"),console.error("Error ejecutando el control general del showroom:",{error:d,scriptError:n,desired:e}),!1}finally{this._clearExpectedStates(r),this._pendingAction="",await this._fetchCurrentStates(),this._updateStatePresentation()}}async _confirmGeneralPower(){const e=this._confirmAction;["on","off"].includes(e)&&await this._executeGeneralPower(e,{successMessage:e==="on"?"Toda la iluminación del showroom está encendida.":"Toda la iluminación del showroom está apagada."})}async _clearScene(){this._pendingAction||await this._executeGeneralPower("off",{successMessage:"Escena apagada. La iluminación del showroom quedó apagada.",errorMessage:"No se pudo apagar completamente la escena."})}async _mediaAction(e){const t=this._config().mediaPlayer;if(!(!t||!e||this._isUnavailable(t)))try{await this._hass.callService("media_player",e,{entity_id:t})}catch(i){this._notify("No se pudo controlar el reproductor.","error"),console.error(`Error ejecutando media_player.${e}:`,i)}}_updateToastPresentation(){if(!this.shadowRoot)return;const e=this.shadowRoot.querySelector("[data-toast]");if(!this._toast){e==null||e.remove();return}if(e){e.className=`toast ${this._escape(this._toast.type)}`,e.textContent=this._toast.message;return}const t=document.createElement("div");t.dataset.toast="",t.className=`toast ${this._escape(this._toast.type)}`,t.setAttribute("role","status"),t.textContent=this._toast.message,this.shadowRoot.append(t)}_notify(e,t="success"){var i;clearTimeout(this._toastTimer),this._toast={message:e,type:t},(i=this.shadowRoot)!=null&&i.querySelector(".app-shell")?this._updateToastPresentation():this._requestRender(),this._toastTimer=setTimeout(()=>{this._toast=null,this._updateToastPresentation()},4200)}_historyMap(){var t;const e=new Map;for(const i of this._history||[]){const a=(t=i==null?void 0:i[0])==null?void 0:t.entity_id;a&&e.set(a,i)}return e}_historySegments(e,t,i){if(!Array.isArray(e)||!e.length)return[];const a=e.map(s=>({state:s.state,time:new Date(s.last_changed||s.last_updated).getTime()})).filter(s=>Number.isFinite(s.time)).sort((s,o)=>s.time-o.time);if(!a.length)return[];const r=[];for(let s=0;s<a.length;s+=1){const o=a[s],n=a[s+1],c=Math.max(t,o.time),d=Math.min(i,(n==null?void 0:n.time)??i);d<=c||r.push({state:o.state,left:(c-t)/(i-t)*100,width:(d-c)/(i-t)*100})}return r}_sparkline(e,t){var u;const i=this._historyMap().get(e)||[],a=Date.now(),r=a-t*60*60*1e3,s=i.map(m=>({value:Number(m.state),time:new Date(m.last_changed||m.last_updated).getTime()})).filter(m=>Number.isFinite(m.value)&&Number.isFinite(m.time)&&m.time>=r).sort((m,_)=>m.time-_.time),o=Number((u=this._state(e))==null?void 0:u.state);if(Number.isFinite(o)&&s.push({value:o,time:a}),!s.length)return{path:"",min:"--",max:"--",avg:"--"};const n=s.map(m=>m.value),c=Math.min(...n),d=Math.max(...n),p=n.reduce((m,_)=>m+_,0)/n.length,h=d-c||1;return{path:s.map((m,_)=>{const k=(m.time-r)/(a-r)*300,E=66-(m.value-c)/h*52;return`${_?"L":"M"}${Math.max(0,Math.min(300,k)).toFixed(1)},${E.toFixed(1)}`}).join(" "),min:this._formatNumber(c),max:this._formatNumber(d),avg:this._formatNumber(p)}}_formatNumber(e){return Number.isFinite(e)?new Intl.NumberFormat("es-BO",{maximumFractionDigits:1}).format(e):"--"}_updateClock(){var o,n,c;if(!this.shadowRoot)return;const e=new Date,t=new Intl.DateTimeFormat("es-BO",{hour:"numeric",minute:"2-digit",hour12:!0}).formatToParts(e),i=((o=t.find(d=>d.type==="hour"))==null?void 0:o.value)||"--",a=((n=t.find(d=>d.type==="minute"))==null?void 0:n.value)||"--",r=(((c=t.find(d=>d.type==="dayPeriod"))==null?void 0:c.value)||"").replaceAll(".","").replaceAll(" ","").toUpperCase();for(const d of this.shadowRoot.querySelectorAll("[data-clock-time]"))d.textContent=`${i}:${a}`;for(const d of this.shadowRoot.querySelectorAll("[data-clock-period]"))d.textContent=r||"";const s=this.shadowRoot.querySelector("[data-current-time]");s&&(s.dateTime=e.toISOString(),s.setAttribute("aria-label",`${i}:${a} ${r}`.trim()))}_icon(e,t=""){const i=Ie[e]||Ie.bulb;return`<svg class="icon ${this._escape(t)}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${i}</svg>`}_escape(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}_renderDevice(e){const t=this._state(e.entity),i=this._visibleSwitchState(e.entity),a=i==="on",r=!t||["unknown","unavailable"].includes(t.state),s=this._pendingSwitches.has(e.entity),o=this._switchErrors.get(e.entity),n=o||(s?i==="on"?"Encendiendo…":"Apagando…":r?"No disponible":a?"Encendido":"Apagado");return`
    ...
    `}_renderWeather(){const e=this._config(),t=this._state(e.weather);if(!t)return`
      ...
      <section class="surface weather-card">
        <div class="weather-main">
          <div class="weather-symbol">${this._escape(he[a]||"·")}</div>
          <div class="weather-copy">
            <span class="eyebrow">Clima · Casa</span>
            <h2>${this._escape(Le[a]||a)}</h2>
          ...
          <div class="forecast-row">
            ${r.length?r.map(s=>{const o=new Date(s.datetime),n=new Intl.DateTimeFormat("es-BO",{weekday:"short"}).format(o);return`
                <div class="forecast-item">
                  ...
                  <b>${this._escape(he[s.condition]||"·")}</b>
    ...
    `}_renderSceneBlock({eyebrow:e,title:t,scenes:i,className:a}){const r=this._config(),s=i.find(d=>this._sceneStatus(d).active),o=this._pendingAction===r.powerOffScript,n=r.sceneControlEntities.some(d=>{var p;return((p=this._state(d))==null?void 0:p.state)==="on"}),c=!!this._pendingAction||!n;return`
      ...
      <div class="app-shell">
        <header class="topbar">
          ...
          <div class="topbar-meta">
            ...
            <div class="header-weather" aria-label="Clima actual: ${this._escape(Le[r]||r||"Sin datos")}, ${this._escape(a.temperature??"Sin datos")}${this._escape(a.temperature_unit??"°")}">
              <span aria-hidden="true">${this._escape(he[r]||"·")}</span>
              <strong>${this._escape(a.temperature??"--")}${this._escape(a.temperature_unit??"°")}</strong>
            </div>
            <button class="theme-button" data-action="toggle-theme" aria-label="Cambiar a tema ${s}" title="Cambiar a tema ${s}">${Et}</button>
          </div>
        </header>
    ...
    `,this._updateClock(),requestAnimationFrame(()=>this._restoreEnergyChartScroll())}}customElements.get("showroom-panel")||customElements.define("showroom-panel",Mt);const At={"clear-night":"Noche despejada",cloudy:"Nublado",exceptional:"Condición excepcional",fog:"Niebla",hail:"Granizo",lightning:"Tormenta eléctrica","lightning-rainy":"Tormenta y lluvia",partlycloudy:"Parcialmente nublado",pouring:"Lluvia intensa",rainy:"Lluvia",snowy:"Nieve","snowy-rainy":"Aguanieve",sunny:"Soleado",windy:"Ventoso","windy-variant":"Viento y nubes"},Tt={"clear-night":"☾",cloudy:"☁",exceptional:"!",fog:"≋",hail:"◆",lightning:"ϟ","lightning-rainy":"ϟ",partlycloudy:"◒",pouring:"☂",rainy:"☂",snowy:"❄","snowy-rainy":"❄",sunny:"☀",windy:"≈","windy-variant":"≈"},Ct='<svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><line x1="3" x2="21" y1="6" y2="6"></line><line x1="3" x2="21" y1="12" y2="12"></line><line x1="3" x2="21" y1="18" y2="18"></line></svg>',zt='<svg class="theme-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><g class="theme-icon-sun"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"></path></g><path class="theme-icon-moon" d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"></path></svg>',Re={bulb:'<path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5M9 18h6M10 22h4"/>',panel:'<rect width="18" height="18" x="3" y="3" rx="3"/><path d="M3 9h18M3 15h18M9 3v18M15 3v18"/>',corridor:'<path d="M4 3h16v18H4V3Zm2 2v14h5V5H6Zm7 0v14h5V5h-5Z"/>',workshop:'<path d="M3 7l9-5 9 5v14H3V7Zm2 1.2V19h4v-6h6v6h4V8.2l-7-3.9-7 3.9Z"/>',power:'<path d="M12 2v10M18.4 6.6a9 9 0 1 1-12.8 0"/>',energy:'<path d="M13 2 5 13h6l-1 9 8-11h-6l1-9Z"/>',shield:'<path d="M12 3 20 6v5c0 5-3.4 8.3-8 10-4.6-1.7-8-5-8-10V6l8-3Z"/>',office:'<path d="M3 4h18v16H3V4Zm4 4h4v3H7V8Zm6 0h4v3h-4V8ZM7 13h4v3H7v-3Zm6 0h4v3h-4v-3Z"/>'},W=l=>`${new Intl.NumberFormat("es-BO",{maximumFractionDigits:0}).format(l)} W`;class Nt extends HTMLElement{constructor(){super(),this._hass=null,this._panel={},this._started=!1,this._renderQueued=!1,this._pending=new Map,this._errors=new Map,this._pendingAction="",this._confirmAction="",this._toast="",this._toastTimer=null,this._theme=this._loadTheme(),this.attachShadow({mode:"open"}),this.shadowRoot.addEventListener("click",e=>this._handleClick(e))}set hass(e){var t;this._hass=e,this._started||(this._started=!0),this.isConnected&&((t=this.shadowRoot)!=null&&t.querySelector(".operations-shell")?this._updatePresentation():this._render())}get hass(){return this._hass}set panel(e){this._panel=e&&typeof e=="object"?e:{},this.isConnected&&this._render()}get panel(){return this._panel}set theme(e){if(e==="dark"||e==="light"){const t=this._theme!==e;this._theme=e,this.setAttribute("data-theme",e),this._saveTheme(),t&&this.isConnected&&this._queueRender()}}get theme(){return this._theme}connectedCallback(){this.setAttribute("data-theme",this._theme),this._hass&&this._render()}disconnectedCallback(){this._toastTimer&&window.clearTimeout(this._toastTimer)}_kind(){return String(this._panel.panel_kind||this._panel.panelKind||"offices").toLowerCase()}_loadTheme(){try{return localStorage.getItem("witmind-showroom-panel-theme")==="light"?"light":"dark"}catch{return"dark"}}_saveTheme(){try{localStorage.setItem("witmind-showroom-panel-theme",this._theme)}catch{}}_toggleTheme(){this.theme=this._theme==="dark"?"light":"dark",this.dispatchEvent(new CustomEvent("witmind-theme-change",{detail:{theme:this._theme},bubbles:!0,composed:!0}))}_state(e){var t,i;return(i=(t=this._hass)==null?void 0:t.states)==null?void 0:i[e]}_isOn(e){var t;return((t=this._state(e))==null?void 0:t.state)==="on"||this._pending.get(e)==="on"}_unavailable(e){var i;const t=(i=this._state(e))==null?void 0:i.state;return!t||t==="unknown"||t==="unavailable"}_escape(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}_icon(e){return`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${Re[e]||Re.bulb}</svg>`}_devices(){const e=this._kind(),t=this._panel.power_watts||this._panel.powerWatts||this._panel.device_watts||{},i=a=>({...a,watts:a.watts??(Number(t[a.entity]||0)||void 0)});return e==="offices"?(this._panel.areas||[]).flatMap(a=>(a.devices||[]).map(i)):e==="recording"?(this._panel.switches||[]).map(i):(this._panel.zones||[]).flatMap(a=>(a.devices||(a.entities||[]).map(r=>({entity:r,name:r}))).map(i))}_powerTotal(e=this._devices()){return e.reduce((t,i)=>t+Number(i.watts||0),0)}_powerActive(e=this._devices()){return e.filter(t=>this._isOn(t.entity)).reduce((t,i)=>t+Number(i.watts||0),0)}_weather(){const e=this._state(this._panel.weather||"weather.forecast_casa");return{temperature:((e==null?void 0:e.attributes)||{}).temperature??"—",condition:At[String((e==null?void 0:e.state)||"")]||String((e==null?void 0:e.state)||"Sin datos")}}_queueRender(){this._renderQueued||(this._renderQueued=!0,requestAnimationFrame(()=>{this._renderQueued=!1,this._render()}))}_render(){var h;if(!this.shadowRoot)return;const e=this._weather(),t=this._devices(),i=this._kind(),a=this._panel.title||(i==="recording"?"Sala de grabación":i==="control"?"Control general":"Oficinas"),r=this._panel.subtitle||"Control operativo",s=t.filter(g=>this._isOn(g.entity)).length,o=this._powerActive(t),n=this._powerTotal(t),c=new Date,d=new Intl.DateTimeFormat("es-BO",{hour:"numeric",minute:"2-digit"}).format(c);this.setAttribute("data-kind",this._kind()),this.setAttribute("data-theme",this._theme),this.shadowRoot.innerHTML=`
      <style>
      ...
      <div class="operations-shell">
        <header class="topbar">
          <div class="topbar-start">
            <button class="menu-button" data-action="toggle-menu" aria-label="Abrir menú de navegación de Home Assistant" title="Abrir menú">${Ct}</button>
          ...
          <div class="status-strip" aria-label="Resumen de ${this._escape(a)}">
            ...
            <button class="status-pill ${o?"is-active":""}" type="button"><span class="status-pill-icon">${this._icon("power")}</span><span><strong data-active-power>${W(o)}</strong><small>Activos</small></span></button>
            <button class="status-pill" type="button"><span class="status-pill-icon">${this._icon("energy")}</span><span><strong data-installed-power>${W(n)}</strong><small>Instalados</small></span></button>
          </div>
          <div class="topbar-meta">
            <time class="header-clock"><strong>${this._escape(d)}</strong></time>
            <div class="header-weather" aria-label="Clima actual: ${this._escape(e.condition)}, ${this._escape(e.temperature)}°"><span aria-hidden="true">${this._escape(Tt[String(((h=this._state(this._panel.weather||"weather.forecast_casa"))==null?void 0:h.state)||"")]||"·")}</span><strong>${this._escape(e.temperature)}°</strong></div>
            <button class="theme-button" data-action="toggle-theme" aria-label="Cambiar tema" title="Cambiar tema">${zt}</button>
          </div>
        </header>
        <main class="dashboard">
          <section class="workspace-heading"><div><span class="section-kicker">${this._escape(r)}</span><h1>${this._escape(a)}</h1></div><span class="workspace-summary">${t.length} circuitos · ${W(n)}</span></section>
    ...
    `,this.shadowRoot.append(p)}_renderOffices(){const e=this._panel.areas||[];return`<section class="view-panel offices-view" aria-label="Zonas operativas"><div class="section-heading compact-heading offices-section-heading"><div><span class="section-kicker">Zonas operativas</span><h2>Distribución de circuitos</h2></div><span>${e.reduce((i,a)=>i+(a.devices||[]).length,0)} circuitos</span></div><div class="lighting-layout offices-layout">${e.map(i=>{var n,c;const a=i.devices||[],r=i.environment||{},s=r.temperature?(n=this._state(r.temperature))==null?void 0:n.state:"",o=r.humidity?(c=this._state(r.humidity))==null?void 0:c.state:"";return`<section class="surface control-section office-section"><div class="section-heading compact-heading"><div><span class="eyebrow">Zona</span><h2>${this._escape(i.name)}</h2></div><div class="area-meta">${s?`<span>${this._escape(s)} °C</span>`:""}${o?`<span>${this._escape(o)} % HR</span>`:""}</div></div>${i.subtitle||i.descriptor?`<p class="area-description">${this._escape(i.subtitle||i.descriptor)}</p>`:""}<div class="device-grid">${a.map(d=>this._renderDevice(d)).join("")}</div></section>`}).join("")}</div></section>`}_renderRecording(){const e=this._panel.switches||[];return`<section class="surface section"><div class="section-head"><div><span class="eyebrow">Cuatro circuitos</span><h3>Sala de grabación</h3></div><button class="action compact-action danger" data-action="run-action" data-action-id="recording-off"><span class="action-icon">${this._icon("power")}</span><span>Apagar todo</span></button></div><div class="grid">${e.map(t=>this._renderDevice(t)).join("")}</div><div class="section-head section-footnote"><small>Estimación instalada: ${W(this._powerTotal(e))}. El valor representa potencia nominal, no consumo medido.</small></div></section>`}_renderControl(){return`<section class="surface section"><div class="section-head"><div><span class="eyebrow">Escenas y rutinas</span><h3>Control general</h3></div><small>Acciones verificadas</small></div><div class="control-actions">${[...this._panel.main_actions||[],...this._panel.daily_actions||[],...this._panel.danger_action?[this._panel.danger_action]:[]].map(t=>`<button class="action ${t.tone==="danger"?"danger":""}" data-action="run-action" data-action-id="${this._escape(t.id)}" ${this._pendingAction&&this._pendingAction!==t.id?"disabled":""}><span class="action-icon ${t.tone==="danger"?"is-danger":""}">${this._icon(t.icon||(t.tone==="danger"?"power":"bulb"))}</span><span class="action-copy"><strong>${this._escape(t.name)}</strong><small>${this._escape(t.subtitle||"Rutina operativa")}</small></span><span class="action-state">${this._pendingAction===t.id?"Aplicando…":t.tone==="danger"?"Confirmar":"Lista"}</span></button>`).join("")}</div></section><section class="surface section"><div class="section-head"><div><span class="eyebrow">Resumen de zonas</span><h3>Estado actual</h3></div></div>${(this._panel.zones||[]).map(t=>{const i=t.entities||[],a=i.filter(r=>this._isOn(r)).length;return`<div class="area"><div class="area-head"><div><strong>${this._escape(t.name)}</strong><small>${a} de ${i.length} circuitos activos</small></div><span class="device-state">${a?"Activo":"Apagado"}</span></div></div>`}).join("")}</section>${this._confirmAction?`<div class="toast" role="alert"><strong>¿Confirmar ${this._escape(this._confirmAction)}?</strong><button class="action compact-action" data-action="confirm-action" data-action-id="${this._escape(this._confirmAction)}">Confirmar</button><button class="action compact-action" data-action="cancel-action">Cancelar</button></div>`:""}`}_renderDevice(e){const t=this._isOn(e.entity),i=this._unavailable(e.entity),a=this._pending.has(e.entity),r=this._errors.get(e.entity),s=r||(a?t?"Encendiendo…":"Apagando…":i?"No disponible":t?"Encendido":"Apagado");return`<button class="device ${t?"is-on":""} ${a?"is-pending":""} ${r?"is-error":""}" data-action="toggle-switch" data-entity="${this._escape(e.entity)}" aria-pressed="${String(t)}" aria-label="${this._escape(`${e.name}: ${s}`)}" ${i||a?"disabled":""}><span class="device-icon">${this._icon(e.icon||"bulb")}</span><span class="device-copy"><strong>${this._escape(e.name)}</strong><small><span data-device-status="${this._escape(e.entity)}">${this._escape(s)}</span>${e.watts?` · ${W(e.watts)}`:""}</small></span><span class="device-switch" aria-hidden="true"><i></i></span></button>`}_updatePresentation(){var a,r,s,o,n;(a=this.shadowRoot)==null||a.querySelectorAll("[data-action=toggle-switch]").forEach(c=>{const d=c.dataset.entity||"",p=this._isOn(d),h=this._unavailable(d),g=this._pending.has(d),u=this._errors.get(d);c.classList.toggle("is-on",p),c.classList.toggle("is-error",!!u),c.disabled=h||g,c.setAttribute("aria-pressed",String(p));const m=c.querySelector("[data-device-status]");m&&(m.textContent=u||(g?p?"Encendiendo…":"Apagando…":h?"No disponible":p?"Encendido":"Apagado"))});const e=this._devices(),t=(r=this.shadowRoot)==null?void 0:r.querySelector("[data-total-on]"),i=(s=this.shadowRoot)==null?void 0:s.querySelector("[data-active-power]");t&&(t.textContent=String(e.filter(c=>this._isOn(c.entity)).length)),i&&(i.textContent=W(this._powerActive(e))),(o=t==null?void 0:t.closest(".status-pill"))==null||o.classList.toggle("is-active",e.some(c=>this._isOn(c.entity))),(n=i==null?void 0:i.closest(".status-pill"))==null||n.classList.toggle("is-active",this._powerActive(e)>0)}_handleClick(e){const t=e.target.closest("[data-action]");if(!t||!this._hass)return;const i=t.dataset.action;if(i==="toggle-menu"){this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}));return}if(i==="toggle-theme"){this._toggleTheme();return}if(i==="toggle-switch"){this._toggleSwitch(t.dataset.entity||"");return}if(i==="run-action"){const a=t.dataset.actionId||"",r=this._findAction(a);(r==null?void 0:r.tone)==="danger"?this._confirmAction=a:this._executeAction(r),this._queueRender();return}if(i==="confirm-action"){const a=this._findAction(t.dataset.actionId||this._confirmAction);this._confirmAction="",this._executeAction(a),this._queueRender();return}i==="cancel-action"&&(this._confirmAction="",this._queueRender())}_findAction(e){const t=[...this._panel.main_actions||[],...this._panel.daily_actions||[],...this._panel.danger_action?[this._panel.danger_action]:[]];return e==="recording-off"?{id:e,name:"Apagar todo",subtitle:"Apaga los cuatro circuitos",tone:"danger",off_entities:(this._panel.switches||[]).map(i=>i.entity)}:t.find(i=>i.id===e)||null}async _toggleSwitch(e){var i;if(!e||this._pending.has(e)||!((i=this._hass)!=null&&i.callService))return;const t=this._isOn(e)?"off":"on";this._pending.set(e,t),this._errors.delete(e),this._updatePresentation();try{const[a]=e.split(".");if(await this._hass.callService(a,t==="on"?"turn_on":"turn_off",{entity_id:e}),!await this._waitForState(e,t))throw new Error("Home Assistant no confirmó el estado solicitado")}catch(a){this._errors.set(e,a instanceof Error?a.message:"No se pudo cambiar el circuito"),this._showToast(this._errors.get(e)||"No se pudo cambiar el circuito")}finally{this._pending.delete(e),this._updatePresentation()}}async _executeAction(e){var i;if(!e||this._pendingAction||!((i=this._hass)!=null&&i.callService))return;this._pendingAction=e.id,this._queueRender();const t=new Map;(e.on_entities||[]).forEach(a=>t.set(a,"on")),(e.off_entities||[]).forEach(a=>t.set(a,"off"));try{for(const r of e.service_entities||[]){const[s]=r.split(".");await this._hass.callService(s,"turn_on",{entity_id:r})}for(const[r,s]of t){const[o]=r.split(".");await this._hass.callService(o,s==="on"?"turn_on":"turn_off",{entity_id:r})}if((await Promise.all([...t].map(([r,s])=>this._waitForState(r,s)))).some(r=>!r))throw new Error("No todos los circuitos confirmaron el cambio");this._showToast(`${e.name} aplicado.`)}catch(a){this._showToast(a instanceof Error?a.message:"No se pudo ejecutar la acción")}finally{this._pendingAction="",this._queueRender()}}async _waitForState(e,t){var i;for(let a=0;a<20;a+=1){if(((i=this._state(e))==null?void 0:i.state)===t)return!0;await new Promise(r=>window.setTimeout(r,250))}return!1}_showToast(e){this._toast=e,this._toastTimer&&window.clearTimeout(this._toastTimer),this._toastTimer=window.setTimeout(()=>{this._toast="",this._queueRender()},4200),this._queueRender()}}customElements.get("witmind-operations-panel")||customElements.define("witmind-operations-panel",Nt);function dt(l,e){var t,i,a,r,s,o,n;if(!e)return"No hay una regla en edición.";if(l===1){const c=String(((t=e.source)==null?void 0:t.entity_id)||"").trim();return c?c.startsWith("sensor.")?"":"La entidad debe comenzar con sensor.*":"Selecciona un sensor de temperatura."}if(l===2){const c=e.condition,d=c.type;if(!["above","below","outside","inside"].includes(d))return"Tipo de condición no soportado.";const p=Number(c.hysteresis);if(!Number.isFinite(p)||p<0||p>50)return"La histéresis debe ser un número entre 0 y 50 °C.";const h=Number(c.for_seconds);if(!Number.isFinite(h)||h<0||h>86400)return"La duración debe estar entre 0 y 86 400 segundos (24 h).";if(["above","below"].includes(d)){const u=Number(c.threshold);if(!Number.isFinite(u))return"Introduce un umbral de temperatura válido."}else{const u=Number(c.lower),m=Number(c.upper);if(!Number.isFinite(u)||!Number.isFinite(m))return"Introduce límites numéricos válidos para el rango.";if(u>=m)return"El límite inferior debe ser estrictamente menor al superior.";if(d==="outside"&&p*2>=m-u)return"La histéresis es demasiado grande para ese rango (debe ser menor a la mitad del intervalo)."}const g=((i=e.behavior)==null?void 0:i.notification_mode)||"once";if(!["once","repeat","daily"].includes(g))return"Frecuencia de avisos no soportada.";if(g==="repeat"){const u=Number(((a=e.behavior)==null?void 0:a.reminder_interval_seconds)||0);if(!Number.isFinite(u)||u<60||u>604800)return"Para repetir avisos, indica un intervalo de al menos 1 minuto."}return""}if(l===3){const c=e.recipients||[];if(!c.length)return"Selecciona al menos un dispositivo destinatario.";if(c.length>25)return"Máximo 25 destinatarios por regla.";for(const d of c)if(!d.notify_entity_id&&!d.legacy_service)return`El dispositivo ${d.name||"seleccionado"} no tiene entidad ni acción notify válida.`;return""}if(l===4){const c=String(e.name||"").trim();if(!c)return"La regla necesita un nombre interno.";if(c.length>120)return"El nombre no puede superar los 120 caracteres.";if(String(((r=e.message)==null?void 0:r.title)||"").trim().length>240)return"El título no puede superar los 240 caracteres.";const p=String(((s=e.message)==null?void 0:s.body)||"").trim();return p?p.length>2e3?"El cuerpo del mensaje no puede superar los 2000 caracteres.":String(((o=e.message)==null?void 0:o.recovery_title)||"").trim().length>240?"El título de recuperación no puede superar los 240 caracteres.":String(((n=e.message)==null?void 0:n.recovery_body)||"").trim().length>2e3?"El cuerpo de recuperación no puede superar los 2000 caracteres.":"":"El mensaje de la notificación no puede quedar vacío."}return""}function Dt(l){for(let e=1;e<=4;e++){const t=dt(e,l);if(t)return{valid:!1,step:e,error:t}}return{valid:!0,step:0,error:""}}function Lt(l){var h,g;const e=String(l.name||"").trim(),t=l.condition,i=t.type,a=Math.max(0,Math.min(50,Number(t.hysteresis||0))),r=Math.max(0,Math.min(86400,Math.round(Number(t.for_seconds||0)))),s={type:i,hysteresis:a,for_seconds:r};["above","below"].includes(i)?s.threshold=Number(t.threshold):(s.lower=Number(t.lower),s.upper=Number(t.upper));const o=["once","repeat","daily"].includes(l.behavior.notification_mode)?l.behavior.notification_mode:"once";let n=0;o==="daily"?n=86400:o==="repeat"&&(n=Math.max(60,Math.min(604800,Math.round(Number(l.behavior.reminder_interval_seconds||1800)))));const c=(l.recipients||[]).map(u=>({target_id:u.target_id||void 0,identity_keys:Array.isArray(u.identity_keys)?[...u.identity_keys]:[],device_id:u.device_id||void 0,notify_entity_id:u.notify_entity_id||void 0,legacy_service:u.legacy_service||void 0,name:String(u.name||u.notify_entity_id||u.legacy_service||"Dispositivo"),custom_name:u.custom_name?String(u.custom_name).trim():null})),d=String(((h=l.message)==null?void 0:h.recovery_title)||"").trim(),p=String(((g=l.message)==null?void 0:g.recovery_body)||"").trim();return{name:e,enabled:!!l.enabled,source:{entity_id:l.source.entity_id,display_name:l.source.display_name||l.source.entity_id,area_name:l.source.area_name||null},condition:s,recipients:c,message:{title:String(l.message.title||e).trim(),body:String(l.message.body||"").trim(),recovery_title:d||null,recovery_body:p||null},behavior:{notification_mode:o,reminder_interval_seconds:n,notify_recovery:!!l.behavior.notify_recovery}}}function It(l){if(!l)return"—";const e=l,t=Math.round((Number(e.for_seconds)||0)/60),i=t?` · ${t} min`:"";return e.type==="above"?`≥ ${e.threshold??"—"} °C${i}`:e.type==="below"?`≤ ${e.threshold??"—"} °C${i}`:e.type==="outside"?`Fuera de ${e.lower??"—"}–${e.upper??"—"} °C${i}`:e.type==="inside"?`Dentro de ${e.lower??"—"}–${e.upper??"—"} °C${i}`:"—"}function Pe(l){var p,h,g,u,m;if(!l)return"";const e=l.condition,t=((p=l.source)==null?void 0:p.display_name)||((h=l.source)==null?void 0:h.entity_id)||"El sensor",i=Math.round(Number(e.for_seconds||0)/60),a=i?` durante ${i} minuto${i===1?"":"s"}`:"",r=Number(e.hysteresis||0),s=((g=l.behavior)==null?void 0:g.notification_mode)||"once";let o=" Enviará un solo aviso por incidencia.";if(s==="repeat"){const _=Math.max(1,Math.round(Number(((u=l.behavior)==null?void 0:u.reminder_interval_seconds)||1800)/60));o=` Mientras la incidencia siga activa, recordará cada ${_} minuto${_===1?"":"s"}.`}else s==="daily"&&(o=" Mientras la incidencia siga activa, enviará como máximo un recordatorio cada 24 horas.");const n=(m=l.behavior)!=null&&m.notify_recovery?" También avisará cuando la incidencia se considere resuelta.":"",c=" Después de resolverse, la regla queda lista automáticamente para detectar una incidencia nueva.";let d="";return e.type==="above"?d=`${t} activará la alerta al alcanzar o superar ${e.threshold} °C${a}. Con una histéresis de ${r} °C, se considera resuelta a ${Number(e.threshold)-r} °C o menos.`:e.type==="below"?d=`${t} activará la alerta al alcanzar o bajar de ${e.threshold} °C${a}. Con una histéresis de ${r} °C, se considera resuelta a ${Number(e.threshold)+r} °C o más.`:e.type==="outside"?d=`${t} activará la alerta al salir de ${e.lower}–${e.upper} °C${a}. Con histéresis de ${r} °C, se considera resuelta al retornar al intervalo seguro.`:d=`${t} activará la alerta al entrar en ${e.lower}–${e.upper} °C${a}. Con histéresis de ${r} °C, se considera resuelta al salir del intervalo seguro.`,`${d}${o}${n}${c}`}function Rt(l){const e=(l==null?void 0:l.notification_mode)||"once";return e==="once"?"Una vez por incidencia":e==="daily"?"Cada 24 h mientras siga activa":`Cada ${Math.max(1,Math.round(Number((l==null?void 0:l.reminder_interval_seconds)||1800)/60))} min mientras siga activa`}function ge(l,e,t="procesando…"){if(!l)return"";const i=Date.parse(l);if(!Number.isFinite(i))return"";const a=Math.max(0,i-e);if(a<=0)return t;const r=Math.ceil(a/1e3);if(r>=3600){const n=Math.floor(r/3600),c=Math.floor(r%3600/60);return`${n} h ${c} min`}const s=Math.floor(r/60),o=String(r%60).padStart(2,"0");return`${s}:${o}`}function Pt(l){if(l.enabled===!1)return{status:"disabled",label:"Deshabilitada"};const e=l.runtime;return e?e.sending?{status:"sending",label:e.retry_kind==="reminder"?"Enviando recordatorio…":"Enviando alerta…"}:e.retry_at?{status:"retry",label:`${e.active?"Alerta activa · ":""}Error de envío`,countdownType:"retry",countdownValue:e.retry_at}:e.active?e.next_reminder_at?{status:"alert",label:"Alerta activa",countdownType:"reminder",countdownValue:e.next_reminder_at}:{status:"alert",label:"Alerta activa"}:e.pending?{status:"pending",label:"Temporizando",countdownType:"pending",countdownValue:e.pending_until}:{status:"normal",label:"En espera"}:{status:"normal",label:"En espera"}}function Ot(l){return{duration:{title:"¿Qué significa “Durante”?",text:"Es el tiempo que la condición debe mantenerse de forma continua antes del primer aviso.",example:"Ejemplo: ≥ 21 °C durante 2 min. Si llega a 21 °C pero baja antes de completar 2 minutos, no se envía nada y el conteo vuelve a empezar cuando alcance nuevamente 21 °C."},hysteresis:{title:"¿Qué es la histéresis?",text:"Es un margen usado solo para decidir cuándo una incidencia ya terminó. Evita que una temperatura que oscila alrededor del umbral abra y cierre alertas repetidamente.",example:"Ejemplo: alerta ≥ 21 °C con histéresis 0,5 °C. La alerta empieza en 21 °C, pero no se considera resuelta hasta bajar a 20,5 °C o menos. Entre 20,5 y 21 °C sigue siendo la misma incidencia."},frequency:{title:"Frecuencia de avisos",text:"La frecuencia solo controla qué ocurre después del primer aviso mientras la misma incidencia continúa activa.",example:"Una vez por incidencia: un solo aviso. Repetir: vuelve a avisar cada X minutos. Cada 24 h: si el problema sigue activo 24 horas después, envía otro recordatorio. Al resolverse, cualquier opción queda lista automáticamente para una incidencia nueva."},recovery:{title:"Aviso al volver a la normalidad",text:"Es un mensaje adicional de cierre. No controla el rearme ni los recordatorios.",example:"Ejemplo: recibes una alerta por temperatura alta. Cuando baja hasta el valor de recuperación definido por la histéresis, puedes recibir otro mensaje indicando que la situación volvió a la normalidad. La regla queda rearmada automáticamente aunque esta opción esté desactivada."}}[l]||null}const f=l=>String(l??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;"),O=(l,e=[])=>{if(Array.isArray(l))return l;for(const t of e)if(Array.isArray(l==null?void 0:l[t]))return l[t];return[]},Ft='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><line x1="3" x2="21" y1="6" y2="6"></line><line x1="3" x2="21" y1="12" y2="12"></line><line x1="3" x2="21" y1="18" y2="18"></line></svg>',Ht='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"></path></svg>',ue='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><path d="M18 8a6 6 0 1 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9ZM10 21h4"/></svg>',se='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><path d="M7 2h10a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2Zm3 17h4"/></svg>',jt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><path d="M12 3v10m0 0a4 4 0 1 0 4 4 4 4 0 0 0-4-4Zm3-7h3M15 9h2"/></svg>',Oe='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><path d="m4 20 4.5-1 10-10a2.1 2.1 0 0 0-3-3l-10 10L4 20Zm9.5-12.5 3 3"/></svg>',qt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><path d="M4 7h16M9 7V4h6v3m-8 0 1 13h8l1-13M10 11v5M14 11v5"/></svg>',Wt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><path d="m3 11 18-8-8 18-2-8-8-2Zm8 2 5-5"/></svg>',Fe='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><path d="M12 3 2.5 20h19L12 3Zm0 6v5m0 3h.01"/></svg>',He='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><path d="m5 12 4 4L19 6"/></svg>';class Bt extends HTMLElement{constructor(){super(),this._hass=null,this._panel={},this._loaded=!1,this._loading=!1,this._busy=!1,this._error="",this._theme=this._loadTheme(),this._calendar=[],this._todayPayload=null,this._year="all",this._backendType="witmind_calendar",this._modal=null,this._toast="",this._toastAction="",this._toastTimer=null,this._undoDeletedRecord=null,this._notificationLoaded=!1,this._notificationLoading=!1,this._notificationTab="rules",this._rules=[],this._targets=[],this._sensors=[],this._history=[],this._historyTypeFilter="all",this._historyStatusFilter="all",this._historySearch="",this._historyLimit=50,this._notificationBusy="",this._notificationEditorOpen=!1,this._notificationEditorStep=1,this._editingRuleId=null,this._ruleDraft=null,this._deleteRuleId=null,this._renameTargetId=null,this._renameValue="",this._renameError="",this._editorError="",this._deleteError="",this._helpTopic=null,this._recoveryAccordionOpen=!1,this._notificationToast=null,this._notificationToastTimer=null,this._notificationRefreshTimer=null,this._notificationCountdownTimer=null,this.attachShadow({mode:"open"}),this.shadowRoot.addEventListener("click",e=>this._click(e)),this.shadowRoot.addEventListener("submit",e=>this._submit(e)),this.shadowRoot.addEventListener("input",e=>this._input(e)),this.shadowRoot.addEventListener("change",e=>this._change(e))}set hass(e){var a;const t=this._statesSignature(this._hass);if(this._hass=e,!this.isConnected)return;const i=this._statesSignature(e);(a=this.shadowRoot)!=null&&a.querySelector(".admin-shell")?t!==i&&!this._hasLiveInteraction()&&(this._render(),this._applyThemeStyles()):(this._render(),this._applyThemeStyles()),e&&!this._isLoadedForKind()&&this._load()}get hass(){return this._hass}set panel(e){this._panel=e||{},this._loaded=!1,this._notificationLoaded=!1,this.isConnected&&(this._render(),this._applyThemeStyles(),this._hass&&this._load())}get panel(){return this._panel}set theme(e){if(e==="dark"||e==="light"){const t=this._theme!==e;this._theme=e,this.setAttribute("data-theme",e),this._saveTheme(),t&&this.isConnected&&(this._render(),this._applyThemeStyles())}}get theme(){return this._theme}connectedCallback(){this.setAttribute("data-theme",this._theme),this._startCountdownTimer(),this._render(),this._applyThemeStyles(),this._hass&&!this._isLoadedForKind()&&this._load()}disconnectedCallback(){var e;(e=this._calendarUnsubscribe)==null||e.call(this),this._calendarUnsubscribe=void 0,this._notificationUnsubscribe&&(this._notificationUnsubscribe(),this._notificationUnsubscribe=void 0),clearTimeout(this._toastTimer),clearTimeout(this._notificationToastTimer),clearTimeout(this._notificationRefreshTimer),clearInterval(this._notificationCountdownTimer),this._notificationRefreshTimer=null,this._notificationCountdownTimer=null}_kind(){return String(this._panel.panel_kind||this._panel.panelKind||"calendar").toLowerCase()}_isLoadedForKind(){return this._kind()==="notifications"?this._notificationLoaded:this._loaded}_loadTheme(){try{return localStorage.getItem("witmind-showroom-panel-theme")==="light"?"light":"dark"}catch{return"dark"}}_saveTheme(){try{localStorage.setItem("witmind-showroom-panel-theme",this._theme)}catch{}}_toggleTheme(){this.theme=this._theme==="dark"?"light":"dark",this.dispatchEvent(new CustomEvent("witmind-theme-change",{detail:{theme:this._theme},bubbles:!0,composed:!0}))}_applyThemeStyles(){const e=this._theme==="light";this.style.color=e?"#172129":"",this.style.background=e?"linear-gradient(155deg,#f4f7f7,#e9eeee 62%,#dde5e5)":""}_title(){return this._kind()==="notifications"?"Notificaciones Witmind":"Calendario laboral"}_subtitle(){return this._kind()==="notifications"?"Centro de avisos":"Planificación operativa"}_admin(){var e,t;return((t=(e=this._hass)==null?void 0:e.user)==null?void 0:t.is_admin)!==!1}_hasLiveModal(){var e;return!!(this._modal&&((e=this.shadowRoot)!=null&&e.querySelector(".modal-backdrop")))}_hasLiveInteraction(){return!!(this._hasLiveModal()||this._notificationEditorOpen||this._deleteRuleId||this._renameTargetId||this._helpTopic)}_statesSignature(e){var r,s,o,n,c;if(!(e!=null&&e.states))return"";if(this._kind()==="notifications"){const d=[];for(const p of this._rules){const h=e.states[p.source.entity_id];h&&d.push(`${p.source.entity_id}:${h.state}`)}if((s=(r=this._ruleDraft)==null?void 0:r.source)!=null&&s.entity_id){const p=e.states[this._ruleDraft.source.entity_id];p&&d.push(`draft:${this._ruleDraft.source.entity_id}:${p.state}`)}return d.join("|")}const t=((o=e.states["binary_sensor.dia_no_laborable"])==null?void 0:o.state)||"",i=((n=e.states["binary_sensor.bloqueo_automatizaciones_laborales"])==null?void 0:n.state)||"",a=((c=e.states["automation.taller_ciclo_10s"])==null?void 0:c.state)||"";return`${t}:${i}:${a}`}async _request(e,t={}){var a,r;const i=(r=(a=this._hass)==null?void 0:a.connection)==null?void 0:r.sendMessagePromise;if(!i)throw new Error("Conexión de Home Assistant no disponible");return i({type:e,...t})}_showToast(e,t=""){clearTimeout(this._toastTimer),this._toast=e,this._toastAction=t,this._render(),this._toastTimer=setTimeout(()=>{this._toast="",this._toastAction="",this._render()},8e3)}_showNotificationToast(e,t="success"){clearTimeout(this._notificationToastTimer),this._notificationToast={message:e,type:t},this._hasLiveInteraction()||this._render(),this._notificationToastTimer=setTimeout(()=>{this._notificationToast=null,this._hasLiveInteraction()||this._render()},5200)}async _load(){this._kind()==="notifications"?await this._loadNotifications(!0):await this._loadCalendar()}async _loadCalendar(){var e,t;if(!this._loading){this._loading=!0,this._error="",this._hasLiveModal()||this._render();try{let i=null;try{i=await this._request("witmind_calendar/get"),this._backendType="witmind_calendar"}catch{i=await this._request("calendario_laboral/get"),this._backendType="calendario_laboral"}if(this._todayPayload=i||{},this._calendar=O(i,["holidays","records","items","events"]).slice().sort((a,r)=>String((a==null?void 0:a.date)||"").localeCompare(String((r==null?void 0:r.date)||""))),!this._calendarUnsubscribe&&((t=(e=this._hass)==null?void 0:e.connection)!=null&&t.subscribeEvents))try{const a=await this._hass.connection.subscribeEvents(()=>void this._loadCalendar(),"witmind_calendar_updated"),r=await this._hass.connection.subscribeEvents(()=>void this._loadCalendar(),"calendario_laboral_updated");this._calendarUnsubscribe=()=>{typeof a=="function"&&a(),typeof r=="function"&&r()}}catch{}this._loaded=!0}catch(i){this._error=i instanceof Error?i.message:"No se pudieron cargar los datos del calendario"}finally{this._loading=!1,this._hasLiveModal()||this._render()}}}async _loadNotifications(e=!1){if(!this._notificationLoading){this._notificationLoading=!0,this._error="",e&&!this._hasLiveInteraction()&&this._render();try{const[t,i,a,r]=await Promise.all([this._request("witmind_notifications/rules/list"),this._request("witmind_notifications/targets/list"),this._request("witmind_notifications/sensors/list"),this._request("witmind_notifications/history/list",{limit:150})]);this._rules=O(t,["rules"]),this._targets=O(i,["targets"]),this._sensors=O(a,["sensors"]),this._history=O(r,["history","items"]),this._subscribeNotificationEvents(),this._notificationLoaded=!0}catch(t){this._error=t instanceof Error?t.message:"No se pudo conectar con witmind_notifications"}finally{this._notificationLoading=!1,this._hasLiveInteraction()||this._render()}}}_subscribeNotificationEvents(){var e,t;if(!(this._notificationUnsubscribe||!((t=(e=this._hass)==null?void 0:e.connection)!=null&&t.subscribeEvents)))try{this._hass.connection.subscribeEvents(()=>this._scheduleNotificationRefresh(),"witmind_notifications_updated").then(i=>{typeof i=="function"&&(this._notificationUnsubscribe=i)})}catch(i){console.warn("Witmind Notifications: suscripción de eventos no disponible",i)}}_scheduleNotificationRefresh(){clearTimeout(this._notificationRefreshTimer),this._notificationRefreshTimer=setTimeout(()=>{this._notificationRefreshTimer=null,this._refreshNotificationRuntime()},80)}async _refreshNotificationRuntime(){if(this._hass)try{const[e,t]=await Promise.all([this._request("witmind_notifications/rules/list"),this._request("witmind_notifications/history/list",{limit:150})]);this._rules=O(e,["rules"]),this._history=O(t,["history","items"]),this._hasLiveInteraction()||this._render()}catch(e){console.warn("Witmind Notifications: no se pudo refrescar el estado runtime",e)}}_startCountdownTimer(){this._notificationCountdownTimer||(this._notificationCountdownTimer=setInterval(()=>this._updatePendingCountdowns(),1e3))}_updatePendingCountdowns(){if(!this.shadowRoot)return;const e=Date.now();for(const t of this.shadowRoot.querySelectorAll("[data-pending-until]"))t.textContent=ge(t.dataset.pendingUntil,e,"procesando…");for(const t of this.shadowRoot.querySelectorAll("[data-reminder-at]"))t.textContent=ge(t.dataset.reminderAt,e,"ahora");for(const t of this.shadowRoot.querySelectorAll("[data-retry-at]"))t.textContent=ge(t.dataset.retryAt,e,"ahora")}_preferredSensors(){const e=this._panel.config||this._panel||{},t=Array.isArray(e.preferred_sensors)?e.preferred_sensors:[],i=new Map(t.map((a,r)=>[a.entity_id,{name:a.name,index:r}]));return this._sensors.map(a=>{const r=i.get(a.entity_id);return{...a,display_name:(r==null?void 0:r.name)||a.display_name||a.name,preferred:!!r,preferredIndex:(r==null?void 0:r.index)??9999}}).sort((a,r)=>a.preferred!==r.preferred?a.preferred?-1:1:a.preferred&&r.preferred?(a.preferredIndex??0)-(r.preferredIndex??0):String(a.display_name||a.name).localeCompare(String(r.display_name||r.name),"es"))}_findSensor(e){return e&&this._preferredSensors().find(t=>t.entity_id===e)||null}_liveSensorValue(e){var r,s,o;if(!e)return{value:null,raw:"—",unit:"°C",available:!1};const t=(s=(r=this._hass)==null?void 0:r.states)==null?void 0:s[e.entity_id];if(!t)return{value:e.value??null,raw:e.raw_value||"—",unit:e.unit||"°C",available:!!e.available};const i=Number(t.state),a=Number.isFinite(i)&&!["unknown","unavailable"].includes(String(t.state));return{value:a?i:null,raw:String(t.state),unit:String(((o=t.attributes)==null?void 0:o.unit_of_measurement)||e.unit||"°C"),available:a}}_findTarget(e){return e&&this._targets.find(t=>t.target_id===e||t.key===e||t.device_id===e||t.notify_entity_id===e||t.legacy_service===e)||null}_isRecipientSelected(e){var i;if(!((i=this._ruleDraft)!=null&&i.recipients))return!1;const t=e.target_id||e.key;return this._ruleDraft.recipients.some(a=>a.target_id&&a.target_id===t||a.device_id&&e.device_id&&a.device_id===e.device_id||a.notify_entity_id&&e.notify_entity_id&&a.notify_entity_id===e.notify_entity_id||a.legacy_service&&e.legacy_service&&a.legacy_service===e.legacy_service)}_newDraft(){const e=this._preferredSensors()[0]||null;return{name:e?`Temperatura · ${e.display_name||e.name}`:"Alerta de temperatura",enabled:!0,source:{entity_id:(e==null?void 0:e.entity_id)||"",display_name:(e==null?void 0:e.display_name)||(e==null?void 0:e.name)||"",area_name:(e==null?void 0:e.area_name)||null},condition:{type:"above",threshold:28,lower:18,upper:28,for_seconds:300,hysteresis:.5},recipients:[],message:{title:"Alerta de temperatura",body:"{sensor} alcanzó {value} {unit}. Umbral: {threshold} {unit}.",recovery_title:"",recovery_body:""},behavior:{notification_mode:"once",reminder_interval_seconds:1800,notify_recovery:!1}}}_draftFromRule(e){var s,o,n,c;const t=e.condition||{},i=e.behavior||{},a=e.message||{};let r="once";return["once","repeat","daily"].includes(i.notification_mode)?r=i.notification_mode:Number(i.reminder_interval_seconds??i.cooldown_seconds??0)>0&&(r="repeat"),{name:e.name||"",enabled:e.enabled!==!1,source:{entity_id:((s=e.source)==null?void 0:s.entity_id)||"",display_name:((o=e.source)==null?void 0:o.display_name)||((n=e.source)==null?void 0:n.entity_id)||"",area_name:((c=e.source)==null?void 0:c.area_name)||null},condition:{type:t.type||"above",threshold:t.threshold??28,lower:t.lower??18,upper:t.upper??28,for_seconds:t.for_seconds??300,hysteresis:t.hysteresis??.5},recipients:Array.isArray(e.recipients)?JSON.parse(JSON.stringify(e.recipients)):[],message:{title:a.title||e.name||"Alerta de temperatura",body:a.body||"{sensor}: {value} {unit}",recovery_title:a.recovery_title||"",recovery_body:a.recovery_body||""},behavior:{notification_mode:r,reminder_interval_seconds:Number(i.reminder_interval_seconds??i.cooldown_seconds??1800)||1800,notify_recovery:!!i.notify_recovery}}}_render(){if(!this.shadowRoot)return;const e=this._kind();this.setAttribute("data-theme",this._theme),this.setAttribute("data-kind",e);const t=new Intl.DateTimeFormat("es-BO",{hour:"numeric",minute:"2-digit",timeZone:"America/La_Paz"}).format(new Date),i=`
      <header class="topbar signature-topbar">
        ...
        <div class="signature-topbar-end">
          ...
          <button class="theme-button" data-action="toggle-theme" aria-label="Cambiar tema">${Ht}</button>
        </div>
      </header>
    `,a=e==="notifications",r=`
            ...
            <article class="surface rule-card ${r.status}">
              <div class="rule-card-head">
                ...
                <div class="rule-title">
                  ...
                  <p>${f(((p=e.source)==null?void 0:p.display_name)||((h=e.source)==null?void 0:h.entity_id))}</p>
                </div>
                <button
              ...
              <div class="rule-metrics">
                <div>
                  ...
                  <strong>${f(It(e.condition))}</strong>
                </div>
                <div>
                  <small>Actual</small>
              ...
              <div class="rule-footer">
                ...
                <div class="card-actions">
                  ${this._admin()?`
                    <button class="small secondary" data-action="edit-rule" data-id="${t}" title="Editar regla">${Oe} <span>Editar</span></button>
                    <button class="small danger icon-btn" data-action="delete-rule" data-id="${t}" title="Eliminar regla" aria-label="Eliminar regla">${qt}</button>
                  `:""}
                </div>
              </div>
        ...
        ${this._targets.map(e=>{const t=this._notificationBusy===`test:${e.key}`,i=[e.manufacturer,e.model].filter(Boolean).join(" · ")||"Aplicación móvil",a=e.sw_version?`Firmware ${e.sw_version}`:"Firmware no informado",r=e.notify_entity_id||e.legacy_service||"Sin endpoint";return`
            <article class="surface device-card">
              ...
              <button
                ...
                ${t?"disabled":""}
              >
                ${Wt} ${t?"Enviando prueba…":"Enviar prueba individual"}
              </button>
            </article>
          `}).join("")}
      </div>
      ...
      <div class="modal-backdrop" data-action="close-editor-backdrop">
        <div class="modal-card wizard-card" data-editor-card>
          ...
          <div class="wizard-steps">
            ${s.map((n,c)=>{const d=c+1,p=d===t,h=d<t;return`
                <div class="wizard-step-item ${p?"active":""} ${h?"past":""}">
                  <span class="step-num">${h?"✓":d}</span>
            ...
            <div style="display:flex;gap:10px;">
              ...
              ${t<4?'<button type="button" class="primary" data-action="editor-next">Siguiente</button>':`
                <button type="button" class="primary" data-action="save-rule" ${this._notificationBusy==="save"?"disabled":""}>
                  ${He} ${this._notificationBusy==="save"?"Guardando…":i?"Guardar cambios":"Crear regla"}
                </button>
              `}
            </div>
          </div>
      ...
      <div class="editor-section">
        ...
        ${t?`
          <div class="sensor-preview-box">
            <div class="sensor-preview-icon">${jt}</div>
    ...
    `}_renderEditorStep2(e){const t=e.condition,i=["above","below"].includes(t.type),a=e.behavior.notification_mode,r=Math.max(1,Math.round(Number(e.behavior.reminder_interval_seconds||1800)/60)),s=Math.round(Number(t.for_seconds||0)/60);return`
      <div class="editor-section">
        ...
        <div class="logic-preview-box">
          <span style="color:#34d399;">${He}</span>
          <span data-logic-preview-text>${f(Pe(e))}</span>
        </div>
      </div>
    ...
    `:""}_renderHelpModal(){if(!this._helpTopic)return"";const e=Ot(this._helpTopic);return e?`
    ...
    </style><div class="energy-panel"><header class="topbar"><div class="topbar-start"><button class="menu-button" data-action="toggle-menu" aria-label="Abrir menú de Home Assistant">${Zt}</button><div class="brand"><strong>WITMIND</strong><span>WTX · MDTC</span></div></div><div class="status-strip"><div class="status-pill">${ne}<span><strong data-live-active>${this._activeCount()} de ${this._circuits().length}</strong><small>Circuitos activos</small></span></div><div class="status-pill">${ne}<span><strong data-live-power>${this._formatPower(this._currentPower())}</strong><small>Potencia actual</small></span></div><div class="status-pill">${ne}<span><strong>${this._formatPower(this._installedPower())}</strong><small>Potencia conocida</small></span></div></div><div class="topbar-end"><time class="clock">${this._escape(t)}</time><button class="theme-button" data-action="toggle-theme" aria-label="Cambiar tema">${Kt}</button></div></header><main class="dashboard"><section class="workspace-heading"><div><span class="eyebrow">Analítica del edificio</span><h1>Gestión de energía</h1><p>Consumo estimado, horas de uso y escenarios de ahorro para Showroom, Lobby, Oficinas y Sala de grabación.</p></div><div class="toolbar"><div class="range-tabs" role="tablist" aria-label="Período de análisis">${["day","week","month"].map(a=>`<button data-action="range" data-range="${a}" class="${this._range===a?"is-active":""}" role="tab" aria-selected="${this._range===a}">${a==="day"?"24 h":a==="week"?"7 días":"30 días"}</button>`).join("")}</div><button class="icon-button" data-action="refresh" aria-label="Actualizar historial" title="Actualizar">${ne}</button></div></section>${this._loading?`<section class="surface state-card"><div><div class="loader"></div><strong>Cargando historial energético</strong><span>Consultando ${this._circuits().length} circuitos para ${this._escape(e.title.toLowerCase())}.</span></div></section>`:this._error?`<section class="surface state-card"><div><strong>No se pudo cargar el historial</strong><span>${this._escape(this._error)}. Usa Actualizar para volver a intentarlo.</span></div></section>`:i?this._renderReport(i):'<section class="surface state-card"><div><strong>Sin datos disponibles</strong><span>Home Assistant todavía no devolvió historial para este período.</span></div></section>'}</main></div>`}}customElements.get("witmind-energy-panel")||customElements.define("witmind-energy-panel",Qt);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const oe=globalThis,Te=oe.ShadowRoot&&(oe.ShadyCSS===void 0||oe.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ce=Symbol(),We=new WeakMap;let pt=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==Ce)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Te&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=We.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&We.set(t,e))}return e}toString(){return this.cssText}};const Jt=l=>new pt(typeof l=="string"?l:l+"",void 0,Ce),ei=(l,...e)=>{const t=l.length===1?l[0]:e.reduce((i,a,r)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+l[r+1],l[0]);return new pt(t,l,Ce)},ti=(l,e)=>{if(Te)l.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of e){const i=document.createElement("style"),a=oe.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,l.appendChild(i)}},Be=Te?l=>l:l=>l instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Jt(t)})(l):l;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:ii,defineProperty:ai,getOwnPropertyDescriptor:ri,getOwnPropertyNames:si,getOwnPropertySymbols:ni,getPrototypeOf:oi}=Object,P=globalThis,Ue=P.trustedTypes,li=Ue?Ue.emptyScript:"",me=P.reactiveElementPolyfillSupport,K=(l,e)=>l,xe={toAttribute(l,e){switch(e){case Boolean:l=l?li:null;break;case Object:case Array:l=l==null?l:JSON.stringify(l)}return l},fromAttribute(l,e){let t=l;switch(e){case Boolean:t=l!==null;break;case Number:t=l===null?null:Number(l);break;case Object:case Array:try{t=JSON.parse(l)}catch{t=null}}return t}},ht=(l,e)=>!ii(l,e),Ve={attribute:!0,type:String,converter:xe,reflect:!1,useDefault:!1,hasChanged:ht};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),P.litPropertyMetadata??(P.litPropertyMetadata=new WeakMap);let B=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Ve){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const i=Symbol(),a=this.getPropertyDescriptor(e,i,t);a!==void 0&&ai(this.prototype,e,a)}}static getPropertyDescriptor(e,t,i){const{get:a,set:r}=ri(this.prototype,e)??{get(){return this[t]},set(s){this[t]=s}};return{get:a,set(s){const o=a==null?void 0:a.call(this);r==null||r.call(this,s),this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ve}static _$Ei(){if(this.hasOwnProperty(K("elementProperties")))return;const e=oi(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(K("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(K("properties"))){const t=this.properties,i=[...si(t),...ni(t)];for(const a of i)this.createProperty(a,t[a])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[i,a]of t)this.elementProperties.set(i,a)}this._$Eh=new Map;for(const[t,i]of this.elementProperties){const a=this._$Eu(t,i);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const a of i)t.unshift(Be(a))}else e!==void 0&&t.push(Be(e));return t}static _$Eu(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(t=>t(this))}addController(e){var t;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((t=e.hostConnected)==null||t.call(e))}removeController(e){var t;(t=this._$EO)==null||t.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ti(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(t=>{var i;return(i=t.hostConnected)==null?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(t=>{var i;return(i=t.hostDisconnected)==null?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){var r;const i=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,i);if(a!==void 0&&i.reflect===!0){const s=(((r=i.converter)==null?void 0:r.toAttribute)!==void 0?i.converter:xe).toAttribute(t,i.type);this._$Em=e,s==null?this.removeAttribute(a):this.setAttribute(a,s),this._$Em=null}}_$AK(e,t){var r,s;const i=this.constructor,a=i._$Eh.get(e);if(a!==void 0&&this._$Em!==a){const o=i.getPropertyOptions(a),n=typeof o.converter=="function"?{fromAttribute:o.converter}:((r=o.converter)==null?void 0:r.fromAttribute)!==void 0?o.converter:xe;this._$Em=a;const c=n.fromAttribute(t,o.type);this[a]=c??((s=this._$Ej)==null?void 0:s.get(a))??c,this._$Em=null}}requestUpdate(e,t,i,a=!1,r){var s;if(e!==void 0){const o=this.constructor;if(a===!1&&(r=this[e]),i??(i=o.getPropertyOptions(e)),!((i.hasChanged??ht)(r,t)||i.useDefault&&i.reflect&&r===((s=this._$Ej)==null?void 0:s.get(e))&&!this.hasAttribute(o._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:a,wrapped:r},s){i&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,s??t??this[e]),r!==!0||s!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var i;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[r,s]of this._$Ep)this[r]=s;this._$Ep=void 0}const a=this.constructor.elementProperties;if(a.size>0)for(const[r,s]of a){const{wrapped:o}=s,n=this[r];o!==!0||this._$AL.has(r)||n===void 0||this.C(r,void 0,s,n)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),(i=this._$EO)==null||i.forEach(a=>{var r;return(r=a.hostUpdate)==null?void 0:r.call(a)}),this.update(t)):this._$EM()}catch(a){throw e=!1,this._$EM(),a}e&&this._$AE(t)}willUpdate(e){}_$AE(e){var t;(t=this._$EO)==null||t.forEach(i=>{var a;return(a=i.hostUpdated)==null?void 0:a.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(t=>this._$ET(t,this[t]))),this._$EM()}updated(e){}firstUpdated(e){}};B.elementStyles=[],B.shadowRootOptions={mode:"open"},B[K("elementProperties")]=new Map,B[K("finalized")]=new Map,me==null||me({ReactiveElement:B}),(P.reactiveElementVersions??(P.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Q=globalThis,Xe=l=>l,ce=Q.trustedTypes,Ye=ce?ce.createPolicy("lit-html",{createHTML:l=>l}):void 0,gt="$lit$",R=`lit$${Math.random().toFixed(9).slice(2)}$`,ut="?"+R,ci=`<${ut}>`,q=document,ee=()=>q.createComment(""),te=l=>l===null||typeof l!="object"&&typeof l!="function",ze=Array.isArray,di=l=>ze(l)||typeof(l==null?void 0:l[Symbol.iterator])=="function",fe=`[ 	
\f\r]`,G=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ge=/-->/g,Ze=/>/g,F=RegExp(`>|${fe}(?:([^\\s"'>=/]+)(${fe}*=${fe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ke=/'/g,Qe=/"/g,mt=/^(?:script|style|textarea|title)$/i,pi=l=>(e,...t)=>({_$litType$:l,strings:e,values:t}),$=pi(1),X=Symbol.for("lit-noChange"),w=Symbol.for("lit-nothing"),Je=new WeakMap,H=q.createTreeWalker(q,129);function ft(l,e){if(!ze(l)||!l.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ye!==void 0?Ye.createHTML(e):e}const hi=(l,e)=>{const t=l.length-1,i=[];let a,r=e===2?"<svg>":e===3?"<math>":"",s=G;for(let o=0;o<t;o++){const n=l[o];let c,d,p=-1,h=0;for(;h<n.length&&(s.lastIndex=h,d=s.exec(n),d!==null);)h=s.lastIndex,s===G?d[1]==="!--"?s=Ge:d[1]!==void 0?s=Ze:d[2]!==void 0?(mt.test(d[2])&&(a=RegExp("</"+d[2],"g")),s=F):d[3]!==void 0&&(s=F):s===F?d[0]===">"?(s=a??G,p=-1):d[1]===void 0?p=-2:(p=s.lastIndex-d[2].length,c=d[1],s=d[3]===void 0?F:d[3]==='"'?Qe:Ke):s===Qe||s===Ke?s=F:s===Ge||s===Ze?s=G:(s=F,a=void 0);const g=s===F&&l[o+1].startsWith("/>")?" ":"";r+=s===G?n+ci:p>=0?(i.push(c),n.slice(0,p)+gt+n.slice(p)+R+g):n+R+(p===-2?o:g)}return[ft(l,r+(l[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class ie{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let r=0,s=0;const o=e.length-1,n=this.parts,[c,d]=hi(e,t);if(this.el=ie.createElement(c,i),H.currentNode=this.el.content,t===2||t===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=H.nextNode())!==null&&n.length<o;){if(a.nodeType===1){if(a.hasAttributes())for(const p of a.getAttributeNames())if(p.endsWith(gt)){const h=d[s++],g=a.getAttribute(p).split(R),u=/([.?@])?(.*)/.exec(h);n.push({type:1,index:r,name:u[2],strings:g,ctor:u[1]==="."?ui:u[1]==="?"?mi:u[1]==="@"?fi:de}),a.removeAttribute(p)}else p.startsWith(R)&&(n.push({type:6,index:r}),a.removeAttribute(p));if(mt.test(a.tagName)){const p=a.textContent.split(R),h=p.length-1;if(h>0){a.textContent=ce?ce.emptyScript:"";for(let g=0;g<h;g++)a.append(p[g],ee()),H.nextNode(),n.push({type:2,index:++r});a.append(p[h],ee())}}}else if(a.nodeType===8)if(a.data===ut)n.push({type:2,index:r});else{let p=-1;for(;(p=a.data.indexOf(R,p+1))!==-1;)n.push({type:7,index:r}),p+=R.length-1}r++}}static createElement(e,t){const i=q.createElement("template");return i.innerHTML=e,i}}function Y(l,e,t=l,i){var s,o;if(e===X)return e;let a=i!==void 0?(s=t._$Co)==null?void 0:s[i]:t._$Cl;const r=te(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==r&&((o=a==null?void 0:a._$AO)==null||o.call(a,!1),r===void 0?a=void 0:(a=new r(l),a._$AT(l,t,i)),i!==void 0?(t._$Co??(t._$Co=[]))[i]=a:t._$Cl=a),a!==void 0&&(e=Y(l,a._$AS(l,e.values),a,i)),e}class gi{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,a=((e==null?void 0:e.creationScope)??q).importNode(t,!0);H.currentNode=a;let r=H.nextNode(),s=0,o=0,n=i[0];for(;n!==void 0;){if(s===n.index){let c;n.type===2?c=new ae(r,r.nextSibling,this,e):n.type===1?c=new n.ctor(r,n.name,n.strings,this,e):n.type===6&&(c=new bi(r,this,e)),this._$AV.push(c),n=i[++o]}s!==(n==null?void 0:n.index)&&(r=H.nextNode(),s++)}return H.currentNode=q,a}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class ae{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,i,a){this.type=2,this._$AH=w,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cv=(a==null?void 0:a.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Y(this,e,t),te(e)?e===w||e==null||e===""?(this._$AH!==w&&this._$AR(),this._$AH=w):e!==this._$AH&&e!==X&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):di(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==w&&te(this._$AH)?this._$AA.nextSibling.data=e:this.T(q.createTextNode(e)),this._$AH=e}$(e){var r;const{values:t,_$litType$:i}=e,a=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=ie.createElement(ft(i.h,i.h[0]),this.options)),i);if(((r=this._$AH)==null?void 0:r._$AD)===a)this._$AH.p(t);else{const s=new gi(a,this),o=s.u(this.options);s.p(t),this.T(o),this._$AH=s}}_$AC(e){let t=Je.get(e.strings);return t===void 0&&Je.set(e.strings,t=new ie(e)),t}k(e){ze(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const r of e)a===t.length?t.push(i=new ae(this.O(ee()),this.O(ee()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,t);e!==this._$AB;){const a=Xe(e).nextSibling;Xe(e).remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}}class de{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,a,r){this.type=1,this._$AH=w,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=w}_$AI(e,t=this,i,a){const r=this.strings;let s=!1;if(r===void 0)e=Y(this,e,t,0),s=!te(e)||e!==this._$AH&&e!==X,s&&(this._$AH=e);else{const o=e;let n,c;for(e=r[0],n=0;n<r.length-1;n++)c=Y(this,o[i+n],t,n),c===X&&(c=this._$AH[n]),s||(s=!te(c)||c!==this._$AH[n]),c===w?e=w:e!==w&&(e+=(c??"")+r[n+1]),this._$AH[n]=c}s&&!a&&this.j(e)}j(e){e===w?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ui extends de{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===w?void 0:e}}class mi extends de{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==w)}}class fi extends de{constructor(e,t,i,a,r){super(e,t,i,a,r),this.type=5}_$AI(e,t=this){if((e=Y(this,e,t,0)??w)===X)return;const i=this._$AH,a=e===w&&i!==w||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==w&&(i===w||a);a&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}}class bi{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Y(this,e)}}const be=Q.litHtmlPolyfillSupport;be==null||be(ie,ae),(Q.litHtmlVersions??(Q.litHtmlVersions=[])).push("3.3.3");const _i=(l,e,t)=>{const i=(t==null?void 0:t.renderBefore)??e;let a=i._$litPart$;if(a===void 0){const r=(t==null?void 0:t.renderBefore)??null;i._$litPart$=a=new ae(e.insertBefore(ee(),r),r,void 0,t??{})}return a._$AI(l),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const j=globalThis;class J extends B{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t;const e=super.createRenderRoot();return(t=this.renderOptions).renderBefore??(t.renderBefore=e.firstChild),e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=_i(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return X}}var ct;J._$litElement$=!0,J.finalized=!0,(ct=j.litElementHydrateSupport)==null||ct.call(j,{LitElement:J});const _e=j.litElementPolyfillSupport;_e==null||_e({LitElement:J});(j.litElementVersions??(j.litElementVersions=[])).push("4.2.2");/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yi=[["path",{d:"M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vi=[["path",{d:"m7 7 10 10"}],["path",{d:"M17 7v10H7"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xi=[["path",{d:"M7 7h10v10"}],["path",{d:"M7 17 17 7"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wi=[["path",{d:"M20 6 9 17l-5-5"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Mi=[["circle",{cx:"12",cy:"12",r:"10"}],["polyline",{points:"12 6 12 12 16 14"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ai=[["rect",{width:"16",height:"16",x:"4",y:"4",rx:"2"}],["rect",{width:"6",height:"6",x:"9",y:"9",rx:"1"}],["path",{d:"M15 2v2"}],["path",{d:"M15 20v2"}],["path",{d:"M2 15h2"}],["path",{d:"M2 9h2"}],["path",{d:"M20 15h2"}],["path",{d:"M20 9h2"}],["path",{d:"M9 2v2"}],["path",{d:"M9 20v2"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ti=[["path",{d:"M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 6.75 7 5.3c-.29 1.45-1.14 2.84-2.29 3.76S3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05z"}],["path",{d:"M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 6.98 0 0 1-11.91 4.97"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ci=[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"}],["circle",{cx:"12",cy:"12",r:"3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zi=[["path",{d:"M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ni=[["path",{d:"m12 14 4-4"}],["path",{d:"M3.34 19a10 10 0 1 1 17.32 0"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Di=[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2"}],["path",{d:"M3 9h18"}],["path",{d:"M3 15h18"}],["path",{d:"M9 3v18"}],["path",{d:"M15 3v18"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Li=[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ii=[["circle",{cx:"12",cy:"12",r:"10"}],["path",{d:"M12 16v-4"}],["path",{d:"M12 8h.01"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ri=[["path",{d:"M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"}],["path",{d:"M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"}],["path",{d:"M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Pi=[["path",{d:"M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"}],["path",{d:"M9 18h6"}],["path",{d:"M10 22h4"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oi=[["polyline",{points:"15 3 21 3 21 9"}],["polyline",{points:"9 21 3 21 3 15"}],["line",{x1:"21",x2:"14",y1:"3",y2:"10"}],["line",{x1:"3",x2:"10",y1:"21",y2:"14"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fi=[["polyline",{points:"4 14 10 14 10 20"}],["polyline",{points:"20 10 14 10 14 4"}],["line",{x1:"14",x2:"21",y1:"10",y2:"3"}],["line",{x1:"3",x2:"10",y1:"21",y2:"14"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Hi=[["path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ji=[["path",{d:"M12 2v20"}],["path",{d:"m15 19-3 3-3-3"}],["path",{d:"m19 9 3 3-3 3"}],["path",{d:"M2 12h20"}],["path",{d:"m5 9-3 3 3 3"}],["path",{d:"m9 5 3-3 3 3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qi=[["path",{d:"M9 18V5l12-2v13"}],["circle",{cx:"6",cy:"18",r:"3"}],["circle",{cx:"18",cy:"16",r:"3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wi=[["rect",{x:"14",y:"4",width:"4",height:"16",rx:"1"}],["rect",{x:"6",y:"4",width:"4",height:"16",rx:"1"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bi=[["polygon",{points:"6 3 20 12 6 21 6 3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vi=[["path",{d:"M4.9 19.1C1 15.2 1 8.8 4.9 4.9"}],["path",{d:"M7.8 16.2c-2.3-2.3-2.3-6.1 0-8.5"}],["circle",{cx:"12",cy:"12",r:"2"}],["path",{d:"M16.2 7.8c2.3 2.3 2.3 6.1 0 8.5"}],["path",{d:"M19.1 4.9C23 8.8 23 15.1 19.1 19"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xi=[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"}],["path",{d:"M21 3v5h-5"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"}],["path",{d:"M8 16H3v5"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Yi=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}],["path",{d:"M3 3v5h5"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Gi=[["path",{d:"M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"}],["path",{d:"M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"}],["path",{d:"M7 3v4a1 1 0 0 0 1 1h7"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Zi=[["path",{d:"M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"}],["circle",{cx:"12",cy:"12",r:"3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ki=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qi=[["polygon",{points:"19 20 9 12 19 4 19 20"}],["line",{x1:"5",x2:"5",y1:"19",y2:"5"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ji=[["polygon",{points:"5 4 15 12 5 20 5 4"}],["line",{x1:"19",x2:"19",y1:"5",y2:"19"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ea=[["line",{x1:"4",x2:"4",y1:"21",y2:"14"}],["line",{x1:"4",x2:"4",y1:"10",y2:"3"}],["line",{x1:"12",x2:"12",y1:"21",y2:"12"}],["line",{x1:"12",x2:"12",y1:"8",y2:"3"}],["line",{x1:"20",x2:"20",y1:"21",y2:"16"}],["line",{x1:"20",x2:"20",y1:"12",y2:"3"}],["line",{x1:"2",x2:"6",y1:"14",y2:"14"}],["line",{x1:"10",x2:"14",y1:"8",y2:"8"}],["line",{x1:"18",x2:"22",y1:"16",y2:"16"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ia=[["circle",{cx:"12",cy:"12",r:"4"}],["path",{d:"M12 2v2"}],["path",{d:"M12 20v2"}],["path",{d:"m4.93 4.93 1.41 1.41"}],["path",{d:"m17.66 17.66 1.41 1.41"}],["path",{d:"M2 12h2"}],["path",{d:"M20 12h2"}],["path",{d:"m6.34 17.66-1.41 1.41"}],["path",{d:"m19.07 4.93-1.41 1.41"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const aa=[["path",{d:"M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ra=[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17"}],["polyline",{points:"16 7 22 7 22 13"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const sa=[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"}],["path",{d:"M12 9v4"}],["path",{d:"M12 17h.01"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const na=[["rect",{width:"20",height:"15",x:"2",y:"7",rx:"2",ry:"2"}],["polyline",{points:"17 2 12 7 7 2"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const la=[["path",{d:"M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z"}],["line",{x1:"22",x2:"16",y1:"9",y2:"15"}],["line",{x1:"16",x2:"22",y1:"9",y2:"15"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ca=[["path",{d:"M12 20h.01"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0"}],["path",{d:"M5 12.859a10 10 0 0 1 5.17-2.69"}],["path",{d:"M19 12.859a10 10 0 0 0-2.007-1.523"}],["path",{d:"M2 8.82a15 15 0 0 1 4.177-2.643"}],["path",{d:"M22 8.82a15 15 0 0 0-11.288-3.764"}],["path",{d:"m2 2 20 20"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const da=[["path",{d:"M12 20h.01"}],["path",{d:"M2 8.82a15 15 0 0 1 20 0"}],["path",{d:"M5 12.859a10 10 0 0 1 14 0"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ha=[["path",{d:"M18 6 6 18"}],["path",{d:"m6 6 12 12"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ga=[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ua=[["circle",{cx:"11",cy:"11",r:"8"}],["line",{x1:"21",x2:"16.65",y1:"21",y2:"16.65"}],["line",{x1:"11",x2:"11",y1:"8",y2:"14"}],["line",{x1:"8",x2:"14",y1:"11",y2:"11"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ma=[["circle",{cx:"11",cy:"11",r:"8"}],["line",{x1:"21",x2:"16.65",y1:"21",y2:"16.65"}],["line",{x1:"8",x2:"14",y1:"11",y2:"11"}]],fa={home:Li,lightbulb:Pi,sun:ia,moon:Hi,zap:ga,music:qi,sliders:ea,activity:yi,shield:Ki,power:Ui,"chevron-right":ki,"chevron-down":$i,"chevron-up":Si,x:ha,check:wi,"alert-triangle":sa,"alert-circle":Ei,clock:Mi,thermometer:aa,droplets:Ti,wind:pa,sparkles:ta,play:Bi,pause:Wi,"skip-forward":Ji,"skip-back":Qi,"volume-2":oa,"volume-x":la,"arrow-up-right":xi,"arrow-down-right":vi,layers:Ri,tv:na,cpu:Ai,"refresh-cw":Xi,eye:Ci,settings:Zi,flame:zi,radio:Vi,wifi:da,"wifi-off":ca,maximize:Oi,minimize:Fi,gauge:Ni,"trending-up":ra,grid:Di,info:Ii,pencil:et,edit:et,move:ji,"rotate-ccw":Yi,save:Gi,"zoom-in":ua,"zoom-out":ma};function y(l,e={}){const t=e.size||22,i=e.strokeWidth||1.8,a=e.color||"currentColor",r=e.className||"",s=fa[l.toLowerCase()];return s?$`
    <svg
  ...
  `:$`
    ...
    `}const ba=(l,e)=>{if(!Number.isFinite(l))return null;const t=String(e||"W").trim().toLowerCase();return t==="kw"?l*1e3:t==="mw"?l*1e6:t==="w"?l:null},L={weather:"weather.forecast_casa",showroomPower:"sensor.showroom_potencia_activa",showroomEnergy:"sensor.showroom_energia_activa",lobbyPower:"sensor.sensor_de_potencia_showroom_p"},le=[{id:"ground.showroom",floor:"ground",label:"Showroom",power:L.showroomPower,circuits:[{entity:"switch.interruptor_inteligente_switch_1",label:"Spots ventana",watts:100},{entity:"switch.interruptor_inteligente_switch_2",label:"Spots 2x3",watts:120},{entity:"switch.interruptor_inteligente_switch_3",label:"Spots 3x3",watts:180},{entity:"switch.interruptor_inteligente_switch_4",label:"Spots TV",watts:25},{entity:"switch.interruptor_inteligente_2_switch_1",label:"Paneles 3k/6k",watts:96},{entity:"switch.interruptor_inteligente_2_switch_2",label:"Colgantes",watts:10},{entity:"switch.interruptor_inteligente_2_switch_3",label:"Slims",watts:432},{entity:"switch.interruptor_inteligente_2_switch_4",label:"Downlights",watts:144},{entity:"switch.smart_relay_switch_4_switch",label:"Paneles",watts:288},{entity:"switch.smart_relay_switch_3_switch",label:"Reflector exterior"}],action:{label:"Modo reunión",serviceEntity:"scene.reunion",onEntities:["switch.interruptor_inteligente_switch_1","switch.interruptor_inteligente_switch_2"],offEntities:["switch.interruptor_inteligente_switch_3","switch.interruptor_inteligente_switch_4","switch.interruptor_inteligente_2_switch_1","switch.interruptor_inteligente_2_switch_2","switch.interruptor_inteligente_2_switch_3","switch.interruptor_inteligente_2_switch_4","switch.smart_relay_switch_4_switch","switch.smart_relay_switch_3_switch"]}},{id:"ground.witronix_admin",floor:"ground",label:"Witronix Admin",temperature:"sensor.t_h_sensor_temperature",humidity:"sensor.t_h_sensor_humidity",showInTable:!1,circuits:[]},{id:"ground.lobby",floor:"ground",label:"Lobby",power:L.lobbyPower,circuits:[{entity:"switch.interruptor_inteligente_3_switch_1",label:"Central colgante"},{entity:"switch.interruptor_inteligente_3_switch_2",label:"Spots decorativos"},{entity:"switch.interruptor_inteligente_3_switch_3",label:"Tira LED"},{entity:"switch.interruptor_inteligente_3_switch_4",label:"Spots principales"}],action:{label:"Modo invitados",onEntities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.interruptor_inteligente_3_switch_4"],offEntities:[]}},{id:"ground.grabacion",floor:"ground",label:"Grabación",circuits:[{entity:"switch.4gang_switch_sala_grabacion_interruptor_1",label:"Tira LED",watts:24},{entity:"switch.4gang_switch_sala_grabacion_interruptor_2",label:"Paneles",watts:96},{entity:"switch.4gang_switch_sala_grabacion_interruptor_3",label:"Spots",watts:50},{entity:"switch.4gang_switch_sala_grabacion_interruptor_4",label:"Otras luces",watts:30}],action:{label:"Iluminación completa",onEntities:["switch.4gang_switch_sala_grabacion_interruptor_1","switch.4gang_switch_sala_grabacion_interruptor_2","switch.4gang_switch_sala_grabacion_interruptor_3","switch.4gang_switch_sala_grabacion_interruptor_4"],offEntities:[]}},{id:"upper.witronix",floor:"upper",label:"Witronix",circuits:[{entity:"switch.oficina_gerencial_interruptor_1",label:"Witronix LED",watts:48}]},{id:"upper.mindtec",floor:"upper",label:"Mindtec",circuits:[{entity:"switch.oficina_mindtec_interruptor_1",label:"Iluminación Mindtec",watts:48}]},{id:"upper.office_large",floor:"upper",label:"Oficina grande",temperature:"sensor.t_h_sensor_2_temperature",humidity:"sensor.t_h_sensor_2_humidity",circuits:[{entity:"switch.oficina_grande_interruptor_1",label:"Oficina grande 1",watts:168},{entity:"switch.oficina_grande_interruptor_2",label:"Oficina grande 2",watts:168}]},{id:"upper.sala_multiuso",floor:"upper",label:"Sala multiuso",circuits:[{entity:"switch.b2_gang_interruptor_1",label:"Multifuncional",watts:96},{entity:"switch.b2_gang_interruptor_2",label:"Pasillos",watts:117}]},{id:"upper.taller",floor:"upper",label:"Taller",circuits:[{entity:"switch.taller_interruptor_1",label:"Iluminación Taller",watts:144}]}],bt={ground:[{zoneId:"ground.witronix_admin",left:8,top:13,width:22},{zoneId:"ground.showroom",left:8,top:47,width:22},{zoneId:"ground.lobby",left:38,top:51,width:21},{zoneId:"ground.grabacion",left:65,top:52,width:15}],upper:[{zoneId:"upper.mindtec",left:8,top:14,width:20},{zoneId:"upper.witronix",left:8,top:50,width:20},{zoneId:"upper.taller",left:41,top:16,width:16},{zoneId:"upper.sala_multiuso",left:38,top:50,width:18},{zoneId:"upper.office_large",left:62,top:50,width:20}]},_a=[...new Set([L.weather,L.showroomPower,L.showroomEnergy,...le.flatMap(l=>{var e,t,i;return[l.temperature,l.humidity,l.power,(e=l.action)==null?void 0:e.serviceEntity,...((t=l.action)==null?void 0:t.onEntities)||[],...((i=l.action)==null?void 0:i.offEntities)||[],...l.circuits.map(a=>a.entity)]})].filter(l=>!!l))],_t="witmind_building_layout_v1",yt={x:0,y:0,scale:1};function V(l,e,t){return Math.min(Math.max(l,e),t)}function vt(l){const e={},t=bt[l]||[];for(const i of t)e[i.zoneId]={zoneId:i.zoneId,left:i.left,top:i.top,width:i.width||21};return e}function we(l){return{image:{...yt},overlays:vt(l)}}function ya(){return{ground:we("ground"),upper:we("upper")}}function $e(l){if(!l||typeof l!="object")return{...yt};const e=typeof l.x=="number"&&Number.isFinite(l.x)?V(Math.round(l.x*10)/10,-40,40):0,t=typeof l.y=="number"&&Number.isFinite(l.y)?V(Math.round(l.y*10)/10,-40,40):0,i=typeof l.scale=="number"&&Number.isFinite(l.scale)?V(Math.round(l.scale*100)/100,.6,2):1;return{x:e,y:t,scale:i}}function xt(l,e,t=21){const i=typeof(e==null?void 0:e.width)=="number"&&Number.isFinite(e.width)?V(Math.round(e.width*10)/10,10,50):t,a=Math.max(0,100-i),r=typeof(e==null?void 0:e.left)=="number"&&Number.isFinite(e.left)?V(Math.round(e.left*10)/10,0,a):10,s=typeof(e==null?void 0:e.top)=="number"&&Number.isFinite(e.top)?V(Math.round(e.top*10)/10,0,92):10;return{zoneId:l,left:r,top:s,width:i}}function va(){const l=ya();if(typeof localStorage>"u")return l;try{const e=localStorage.getItem(_t);if(!e)return l;const t=JSON.parse(e);if(!t||typeof t!="object")return l;for(const i of["ground","upper"]){const a=t[i];if(a&&typeof a=="object"&&(l[i].image=$e(a.image),a.overlays&&typeof a.overlays=="object")){const r=vt(i);for(const[s,o]of Object.entries(a.overlays)){const n=r[s];l[i].overlays[s]=xt(s,o,(n==null?void 0:n.width)||21)}}}}catch(e){console.warn("No se pudieron cargar las personalizaciones del plano:",e)}return l}function Z(l){if(!(typeof localStorage>"u"))try{localStorage.setItem(_t,JSON.stringify(l))}catch(e){console.warn("No se pudo guardar la personalización del plano en localStorage:",e)}}function xa(l,e){const t={...l,[e]:we(e)};return Z(t),t}const wa={ground:{label:"Planta Baja",context:"Showroom",aspectRatio:"1536 / 1024",images:{dark:{webp:"./building/planta-baja-dark.webp",png:"./building/planta-baja-dark.png"},light:{webp:"./building/planta-baja-light.webp",png:"./building/planta-baja-light.png"}}},upper:{label:"Planta Alta",context:"Taller",aspectRatio:"1448 / 1086",images:{dark:{webp:"./building/planta-alta-dark.webp",png:"./building/planta-alta-dark.png"},light:{webp:"./building/planta-alta-light.webp",png:"./building/planta-alta-light.png"}}}},$a={"clear-night":"Despejado de noche",cloudy:"Nublado",exceptional:"Condición excepcional",fog:"Niebla",hail:"Granizo",lightning:"Tormenta eléctrica","lightning-rainy":"Tormenta y lluvia",partlycloudy:"Parcialmente nublado",pouring:"Lluvia intensa",rainy:"Lluvioso",snowy:"Nevado","snowy-rainy":"Aguanieve",sunny:"Soleado",windy:"Ventoso","windy-variant":"Viento y nubes"},D=l=>!l||l.state==="unknown"||l.state==="unavailable",U=(l,e)=>{var a;if(D(l))return null;const t=e?(a=l==null?void 0:l.attributes)==null?void 0:a[e]:l==null?void 0:l.state,i=Number(t);return Number.isFinite(i)?i:null},tt=l=>{var t;const e=U(l);return e===null?null:ba(e,String(((t=l==null?void 0:l.attributes)==null?void 0:t.unit_of_measurement)||"W"))},Ne=class Ne extends J{constructor(){super(...arguments),this._hass=null,this._panel={},this._theme="dark",this._activeFloor="ground",this._actionState="idle",this._actionMessage="",this._clock=new Date,this._history=[],this._historyTrend=null,this._historyState="idle",this._historyRequested=!1,this._touchStartX=null,this._touchLastX=null,this._mouseStartX=null,this._mouseLastX=null,this._editMode=!1,this._layoutStore=va(),this._draggingOverlay=null,this._draggingImage=null,this._onTouchMove=e=>{if(this._editMode||this._touchStartX===null)return;const t=e.touches[0];t&&(this._touchLastX=t.clientX,Math.abs(t.clientX-this._touchStartX)>12&&e.preventDefault())},this._onTouchEnd=()=>{this._editMode||(this._touchStartX!==null&&this._touchLastX!==null&&this._finishFloorSwipe(this._touchLastX-this._touchStartX),this._touchStartX=null,this._touchLastX=null)},this._onTouchCancel=()=>{this._touchStartX=null,this._touchLastX=null},this._onPointerMove=e=>{this._editMode||this._mouseStartX!==null&&(this._mouseLastX=e.clientX)},this._onPointerUp=()=>{this._editMode||(this._mouseStartX!==null&&this._mouseLastX!==null&&this._finishFloorSwipe(this._mouseLastX-this._mouseStartX),this._mouseStartX=null,this._mouseLastX=null)},this._onPointerCancel=()=>{this._mouseStartX=null,this._mouseLastX=null},this._resetActiveFloor=()=>{this._layoutStore=xa(this._layoutStore,this._activeFloor),this.requestUpdate()},this._onOverlayPointerMove=e=>{if(!this._draggingOverlay)return;e.preventDefault(),e.stopPropagation();const{zoneId:t,startPointerX:i,startPointerY:a,startLeft:r,startTop:s,stageWidth:o,stageHeight:n,overlayWidth:c}=this._draggingOverlay,d=(e.clientX-i)/o*100,p=(e.clientY-a)/n*100;this._layoutStore[this._activeFloor].overlays[t]=xt(t,{left:r+d,top:s+p,width:c},c),this.requestUpdate()},this._onOverlayPointerUp=e=>{if(this._draggingOverlay){try{e.currentTarget.releasePointerCapture(e.pointerId)}catch{}this._draggingOverlay=null,Z(this._layoutStore),this.requestUpdate()}},this._onStagePointerDown=e=>{if(!this._editMode||e.button!==0)return;const t=e.target;if(t.closest(".zone-overlay")||t.closest("button"))return;e.preventDefault();const i=e.currentTarget;i.setPointerCapture(e.pointerId);const a=i.getBoundingClientRect(),r=this._layoutStore[this._activeFloor].image;this._draggingImage={startPointerX:e.clientX,startPointerY:e.clientY,startX:r.x,startY:r.y,stageWidth:a.width||1,stageHeight:a.height||1}},this._onStagePointerMove=e=>{if(!this._draggingImage)return;e.preventDefault();const{startPointerX:t,startPointerY:i,startX:a,startY:r,stageWidth:s,stageHeight:o}=this._draggingImage,n=(e.clientX-t)/s*100,c=(e.clientY-i)/o*100;this._layoutStore[this._activeFloor].image=$e({x:a+n,y:r+c,scale:this._layoutStore[this._activeFloor].image.scale}),this.requestUpdate()},this._onStagePointerUp=e=>{if(this._draggingImage){try{e.currentTarget.releasePointerCapture(e.pointerId)}catch{}this._draggingImage=null,Z(this._layoutStore),this.requestUpdate()}}}set hass(e){const t=this._hass;this._hass=e,this.requestUpdate("hass",t),this.isConnected&&!this._historyRequested&&this._loadHistory()}get hass(){return this._hass}set panel(e){const t=this._panel;this._panel=e&&typeof e=="object"?e:{},this.requestUpdate("panel",t)}get panel(){return this._panel}set theme(e){if(e!=="dark"&&e!=="light")return;const t=this._theme;this._theme=e,this.setAttribute("data-theme",e),this.requestUpdate("theme",t)}get theme(){return this._theme}connectedCallback(){super.connectedCallback(),this.setAttribute("data-theme",this._theme),this._clockTimer=window.setInterval(()=>{this._clock=new Date,this.requestUpdate()},3e4),window.addEventListener("touchmove",this._onTouchMove,{passive:!1}),window.addEventListener("touchend",this._onTouchEnd,{passive:!0}),window.addEventListener("touchcancel",this._onTouchCancel,{passive:!0}),window.addEventListener("pointermove",this._onPointerMove),window.addEventListener("pointerup",this._onPointerUp),window.addEventListener("pointercancel",this._onPointerCancel),this._historyRequested||this._loadHistory()}disconnectedCallback(){super.disconnectedCallback(),this._clockTimer&&window.clearInterval(this._clockTimer),window.removeEventListener("touchmove",this._onTouchMove),window.removeEventListener("touchend",this._onTouchEnd),window.removeEventListener("touchcancel",this._onTouchCancel),window.removeEventListener("pointermove",this._onPointerMove),window.removeEventListener("pointerup",this._onPointerUp),window.removeEventListener("pointercancel",this._onPointerCancel)}updated(e){e.has("theme")&&this.setAttribute("data-theme",this._theme)}_state(e){var t,i;return(i=(t=this._hass)==null?void 0:t.states)==null?void 0:i[e]}_zones(){return le.filter(e=>e.floor===this._activeFloor)}_availableCircuits(e){return e.circuits.filter(t=>!D(this._state(t.entity)))}_onCircuits(e){return this._availableCircuits(e).filter(t=>{var i;return((i=this._state(t.entity))==null?void 0:i.state)==="on"})}_profileActive(e){return e.action?[...e.action.onEntities,...e.action.offEntities].some(i=>D(this._state(i)))?!1:e.action.onEntities.every(i=>{var a;return((a=this._state(i))==null?void 0:a.state)==="on"})&&e.action.offEntities.every(i=>{var a;return((a=this._state(i))==null?void 0:a.state)==="off"}):this._onCircuits(e).length>0}_zonePower(e){const t=e.power?tt(this._state(e.power)):null;if(t!==null)return{value:t,measured:!0};const i=this._onCircuits(e).filter(a=>typeof a.watts=="number");return i.length?{value:i.reduce((a,r)=>a+Number(r.watts),0),measured:!1}:null}_format(e,t,i=0){return e===null?"No disponible":`${new Intl.NumberFormat("es-BO",{maximumFractionDigits:i}).format(e)} ${t}`}_weather(){const e=this._state(L.weather);return{available:!D(e),temperature:U(e,"temperature"),condition:$a[String((e==null?void 0:e.state)||"")]||(D(e)?"No disponible":String(e==null?void 0:e.state))}}_environment(){const e=this._zones().map(a=>a.temperature&&U(this._state(a.temperature))).filter(a=>typeof a=="number"),t=this._zones().map(a=>a.humidity&&U(this._state(a.humidity))).filter(a=>typeof a=="number"),i=a=>a.length?a.reduce((r,s)=>r+s,0)/a.length:null;return{temperature:i(e),humidity:i(t)}}_activePower(){const e=tt(this._state(L.showroomPower));return e===null?null:e}async _loadHistory(){var i,a;const e=(a=(i=this._hass)==null?void 0:i.connection)==null?void 0:a.sendMessagePromise;if(!e||D(this._state(L.showroomPower))){this._historyState="unavailable",this.requestUpdate();return}this._historyRequested=!0,this._historyState="loading",this.requestUpdate();const t=Date.now();try{const r=await e({type:"history/history_during_period",start_time:new Date(t-1728e5).toISOString(),end_time:new Date(t).toISOString(),entity_ids:[L.showroomPower],minimal_response:!0,no_attributes:!0,significant_changes_only:!1}),s=Array.isArray(r)?Array.isArray(r[0])?r[0]:r:Object.values(r||{})[0],o=(Array.isArray(s)?s:[]).map(h=>({value:Number((h==null?void 0:h.state)??(h==null?void 0:h.s)),time:Date.parse(String((h==null?void 0:h.last_changed)??(h==null?void 0:h.last_updated)??(h==null?void 0:h.lu)??(h==null?void 0:h.lc)??""))})).filter(h=>Number.isFinite(h.value)&&Number.isFinite(h.time)),n=new Map;o.forEach(h=>n.set(Math.floor(h.time/36e5),h.value));const c=Math.floor(t/36e5),d=Array.from({length:24},(h,g)=>n.get(c-23+g)).filter(h=>typeof h=="number"),p=Array.from({length:24},(h,g)=>n.get(c-47+g)).filter(h=>typeof h=="number");if(this._history=d,d.length&&p.length){const h=d.reduce((u,m)=>u+m,0)/d.length,g=p.reduce((u,m)=>u+m,0)/p.length;this._historyTrend=g>0?(h-g)/g*100:null}this._historyState=d.length?"ready":"unavailable"}catch{this._historyState="error"}this.requestUpdate()}_setFloor(e){e!==this._activeFloor&&(this._activeFloor=e,this.requestUpdate())}_onTouchStart(e){if(this._editMode)return;const t=e.changedTouches[0]||e.touches[0];t&&(this._touchStartX=t.clientX,this._touchLastX=t.clientX)}_onPointerDown(e){this._editMode||e.pointerType==="touch"||e.button!==0||(this._mouseStartX=e.clientX,this._mouseLastX=e.clientX)}_finishFloorSwipe(e){this._editMode||Math.abs(e)<54||this._setFloor(e<0?"upper":"ground")}_toggleEditMode(){this._editMode=!this._editMode,this._editMode||Z(this._layoutStore),this.requestUpdate()}_adjustImage(e,t,i=0){const a=this._layoutStore[this._activeFloor].image;this._layoutStore[this._activeFloor].image=$e({x:a.x+e,y:a.y+t,scale:a.scale+i}),Z(this._layoutStore),this.requestUpdate()}_onOverlayPointerDown(e,t){if(!this._editMode||e.button!==0)return;e.preventDefault(),e.stopPropagation(),e.currentTarget.setPointerCapture(e.pointerId);const a=this.renderRoot.querySelector(".floor-stage"),r=a?a.getBoundingClientRect():{width:1,height:1},s=this._layoutStore[this._activeFloor].overlays[t],o=(s==null?void 0:s.left)??10,n=(s==null?void 0:s.top)??10,c=(s==null?void 0:s.width)??21;this._draggingOverlay={zoneId:t,startPointerX:e.clientX,startPointerY:e.clientY,startLeft:o,startTop:n,stageWidth:r.width||1,stageHeight:r.height||1,overlayWidth:c}}_renderEditToolbar(){const e=this._layoutStore[this._activeFloor].image,t=this._activeFloor==="ground"?"Planta Baja":"Planta Alta";return $`
      ...
      <div class="circuit-row" role="row">
        ...
        <div
          ...
          title=${this._editMode?`Arrastrar ${r.label} (${h.left.toFixed(1)}%, ${h.top.toFixed(1)}%)`:r.label}
        >
          <div class="overlay-header">
            ${this._editMode?$`<span class="drag-handle">${y("move",{size:12})}</span>`:w}
            <strong>${r.label}</strong>
          </div>
          <div class="overlay-metrics">
            ${s.length?$`<span>${y("lightbulb",{size:12})}${o.length}/${s.length}</span>`:w}
            ${n?$`<span>${y("zap",{size:12})}${this._format(n.value,"W")}</span>`:w}
            ${c!==null?$`<span>${y("thermometer",{size:12})}${this._format(c,"°C",1)}</span>`:w}
            ${d!==null?$`<span>${y("droplets",{size:12})}${this._format(d,"%",0)}</span>`:w}
            ${!p&&this._editMode?$`<span class="empty-badge">Sin telemetría</span>`:w}
          </div>
        </div>`})}render(){var g;const e=wa[this._activeFloor],t=this._theme==="light"?"light":"dark",i=e.images[t],a=this._weather(),r=this._environment(),s=this._activePower(),o=this._history.length?Math.max(...this._history,1):1,c=(Array.isArray(this._panel.alarm_entities)?this._panel.alarm_entities:[]).map(u=>this._state(u)).filter(u=>u&&!D(u)&&u.state!=="off"),d=!!((g=this._hass)!=null&&g.states&&Object.keys(this._hass.states).length),p=new Intl.DateTimeFormat("es-BO",{hour:"2-digit",minute:"2-digit",hour12:!1}).format(this._clock),h=new Intl.DateTimeFormat("es-BO",{day:"2-digit",month:"short",year:"numeric"}).format(this._clock);return $`
      <div class="bms-shell">
        <header class="topbar">
          <button class="menu-button" @click=${this._toggleMenu} aria-label="Abrir menú de Home Assistant">${y("sliders",{size:21})}</button>
          <div class="brand-mark">${y("home",{size:27})}<div><strong>WITMIND</strong><span>CONTROL DE EDIFICIO</span></div></div>
          <div class="title-block"><h1>Control de Edificio</h1><p>Sistema de gestión y monitoreo</p></div>
          <div class="header-status"><div class="clock"><strong>${p}</strong><span>${h}</span></div><div class="weather-chip">${y("sun",{size:22})}<span><strong>${this._format(a.temperature,"°C",1)}</strong>${a.condition}</span></div><div class="mode-chip ${d?"ok":"warn"}">${y(d?"check":"alert-circle",{size:18})}<span><small>Estado</small><strong>${d?"Supervisión activa":"Conexión pendiente"}</strong></span></div></div>
        </header>

        <aside class="sidebar" aria-label="Secciones del edificio">
          <div class="side-brand">${y("home",{size:24})}<span>WITMIND</span></div>
          <nav>
            <button class="active" @click=${()=>this._scrollTo("floor-plan")}>${y("home")}<span>Inicio</span></button>
            <button @click=${()=>this._scrollTo("consumption")}>${y("zap")}<span>Eléctrico</span></button>
            <button @click=${()=>this._scrollTo("environment")}>${y("sun")}<span>Clima</span></button>
            <button @click=${()=>this._scrollTo("circuits")}>${y("lightbulb")}<span>Iluminación</span></button>
            <button @click=${()=>this._scrollTo("alerts")}>${y("shield")}<span>Seguridad</span></button>
            <button @click=${()=>this._scrollTo("consumption")}>${y("activity")}<span>Energía</span></button>
            <button disabled>${y("layers")}<span>Reportes</span></button>
            <button disabled>${y("settings")}<span>Configuración</span></button>
          </nav>
        ...
        <main class="dashboard-grid">
          <section class="main-column">
            <article id="floor-plan" class="panel floor-card">
              <div class="panel-head"><div class="panel-title">${y("home",{size:19})}<h2>PLANO DEL EDIFICIO <span>${e.context}</span></h2></div><div class="floor-selector" role="group" aria-label="Seleccionar planta"><button class=${this._activeFloor==="ground"?"selected":""} @click=${()=>this._setFloor("ground")}>Planta Baja</button><button class=${this._activeFloor==="upper"?"selected":""} @click=${()=>this._setFloor("upper")}>Planta Alta</button></div></div>
              <div class="floor-viewport ${this._editMode?"viewport-editing":""}" data-no-swipe @touchstart=${this._onTouchStart} @pointerdown=${this._onPointerDown} aria-label="${e.label}: ${e.context}">
                ${this._editMode?this._renderEditToolbar():w}
                ...
                >
                  <picture class="floor-picture" style="transform: translate(${this._layoutStore[this._activeFloor].image.x}%, ${this._layoutStore[this._activeFloor].image.y}%) scale(${this._layoutStore[this._activeFloor].image.scale}); transform-origin: center center;">
                    ...
                    <img src=${i.png} alt="Plano arquitectónico real de ${e.label}" draggable="false" />
                  </picture>
                ...
                <div class="viewport-tools">
                  ...
                  >
                    ${y(this._editMode?"check":"pencil",{size:18})}
                  </button>
            ...
            <article id="circuits" class="panel circuits-card">
              <div class="panel-head"><div class="panel-title">${y("lightbulb",{size:19})}<h2>CIRCUITOS POR ZONA</h2></div><span class="head-meta">${e.label}</span></div>
          ...
          <section class="side-column">
            <article id="alerts" class="panel side-card alerts-card">
              <div class="panel-head"><div class="panel-title warning-icon">${y("alert-triangle",{size:19})}<h2>ALARMAS / EVENTOS</h2></div><span class="head-meta">${c.length} activas</span></div>
              ${c.length?$`<div class="alert-list">${c.map(u=>{var m;return $`<div class="alert-row">${y("alert-triangle",{size:20})}<div><strong>${String(((m=u==null?void 0:u.attributes)==null?void 0:m.friendly_name)||(u==null?void 0:u.entity_id))}</strong><span>${String(u==null?void 0:u.state)}</span></div></div>`})}</div>`:$`<div class="empty-state">${y("shield",{size:26})}<div><strong>Sin alarmas configuradas</strong><span>Conecta entidades en <code>alarm_entities</code> para habilitar esta sección.</span></div></div>`}
            </article>

            <article id="environment" class="panel side-card">
              <div class="panel-head"><div class="panel-title">${y("sun",{size:19})}<h2>CONDICIONES AMBIENTALES</h2></div></div>
              <div class="environment-grid"><div>${y("thermometer",{size:27})}<strong>${this._format(r.temperature,"°C",1)}</strong><span>Interior promedio</span></div><div>${y("droplets",{size:27})}<strong>${this._format(r.humidity,"%",0)}</strong><span>Humedad promedio</span></div><div>${y("sun",{size:27})}<strong>${this._format(a.temperature,"°C",1)}</strong><span>Exterior</span></div><div>${y("activity",{size:27})}<strong class="condition">${a.condition}</strong><span>WTX - MDTC</span></div></div>
            </article>

            <article id="consumption" class="panel side-card consumption-card">
              <div class="panel-head"><div class="panel-title">${y("zap",{size:19})}<h2>CONSUMO ELÉCTRICO</h2></div></div>
              <div class="power-reading">${y("zap",{size:43})}<div><strong>${this._format(s,"W")}</strong><span>${s===null?"Medición no disponible":"Showroom - potencia activa"}</span></div>${this._historyTrend!==null?$`<b class=${this._historyTrend<=0?"trend good":"trend bad"}>${this._historyTrend>0?"+":""}${this._historyTrend.toFixed(0)} %<small>vs. 24 h previas</small></b>`:w}</div>
