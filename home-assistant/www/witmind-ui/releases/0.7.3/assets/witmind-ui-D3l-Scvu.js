              ...
              <div class="rule-footer">
                ...
                <div class="card-actions">
                  ${this._admin()?`
                    ...
                    <button class="small danger icon-btn" data-action="delete-rule" data-id="${t}" title="Eliminar regla" aria-label="Eliminar regla">${Wt}</button>
                  `:""}
                </div>
              </div>
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wi=[["path",{d:"M9 18V5l12-2v13"}],["circle",{cx:"6",cy:"18",r:"3"}],["circle",{cx:"18",cy:"16",r:"3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fa=[["circle",{cx:"11",cy:"11",r:"8"}],["line",{x1:"21",x2:"16.65",y1:"21",y2:"16.65"}],["line",{x1:"8",x2:"14",y1:"11",y2:"11"}]],ba={home:Ii,lightbulb:Oi,sun:aa,moon:Hi,zap:ua,music:Wi,sliders:ta,activity:vi,shield:Qi,power:Vi,"chevron-right":Si,"chevron-down":ki,"chevron-up":Ei,x:ga,check:$i,"alert-triangle":na,"alert-circle":Mi,clock:Ai,thermometer:ra,droplets:Ci,wind:ha,sparkles:ia,play:Ui,pause:Bi,"skip-forward":ea,"skip-back":Ji,"volume-2":la,"volume-x":ca,"arrow-up-right":wi,"arrow-down-right":xi,layers:Pi,tv:oa,cpu:zi,"refresh-cw":Yi,eye:Ti,settings:Ki,flame:Ni,radio:Xi,wifi:pa,"wifi-off":da,maximize:Fi,minimize:qi,gauge:Di,"trending-up":sa,grid:Li,info:Ri,pencil:tt,edit:tt,move:ji,"rotate-ccw":Gi,save:Zi,"zoom-in":ma,"zoom-out":fa};function v(l,e={}){const t=e.size||22,i=e.strokeWidth||1.8,a=e.color||"currentColor",r=e.className||"",s=ba[l.toLowerCase()];return s?$`
    <svg
