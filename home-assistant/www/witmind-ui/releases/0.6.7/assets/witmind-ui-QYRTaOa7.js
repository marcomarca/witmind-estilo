      ...
      <div class="operations-shell">
        <header class="topbar">
          ...
          <div class="topbar-meta">
            ...
            <div class="header-weather" aria-label="Clima actual: ${this._escape(e.condition)}, ${this._escape(e.temperature)}°"><span aria-hidden="true">${this._escape(yt[String(((h=this._state(this._panel.weather||"weather.forecast_casa"))==null?void 0:h.state)||"")]||"·")}</span><strong>${this._escape(e.temperature)}°</strong></div>
            ...
            <article class="surface rule-card ${r.status}">
              ...
              <div class="rule-metrics">
                <div>
                  ...
                  <strong>${f(St(e.condition))}</strong>
                </div>
                <div>
                  <small>Actual</small>
              ...
              <div class="rule-footer">
                <span class="recipient-line ${n?"stale-warning":""}">
                  ${ae} ${n?"<strong>[Acción Requerida]</strong> ":""}${f(c||"Sin destinatarios asignados")}
                </span>
                <div class="card-actions">
                  ${this._admin()?`
                    <button class="small secondary" data-action="edit-rule" data-id="${t}" title="Editar regla">${Le} <span>Editar</span></button>
                    <button class="small danger icon-btn" data-action="delete-rule" data-id="${t}" title="Eliminar regla" aria-label="Eliminar regla">${Nt}</button>
                  `:""}
                </div>
              </div>
    ...
    `}_renderEditorStep2(e){const t=e.condition,i=["above","below"].includes(t.type),a=e.behavior.notification_mode,r=Math.max(1,Math.round(Number(e.behavior.reminder_interval_seconds||1800)/60)),s=Math.round(Number(t.for_seconds||0)/60);return`
      <div class="editor-section">
        ...
        <div class="logic-preview-box">
          ...
          <span data-logic-preview-text>${f(De(e))}</span>
        </div>
      </div>
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bi=[["circle",{cx:"12",cy:"12",r:"10"}],["polyline",{points:"12 6 12 12 16 14"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _i=[["rect",{width:"16",height:"16",x:"4",y:"4",rx:"2"}],["rect",{width:"6",height:"6",x:"9",y:"9",rx:"1"}],["path",{d:"M15 2v2"}],["path",{d:"M15 20v2"}],["path",{d:"M2 15h2"}],["path",{d:"M2 9h2"}],["path",{d:"M20 15h2"}],["path",{d:"M20 9h2"}],["path",{d:"M9 2v2"}],["path",{d:"M9 20v2"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ki=[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2"}],["path",{d:"M3 9h18"}],["path",{d:"M3 15h18"}],["path",{d:"M9 3v18"}],["path",{d:"M15 3v18"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $i=[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ea=[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"}]],ta={home:$i,lightbulb:Ai,sun:Wi,moon:Ci,zap:ea,music:zi,sliders:qi,activity:ci,shield:Oi,power:Li,"chevron-right":ui,"chevron-down":gi,"chevron-up":mi,x:Ji,check:hi,"alert-triangle":Vi,"alert-circle":fi,clock:bi,thermometer:Bi,droplets:yi,wind:Qi,sparkles:ji,play:Di,pause:Ni,"skip-forward":Hi,"skip-back":Fi,"volume-2":Yi,"volume-x":Gi,"arrow-up-right":pi,"arrow-down-right":di,layers:Ei,tv:Xi,cpu:_i,"refresh-cw":Ri,eye:vi,settings:Pi,flame:xi,radio:Ii,wifi:Ki,"wifi-off":Zi,maximize:Mi,minimize:Ti,gauge:wi,"trending-up":Ui,grid:ki,info:Si};function y(l,e={}){const t=e.size||22,i=e.strokeWidth||1.8,a=e.color||"currentColor",r=e.className||"",s=ta[l.toLowerCase()];return s?S`
    <svg
  ...
  `:S`
    ...
    `}const ia=(l,e)=>{if(!Number.isFinite(l))return null;const t=String(e||"W").trim().toLowerCase();return t==="kw"?l*1e3:t==="mw"?l*1e6:t==="w"?l:null},L={weather:"weather.forecast_casa",showroomPower:"sensor.showroom_potencia_activa",showroomEnergy:"sensor.showroom_energia_activa",lobbyPower:"sensor.sensor_de_potencia_showroom_p"},ne=[{id:"ground.showroom",floor:"ground",label:"Showroom",power:L.showroomPower,circuits:[{entity:"switch.interruptor_inteligente_switch_1",label:"Spots ventana",watts:100},{entity:"switch.interruptor_inteligente_switch_2",label:"Spots 2x3",watts:120},{entity:"switch.interruptor_inteligente_switch_3",label:"Spots 3x3",watts:180},{entity:"switch.interruptor_inteligente_switch_4",label:"Spots TV",watts:25},{entity:"switch.interruptor_inteligente_2_switch_1",label:"Paneles 3k/6k",watts:96},{entity:"switch.interruptor_inteligente_2_switch_2",label:"Colgantes",watts:10},{entity:"switch.interruptor_inteligente_2_switch_3",label:"Slims",watts:432},{entity:"switch.interruptor_inteligente_2_switch_4",label:"Downlights",watts:144},{entity:"switch.smart_relay_switch_4_switch",label:"Paneles",watts:288},{entity:"switch.smart_relay_switch_3_switch",label:"Reflector exterior"}],action:{label:"Modo reunión",serviceEntity:"scene.reunion",onEntities:["switch.interruptor_inteligente_switch_1","switch.interruptor_inteligente_switch_2"],offEntities:["switch.interruptor_inteligente_switch_3","switch.interruptor_inteligente_switch_4","switch.interruptor_inteligente_2_switch_1","switch.interruptor_inteligente_2_switch_2","switch.interruptor_inteligente_2_switch_3","switch.interruptor_inteligente_2_switch_4","switch.smart_relay_switch_4_switch","switch.smart_relay_switch_3_switch"]}},{id:"ground.witronix_admin",floor:"ground",label:"Witronix Admin",temperature:"sensor.t_h_sensor_temperature",humidity:"sensor.t_h_sensor_humidity",showInTable:!1,circuits:[]},{id:"ground.lobby",floor:"ground",label:"Lobby",power:L.lobbyPower,circuits:[{entity:"switch.interruptor_inteligente_3_switch_1",label:"Central colgante"},{entity:"switch.interruptor_inteligente_3_switch_2",label:"Spots decorativos"},{entity:"switch.interruptor_inteligente_3_switch_3",label:"Tira LED"},{entity:"switch.interruptor_inteligente_3_switch_4",label:"Spots principales"}],action:{label:"Modo invitados",onEntities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.interruptor_inteligente_3_switch_4"],offEntities:[]}},{id:"ground.grabacion",floor:"ground",label:"Grabación",circuits:[{entity:"switch.4gang_switch_sala_grabacion_interruptor_1",label:"Tira LED",watts:24},{entity:"switch.4gang_switch_sala_grabacion_interruptor_2",label:"Paneles",watts:96},{entity:"switch.4gang_switch_sala_grabacion_interruptor_3",label:"Spots",watts:50},{entity:"switch.4gang_switch_sala_grabacion_interruptor_4",label:"Otras luces",watts:30}],action:{label:"Iluminación completa",onEntities:["switch.4gang_switch_sala_grabacion_interruptor_1","switch.4gang_switch_sala_grabacion_interruptor_2","switch.4gang_switch_sala_grabacion_interruptor_3","switch.4gang_switch_sala_grabacion_interruptor_4"],offEntities:[]}},{id:"upper.witronix",floor:"upper",label:"Witronix",circuits:[{entity:"switch.oficina_gerencial_interruptor_1",label:"Witronix LED",watts:48}]},{id:"upper.mindtec",floor:"upper",label:"Mindtec",circuits:[{entity:"switch.oficina_mindtec_interruptor_1",label:"Iluminación Mindtec",watts:48}]},{id:"upper.office_large",floor:"upper",label:"Oficina grande",temperature:"sensor.t_h_sensor_2_temperature",humidity:"sensor.t_h_sensor_2_humidity",circuits:[{entity:"switch.oficina_grande_interruptor_1",label:"Oficina grande 1",watts:168},{entity:"switch.oficina_grande_interruptor_2",label:"Oficina grande 2",watts:168}]},{id:"upper.sala_multiuso",floor:"upper",label:"Sala multiuso",circuits:[{entity:"switch.b2_gang_interruptor_1",label:"Multifuncional",watts:96},{entity:"switch.b2_gang_interruptor_2",label:"Pasillos",watts:117}]},{id:"upper.taller",floor:"upper",label:"Taller",circuits:[{entity:"switch.taller_interruptor_1",label:"Iluminación Taller",watts:144}]}],aa={ground:[{zoneId:"ground.witronix_admin",left:8,top:13,width:22},{zoneId:"ground.showroom",left:8,top:47,width:22},{zoneId:"ground.lobby",left:38,top:51,width:21},{zoneId:"ground.grabacion",left:65,top:52,width:15}],upper:[{zoneId:"upper.mindtec",left:8,top:14,width:20},{zoneId:"upper.witronix",left:8,top:50,width:20},{zoneId:"upper.taller",left:41,top:16,width:16},{zoneId:"upper.sala_multiuso",left:38,top:50,width:18},{zoneId:"upper.office_large",left:62,top:50,width:20}]},ra=[...new Set([L.weather,L.showroomPower,L.showroomEnergy,...ne.flatMap(l=>{var e,t,i;return[l.temperature,l.humidity,l.power,(e=l.action)==null?void 0:e.serviceEntity,...((t=l.action)==null?void 0:t.onEntities)||[],...((i=l.action)==null?void 0:i.offEntities)||[],...l.circuits.map(a=>a.entity)]})].filter(l=>!!l))],sa={ground:{label:"Planta Baja",context:"Showroom",aspectRatio:"1536 / 1024",images:{dark:{webp:"./building/planta-baja-dark.webp",png:"./building/planta-baja-dark.png"},light:{webp:"./building/planta-baja-light.webp",png:"./building/planta-baja-light.png"}}},upper:{label:"Planta Alta",context:"Taller",aspectRatio:"1448 / 1086",images:{dark:{webp:"./building/planta-alta-dark.webp",png:"./building/planta-alta-dark.png"},light:{webp:"./building/planta-alta-light.webp",png:"./building/planta-alta-light.png"}}}},na={"clear-night":"Despejado de noche",cloudy:"Nublado",exceptional:"Condición excepcional",fog:"Niebla",hail:"Granizo",lightning:"Tormenta eléctrica","lightning-rainy":"Tormenta y lluvia",partlycloudy:"Parcialmente nublado",pouring:"Lluvia intensa",rainy:"Lluvioso",snowy:"Nevado","snowy-rainy":"Aguanieve",sunny:"Soleado",windy:"Ventoso","windy-variant":"Viento y nubes"},D=l=>!l||l.state==="unknown"||l.state==="unavailable",U=(l,e)=>{var a;if(D(l))return null;const t=e?(a=l==null?void 0:l.attributes)==null?void 0:a[e]:l==null?void 0:l.state,i=Number(t);return Number.isFinite(i)?i:null},Ze=l=>{var t;const e=U(l);return e===null?null:ia(e,String(((t=l==null?void 0:l.attributes)==null?void 0:t.unit_of_measurement)||"W"))},Me=class Me extends K{constructor(){super(...arguments),this._hass=null,this._panel={},this._theme="dark",this._activeFloor="ground",this._actionState="idle",this._actionMessage="",this._clock=new Date,this._history=[],this._historyTrend=null,this._historyState="idle",this._historyRequested=!1,this._touchStartX=null,this._touchLastX=null,this._mouseStartX=null,this._mouseLastX=null,this._onTouchMove=e=>{if(this._touchStartX===null)return;const t=e.touches[0];t&&(this._touchLastX=t.clientX,Math.abs(t.clientX-this._touchStartX)>12&&e.preventDefault())},this._onTouchEnd=()=>{this._touchStartX!==null&&this._touchLastX!==null&&this._finishFloorSwipe(this._touchLastX-this._touchStartX),this._touchStartX=null,this._touchLastX=null},this._onTouchCancel=()=>{this._touchStartX=null,this._touchLastX=null},this._onPointerMove=e=>{this._mouseStartX!==null&&(this._mouseLastX=e.clientX)},this._onPointerUp=()=>{this._mouseStartX!==null&&this._mouseLastX!==null&&this._finishFloorSwipe(this._mouseLastX-this._mouseStartX),this._mouseStartX=null,this._mouseLastX=null},this._onPointerCancel=()=>{this._mouseStartX=null,this._mouseLastX=null}}set hass(e){const t=this._hass;this._hass=e,this.requestUpdate("hass",t),this.isConnected&&!this._historyRequested&&this._loadHistory()}get hass(){return this._hass}set panel(e){const t=this._panel;this._panel=e&&typeof e=="object"?e:{},this.requestUpdate("panel",t)}get panel(){return this._panel}set theme(e){if(e!=="dark"&&e!=="light")return;const t=this._theme;this._theme=e,this.setAttribute("data-theme",e),this.requestUpdate("theme",t)}get theme(){return this._theme}connectedCallback(){super.connectedCallback(),this.setAttribute("data-theme",this._theme),this._clockTimer=window.setInterval(()=>{this._clock=new Date,this.requestUpdate()},3e4),window.addEventListener("touchmove",this._onTouchMove,{passive:!1}),window.addEventListener("touchend",this._onTouchEnd,{passive:!0}),window.addEventListener("touchcancel",this._onTouchCancel,{passive:!0}),window.addEventListener("pointermove",this._onPointerMove),window.addEventListener("pointerup",this._onPointerUp),window.addEventListener("pointercancel",this._onPointerCancel),this._historyRequested||this._loadHistory()}disconnectedCallback(){super.disconnectedCallback(),this._clockTimer&&window.clearInterval(this._clockTimer),window.removeEventListener("touchmove",this._onTouchMove),window.removeEventListener("touchend",this._onTouchEnd),window.removeEventListener("touchcancel",this._onTouchCancel),window.removeEventListener("pointermove",this._onPointerMove),window.removeEventListener("pointerup",this._onPointerUp),window.removeEventListener("pointercancel",this._onPointerCancel)}updated(e){e.has("theme")&&this.setAttribute("data-theme",this._theme)}_state(e){var t,i;return(i=(t=this._hass)==null?void 0:t.states)==null?void 0:i[e]}_zones(){return ne.filter(e=>e.floor===this._activeFloor)}_availableCircuits(e){return e.circuits.filter(t=>!D(this._state(t.entity)))}_onCircuits(e){return this._availableCircuits(e).filter(t=>{var i;return((i=this._state(t.entity))==null?void 0:i.state)==="on"})}_profileActive(e){return e.action?[...e.action.onEntities,...e.action.offEntities].some(i=>D(this._state(i)))?!1:e.action.onEntities.every(i=>{var a;return((a=this._state(i))==null?void 0:a.state)==="on"})&&e.action.offEntities.every(i=>{var a;return((a=this._state(i))==null?void 0:a.state)==="off"}):this._onCircuits(e).length>0}_zonePower(e){const t=e.power?Ze(this._state(e.power)):null;if(t!==null)return{value:t,measured:!0};const i=this._onCircuits(e).filter(a=>typeof a.watts=="number");return i.length?{value:i.reduce((a,r)=>a+Number(r.watts),0),measured:!1}:null}_format(e,t,i=0){return e===null?"No disponible":`${new Intl.NumberFormat("es-BO",{maximumFractionDigits:i}).format(e)} ${t}`}_weather(){const e=this._state(L.weather);return{available:!D(e),temperature:U(e,"temperature"),condition:na[String((e==null?void 0:e.state)||"")]||(D(e)?"No disponible":String(e==null?void 0:e.state))}}_environment(){const e=this._zones().map(a=>a.temperature&&U(this._state(a.temperature))).filter(a=>typeof a=="number"),t=this._zones().map(a=>a.humidity&&U(this._state(a.humidity))).filter(a=>typeof a=="number"),i=a=>a.length?a.reduce((r,s)=>r+s,0)/a.length:null;return{temperature:i(e),humidity:i(t)}}_activePower(){const e=Ze(this._state(L.showroomPower));return e===null?null:e}async _loadHistory(){var i,a;const e=(a=(i=this._hass)==null?void 0:i.connection)==null?void 0:a.sendMessagePromise;if(!e||D(this._state(L.showroomPower))){this._historyState="unavailable",this.requestUpdate();return}this._historyRequested=!0,this._historyState="loading",this.requestUpdate();const t=Date.now();try{const r=await e({type:"history/history_during_period",start_time:new Date(t-1728e5).toISOString(),end_time:new Date(t).toISOString(),entity_ids:[L.showroomPower],minimal_response:!0,no_attributes:!0,significant_changes_only:!1}),s=Array.isArray(r)?Array.isArray(r[0])?r[0]:r:Object.values(r||{})[0],o=(Array.isArray(s)?s:[]).map(h=>({value:Number((h==null?void 0:h.state)??(h==null?void 0:h.s)),time:Date.parse(String((h==null?void 0:h.last_changed)??(h==null?void 0:h.last_updated)??(h==null?void 0:h.lu)??(h==null?void 0:h.lc)??""))})).filter(h=>Number.isFinite(h.value)&&Number.isFinite(h.time)),n=new Map;o.forEach(h=>n.set(Math.floor(h.time/36e5),h.value));const c=Math.floor(t/36e5),d=Array.from({length:24},(h,g)=>n.get(c-23+g)).filter(h=>typeof h=="number"),p=Array.from({length:24},(h,g)=>n.get(c-47+g)).filter(h=>typeof h=="number");if(this._history=d,d.length&&p.length){const h=d.reduce((u,m)=>u+m,0)/d.length,g=p.reduce((u,m)=>u+m,0)/p.length;this._historyTrend=g>0?(h-g)/g*100:null}this._historyState=d.length?"ready":"unavailable"}catch{this._historyState="error"}this.requestUpdate()}_setFloor(e){e!==this._activeFloor&&(this._activeFloor=e,this.requestUpdate())}_onTouchStart(e){const t=e.changedTouches[0]||e.touches[0];t&&(this._touchStartX=t.clientX,this._touchLastX=t.clientX)}_onPointerDown(e){e.pointerType==="touch"||e.button!==0||(this._mouseStartX=e.clientX,this._mouseLastX=e.clientX)}_finishFloorSwipe(e){Math.abs(e)<54||this._setFloor(e<0?"upper":"ground")}async _toggleZone(e){var a;if(!((a=this._hass)!=null&&a.callService)||this._actionState==="loading")return;const t=this._availableCircuits(e);if(!t.length)return;const i=e.action?!this._profileActive(e):this._onCircuits(e).length!==t.length;this._actionState="loading",this._actionMessage=`${i?"Encendiendo":"Apagando"} ${e.label}`,this.requestUpdate();try{if(e.action)if(!i)await this._hass.callService("switch","turn_off",{entity_id:t.map(r=>r.entity)});else{e.action.serviceEntity&&!D(this._state(e.action.serviceEntity))&&await this._hass.callService("scene","turn_on",{entity_id:e.action.serviceEntity});const r=e.action.offEntities.filter(o=>!D(this._state(o))),s=e.action.onEntities.filter(o=>!D(this._state(o)));r.length&&await this._hass.callService("switch","turn_off",{entity_id:r}),s.length&&await this._hass.callService("switch","turn_on",{entity_id:s})}else await this._hass.callService("switch",i?"turn_on":"turn_off",{entity_id:t.map(r=>r.entity)});this._actionState="idle",this._actionMessage=i&&e.action?`${e.action.label} aplicado en ${e.label}`:`Orden enviada a ${e.label}`}catch(r){this._actionState="error",this._actionMessage=r instanceof Error?r.message:"No se pudo ejecutar la acción"}this.requestUpdate()}async _setAll(e){var i;if(!((i=this._hass)!=null&&i.callService)||this._actionState==="loading")return;const t=ne.flatMap(a=>this._availableCircuits(a).map(r=>r.entity));if(t.length){this._actionState="loading",this._actionMessage=e?"Encendiendo circuitos disponibles":"Apagando circuitos disponibles",this.requestUpdate();try{await this._hass.callService("switch",e?"turn_on":"turn_off",{entity_id:t}),this._actionState="idle",this._actionMessage="Orden enviada. Esperando confirmación de Home Assistant"}catch(a){this._actionState="error",this._actionMessage=a instanceof Error?a.message:"No se pudo ejecutar la acción"}this.requestUpdate()}}_scrollTo(e){var t;(t=this.renderRoot.querySelector(`#${e}`))==null||t.scrollIntoView({behavior:"smooth",block:"start"})}_toggleMenu(){this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}))}_renderZoneRow(e){var c;const t=this._availableCircuits(e),i=this._onCircuits(e),a=e.circuits.length-t.length,r=this._zonePower(e),s=this._profileActive(e),o=t.length?a?"warning":i.length?"normal":"off":"unavailable",n=o==="unavailable"?"No disponible":o==="warning"?"Parcial":o==="normal"?"Normal":"Apagada";return S`
      <div class="circuit-row" role="row">
        ...
        </div>`:w})}render(){var g;const e=sa[this._activeFloor],t=this._theme==="light"?"light":"dark",i=e.images[t],a=this._weather(),r=this._environment(),s=this._activePower(),o=this._history.length?Math.max(...this._history,1):1,c=(Array.isArray(this._panel.alarm_entities)?this._panel.alarm_entities:[]).map(u=>this._state(u)).filter(u=>u&&!D(u)&&u.state!=="off"),d=!!((g=this._hass)!=null&&g.states&&Object.keys(this._hass.states).length),p=new Intl.DateTimeFormat("es-BO",{hour:"2-digit",minute:"2-digit",hour12:!1}).format(this._clock),h=new Intl.DateTimeFormat("es-BO",{day:"2-digit",month:"short",year:"numeric"}).format(this._clock);return S`
      <div class="bms-shell">
        <header class="topbar">
        ...
        <main class="dashboard-grid">
          <section class="main-column">
            <article id="floor-plan" class="panel floor-card">
              ...
              <div class="floor-viewport" data-no-swipe @touchstart=${this._onTouchStart} @pointerdown=${this._onPointerDown} aria-label="${e.label}: ${e.context}">
                <div class="floor-stage" style="aspect-ratio: ${e.aspectRatio};">
                  <picture>
          ...
          <section class="side-column">
            <article id="alerts" class="panel side-card alerts-card">
              ...
              ${c.length?S`<div class="alert-list">${c.map(u=>{var m;return S`<div class="alert-row">${y("alert-triangle",{size:20})}<div><strong>${String(((m=u==null?void 0:u.attributes)==null?void 0:m.friendly_name)||(u==null?void 0:u.entity_id))}</strong><span>${String(u==null?void 0:u.state)}</span></div></div>`})}</div>`:S`<div class="empty-state">${y("shield",{size:26})}<div><strong>Sin alarmas configuradas</strong><span>Conecta entidades en <code>alarm_entities</code> para habilitar esta sección.</span></div></div>`}
            </article>
