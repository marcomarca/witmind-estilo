      ...
      <div class="app-shell">
        <header class="topbar">
          ...
          <div class="topbar-meta">
            ...
            <button class="theme-button" data-action="toggle-theme" aria-label="Cambiar a tema ${a}" title="Cambiar a tema ${a}">${q}</button>
          </div>
        </header>
