      ...
      <div class="app-shell">
        <header class="topbar">
          ...
          <div class="topbar-meta">
            ...
            <div class="header-weather" aria-label="Clima actual: ${this._escape(C[i]||i||"Sin datos")}, ${this._escape(r.temperature??"Sin datos")}${this._escape(r.temperature_unit??"°")}">
              <span aria-hidden="true">${this._escape(A[i]||"·")}</span>
              <strong>${this._escape(r.temperature??"--")}${this._escape(r.temperature_unit??"°")}</strong>
            </div>
            <button class="theme-button" data-action="toggle-theme" aria-label="Cambiar a tema ${a}" title="Cambiar a tema ${a}">${P}</button>
          </div>
        </header>
