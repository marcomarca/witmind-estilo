      ...
      <div class="operations-shell">
        <header class="topbar">
          ...
          <div class="status-strip" aria-label="Resumen de ${this._escape(a)}">
            <button class="status-pill ${n?"is-active":""}" type="button"><span class="status-pill-icon">${this._icon("bulb")}</span><span><strong>${n} de ${t.length}</strong><small>Circuitos</small></span></button>
            <button class="status-pill ${o?"is-active":""}" type="button"><span class="status-pill-icon">${this._icon("power")}</span><span><strong>${N(o)}</strong><small>Activos</small></span></button>
            <button class="status-pill" type="button"><span class="status-pill-icon">${this._icon("energy")}</span><span><strong>${N(s)}</strong><small>Instalados</small></span></button>
          </div>
          <div class="topbar-meta">
