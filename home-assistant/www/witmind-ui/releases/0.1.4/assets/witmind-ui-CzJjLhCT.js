...
`;class j extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._hass=null,this._panel=null,this._narrow=!1,this._started=!1,this._renderQueued=!1,this._forecast=[],this._history=[],this._historyError="",this._liveStates=new Map,this._pendingSwitches=new Map,this._switchErrors=new Map,this._switchTimers=new Map,this._pendingAction="",this._confirmAction="",this._toast=null,this._toastTimer=null,this._clockTimer=null,this._historyTimer=null,this._unsubscribeStates=null,this._unsubscribeForecast=null,this._forecastEntity="",this._energyRange="day",this._energyDayOffset=0,this._energyData=[],this._energyLoading=!1,this._energyError=null,this._energyMonthTotal=null,this._energyRequestId=0,this._energyRefreshTimer=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._themeStorageKey="witmind-showroom-panel-theme",this._theme=this._loadTheme(),this._activeView="home",this.shadowRoot.addEventListener("click",e=>this._handleClick(e)),this.shadowRoot.addEventListener("scroll",e=>this._handleEnergyScroll(e),!0)}set hass(e){var o,s,l,c;const t=this._hass,r=this._config(),i=this._relevantHassChanged(t,e),a=!t||((o=t.states)==null?void 0:o[r.energySensor])!==((s=e==null?void 0:e.states)==null?void 0:s[r.energySensor]),n=!((l=t==null?void 0:t.states)!=null&&l[r.energySensor])&&!!((c=e==null?void 0:e.states)!=null&&c[r.energySensor]);this._hass=e,i&&this._syncStatesFromHass(),this._started?a&&(n?this._loadEnergyStatistics():this._scheduleEnergyRefresh()):(this._started=!0,this._start()),i&&this._requestRender()}get hass(){return this._hass}set panel(e){const t=this._config().weather;this._panel=e;const r=this._config().weather;this._started&&t!==r&&(this._resetForecastSubscription(),this._subscribeWeather()),this._hass&&(this._syncStatesFromHass(),this._loadEnergyStatistics(),this._requestRender())}get panel(){return this._panel}set narrow(e){this._narrow=!!e,this.toggleAttribute("narrow",this._narrow)}get narrow(){return this._narrow}connectedCallback(){this._hass&&(this._requestRender(),this._scheduleEnergyRefresh(!0))}disconnectedCallback(){clearInterval(this._clockTimer),clearInterval(this._historyTimer),clearTimeout(this._toastTimer),clearTimeout(this._energyRefreshTimer),this._energyRequestId+=1;for(const e of this._switchTimers.values())clearTimeout(e);this._switchTimers.clear(),this._resetForecastSubscription(),this._unsubscribeStates&&(this._unsubscribeStates(),this._unsubscribeStates=null),this._started=!1}_requestRender(){this._renderQueued||!this._hass||!this.shadowRoot||(this._renderQueued=!0,requestAnimationFrame(()=>{this._renderQueued=!1,this.render()}))}_handleClick(e){const t=e.target.closest("[data-action]");if(!t||!this._hass)return;const r=t.dataset.action;if(r==="toggle-menu"){this._toggleHomeAssistantMenu();return}if(r==="toggle-theme"){this._toggleTheme();return}if(r==="set-view"){const i=t.dataset.view;["home","lights","energy","system"].includes(i)&&(this._activeView=i,this._requestRender());return}if(r==="toggle-switch"){this._toggleSwitch(t.dataset.entity);return}if(r==="run-scene"){this._runScene(t.dataset.sceneKey||t.dataset.entity,t.dataset.label);return}if(r==="open-power-on"){this._pendingAction||(this._confirmAction="on",this._requestRender());return}if(r==="open-power-off"){this._pendingAction||(this._confirmAction="off",this._requestRender());return}if(r==="cancel-power-confirm"){const i=e.target.closest("[data-dialog-card]");if(t.classList.contains("dialog-backdrop")&&i)return;this._pendingAction||(this._confirmAction="",this._requestRender());return}if(r==="confirm-power"){this._confirmGeneralPower();return}if(r==="clear-scene"){this._clearScene();return}if(r==="media"){this._mediaAction(t.dataset.service);return}if(r==="energy-range"){this._setEnergyRange(t.dataset.range);return}if(r==="energy-day-prev"){this._shiftEnergyDay(-1);return}if(r==="energy-day-next"){this._shiftEnergyDay(1);return}if(r==="energy-day-today"){this._resetEnergyDay();return}r==="refresh-energy"&&(this._energyLastLoadedAt=0,this._loadEnergyStatistics())}_toggleHomeAssistantMenu(){this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}))}_loadTheme(){try{return localStorage.getItem(this._themeStorageKey)==="light"?"light":"dark"}catch{return"dark"}}_saveTheme(){try{localStorage.setItem(this._themeStorageKey,this._theme)}catch(e){console.warn("No se pudo guardar el tema del showroom:",e)}}_toggleTheme(){this._theme=this._theme==="dark"?"light":"dark",this.setAttribute("data-theme",this._theme),this._saveTheme(),this._requestRender()}_config(){var p;const e=((p=this._panel)==null?void 0:p.config)||{},t=h=>Array.isArray(h)?[...new Set(h.filter(Boolean).map(m=>String(m)))]:[],r=(h,m)=>(Array.isArray(h)&&h.length?h:m).filter(S=>S==null?void 0:S.entity).map((S,u)=>({entity:String(S.entity),name:S.name||`Dispositivo ${u+1}`,subtitle:S.subtitle||"Iluminación",icon:S.icon||"bulb"})),i=r(e.spots,b.spots),a=r(e.samples||e.muestras,b.samples),n=[...i,...a].map(h=>h.entity),o=t(e.scene_control_entities||e.sceneControlEntities),s=o.length?o:n,l=(h,m,x)=>(Array.isArray(h)&&h.length?h:m).filter(u=>(u==null?void 0:u.entity)||(u==null?void 0:u.id)||(u==null?void 0:u.key)).map((u,_)=>{const k=u.entity?String(u.entity):"",$=String(u.id||u.key||k||`${x}-${_+1}`),y=m.find(M=>{const L=M.entity?String(M.entity):"",H=String(M.id||M.key||L||"");return k&&L===k||H===$}),E=k||(y!=null&&y.entity?String(y.entity):""),D=String(u.id||u.key||(y==null?void 0:y.id)||E||`${x}-${_+1}`),N=E||`${x}:${D}`,w=Array.isArray(u.on_entities)||Array.isArray(u.onEntities),f=Array.isArray(u.off_entities)||Array.isArray(u.offEntities),T=t(w?u.on_entities||u.onEntities:y==null?void 0:y.onEntities),O=t(f?u.off_entities||u.offEntities:[]),q=f?O.filter(M=>!T.includes(M)):s.filter(M=>!T.includes(M));return{key:N,id:D,entity:E,name:u.name||(y==null?void 0:y.name)||`Escena ${_+1}`,subtitle:u.subtitle||(y==null?void 0:y.subtitle)||"Escena del showroom",icon:u.icon||(y==null?void 0:y.icon)||"presentation",directOnly:u.direct_only??u.directOnly??(y==null?void 0:y.directOnly)??!1,onEntities:T,offEntities:q}}),c=e.reflector||b.reflector,d=Number(e.history_hours??e.historyHours),g=Number(e.chart_hours??e.chartHours);return{title:e.title||b.title,subtitle:e.subtitle||b.subtitle,siteLabel:e.site_label||e.siteLabel||b.siteLabel,logo:e.logo||b.logo,weather:e.weather||b.weather,mediaPlayer:e.media_player||e.mediaPlayer||b.mediaPlayer,lightCountSensor:e.light_count_sensor||e.lightCountSensor||b.lightCountSensor,energySensor:e.energy_sensor||e.energySensor||b.energySensor,batteryLevel:e.battery_level||e.batteryLevel||b.batteryLevel,powerOnScript:e.power_on_script||e.powerOnScript||b.powerOnScript,powerOffScript:e.power_off_script||e.powerOffScript||b.powerOffScript,historyHours:Number.isFinite(d)&&d>0?Math.min(24,d):b.historyHours,chartHours:Number.isFinite(g)&&g>0?Math.min(72,g):b.chartHours,showForecast:e.show_forecast??e.showForecast??b.showForecast,spots:i,samples:a,sceneControlEntities:s,reflector:c!=null&&c.entity?{entity:String(c.entity),name:c.name||b.reflector.name,subtitle:c.subtitle||b.reflector.subtitle,icon:c.icon||b.reflector.icon}:null,scenes:l(e.scenes,b.scenes,"scene"),sampleScenes:l(e.sample_scenes||e.sampleScenes,b.sampleScenes,"sample")}}_allDevices(){const e=this._config();return[...e.spots,...e.samples,...e.reflector?[e.reflector]:[]]}_allScenes(e=this._config()){return[...e.scenes,...e.sampleScenes]}_trackedEntities(){const e=this._config();return new Set([...this._allDevices().map(t=>t.entity),...e.sceneControlEntities,...this._allScenes(e).flatMap(t=>[t.entity,...t.onEntities,...t.offEntities]),e.weather,e.mediaPlayer,e.lightCountSensor,e.energySensor,e.batteryLevel,e.powerOnScript,e.powerOffScript].filter(Boolean))}_relevantHassChanged(e,t){var r,i;if(!e||!t)return!0;for(const a of this._trackedEntities())if(((r=e.states)==null?void 0:r[a])!==((i=t.states)==null?void 0:i[a]))return!0;return!1}async _start(){this._clockTimer=setInterval(()=>this._updateClock(),3e4),await Promise.allSettled([this._fetchCurrentStates(),this._subscribeStateChanges(),this._subscribeWeather(),this._loadEnergyStatistics()])}_syncStatesFromHass(){var e;if((e=this._hass)!=null&&e.states)for(const t of this._trackedEntities()){const r=this._hass.states[t];r&&this._applyLiveState(t,r)}}_applyLiveState(e,t){if(!t){this._liveStates.delete(e);return}this._liveStates.set(e,t);const r=this._pendingSwitches.get(e);if(r&&t.state===r.desired){this._pendingSwitches.delete(e),this._switchErrors.delete(e);const i=this._switchTimers.get(e);i&&clearTimeout(i),this._switchTimers.delete(e)}}async _fetchCurrentStates(){var e;if((e=this._hass)!=null&&e.callWS)try{const t=await this._hass.callWS({type:"get_states"}),r=this._trackedEntities();for(const i of t||[])r.has(i.entity_id)&&this._applyLiveState(i.entity_id,i);this._requestRender()}catch(t){console.error("No se pudieron sincronizar los estados del showroom:",t)}}async _subscribeStateChanges(){var e;if(!(!((e=this._hass)!=null&&e.connection)||this._unsubscribeStates))try{this._unsubscribeStates=await this._hass.connection.subscribeEvents(t=>{var i;const r=(i=t==null?void 0:t.data)==null?void 0:i.entity_id;!r||!this._trackedEntities().has(r)||(this._applyLiveState(r,t.data.new_state),r===this._config().energySensor&&this._scheduleEnergyRefresh(),this._requestRender())},"state_changed")}catch(t){console.error("No se pudo suscribir a state_changed:",t)}}_resetForecastSubscription(){this._unsubscribeForecast&&(this._unsubscribeForecast(),this._unsubscribeForecast=null),this._forecastEntity=""}async _subscribeWeather(){var t;const e=this._config();if(!(!((t=this._hass)!=null&&t.connection)||!e.weather)&&!(this._unsubscribeForecast&&this._forecastEntity===e.weather)){this._resetForecastSubscription();try{this._forecastEntity=e.weather,this._unsubscribeForecast=await this._hass.connection.subscribeMessage(r=>{this._forecast=Array.isArray(r==null?void 0:r.forecast)?r.forecast:[],this._requestRender()},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e.weather})}catch(r){this._forecastEntity="",console.error("No se pudo cargar el pronóstico:",r)}}}_energyRefreshInterval(){return this._energyRange==="day"?3e4:this._energyRange==="month"?12e4:3e5}_scheduleEnergyRefresh(e=!1){if(!this._hass||!this.isConnected||(clearTimeout(this._energyRefreshTimer),this._energyRange==="day"&&this._energyDayOffset!==0))return;const t=this._energyRefreshInterval(),r=this._energyLastLoadedAt?Date.now()-this._energyLastLoadedAt:0,i=e?0:this._energyLastLoadedAt?Math.max(1e3,t-r):t;this._energyRefreshTimer=setTimeout(()=>this._loadEnergyStatistics(),i)}_energyRangeDefinition(e=this._energyRange){const t=new Date;let r,i=t,a,n,o,s=!1;if(e==="year")r=new Date(t.getFullYear(),0,1,0,0,0,0),a="month",n=`Año ${t.getFullYear()}`,o="mes";else if(e==="month")r=new Date(t.getFullYear(),t.getMonth(),1,0,0,0,0),a="day",n=t.toLocaleDateString("es-BO",{month:"long",year:"numeric"}),o="día";else{const l=new Date(t.getFullYear(),t.getMonth(),t.getDate(),0,0,0,0);r=new Date(l.getFullYear(),l.getMonth(),l.getDate()+Math.min(0,Number(this._energyDayOffset)||0),0,0,0,0),s=r.getTime()===l.getTime(),i=s?t:new Date(r.getFullYear(),r.getMonth(),r.getDate()+1,0,0,0,0),a="hour",n=r.toLocaleDateString("es-BO",{weekday:"long",day:"numeric",month:"long"}),o="hora"}return{start:r,end:i,period:a,title:n,intervalLabel:o,isToday:s}}_energyValueToKWh(e,t){const r=Number(e);if(!Number.isFinite(r))return null;const i=String(t||"kWh").trim().toLowerCase().replaceAll(" ","");return i==="kwh"?r:i==="wh"?r/1e3:i==="mwh"?r*1e3:null}_deriveEnergyStateDeltas(e,t,r){const i=Number(t instanceof Date?t.getTime():t),a=Number(r instanceof Date?r.getTime():r),n=e.filter(l=>Number.isFinite(Number(l.start))&&Number.isFinite(Number(l.state))).sort((l,c)=>Number(l.start)-Number(c.start)),o=[];let s=null;for(const l of n){const c=Number(l.start),d=Number(l.state);if(c<i){s=d;continue}if(c>=a)break;let g=0;if(Number.isFinite(s)){const p=d-s;g=p>=0?p:Math.max(0,d)}o.push({...l,change:g}),s=d}return o}_aggregateEnergyDayRows(e,t,r){var l;const i=new Date(t.start),a=new Date(t.end),n=t.isToday?new Date(a.getFullYear(),a.getMonth(),a.getDate(),a.getHours(),0,0,0):new Date(i.getFullYear(),i.getMonth(),i.getDate(),23,0,0,0),o=new Map;for(let c=new Date(i);c<=n;c.setHours(c.getHours()+1)){const d=c.getTime();o.set(d,{start:d,end:new Date(c.getFullYear(),c.getMonth(),c.getDate(),c.getHours()+1,0,0,0).getTime(),change:0,samples:0,partial:t.isToday&&d===n.getTime(),live:!1})}let s=null;for(const c of e){const d=new Date(Number(c.start));if(!Number.isFinite(d.getTime()))continue;const g=new Date(d.getFullYear(),d.getMonth(),d.getDate(),d.getHours(),0,0,0).getTime(),p=o.get(g);p&&(p.change+=Math.max(0,Number(c.change)||0),p.samples+=1,Number.isFinite(c.state)&&(!s||Number(c.end||c.start)>Number(s.end||s.start))&&(s=c))}if(t.isToday){const c=this._energyValueToKWh(r==null?void 0:r.state,(l=r==null?void 0:r.attributes)==null?void 0:l.unit_of_measurement),d=s==null?void 0:s.state,g=Number((s==null?void 0:s.end)||(s==null?void 0:s.start)),p=o.get(n.getTime());if(p&&Number.isFinite(c)&&Number.isFinite(d)&&Number.isFinite(g)&&g>=n.getTime()&&a.getTime()-g>=0&&a.getTime()-g<=900*1e3){const h=c-d;Number.isFinite(h)&&h>=0&&(p.change+=h,p.live=h>0)}}return[...o.values()].filter(c=>c.samples>0||c.live)}_calculateCurrentMonthEnergy(e,t,r){var g;const i=new Date(t),a=new Date(i.getFullYear(),i.getMonth(),1,0,0,0,0).getTime(),n=e.filter(p=>Number.isFinite(Number(p.start))&&Number(p.start)>=a).sort((p,h)=>Number(p.start)-Number(h.start));let o=n.reduce((p,h)=>p+Math.max(0,Number(h.change)||0),0),s=null;for(const p of n)Number.isFinite(Number(p.state))&&(!s||Number(p.end||p.start)>Number(s.end||s.start))&&(s=p);const l=this._energyValueToKWh(r==null?void 0:r.state,(g=r==null?void 0:r.attributes)==null?void 0:g.unit_of_measurement),c=Number(s==null?void 0:s.state),d=Number((s==null?void 0:s.end)||(s==null?void 0:s.start));if(Number.isFinite(l)&&Number.isFinite(c)&&Number.isFinite(d)&&d>=a&&d<=i.getTime()&&i.getTime()-d<=7200*1e3){const p=l-c;Number.isFinite(p)&&p>=0&&(o+=p)}return n.length||Number.isFinite(c)?o:null}_aggregateEnergyCalendarRows(e,t,r,i){var d;if(!["month","year"].includes(i))return[];const a=new Map;let n=null;for(const g of e){const p=Number(g.start);if(!Number.isFinite(p))continue;const h=new Date(p),m=i==="month"?new Date(h.getFullYear(),h.getMonth(),h.getDate(),0,0,0,0).getTime():new Date(h.getFullYear(),h.getMonth(),1,0,0,0,0).getTime(),x=a.get(m)||{start:m,change:0,samples:0,partial:!1,live:!1};x.change+=Math.max(0,Number(g.change)||0),x.samples+=1,a.set(m,x),Number.isFinite(Number(g.state))&&(!n||p>Number(n.start))&&(n=g)}const o=this._energyValueToKWh(r==null?void 0:r.state,(d=r==null?void 0:r.attributes)==null?void 0:d.unit_of_measurement),s=Number(n==null?void 0:n.state),l=Number(n==null?void 0:n.start),c=new Date(t.end);if(Number.isFinite(o)&&Number.isFinite(s)&&Number.isFinite(l)&&l<=c.getTime()&&c.getTime()-l<=7200*1e3){const g=o-s;if(Number.isFinite(g)&&g>=0){const p=i==="month"?new Date(c.getFullYear(),c.getMonth(),c.getDate(),0,0,0,0).getTime():new Date(c.getFullYear(),c.getMonth(),1,0,0,0,0).getTime(),h=a.get(p)||{start:p,change:0,samples:0,partial:!1,live:!1};h.change+=g,h.live=g>0,a.set(p,h)}}return[...a.values()].sort((g,p)=>Number(g.start)-Number(p.start))}_energyViewSignature(){return JSON.stringify([this._energyRange,this._energyDayOffset,this._energyMonthTotal,this._energyError||"",this._energyData.map(e=>[Number(e.start),Number(e.change)||0,Number(e.samples)||0,!!e.partial,!!e.live])])}async _loadEnergyStatistics(){var p;if(!((p=this._hass)!=null&&p.connection))return;clearTimeout(this._energyRefreshTimer);const e=this._config(),t=this._state(e.energySensor),r=Number(t==null?void 0:t.state);if(!t){this._energyData=[],this._energyMonthTotal=null,this._energyError=`No existe ${e.energySensor} en Home Assistant.`,this._energyLoading=!1,this._requestRender();return}if(!Number.isFinite(r)){this._energyData=[],this._energyMonthTotal=null,this._energyError=`${e.energySensor} no entrega un valor numérico.`,this._energyLoading=!1,this._requestRender();return}const i=++this._energyRequestId,a=this._energyViewSignature(),n=this._energyData.length>0,o=this._energyRangeDefinition(),s=new Date,l=new Date(s.getFullYear(),s.getMonth(),1,0,0,0,0),c=new Date(o.start.getTime()-3600*1e3),d=this._energyRange==="year"?"hour":"5minute",g=new Date(l.getTime()-3600*1e3);this._energyLoading=!0,this._energyError=null,n||this._requestRender();try{const h=await this._hass.connection.sendMessagePromise({type:"recorder/get_statistics_metadata",statistic_ids:[e.energySensor]});if(i!==this._energyRequestId)return;const x=(Array.isArray(h)?h:[]).find(w=>(w==null?void 0:w.statistic_id)===e.energySensor)||null;if(!x||!x.has_sum)throw new Error("La entidad no dispone de estadísticas acumulables. Verifica device_class: energy y state_class total/total_increasing.");const S=this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:c.toISOString(),end_time:o.end.toISOString(),statistic_ids:[e.energySensor],period:d,units:{energy:"kWh"},types:["state"]}),u=this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:g.toISOString(),end_time:s.toISOString(),statistic_ids:[e.energySensor],period:"hour",units:{energy:"kWh"},types:["state"]}),[_,k]=await Promise.all([S,u]);if(i!==this._energyRequestId)return;const $=w=>(Array.isArray(w==null?void 0:w[e.energySensor])?w[e.energySensor]:[]).map(f=>({start:Number(f.start),end:Number(f.end),change:f.change===void 0||f.change===null?null:Math.max(0,Number(f.change)||0),state:f.state===void 0||f.state===null?null:Number(f.state)})).filter(f=>Number.isFinite(f.start)&&(Number.isFinite(f.state)||Number.isFinite(f.change))),y=$(_),E=this._deriveEnergyStateDeltas(y,o.start,o.end);this._energyData=this._energyRange==="day"?this._aggregateEnergyDayRows(E,o,t):this._aggregateEnergyCalendarRows(E,o,t,this._energyRange);const D=$(k),N=this._deriveEnergyStateDeltas(D,l,s);if(this._energyMonthTotal=this._calculateCurrentMonthEnergy(N,s,t),this._energyRange==="month"&&this._energyData.length)this._energyMonthTotal=this._energyData.reduce((w,f)=>w+Math.max(0,Number(f.change)||0),0);else if(this._energyRange==="year"&&Number.isFinite(this._energyMonthTotal)){const w=new Date(s.getFullYear(),s.getMonth(),1,0,0,0,0).getTime(),f=this._energyData.find(T=>Number(T.start)===w);f&&(f.change=this._energyMonthTotal)}this._energyLastLoadedAt=Date.now(),this._energyError=null}catch(h){if(i!==this._energyRequestId)return;this._energyData=[],this._energyMonthTotal=null,this._energyError=(h==null?void 0:h.message)||"No se pudieron consultar las estadísticas energéticas.",console.error("Error cargando estadísticas de energía del showroom:",h)}finally{if(i===this._energyRequestId){this._energyLoading=!1;const h=a!==this._energyViewSignature();(!n||h)&&this._requestRender(),this._scheduleEnergyRefresh()}}}_setEnergyRange(e){!["day","month","year"].includes(e)||e===this._energyRange||(this._energyRange=e,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_shiftEnergyDay(e){if(this._energyRange!=="day")return;const t=Number(e);if(!Number.isFinite(t)||t===0)return;const r=Math.min(0,this._energyDayOffset+t);r!==this._energyDayOffset&&(this._energyDayOffset=r,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_resetEnergyDay(){this._energyRange!=="day"||this._energyDayOffset===0||(this._energyDayOffset=0,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_formatEnergy(e,t=2){const r=Number(e);return Number.isFinite(r)?r.toLocaleString("es-BO",{minimumFractionDigits:t,maximumFractionDigits:t}):"--"}_energyLabel(e,t=this._energyRange){const r=new Date(Number(e));return Number.isFinite(r.getTime())?t==="year"?r.toLocaleDateString("es-BO",{month:"short"}).replace(".",""):t==="month"?String(r.getDate()):r.toLocaleTimeString("es-BO",{hour:"2-digit",minute:"2-digit",hour12:!1}):"--"}_captureEnergyChartScroll(){var r;const e=(r=this.shadowRoot)==null?void 0:r.querySelector("[data-energy-scroll]");if(!e)return;const t=Math.max(0,e.scrollWidth-e.clientWidth);this._energyScrollLeft=e.scrollLeft,this._energyAutoFollow=t<=0||t-e.scrollLeft<=8}_handleEnergyScroll(e){var i,a;const t=(a=(i=e.target)==null?void 0:i.closest)==null?void 0:a.call(i,"[data-energy-scroll]");if(!t)return;const r=Math.max(0,t.scrollWidth-t.clientWidth);this._energyScrollLeft=t.scrollLeft,this._energyAutoFollow=r<=0||r-t.scrollLeft<=8}_restoreEnergyChartScroll(){var r;const e=(r=this.shadowRoot)==null?void 0:r.querySelector("[data-energy-scroll]");if(!e)return;const t=Math.max(0,e.scrollWidth-e.clientWidth);if(this._energyAutoFollow||this._energyScrollLeft===null){e.scrollLeft=t,this._energyScrollLeft=e.scrollLeft;return}e.scrollLeft=Math.max(0,Math.min(this._energyScrollLeft,t))}_energyChart(){const e=this._energyData;if(this._energyLoading&&!e.length)return'<div class="energy-empty"><span class="energy-spinner"></span>Consultando estadísticas de Home Assistant…</div>';if(this._energyError)return`<div class="energy-empty error">${this._icon("status")}<span>${this._escape(this._energyError)}</span></div>`;if(!e.length)return'<div class="energy-empty">No hay estadísticas de consumo disponibles para este período.</div>';const t=280,r=14,i=16,a=22,n=42,o=this._energyRange==="day"?64:this._energyRange==="month"?36:58,s=Math.max(620,e.length*o+r+i),l=t-a-n,c=s-r-i,d=Math.max(...e.map(_=>_.change),.001),g=this._energyRange==="day"?10:e.length>24?4:7,p=Math.max(6,(c-g*Math.max(0,e.length-1))/e.length),h=this._energyRange==="month"?Math.max(1,Math.ceil(e.length/10)):this._energyRange==="day"?2:1,m=[0,.25,.5,.75,1],x=m.map(_=>{const k=a+l*(1-_);return`<line x1="${r}" y1="${k.toFixed(1)}" x2="${s-i}" y2="${k.toFixed(1)}" class="energy-grid-line"/>`}).join(""),S=m.map(_=>{const k=a+l*(1-_),$=this._formatEnergy(d*_,d<1?2:1);return`<span class="energy-y-tick" style="top:${k.toFixed(1)}px">${this._escape($)}</span>`}).join(""),u=e.map((_,k)=>{const $=r+k*(p+g),y=_.change>0?Math.max(2,_.change/d*l):1,E=a+l-y,D=k%h===0||k===e.length-1,N=this._energyLabel(_.start),w=_.partial?" · en curso":"",f=_.partial?`<text x="${($+p/2).toFixed(1)}" y="${(a+10).toFixed(1)}" text-anchor="middle" class="energy-current-label">ahora</text>`:"";return`<g class="energy-bar-group ${_.partial?"is-current":""}"><rect x="${$.toFixed(1)}" y="${E.toFixed(1)}" width="${p.toFixed(1)}" height="${y.toFixed(1)}" rx="${Math.min(4,p/2).toFixed(1)}" class="energy-bar ${_.partial?"is-partial":""}"><title>${this._escape(N)} · ${this._formatEnergy(_.change)} kWh${w}</title></rect>${f}${D?`<text x="${($+p/2).toFixed(1)}" y="${t-14}" text-anchor="middle" class="energy-axis-text">${this._escape(N)}</text>`:""}</g>`}).join("");return`<div class="energy-chart-layout"><div class="energy-y-axis" aria-hidden="true"><span class="energy-y-unit">kWh</span>${S}</div><div class="energy-chart-wrap" data-energy-scroll><svg class="energy-chart" width="${s}" height="${t}" viewBox="0 0 ${s} ${t}" role="img" aria-label="Gráfica de consumo energético estimado en kWh">${x}${u}</svg></div></div>`}async _loadHistory(){var o;const e=this._config();if(!((o=this._hass)!=null&&o.callApi))return;const t=Math.max(e.historyHours,e.chartHours),r=new Date(Date.now()-t*60*60*1e3).toISOString(),i=new Date().toISOString(),a=[e.lightCountSensor,...e.spots.map(s=>s.entity),...e.samples.map(s=>s.entity)].filter(Boolean).join(",");if(!a)return;const n=`history/period/${encodeURIComponent(r)}?filter_entity_id=${encodeURIComponent(a)}&end_time=${encodeURIComponent(i)}&minimal_response&no_attributes`;try{this._history=await this._hass.callApi("GET",n),this._historyError=""}catch(s){this._history=[],this._historyError="No se pudo cargar el historial.",console.error("No se pudo cargar el historial del showroom:",s)}this._requestRender()}_state(e){var t,r;return this._liveStates.get(e)||((r=(t=this._hass)==null?void 0:t.states)==null?void 0:r[e])}_isUnavailable(e){var r;const t=(r=this._state(e))==null?void 0:r.state;return!t||t==="unknown"||t==="unavailable"}_visibleSwitchState(e){var t,r;return((t=this._pendingSwitches.get(e))==null?void 0:t.desired)||((r=this._state(e))==null?void 0:r.state)||"unavailable"}async _toggleSwitch(e){if(!e||!this._hass)return;const t=this._state(e);if(!t||["unknown","unavailable"].includes(t.state)){this._switchErrors.set(e,"No disponible"),this._requestRender();return}const i=this._visibleSwitchState(e)==="on"?"off":"on",a=i==="on"?"turn_on":"turn_off",n=e.split(".")[0]||"switch";this._pendingSwitches.set(e,{desired:i,startedAt:Date.now()}),this._switchErrors.delete(e),this._requestRender();try{await this._hass.callService(n,a,{entity_id:e});const o=this._switchTimers.get(e);o&&clearTimeout(o);const s=setTimeout(()=>this._verifySwitchState(e,i),6e3);this._switchTimers.set(e,s)}catch(o){this._pendingSwitches.delete(e),this._switchErrors.set(e,"La acción falló"),this._requestRender(),console.error(`Error ejecutando ${a} en ${e}:`,o)}}async _verifySwitchState(e,t){var i;await this._fetchCurrentStates();const r=((i=this._state(e))==null?void 0:i.state)===t;this._pendingSwitches.delete(e),this._switchTimers.delete(e),r?this._switchErrors.delete(e):this._switchErrors.set(e,"Sin confirmación"),this._requestRender()}_sceneStatus(e){const t=[...e.onEntities.map(a=>({entityId:a,desired:"on"})),...e.offEntities.map(a=>({entityId:a,desired:"off"}))];if(!t.length)return{active:!1,unavailable:!1,mismatches:[]};const r=t.some(({entityId:a})=>this._isUnavailable(a)),i=t.filter(({entityId:a,desired:n})=>{var o;return((o=this._state(a))==null?void 0:o.state)!==n});return{active:!r&&i.length===0,unavailable:r,mismatches:i}}_sceneExpectations(e){return[...e.offEntities.map(t=>({entityId:t,desired:"off"})),...e.onEntities.map(t=>({entityId:t,desired:"on"}))]}_markExpectedStates(e){const t=Date.now();for(const{entityId:r,desired:i}of e)this._pendingSwitches.set(r,{desired:i,startedAt:t}),this._switchErrors.delete(r)}_clearExpectedStates(e){for(const{entityId:t}of e){this._pendingSwitches.delete(t);const r=this._switchTimers.get(t);r&&clearTimeout(r),this._switchTimers.delete(t)}}async _setEntitiesState(e,t){const r=[...new Set((e||[]).filter(Boolean))];if(!r.length)return;const i=new Map;for(const n of r){const o=n.split(".")[0];o&&(i.has(o)||i.set(o,[]),i.get(o).push(n))}const a=t==="on"?"turn_on":"turn_off";for(const[n,o]of i)await this._hass.callService(n,a,{entity_id:o})}async _waitForExpectedStates(e,t=7e3){const r=Date.now()+t;let i=e;for(;Date.now()<r;){if(await this._fetchCurrentStates(),i=e.filter(({entityId:a,desired:n})=>{var o;return((o=this._state(a))==null?void 0:o.state)!==n}),!i.length)return{ok:!0,mismatches:[]};await new Promise(a=>setTimeout(a,450))}return{ok:!1,mismatches:i}}async _runScene(e,t){var o;if(!e||this._pendingAction)return;const r=this._config(),i=this._allScenes(r).find(s=>s.key===e||s.entity===e);if(!i){this._notify("La escena no está configurada.","error");return}const a=this._sceneExpectations(i);this._pendingAction=i.key,this._markExpectedStates(a),this._requestRender();let n=null;try{if(i.entity&&!i.directOnly)try{await this._hass.callService("scene","turn_on",{entity_id:i.entity})}catch(c){n=c,console.warn(`La escena ${i.entity} no respondió; se aplicará el perfil directo.`,c)}await this._setEntitiesState(i.offEntities,"off"),await this._setEntitiesState(i.onEntities,"on");const s=await this._waitForExpectedStates(a);if(!s.ok){const c=s.mismatches.map(d=>d.entityId).join(", ");throw new Error(`No se confirmaron los estados de: ${c}`)}const l=n?`${t||"Modo"} aplicado mediante control directo.`:`${t||"Modo"} activo.`;this._notify(l,"success")}catch(s){for(const{entityId:l,desired:c}of a)((o=this._state(l))==null?void 0:o.state)!==c&&this._switchErrors.set(l,"No confirmó el modo");this._notify("No se pudo aplicar completamente el modo seleccionado.","error"),console.error("Error aplicando modo del showroom:",s)}finally{this._clearExpectedStates(a),this._pendingAction="",await this._fetchCurrentStates(),this._requestRender()}}async _executeGeneralPower(e,t={}){var l;if(!this._hass||this._pendingAction||!["on","off"].includes(e))return!1;const r=this._config(),i=e==="on"?r.powerOnScript:r.powerOffScript,a=r.sceneControlEntities.map(c=>({entityId:c,desired:e})),n=t.successMessage||(e==="on"?"Iluminación general encendida.":"Iluminación general apagada."),o=t.errorMessage||(e==="on"?"No se pudo encender toda la iluminación.":"No se pudo apagar toda la iluminación.");this._pendingAction=i||`direct-power-${e}`,this._markExpectedStates(a),this._requestRender();let s=null;try{if(i)try{await this._hass.callService("script","turn_on",{entity_id:i})}catch(d){s=d,console.warn(`El script ${i} no respondió; se aplicará el control directo.`,d)}await this._setEntitiesState(r.sceneControlEntities,e);const c=await this._waitForExpectedStates(a);if(!c.ok){const d=c.mismatches.map(g=>g.entityId).join(", ");throw new Error(`No se confirmaron los estados de: ${d}`)}return this._confirmAction="",this._notify(n,"success"),!0}catch(c){for(const{entityId:d,desired:g}of a)((l=this._state(d))==null?void 0:l.state)!==g&&this._switchErrors.set(d,"Sin confirmación");return this._notify(o,"error"),console.error("Error ejecutando el control general del showroom:",{error:c,scriptError:s,desired:e}),!1}finally{this._clearExpectedStates(a),this._pendingAction="",await this._fetchCurrentStates(),this._requestRender()}}async _confirmGeneralPower(){const e=this._confirmAction;["on","off"].includes(e)&&await this._executeGeneralPower(e,{successMessage:e==="on"?"Toda la iluminación del showroom está encendida.":"Toda la iluminación del showroom está apagada."})}async _clearScene(){this._pendingAction||await this._executeGeneralPower("off",{successMessage:"Escena apagada. La iluminación del showroom quedó apagada.",errorMessage:"No se pudo apagar completamente la escena."})}async _mediaAction(e){const t=this._config().mediaPlayer;if(!(!t||!e||this._isUnavailable(t)))try{await this._hass.callService("media_player",e,{entity_id:t})}catch(r){this._notify("No se pudo controlar el reproductor.","error"),console.error(`Error ejecutando media_player.${e}:`,r)}}_notify(e,t="success"){clearTimeout(this._toastTimer),this._toast={message:e,type:t},this._requestRender(),this._toastTimer=setTimeout(()=>{this._toast=null,this._requestRender()},4200)}_historyMap(){var t;const e=new Map;for(const r of this._history||[]){const i=(t=r==null?void 0:r[0])==null?void 0:t.entity_id;i&&e.set(i,r)}return e}_historySegments(e,t,r){if(!Array.isArray(e)||!e.length)return[];const i=e.map(n=>({state:n.state,time:new Date(n.last_changed||n.last_updated).getTime()})).filter(n=>Number.isFinite(n.time)).sort((n,o)=>n.time-o.time);if(!i.length)return[];const a=[];for(let n=0;n<i.length;n+=1){const o=i[n],s=i[n+1],l=Math.max(t,o.time),c=Math.min(r,(s==null?void 0:s.time)??r);c<=l||a.push({state:o.state,left:(l-t)/(r-t)*100,width:(c-l)/(r-t)*100})}return a}_sparkline(e,t){var h;const r=this._historyMap().get(e)||[],i=Date.now(),a=i-t*60*60*1e3,n=r.map(m=>({value:Number(m.state),time:new Date(m.last_changed||m.last_updated).getTime()})).filter(m=>Number.isFinite(m.value)&&Number.isFinite(m.time)&&m.time>=a).sort((m,x)=>m.time-x.time),o=Number((h=this._state(e))==null?void 0:h.state);if(Number.isFinite(o)&&n.push({value:o,time:i}),!n.length)return{path:"",min:"--",max:"--",avg:"--"};const s=n.map(m=>m.value),l=Math.min(...s),c=Math.max(...s),d=s.reduce((m,x)=>m+x,0)/s.length,g=c-l||1;return{path:n.map((m,x)=>{const S=(m.time-a)/(i-a)*300,u=66-(m.value-l)/g*52;return`${x?"L":"M"}${Math.max(0,Math.min(300,S)).toFixed(1)},${u.toFixed(1)}`}).join(" "),min:this._formatNumber(l),max:this._formatNumber(c),avg:this._formatNumber(d)}}_formatNumber(e){return Number.isFinite(e)?new Intl.NumberFormat("es-BO",{maximumFractionDigits:1}).format(e):"--"}_updateClock(){var o,s,l;if(!this.shadowRoot)return;const e=new Date,t=new Intl.DateTimeFormat("es-BO",{hour:"numeric",minute:"2-digit",hour12:!0}).formatToParts(e),r=((o=t.find(c=>c.type==="hour"))==null?void 0:o.value)||"--",i=((s=t.find(c=>c.type==="minute"))==null?void 0:s.value)||"--",a=(((l=t.find(c=>c.type==="dayPeriod"))==null?void 0:l.value)||"").replaceAll(".","").replaceAll(" ","").toUpperCase();for(const c of this.shadowRoot.querySelectorAll("[data-clock-time]"))c.textContent=`${r}:${i}`;for(const c of this.shadowRoot.querySelectorAll("[data-clock-period]"))c.textContent=a||"";const n=this.shadowRoot.querySelector("[data-current-time]");n&&(n.dateTime=e.toISOString(),n.setAttribute("aria-label",`${r}:${i} ${a}`.trim()))}_icon(e,t=""){const r=F[e]||F.bulb;return`<svg class="icon ${this._escape(t)}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${r}</svg>`}_escape(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}_renderDevice(e){const t=this._state(e.entity),r=this._visibleSwitchState(e.entity),i=r==="on",a=!t||["unknown","unavailable"].includes(t.state),n=this._pendingSwitches.has(e.entity),o=this._switchErrors.get(e.entity),s=o||(n?r==="on"?"Encendiendo…":"Apagando…":a?"No disponible":i?"Encendido":"Apagado");return`
    ...
    `}_renderWeather(){const e=this._config(),t=this._state(e.weather);if(!t)return`
      ...
      <section class="surface weather-card">
        <div class="weather-main">
          <div class="weather-symbol">${this._escape(A[i]||"·")}</div>
          <div class="weather-copy">
            <span class="eyebrow">Clima · Casa</span>
            <h2>${this._escape(R[i]||i)}</h2>
      ...
      <div class="app-shell">
        <header class="topbar">
          ...
          <div class="status-strip" aria-label="Resumen del showroom">
            ...
            <button class="status-pill ${s==="playing"?"is-active":""}" data-action="set-view" data-view="home">
          ...
          <div class="topbar-meta">
            ...
            <div class="header-weather" aria-label="Clima actual: ${this._escape(R[i]||i||"Sin datos")}, ${this._escape(r.temperature??"Sin datos")}${this._escape(r.temperature_unit??"°")}">
              <span aria-hidden="true">${this._escape(A[i]||"·")}</span>
              <strong>${this._escape(r.temperature??"--")}${this._escape(r.temperature_unit??"°")}</strong>
            </div>
            <button class="theme-button" data-action="toggle-theme" aria-label="Cambiar a tema ${a}" title="Cambiar a tema ${a}">${W}</button>
          </div>
        </header>
    ...
    `,this._updateClock(),requestAnimationFrame(()=>this._restoreEnergyChartScroll())}}customElements.get("showroom-panel")||customElements.define("showroom-panel",j);const z=()=>{var v,e;return((e=(v=globalThis.crypto)==null?void 0:v.randomUUID)==null?void 0:e.call(v))||`${Date.now()}-${Math.random().toString(16).slice(2)}`};class B{constructor(e=window.parent){this.target=e,this.states=new Map,this.listeners=new Set,this.pending=new Map,window.addEventListener("message",t=>this.onMessage(t)),this.post({type:"WITMIND_READY"})}subscribeEntities(e,t){return this.listeners.add(t),this.post({type:"WITMIND_SUBSCRIBE_ENTITIES",entityIds:[...new Set(e)]}),t(Object.fromEntries(this.states)),()=>this.listeners.delete(t)}getEntity(e){return this.states.get(e)}callService(e,t={},r){return this.request("WITMIND_CALL_SERVICE","WITMIND_SERVICE_RESULT",{service:e,serviceData:t,target:r})}dbRequest(e,t={}){return this.request("WITMIND_DB_REQUEST","WITMIND_DB_RESULT",{command:e,payload:t})}haRequest(e,t={}){return this.request("WITMIND_HA_COMMAND","WITMIND_HA_RESULT",{command:e,payload:t})}haSubscribe(e,t,r){const i=z(),a=()=>this.post({type:"WITMIND_HA_UNSUBSCRIBE",requestId:i});return new Promise((n,o)=>{const s=window.setTimeout(()=>{this.pending.delete(i),o(new Error("Timeout esperando suscripción HA"))},1e4);this.pending.set(i,{resolve:()=>{window.clearTimeout(s),n(a)},reject:o,timer:s,listener:r}),this.post({type:"WITMIND_HA_SUBSCRIBE",requestId:i,command:e,payload:t})})}post(e){this.target.postMessage({protocol:1,source:"witmind-ui",...e},"*")}request(e,t,r){const i=z();return new Promise((a,n)=>{const o=window.setTimeout(()=>{this.pending.delete(i),n(new Error(`Timeout esperando ${t}`))},1e4);this.pending.set(i,{resolve:a,reject:n,timer:o}),this.post({type:e,requestId:i,...r})})}onMessage(e){var i,a,n,o;if(e.source!==this.target||((i=e.data)==null?void 0:i.protocol)!==1||((a=e.data)==null?void 0:a.source)!=="witmind-ha")return;const t=e.data;if(t.type==="WITMIND_HA_EVENT"){(o=(n=this.pending.get(t.requestId))==null?void 0:n.listener)==null||o.call(n,t.result);return}if(t.type==="WITMIND_ENTITY_UPDATE"){Object.entries(t.states||{}).forEach(([l,c])=>this.states.set(l,c)),(t.removed||[]).forEach(l=>this.states.delete(l));const s=Object.fromEntries(this.states);this.listeners.forEach(l=>l(s));return}const r=this.pending.get(t.requestId);r&&(this.pending.delete(t.requestId),window.clearTimeout(r.timer),t.ok?r.resolve(t.result):r.reject(new Error(String(t.error||"Witmind request failed"))))}}const I=["weather.forecast_casa","media_player.showroom_1","sensor.showroom_luminarias_encendidas","sensor.showroom_energia_estimada","sensor.21051182g_battery_level","switch.interruptor_inteligente_switch_1","switch.interruptor_inteligente_switch_2","switch.interruptor_inteligente_switch_3","switch.interruptor_inteligente_switch_4","switch.interruptor_inteligente_2_switch_1","switch.interruptor_inteligente_2_switch_2","switch.interruptor_inteligente_2_switch_3","switch.interruptor_inteligente_2_switch_4","switch.smart_relay_switch_3_switch","switch.smart_relay_switch_4_switch","scene.presentacion","scene.reunion","script.showroom_encendido_general","script.showroom_apagado_general"],C=(v,e=new Set)=>(typeof v=="string"&&/^[a-z_]+\.[a-z0-9_]+$/i.test(v)?e.add(v):Array.isArray(v)?v.forEach(t=>C(t,e)):v&&typeof v=="object"&&Object.values(v).forEach(t=>C(t,e)),[...e]);class V extends HTMLElement{constructor(){super(...arguments),this.states={},this.previousStates={},this.eventListeners=new Set,this.panelConfig={},this.messageHandler=e=>{var r,i;if(e.source!==window.parent||((r=e.data)==null?void 0:r.protocol)!==1||((i=e.data)==null?void 0:i.source)!=="witmind-ha")return;e.data.type==="WITMIND_INIT"&&e.data.panelConfig&&(this.panelConfig=e.data.panelConfig,this.applyPanelConfig(),this.resubscribeWithConfig());const t=e.data.theme;(t==="light"||t==="dark")&&this.panel&&this.panel.setAttribute("theme",t)}}connectedCallback(){this.attachShadow({mode:"open"}),window.addEventListener("message",this.messageHandler),this.shadowRoot.innerHTML="<style>:host{display:block;min-height:100dvh;background:var(--wit-surface,#071118)} showroom-panel{display:block;min-height:100dvh}</style><showroom-panel></showroom-panel>",this.panel=this.shadowRoot.querySelector("showroom-panel"),this.client=new B(window.parent),this.applyPanelConfig(),this.subscribe(I),this.panel.hass=this.createHassAdapter()}subscribe(e){var t;(t=this.unsubscribe)==null||t.call(this),this.unsubscribe=this.client.subscribeEntities(e,r=>{this.previousStates=this.states,this.states=r,this.panel.hass=this.createHassAdapter(),this.emitStateChanges()})}resubscribeWithConfig(){const e=[...new Set([...I,...C(this.panelConfig)])];this.subscribe(e)}applyPanelConfig(){if(!this.panel||this.panelConfig.panel_kind!=="lobby")return;const e=this.panelConfig,t=Array.isArray(e.devices)?e.devices:[],r=Array.isArray(e.scenes)?e.scenes:[];this.panel.panel={config:{title:e.title||"Lobby",subtitle:e.subtitle||"Control operativo",site_label:e.site_label||e.siteLabel||"WTX · MDTC",logo:e.logo||"/local/logo-witmind.png?v=2.0.0",weather:e.weather||"weather.forecast_casa",light_count_sensor:e.light_count_sensor||"sensor.lobby_luminarias_encendidas",energy_sensor:e.energy_sensor||"sensor.showroom_energia_estimada",history_hours:e.history_hours||4,chart_hours:e.chart_hours||24,show_forecast:e.show_forecast??!0,spots:t,samples:[],reflector:{entity:""},scene_control_entities:e.scene_control_entities||e.sceneControlEntities||t.map(i=>i.entity),scenes:r.map(i=>({...i,onEntities:i.on_entities||i.onEntities||[],offEntities:i.off_entities||i.offEntities||[],directOnly:!0})),sample_scenes:[],power_on_script:"",power_off_script:""}}}disconnectedCallback(){var e;(e=this.unsubscribe)==null||e.call(this),window.removeEventListener("message",this.messageHandler)}createHassAdapter(){const e=this.client;return{states:this.states,language:"es",selectedTheme:null,callService:(r,i,a={},n)=>e.callService(`${r}.${i}`,a,n),callWS:async r=>r.type==="get_states"?Object.values(this.states):e.haRequest(String(r.type||""),r),callApi:async(r,i)=>[],connection:{subscribeEvents:async(r,i)=>{const a=n=>{(!i||i==="state_changed")&&r(n)};return this.eventListeners.add(a),()=>this.eventListeners.delete(a)},sendMessagePromise:r=>e.haRequest(String(r.type||""),r),subscribeMessage:(r,i)=>e.haSubscribe(String(i.type||""),i,r)}}}emitStateChanges(){Object.entries(this.states).forEach(([e,t])=>{this.previousStates[e]!==t&&this.eventListeners.forEach(r=>r({event_type:"state_changed",data:{entity_id:e,new_state:t,old_state:this.previousStates[e]||null}}))})}}customElements.define("witmind-ui-app",V);
