...
`;class J extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._hass=null,this._panel=null,this._narrow=!1,this._started=!1,this._renderQueued=!1,this._forecast=[],this._history=[],this._historyError="",this._liveStates=new Map,this._pendingSwitches=new Map,this._switchErrors=new Map,this._switchTimers=new Map,this._pendingAction="",this._confirmAction="",this._toast=null,this._toastTimer=null,this._clockTimer=null,this._historyTimer=null,this._unsubscribeStates=null,this._unsubscribeForecast=null,this._forecastEntity="",this._energyRange="day",this._energyDayOffset=0,this._energyData=[],this._energyLoading=!1,this._energyError=null,this._energyMonthTotal=null,this._energyRequestId=0,this._energyRefreshTimer=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._themeStorageKey="witmind-showroom-panel-theme",this._theme=this._loadTheme(),this._activeView="home",this.shadowRoot.addEventListener("click",e=>this._handleClick(e)),this.shadowRoot.addEventListener("scroll",e=>this._handleEnergyScroll(e),!0)}set hass(e){var o,s,l,c;const t=this._hass,i=this._config(),a=this._relevantHassChanged(t,e),r=!t||((o=t.states)==null?void 0:o[i.energySensor])!==((s=e==null?void 0:e.states)==null?void 0:s[i.energySensor]),n=!((l=t==null?void 0:t.states)!=null&&l[i.energySensor])&&!!((c=e==null?void 0:e.states)!=null&&c[i.energySensor]);this._hass=e,a&&this._syncStatesFromHass(),this._started?r&&(n?this._loadEnergyStatistics():this._scheduleEnergyRefresh()):(this._started=!0,this._start()),a&&this._updateStatePresentation()}get hass(){return this._hass}set panel(e){const t=this._config().weather;this._panel=e;const i=this._config().weather;this._started&&t!==i&&(this._resetForecastSubscription(),this._subscribeWeather()),this._hass&&(this._syncStatesFromHass(),this._loadEnergyStatistics(),this._updateStatePresentation())}get panel(){return this._panel}set narrow(e){this._narrow=!!e,this.toggleAttribute("narrow",this._narrow)}get narrow(){return this._narrow}connectedCallback(){this._hass&&(this._updateStatePresentation(),this._scheduleEnergyRefresh(!0))}disconnectedCallback(){clearInterval(this._clockTimer),clearInterval(this._historyTimer),clearTimeout(this._toastTimer),clearTimeout(this._energyRefreshTimer),this._energyRequestId+=1;for(const e of this._switchTimers.values())clearTimeout(e);this._switchTimers.clear(),this._resetForecastSubscription(),this._unsubscribeStates&&(this._unsubscribeStates(),this._unsubscribeStates=null),this._started=!1}_requestRender(){this._renderQueued||!this._hass||!this.shadowRoot||(this._renderQueued=!0,requestAnimationFrame(()=>{this._renderQueued=!1,this.render()}))}_updateStatePresentation(){var o;if(!((o=this.shadowRoot)!=null&&o.querySelector(".app-shell"))){this._requestRender();return}const e=s=>{var g;const l=s.dataset.entity;if(!l)return;const c=this._state(l),d=this._visibleSwitchState(l),h=d==="on",p=!c||["unknown","unavailable"].includes(c.state),u=this._pendingSwitches.has(l),m=this._switchErrors.get(l),b=m||(u?d==="on"?"Encendiendo…":"Apagando…":p?"No disponible":h?"Encendido":"Apagado");s.classList.toggle("is-on",h),s.classList.toggle("is-pending",u),s.classList.toggle("is-error",!!m),s.disabled=p,s.setAttribute("aria-pressed",String(h));const E=((g=s.querySelector(".device-copy strong"))==null?void 0:g.textContent)||l;s.setAttribute("aria-label",`${E}: ${b}`);const v=s.querySelector(".device-copy small");v&&(v.textContent=b)};this.shadowRoot.querySelectorAll('[data-action="toggle-switch"]').forEach(e),this.shadowRoot.querySelectorAll('[data-action="run-scene"]').forEach(s=>{const l=this._allScenes().find(u=>u.key===s.dataset.sceneKey);if(!l)return;const c=this._sceneStatus(l),d=this._pendingAction===l.key,h=d?"Aplicando...":c.active?"Activo":c.unavailable?"Sin datos":"Inactivo";s.classList.toggle("is-pending",d),s.classList.toggle("is-active",c.active),s.classList.toggle("is-unavailable",c.unavailable),s.disabled=!!(this._pendingAction&&!d),s.setAttribute("aria-pressed",String(c.active));const p=s.querySelector(".scene-state");p&&(p.textContent=h)});const t=this._config(),i=[...t.spots,...t.samples,...t.reflector?[t.reflector]:[]],a=i.filter(s=>this._visibleSwitchState(s.entity)==="on").length,r=this.shadowRoot.querySelector("[data-lights-summary]");r&&(r.textContent=`${a} de ${i.length}`);const n=this.shadowRoot.querySelector("[data-energy-summary]");n&&(n.textContent=this._energyMonthTotal===null?"Sin datos":`${this._formatEnergy(this._energyMonthTotal)} kWh`)}_handleClick(e){const t=e.target.closest("[data-action]");if(!t||!this._hass)return;const i=t.dataset.action;if(i==="toggle-menu"){this._toggleHomeAssistantMenu();return}if(i==="toggle-theme"){this._toggleTheme();return}if(i==="set-view"){const a=t.dataset.view;["home","lights","energy","system"].includes(a)&&(this._activeView=a,this._requestRender());return}if(i==="toggle-switch"){this._toggleSwitch(t.dataset.entity);return}if(i==="run-scene"){this._runScene(t.dataset.sceneKey||t.dataset.entity,t.dataset.label);return}if(i==="open-power-on"){this._pendingAction||(this._confirmAction="on",this._requestRender());return}if(i==="open-power-off"){this._pendingAction||(this._confirmAction="off",this._requestRender());return}if(i==="general-off"){const a=this._config().generalOffScript;a?this._hass.callService("script","turn_on",{entity_id:a}).catch(r=>{this._notify("No se pudo ejecutar Apagar todo Witmind.","error"),console.error("Error ejecutando el apagado general de Witmind:",r)}):this._notify("El apagado general aún no tiene una entidad configurada.","error");return}if(i==="cancel-power-confirm"){const a=e.target.closest("[data-dialog-card]");if(t.classList.contains("dialog-backdrop")&&a)return;this._pendingAction||(this._confirmAction="",this._requestRender());return}if(i==="confirm-power"){this._confirmGeneralPower();return}if(i==="clear-scene"){this._clearScene();return}if(i==="media"){this._mediaAction(t.dataset.service);return}if(i==="energy-range"){this._setEnergyRange(t.dataset.range);return}if(i==="energy-day-prev"){this._shiftEnergyDay(-1);return}if(i==="energy-day-next"){this._shiftEnergyDay(1);return}if(i==="energy-day-today"){this._resetEnergyDay();return}i==="refresh-energy"&&(this._energyLastLoadedAt=0,this._loadEnergyStatistics())}_toggleHomeAssistantMenu(){this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}))}_loadTheme(){try{return localStorage.getItem(this._themeStorageKey)==="light"?"light":"dark"}catch{return"dark"}}_saveTheme(){try{localStorage.setItem(this._themeStorageKey,this._theme)}catch(e){console.warn("No se pudo guardar el tema del showroom:",e)}}_toggleTheme(){this._theme=this._theme==="dark"?"light":"dark",this.setAttribute("data-theme",this._theme),this._saveTheme(),this._requestRender()}_config(){var u;const e=((u=this._panel)==null?void 0:u.config)||{},t=e.panel_kind==="lobby"||e.panel_kind==="general"||e.static_only===!0||e.staticOnly===!0,i=m=>Array.isArray(m)?[...new Set(m.filter(Boolean).map(b=>String(b)))]:[],a=(m,b)=>(Array.isArray(m)&&(m.length||t)?m:b).filter(v=>v==null?void 0:v.entity).map((v,g)=>({entity:String(v.entity),name:v.name||`Dispositivo ${g+1}`,subtitle:v.subtitle||"Iluminación",icon:v.icon||"bulb"})),r=a(e.spots,y.spots),n=a(e.samples||e.muestras,y.samples),o=[...r,...n].map(m=>m.entity),s=i(e.scene_control_entities||e.sceneControlEntities),l=s.length?s:o,c=(m,b,E)=>(Array.isArray(m)&&(m.length||t)?m:b).filter(g=>(g==null?void 0:g.entity)||(g==null?void 0:g.id)||(g==null?void 0:g.key)).map((g,S)=>{const $=g.entity?String(g.entity):"",T=String(g.id||g.key||$||`${E}-${S+1}`),f=b.find(A=>{const H=A.entity?String(A.entity):"",K=String(A.id||A.key||H||"");return $&&H===$||K===T}),M=$||(f!=null&&f.entity?String(f.entity):""),N=String(g.id||g.key||(f==null?void 0:f.id)||M||`${E}-${S+1}`),k=M||`${E}:${N}`,w=Array.isArray(g.on_entities)||Array.isArray(g.onEntities),L=Array.isArray(g.off_entities)||Array.isArray(g.offEntities),R=i(w?g.on_entities||g.onEntities:f==null?void 0:f.onEntities),U=i(L?g.off_entities||g.offEntities:[]),Z=L?U.filter(A=>!R.includes(A)):l.filter(A=>!R.includes(A));return{key:k,id:N,entity:M,name:g.name||(f==null?void 0:f.name)||`Escena ${S+1}`,subtitle:g.subtitle||(f==null?void 0:f.subtitle)||"Escena del showroom",icon:g.icon||(f==null?void 0:f.icon)||"presentation",directOnly:g.direct_only??g.directOnly??(f==null?void 0:f.directOnly)??!1,onEntities:R,offEntities:Z}}),d=e.reflector||y.reflector,h=Number(e.history_hours??e.historyHours),p=Number(e.chart_hours??e.chartHours);return{title:e.title||y.title,subtitle:e.subtitle||y.subtitle,siteLabel:e.site_label||e.siteLabel||y.siteLabel,logo:e.logo||y.logo,weather:e.weather||y.weather,mediaPlayer:e.media_player||e.mediaPlayer||y.mediaPlayer,lightCountSensor:e.light_count_sensor||e.lightCountSensor||y.lightCountSensor,energySensor:e.energy_sensor||e.energySensor||y.energySensor,batteryLevel:e.battery_level||e.batteryLevel||y.batteryLevel,powerOnScript:e.power_on_script||e.powerOnScript||y.powerOnScript,powerOffScript:e.power_off_script||e.powerOffScript||y.powerOffScript,historyHours:Number.isFinite(h)&&h>0?Math.min(24,h):y.historyHours,chartHours:Number.isFinite(p)&&p>0?Math.min(72,p):y.chartHours,showForecast:e.show_forecast??e.showForecast??y.showForecast,panelKind:e.panel_kind||e.panelKind||"showroom",staticOnly:e.static_only??e.staticOnly??!1,generalOffScript:e.general_off_script||e.generalOffScript||"",spots:r,samples:n,sceneControlEntities:l,reflector:d!=null&&d.entity?{entity:String(d.entity),name:d.name||y.reflector.name,subtitle:d.subtitle||y.reflector.subtitle,icon:d.icon||y.reflector.icon}:null,scenes:c(e.scenes,y.scenes,"scene"),sampleScenes:c(e.sample_scenes||e.sampleScenes,y.sampleScenes,"sample")}}_allDevices(){const e=this._config();return[...e.spots,...e.samples,...e.reflector?[e.reflector]:[]]}_allScenes(e=this._config()){return[...e.scenes,...e.sampleScenes]}_trackedEntities(){const e=this._config();return new Set([...this._allDevices().map(t=>t.entity),...e.sceneControlEntities,...this._allScenes(e).flatMap(t=>[t.entity,...t.onEntities,...t.offEntities]),e.weather,e.mediaPlayer,e.lightCountSensor,e.energySensor,e.batteryLevel,e.powerOnScript,e.powerOffScript].filter(Boolean))}_relevantHassChanged(e,t){var i,a;if(!e||!t)return!0;for(const r of this._trackedEntities())if(((i=e.states)==null?void 0:i[r])!==((a=t.states)==null?void 0:a[r]))return!0;return!1}async _start(){this._clockTimer=setInterval(()=>this._updateClock(),3e4),await Promise.allSettled([this._fetchCurrentStates(),this._subscribeStateChanges(),this._subscribeWeather(),this._loadEnergyStatistics()])}_syncStatesFromHass(){var e;if((e=this._hass)!=null&&e.states)for(const t of this._trackedEntities()){const i=this._hass.states[t];i&&this._applyLiveState(t,i)}}_applyLiveState(e,t){if(!t){this._liveStates.delete(e);return}this._liveStates.set(e,t);const i=this._pendingSwitches.get(e);if(i&&t.state===i.desired){this._pendingSwitches.delete(e),this._switchErrors.delete(e);const a=this._switchTimers.get(e);a&&clearTimeout(a),this._switchTimers.delete(e)}}async _fetchCurrentStates(){var e;if((e=this._hass)!=null&&e.callWS)try{const t=await this._hass.callWS({type:"get_states"}),i=this._trackedEntities();for(const a of t||[])i.has(a.entity_id)&&this._applyLiveState(a.entity_id,a);this._updateStatePresentation()}catch(t){console.error("No se pudieron sincronizar los estados del showroom:",t)}}async _subscribeStateChanges(){var e;if(!(!((e=this._hass)!=null&&e.connection)||this._unsubscribeStates))try{this._unsubscribeStates=await this._hass.connection.subscribeEvents(t=>{var a;const i=(a=t==null?void 0:t.data)==null?void 0:a.entity_id;!i||!this._trackedEntities().has(i)||(this._applyLiveState(i,t.data.new_state),i===this._config().energySensor&&this._scheduleEnergyRefresh(),this._updateStatePresentation())},"state_changed")}catch(t){console.error("No se pudo suscribir a state_changed:",t)}}_resetForecastSubscription(){this._unsubscribeForecast&&(this._unsubscribeForecast(),this._unsubscribeForecast=null),this._forecastEntity=""}async _subscribeWeather(){var t;const e=this._config();if(!(!((t=this._hass)!=null&&t.connection)||!e.weather)&&!(this._unsubscribeForecast&&this._forecastEntity===e.weather)){this._resetForecastSubscription();try{this._forecastEntity=e.weather,this._unsubscribeForecast=await this._hass.connection.subscribeMessage(i=>{this._forecast=Array.isArray(i==null?void 0:i.forecast)?i.forecast:[],this._requestRender()},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e.weather})}catch(i){this._forecastEntity="",console.error("No se pudo cargar el pronóstico:",i)}}}_energyRefreshInterval(){return this._energyRange==="day"?3e4:this._energyRange==="month"?12e4:3e5}_scheduleEnergyRefresh(e=!1){if(!this._hass||!this.isConnected||(clearTimeout(this._energyRefreshTimer),this._energyRange==="day"&&this._energyDayOffset!==0))return;const t=this._energyRefreshInterval(),i=this._energyLastLoadedAt?Date.now()-this._energyLastLoadedAt:0,a=e?0:this._energyLastLoadedAt?Math.max(1e3,t-i):t;this._energyRefreshTimer=setTimeout(()=>this._loadEnergyStatistics(),a)}_energyRangeDefinition(e=this._energyRange){const t=new Date;let i,a=t,r,n,o,s=!1;if(e==="year")i=new Date(t.getFullYear(),0,1,0,0,0,0),r="month",n=`Año ${t.getFullYear()}`,o="mes";else if(e==="month")i=new Date(t.getFullYear(),t.getMonth(),1,0,0,0,0),r="day",n=t.toLocaleDateString("es-BO",{month:"long",year:"numeric"}),o="día";else{const l=new Date(t.getFullYear(),t.getMonth(),t.getDate(),0,0,0,0);i=new Date(l.getFullYear(),l.getMonth(),l.getDate()+Math.min(0,Number(this._energyDayOffset)||0),0,0,0,0),s=i.getTime()===l.getTime(),a=s?t:new Date(i.getFullYear(),i.getMonth(),i.getDate()+1,0,0,0,0),r="hour",n=i.toLocaleDateString("es-BO",{weekday:"long",day:"numeric",month:"long"}),o="hora"}return{start:i,end:a,period:r,title:n,intervalLabel:o,isToday:s}}_energyValueToKWh(e,t){const i=Number(e);if(!Number.isFinite(i))return null;const a=String(t||"kWh").trim().toLowerCase().replaceAll(" ","");return a==="kwh"?i:a==="wh"?i/1e3:a==="mwh"?i*1e3:null}_deriveEnergyStateDeltas(e,t,i){const a=Number(t instanceof Date?t.getTime():t),r=Number(i instanceof Date?i.getTime():i),n=e.filter(l=>Number.isFinite(Number(l.start))&&Number.isFinite(Number(l.state))).sort((l,c)=>Number(l.start)-Number(c.start)),o=[];let s=null;for(const l of n){const c=Number(l.start),d=Number(l.state);if(c<a){s=d;continue}if(c>=r)break;let h=0;if(Number.isFinite(s)){const p=d-s;h=p>=0?p:Math.max(0,d)}o.push({...l,change:h}),s=d}return o}_aggregateEnergyDayRows(e,t,i){var l;const a=new Date(t.start),r=new Date(t.end),n=t.isToday?new Date(r.getFullYear(),r.getMonth(),r.getDate(),r.getHours(),0,0,0):new Date(a.getFullYear(),a.getMonth(),a.getDate(),23,0,0,0),o=new Map;for(let c=new Date(a);c<=n;c.setHours(c.getHours()+1)){const d=c.getTime();o.set(d,{start:d,end:new Date(c.getFullYear(),c.getMonth(),c.getDate(),c.getHours()+1,0,0,0).getTime(),change:0,samples:0,partial:t.isToday&&d===n.getTime(),live:!1})}let s=null;for(const c of e){const d=new Date(Number(c.start));if(!Number.isFinite(d.getTime()))continue;const h=new Date(d.getFullYear(),d.getMonth(),d.getDate(),d.getHours(),0,0,0).getTime(),p=o.get(h);p&&(p.change+=Math.max(0,Number(c.change)||0),p.samples+=1,Number.isFinite(c.state)&&(!s||Number(c.end||c.start)>Number(s.end||s.start))&&(s=c))}if(t.isToday){const c=this._energyValueToKWh(i==null?void 0:i.state,(l=i==null?void 0:i.attributes)==null?void 0:l.unit_of_measurement),d=s==null?void 0:s.state,h=Number((s==null?void 0:s.end)||(s==null?void 0:s.start)),p=o.get(n.getTime());if(p&&Number.isFinite(c)&&Number.isFinite(d)&&Number.isFinite(h)&&h>=n.getTime()&&r.getTime()-h>=0&&r.getTime()-h<=900*1e3){const u=c-d;Number.isFinite(u)&&u>=0&&(p.change+=u,p.live=u>0)}}return[...o.values()].filter(c=>c.samples>0||c.live)}_calculateCurrentMonthEnergy(e,t,i){var h;const a=new Date(t),r=new Date(a.getFullYear(),a.getMonth(),1,0,0,0,0).getTime(),n=e.filter(p=>Number.isFinite(Number(p.start))&&Number(p.start)>=r).sort((p,u)=>Number(p.start)-Number(u.start));let o=n.reduce((p,u)=>p+Math.max(0,Number(u.change)||0),0),s=null;for(const p of n)Number.isFinite(Number(p.state))&&(!s||Number(p.end||p.start)>Number(s.end||s.start))&&(s=p);const l=this._energyValueToKWh(i==null?void 0:i.state,(h=i==null?void 0:i.attributes)==null?void 0:h.unit_of_measurement),c=Number(s==null?void 0:s.state),d=Number((s==null?void 0:s.end)||(s==null?void 0:s.start));if(Number.isFinite(l)&&Number.isFinite(c)&&Number.isFinite(d)&&d>=r&&d<=a.getTime()&&a.getTime()-d<=7200*1e3){const p=l-c;Number.isFinite(p)&&p>=0&&(o+=p)}return n.length||Number.isFinite(c)?o:null}_aggregateEnergyCalendarRows(e,t,i,a){var d;if(!["month","year"].includes(a))return[];const r=new Map;let n=null;for(const h of e){const p=Number(h.start);if(!Number.isFinite(p))continue;const u=new Date(p),m=a==="month"?new Date(u.getFullYear(),u.getMonth(),u.getDate(),0,0,0,0).getTime():new Date(u.getFullYear(),u.getMonth(),1,0,0,0,0).getTime(),b=r.get(m)||{start:m,change:0,samples:0,partial:!1,live:!1};b.change+=Math.max(0,Number(h.change)||0),b.samples+=1,r.set(m,b),Number.isFinite(Number(h.state))&&(!n||p>Number(n.start))&&(n=h)}const o=this._energyValueToKWh(i==null?void 0:i.state,(d=i==null?void 0:i.attributes)==null?void 0:d.unit_of_measurement),s=Number(n==null?void 0:n.state),l=Number(n==null?void 0:n.start),c=new Date(t.end);if(Number.isFinite(o)&&Number.isFinite(s)&&Number.isFinite(l)&&l<=c.getTime()&&c.getTime()-l<=7200*1e3){const h=o-s;if(Number.isFinite(h)&&h>=0){const p=a==="month"?new Date(c.getFullYear(),c.getMonth(),c.getDate(),0,0,0,0).getTime():new Date(c.getFullYear(),c.getMonth(),1,0,0,0,0).getTime(),u=r.get(p)||{start:p,change:0,samples:0,partial:!1,live:!1};u.change+=h,u.live=h>0,r.set(p,u)}}return[...r.values()].sort((h,p)=>Number(h.start)-Number(p.start))}_energyViewSignature(){return JSON.stringify([this._energyRange,this._energyDayOffset,this._energyMonthTotal,this._energyError||"",this._energyData.map(e=>[Number(e.start),Number(e.change)||0,Number(e.samples)||0,!!e.partial,!!e.live])])}async _loadEnergyStatistics(){var p;if(!((p=this._hass)!=null&&p.connection))return;clearTimeout(this._energyRefreshTimer);const e=this._config(),t=this._state(e.energySensor),i=Number(t==null?void 0:t.state);if(!t){this._energyData=[],this._energyMonthTotal=null,this._energyError=`No existe ${e.energySensor} en Home Assistant.`,this._energyLoading=!1,this._requestRender();return}if(!Number.isFinite(i)){this._energyData=[],this._energyMonthTotal=null,this._energyError=`${e.energySensor} no entrega un valor numérico.`,this._energyLoading=!1,this._requestRender();return}const a=++this._energyRequestId,r=this._energyViewSignature(),n=this._energyData.length>0,o=this._energyRangeDefinition(),s=new Date,l=new Date(s.getFullYear(),s.getMonth(),1,0,0,0,0),c=new Date(o.start.getTime()-3600*1e3),d=this._energyRange==="year"?"hour":"5minute",h=new Date(l.getTime()-3600*1e3);this._energyLoading=!0,this._energyError=null,n||this._requestRender();try{const u=await this._hass.connection.sendMessagePromise({type:"recorder/get_statistics_metadata",statistic_ids:[e.energySensor]});if(a!==this._energyRequestId)return;const b=(Array.isArray(u)?u:[]).find(k=>(k==null?void 0:k.statistic_id)===e.energySensor)||null;if(!b||!b.has_sum)throw new Error("La entidad no dispone de estadísticas acumulables. Verifica device_class: energy y state_class total/total_increasing.");const E=this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:c.toISOString(),end_time:o.end.toISOString(),statistic_ids:[e.energySensor],period:d,units:{energy:"kWh"},types:["state"]}),v=this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:h.toISOString(),end_time:s.toISOString(),statistic_ids:[e.energySensor],period:"hour",units:{energy:"kWh"},types:["state"]}),[g,S]=await Promise.all([E,v]);if(a!==this._energyRequestId)return;const $=k=>(Array.isArray(k==null?void 0:k[e.energySensor])?k[e.energySensor]:[]).map(w=>({start:Number(w.start),end:Number(w.end),change:w.change===void 0||w.change===null?null:Math.max(0,Number(w.change)||0),state:w.state===void 0||w.state===null?null:Number(w.state)})).filter(w=>Number.isFinite(w.start)&&(Number.isFinite(w.state)||Number.isFinite(w.change))),T=$(g),f=this._deriveEnergyStateDeltas(T,o.start,o.end);this._energyData=this._energyRange==="day"?this._aggregateEnergyDayRows(f,o,t):this._aggregateEnergyCalendarRows(f,o,t,this._energyRange);const M=$(S),N=this._deriveEnergyStateDeltas(M,l,s);if(this._energyMonthTotal=this._calculateCurrentMonthEnergy(N,s,t),this._energyRange==="month"&&this._energyData.length)this._energyMonthTotal=this._energyData.reduce((k,w)=>k+Math.max(0,Number(w.change)||0),0);else if(this._energyRange==="year"&&Number.isFinite(this._energyMonthTotal)){const k=new Date(s.getFullYear(),s.getMonth(),1,0,0,0,0).getTime(),w=this._energyData.find(L=>Number(L.start)===k);w&&(w.change=this._energyMonthTotal)}this._energyLastLoadedAt=Date.now(),this._energyError=null}catch(u){if(a!==this._energyRequestId)return;this._energyData=[],this._energyMonthTotal=null,this._energyError=(u==null?void 0:u.message)||"No se pudieron consultar las estadísticas energéticas.",console.error("Error cargando estadísticas de energía del showroom:",u)}finally{if(a===this._energyRequestId){this._energyLoading=!1;const u=r!==this._energyViewSignature();!n||u&&this._activeView==="energy"?this._requestRender():this._updateStatePresentation(),this._scheduleEnergyRefresh()}}}_setEnergyRange(e){!["day","month","year"].includes(e)||e===this._energyRange||(this._energyRange=e,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_shiftEnergyDay(e){if(this._energyRange!=="day")return;const t=Number(e);if(!Number.isFinite(t)||t===0)return;const i=Math.min(0,this._energyDayOffset+t);i!==this._energyDayOffset&&(this._energyDayOffset=i,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_resetEnergyDay(){this._energyRange!=="day"||this._energyDayOffset===0||(this._energyDayOffset=0,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_formatEnergy(e,t=2){const i=Number(e);return Number.isFinite(i)?i.toLocaleString("es-BO",{minimumFractionDigits:t,maximumFractionDigits:t}):"--"}_energyLabel(e,t=this._energyRange){const i=new Date(Number(e));return Number.isFinite(i.getTime())?t==="year"?i.toLocaleDateString("es-BO",{month:"short"}).replace(".",""):t==="month"?String(i.getDate()):i.toLocaleTimeString("es-BO",{hour:"2-digit",minute:"2-digit",hour12:!1}):"--"}_captureEnergyChartScroll(){var i;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("[data-energy-scroll]");if(!e)return;const t=Math.max(0,e.scrollWidth-e.clientWidth);this._energyScrollLeft=e.scrollLeft,this._energyAutoFollow=t<=0||t-e.scrollLeft<=8}_handleEnergyScroll(e){var a,r;const t=(r=(a=e.target)==null?void 0:a.closest)==null?void 0:r.call(a,"[data-energy-scroll]");if(!t)return;const i=Math.max(0,t.scrollWidth-t.clientWidth);this._energyScrollLeft=t.scrollLeft,this._energyAutoFollow=i<=0||i-t.scrollLeft<=8}_restoreEnergyChartScroll(){var i;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("[data-energy-scroll]");if(!e)return;const t=Math.max(0,e.scrollWidth-e.clientWidth);if(this._energyAutoFollow||this._energyScrollLeft===null){e.scrollLeft=t,this._energyScrollLeft=e.scrollLeft;return}e.scrollLeft=Math.max(0,Math.min(this._energyScrollLeft,t))}_energyChart(){const e=this._energyData;if(this._energyLoading&&!e.length)return'<div class="energy-empty"><span class="energy-spinner"></span>Consultando estadísticas de Home Assistant…</div>';if(this._energyError)return`<div class="energy-empty error">${this._icon("status")}<span>${this._escape(this._energyError)}</span></div>`;if(!e.length)return'<div class="energy-empty">No hay estadísticas de consumo disponibles para este período.</div>';const t=280,i=14,a=16,r=22,n=42,o=this._energyRange==="day"?64:this._energyRange==="month"?36:58,s=Math.max(620,e.length*o+i+a),l=t-r-n,c=s-i-a,d=Math.max(...e.map(g=>g.change),.001),h=this._energyRange==="day"?10:e.length>24?4:7,p=Math.max(6,(c-h*Math.max(0,e.length-1))/e.length),u=this._energyRange==="month"?Math.max(1,Math.ceil(e.length/10)):this._energyRange==="day"?2:1,m=[0,.25,.5,.75,1],b=m.map(g=>{const S=r+l*(1-g);return`<line x1="${i}" y1="${S.toFixed(1)}" x2="${s-a}" y2="${S.toFixed(1)}" class="energy-grid-line"/>`}).join(""),E=m.map(g=>{const S=r+l*(1-g),$=this._formatEnergy(d*g,d<1?2:1);return`<span class="energy-y-tick" style="top:${S.toFixed(1)}px">${this._escape($)}</span>`}).join(""),v=e.map((g,S)=>{const $=i+S*(p+h),T=g.change>0?Math.max(2,g.change/d*l):1,f=r+l-T,M=S%u===0||S===e.length-1,N=this._energyLabel(g.start),k=g.partial?" · en curso":"",w=g.partial?`<text x="${($+p/2).toFixed(1)}" y="${(r+10).toFixed(1)}" text-anchor="middle" class="energy-current-label">ahora</text>`:"";return`<g class="energy-bar-group ${g.partial?"is-current":""}"><rect x="${$.toFixed(1)}" y="${f.toFixed(1)}" width="${p.toFixed(1)}" height="${T.toFixed(1)}" rx="${Math.min(4,p/2).toFixed(1)}" class="energy-bar ${g.partial?"is-partial":""}"><title>${this._escape(N)} · ${this._formatEnergy(g.change)} kWh${k}</title></rect>${w}${M?`<text x="${($+p/2).toFixed(1)}" y="${t-14}" text-anchor="middle" class="energy-axis-text">${this._escape(N)}</text>`:""}</g>`}).join("");return`<div class="energy-chart-layout"><div class="energy-y-axis" aria-hidden="true"><span class="energy-y-unit">kWh</span>${E}</div><div class="energy-chart-wrap" data-energy-scroll><svg class="energy-chart" width="${s}" height="${t}" viewBox="0 0 ${s} ${t}" role="img" aria-label="Gráfica de consumo energético estimado en kWh">${b}${v}</svg></div></div>`}async _loadHistory(){var o;const e=this._config();if(!((o=this._hass)!=null&&o.callApi))return;const t=Math.max(e.historyHours,e.chartHours),i=new Date(Date.now()-t*60*60*1e3).toISOString(),a=new Date().toISOString(),r=[e.lightCountSensor,...e.spots.map(s=>s.entity),...e.samples.map(s=>s.entity)].filter(Boolean).join(",");if(!r)return;const n=`history/period/${encodeURIComponent(i)}?filter_entity_id=${encodeURIComponent(r)}&end_time=${encodeURIComponent(a)}&minimal_response&no_attributes`;try{this._history=await this._hass.callApi("GET",n),this._historyError=""}catch(s){this._history=[],this._historyError="No se pudo cargar el historial.",console.error("No se pudo cargar el historial del showroom:",s)}this._requestRender()}_state(e){var t,i;return this._liveStates.get(e)||((i=(t=this._hass)==null?void 0:t.states)==null?void 0:i[e])}_isUnavailable(e){var i;const t=(i=this._state(e))==null?void 0:i.state;return!t||t==="unknown"||t==="unavailable"}_visibleSwitchState(e){var t,i;return((t=this._pendingSwitches.get(e))==null?void 0:t.desired)||((i=this._state(e))==null?void 0:i.state)||"unavailable"}async _toggleSwitch(e){if(!e||!this._hass)return;const t=this._state(e);if(!t||["unknown","unavailable"].includes(t.state)){this._switchErrors.set(e,"No disponible"),this._updateStatePresentation();return}const a=this._visibleSwitchState(e)==="on"?"off":"on",r=a==="on"?"turn_on":"turn_off",n=e.split(".")[0]||"switch";this._pendingSwitches.set(e,{desired:a,startedAt:Date.now()}),this._switchErrors.delete(e),this._updateStatePresentation();try{await this._hass.callService(n,r,{entity_id:e});const o=this._switchTimers.get(e);o&&clearTimeout(o);const s=setTimeout(()=>this._verifySwitchState(e,a),6e3);this._switchTimers.set(e,s)}catch(o){this._pendingSwitches.delete(e),this._switchErrors.set(e,"La acción falló"),this._updateStatePresentation(),console.error(`Error ejecutando ${r} en ${e}:`,o)}}async _verifySwitchState(e,t){var a;await this._fetchCurrentStates();const i=((a=this._state(e))==null?void 0:a.state)===t;this._pendingSwitches.delete(e),this._switchTimers.delete(e),i?this._switchErrors.delete(e):this._switchErrors.set(e,"Sin confirmación"),this._updateStatePresentation()}_sceneStatus(e){const t=[...e.onEntities.map(r=>({entityId:r,desired:"on"})),...e.offEntities.map(r=>({entityId:r,desired:"off"}))];if(!t.length)return{active:!1,unavailable:!1,mismatches:[]};const i=t.some(({entityId:r})=>this._isUnavailable(r)),a=t.filter(({entityId:r,desired:n})=>{var o;return((o=this._state(r))==null?void 0:o.state)!==n});return{active:!i&&a.length===0,unavailable:i,mismatches:a}}_sceneExpectations(e){return[...e.offEntities.map(t=>({entityId:t,desired:"off"})),...e.onEntities.map(t=>({entityId:t,desired:"on"}))]}_markExpectedStates(e){const t=Date.now();for(const{entityId:i,desired:a}of e)this._pendingSwitches.set(i,{desired:a,startedAt:t}),this._switchErrors.delete(i)}_clearExpectedStates(e){for(const{entityId:t}of e){this._pendingSwitches.delete(t);const i=this._switchTimers.get(t);i&&clearTimeout(i),this._switchTimers.delete(t)}}async _setEntitiesState(e,t){const i=[...new Set((e||[]).filter(Boolean))];if(!i.length)return;const a=new Map;for(const n of i){const o=n.split(".")[0];o&&(a.has(o)||a.set(o,[]),a.get(o).push(n))}const r=t==="on"?"turn_on":"turn_off";for(const[n,o]of a)await this._hass.callService(n,r,{entity_id:o})}async _waitForExpectedStates(e,t=7e3){const i=Date.now()+t;let a=e;for(;Date.now()<i;){if(await this._fetchCurrentStates(),a=e.filter(({entityId:r,desired:n})=>{var o;return((o=this._state(r))==null?void 0:o.state)!==n}),!a.length)return{ok:!0,mismatches:[]};await new Promise(r=>setTimeout(r,450))}return{ok:!1,mismatches:a}}async _runScene(e,t){var o;if(!e||this._pendingAction)return;const i=this._config(),a=this._allScenes(i).find(s=>s.key===e||s.entity===e);if(!a){this._notify("La escena no está configurada.","error");return}const r=this._sceneExpectations(a);this._pendingAction=a.key,this._markExpectedStates(r),this._updateStatePresentation();let n=null;try{if(a.entity&&!a.directOnly)try{await this._hass.callService("scene","turn_on",{entity_id:a.entity})}catch(c){n=c,console.warn(`La escena ${a.entity} no respondió; se aplicará el perfil directo.`,c)}await this._setEntitiesState(a.offEntities,"off"),await this._setEntitiesState(a.onEntities,"on");const s=await this._waitForExpectedStates(r);if(!s.ok){const c=s.mismatches.map(d=>d.entityId).join(", ");throw new Error(`No se confirmaron los estados de: ${c}`)}const l=n?`${t||"Modo"} aplicado mediante control directo.`:`${t||"Modo"} activo.`;this._notify(l,"success")}catch(s){for(const{entityId:l,desired:c}of r)((o=this._state(l))==null?void 0:o.state)!==c&&this._switchErrors.set(l,"No confirmó el modo");this._notify("No se pudo aplicar completamente el modo seleccionado.","error"),console.error("Error aplicando modo del showroom:",s)}finally{this._clearExpectedStates(r),this._pendingAction="",await this._fetchCurrentStates(),this._updateStatePresentation()}}async _executeGeneralPower(e,t={}){var l;if(!this._hass||this._pendingAction||!["on","off"].includes(e))return!1;const i=this._config(),a=e==="on"?i.powerOnScript:i.powerOffScript,r=i.sceneControlEntities.map(c=>({entityId:c,desired:e})),n=t.successMessage||(e==="on"?"Iluminación general encendida.":"Iluminación general apagada."),o=t.errorMessage||(e==="on"?"No se pudo encender toda la iluminación.":"No se pudo apagar toda la iluminación.");this._pendingAction=a||`direct-power-${e}`,this._markExpectedStates(r),this._updateStatePresentation();let s=null;try{if(a)try{await this._hass.callService("script","turn_on",{entity_id:a})}catch(d){s=d,console.warn(`El script ${a} no respondió; se aplicará el control directo.`,d)}await this._setEntitiesState(i.sceneControlEntities,e);const c=await this._waitForExpectedStates(r);if(!c.ok){const d=c.mismatches.map(h=>h.entityId).join(", ");throw new Error(`No se confirmaron los estados de: ${d}`)}return this._confirmAction="",this._notify(n,"success"),!0}catch(c){for(const{entityId:d,desired:h}of r)((l=this._state(d))==null?void 0:l.state)!==h&&this._switchErrors.set(d,"Sin confirmación");return this._notify(o,"error"),console.error("Error ejecutando el control general del showroom:",{error:c,scriptError:s,desired:e}),!1}finally{this._clearExpectedStates(r),this._pendingAction="",await this._fetchCurrentStates(),this._updateStatePresentation()}}async _confirmGeneralPower(){const e=this._confirmAction;["on","off"].includes(e)&&await this._executeGeneralPower(e,{successMessage:e==="on"?"Toda la iluminación del showroom está encendida.":"Toda la iluminación del showroom está apagada."})}async _clearScene(){this._pendingAction||await this._executeGeneralPower("off",{successMessage:"Escena apagada. La iluminación del showroom quedó apagada.",errorMessage:"No se pudo apagar completamente la escena."})}async _mediaAction(e){const t=this._config().mediaPlayer;if(!(!t||!e||this._isUnavailable(t)))try{await this._hass.callService("media_player",e,{entity_id:t})}catch(i){this._notify("No se pudo controlar el reproductor.","error"),console.error(`Error ejecutando media_player.${e}:`,i)}}_updateToastPresentation(){if(!this.shadowRoot)return;const e=this.shadowRoot.querySelector("[data-toast]");if(!this._toast){e==null||e.remove();return}if(e){e.className=`toast ${this._escape(this._toast.type)}`,e.textContent=this._toast.message;return}const t=document.createElement("div");t.dataset.toast="",t.className=`toast ${this._escape(this._toast.type)}`,t.setAttribute("role","status"),t.textContent=this._toast.message,this.shadowRoot.append(t)}_notify(e,t="success"){var i;clearTimeout(this._toastTimer),this._toast={message:e,type:t},(i=this.shadowRoot)!=null&&i.querySelector(".app-shell")?this._updateToastPresentation():this._requestRender(),this._toastTimer=setTimeout(()=>{this._toast=null,this._updateToastPresentation()},4200)}_historyMap(){var t;const e=new Map;for(const i of this._history||[]){const a=(t=i==null?void 0:i[0])==null?void 0:t.entity_id;a&&e.set(a,i)}return e}_historySegments(e,t,i){if(!Array.isArray(e)||!e.length)return[];const a=e.map(n=>({state:n.state,time:new Date(n.last_changed||n.last_updated).getTime()})).filter(n=>Number.isFinite(n.time)).sort((n,o)=>n.time-o.time);if(!a.length)return[];const r=[];for(let n=0;n<a.length;n+=1){const o=a[n],s=a[n+1],l=Math.max(t,o.time),c=Math.min(i,(s==null?void 0:s.time)??i);c<=l||r.push({state:o.state,left:(l-t)/(i-t)*100,width:(c-l)/(i-t)*100})}return r}_sparkline(e,t){var u;const i=this._historyMap().get(e)||[],a=Date.now(),r=a-t*60*60*1e3,n=i.map(m=>({value:Number(m.state),time:new Date(m.last_changed||m.last_updated).getTime()})).filter(m=>Number.isFinite(m.value)&&Number.isFinite(m.time)&&m.time>=r).sort((m,b)=>m.time-b.time),o=Number((u=this._state(e))==null?void 0:u.state);if(Number.isFinite(o)&&n.push({value:o,time:a}),!n.length)return{path:"",min:"--",max:"--",avg:"--"};const s=n.map(m=>m.value),l=Math.min(...s),c=Math.max(...s),d=s.reduce((m,b)=>m+b,0)/s.length,h=c-l||1;return{path:n.map((m,b)=>{const E=(m.time-r)/(a-r)*300,v=66-(m.value-l)/h*52;return`${b?"L":"M"}${Math.max(0,Math.min(300,E)).toFixed(1)},${v.toFixed(1)}`}).join(" "),min:this._formatNumber(l),max:this._formatNumber(c),avg:this._formatNumber(d)}}_formatNumber(e){return Number.isFinite(e)?new Intl.NumberFormat("es-BO",{maximumFractionDigits:1}).format(e):"--"}_updateClock(){var o,s,l;if(!this.shadowRoot)return;const e=new Date,t=new Intl.DateTimeFormat("es-BO",{hour:"numeric",minute:"2-digit",hour12:!0}).formatToParts(e),i=((o=t.find(c=>c.type==="hour"))==null?void 0:o.value)||"--",a=((s=t.find(c=>c.type==="minute"))==null?void 0:s.value)||"--",r=(((l=t.find(c=>c.type==="dayPeriod"))==null?void 0:l.value)||"").replaceAll(".","").replaceAll(" ","").toUpperCase();for(const c of this.shadowRoot.querySelectorAll("[data-clock-time]"))c.textContent=`${i}:${a}`;for(const c of this.shadowRoot.querySelectorAll("[data-clock-period]"))c.textContent=r||"";const n=this.shadowRoot.querySelector("[data-current-time]");n&&(n.dateTime=e.toISOString(),n.setAttribute("aria-label",`${i}:${a} ${r}`.trim()))}_icon(e,t=""){const i=B[e]||B.bulb;return`<svg class="icon ${this._escape(t)}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${i}</svg>`}_escape(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}_renderDevice(e){const t=this._state(e.entity),i=this._visibleSwitchState(e.entity),a=i==="on",r=!t||["unknown","unavailable"].includes(t.state),n=this._pendingSwitches.has(e.entity),o=this._switchErrors.get(e.entity),s=o||(n?i==="on"?"Encendiendo…":"Apagando…":r?"No disponible":a?"Encendido":"Apagado");return`
      <button
        class="device ${a?"is-on":""} ${n?"is-pending":""} ${o?"is-error":""}"
    ...
    `}_renderWeather(){const e=this._config(),t=this._state(e.weather);if(!t)return`
      ...
      <section class="surface weather-card">
        <div class="weather-main">
          <div class="weather-symbol">${this._escape(I[a]||"·")}</div>
          <div class="weather-copy">
            <span class="eyebrow">Clima · Casa</span>
            <h2>${this._escape(j[a]||a)}</h2>
        ...
        ${e.showForecast?`
          <div class="forecast-row">
            ${r.length?r.map(n=>{const o=new Date(n.datetime),s=new Intl.DateTimeFormat("es-BO",{weekday:"short"}).format(o);return`
                <div class="forecast-item">
                  <span>${this._escape(s)}</span>
                  <b>${this._escape(I[n.condition]||"·")}</b>
    ...
    `;return`
      <section class="surface media-card ${i?"is-unavailable":""}">
        <div class="section-heading compact-heading">
          ...
          <span class="media-state ${r?"is-playing":""}">${this._escape(n)}</span>
        </div>
    ...
    `}_renderSceneBlock({eyebrow:e,title:t,scenes:i,className:a}){const r=this._config(),n=i.find(c=>this._sceneStatus(c).active),o=this._pendingAction===r.powerOffScript,s=r.sceneControlEntities.some(c=>{var d;return((d=this._state(c))==null?void 0:d.state)==="on"}),l=!!this._pendingAction||!s;return`
    ...
    `}_renderScenes(){const e=this._config(),t=[...e.scenes,...e.sampleScenes],i=t.find(o=>this._sceneStatus(o).active),a=this._pendingAction===e.powerOffScript,r=e.sceneControlEntities.some(o=>{var s;return((s=this._state(o))==null?void 0:s.state)==="on"}),n=!!this._pendingAction||!r;return`
    ...
    `}_renderActivity(){const e=this._energyRangeDefinition(),t=this._energyData.map(s=>Math.max(0,Number(s.change)||0)),i=t.reduce((s,l)=>s+l,0),a=t.length?i/t.length:0,r=t.length?Math.max(...t):0,n=new Date().toLocaleDateString("es-BO",{month:"short",year:"numeric"}).replace(".",""),o=this._energyRange==="day"?`${t.length} ${t.length===1?"hora":"horas"}`:this._energyRange==="month"?`${t.length} ${t.length===1?"día":"días"}`:`${t.length} ${t.length===1?"mes":"meses"}`;return`
    ...
    `}_renderNavigation(){return`
      <nav class="view-navigation" aria-label="Secciones del showroom">
        ${[["home","bulb","Inicio"],["lights","spot","Iluminación"],["energy","energy","Energía"],["system","health","Sistema"]].map(([t,i,a])=>`
          <button
    ...
    `}render(){var h;if(!this.shadowRoot||!this._hass)return;this._captureEnergyChartScroll(),this.setAttribute("data-theme",this._theme);const e=this._config(),t=e.staticOnly||e.panelKind==="general",i=this._state(e.weather),a=(i==null?void 0:i.attributes)||{},r=i==null?void 0:i.state,n=this._theme==="dark"?"claro":"oscuro",o=[...e.spots,...e.samples,...e.reflector?[e.reflector]:[]],s=o.filter(p=>this._visibleSwitchState(p.entity)==="on").length,l=(h=this._state(e.mediaPlayer))==null?void 0:h.state,c=l==="playing"?"Reproduciendo":l==="paused"?"En pausa":"Detenido",d=this._energyMonthTotal===null?"Sin datos":`${this._formatEnergy(this._energyMonthTotal)} kWh`;this.shadowRoot.innerHTML=`
      <style>
        :host {
          --primary: #f26522;
        ...
        <header class="topbar">
          ...
          ${t?"":`<div class="status-strip" aria-label="Resumen del showroom">
            ...
            <button class="status-pill" data-action="set-view" data-view="energy">
              ...
              <span><strong data-energy-summary>${this._escape(d)}</strong><small>Este mes</small></span>
            </button>
          </div>`}
          <div class="topbar-meta">
            ...
            <div class="header-weather" aria-label="Clima actual: ${this._escape(j[r]||r||"Sin datos")}, ${this._escape(a.temperature??"Sin datos")}${this._escape(a.temperature_unit??"°")}">
              <span aria-hidden="true">${this._escape(I[r]||"·")}</span>
              <strong>${this._escape(a.temperature??"--")}${this._escape(a.temperature_unit??"°")}</strong>
            </div>
            <button class="theme-button" data-action="toggle-theme" aria-label="Cambiar a tema ${n}" title="Cambiar a tema ${n}">${X}</button>
          </div>
        </header>
    ...
    `,this._updateClock(),requestAnimationFrame(()=>this._restoreEnergyChartScroll())}}customElements.get("showroom-panel")||customElements.define("showroom-panel",J);const ee={"clear-night":"Noche despejada",cloudy:"Nublado",exceptional:"Condición excepcional",fog:"Niebla",hail:"Granizo",lightning:"Tormenta eléctrica","lightning-rainy":"Tormenta y lluvia",partlycloudy:"Parcialmente nublado",pouring:"Lluvia intensa",rainy:"Lluvia",snowy:"Nieve","snowy-rainy":"Aguanieve",sunny:"Soleado",windy:"Ventoso","windy-variant":"Viento y nubes"},V={bulb:'<path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5M9 18h6M10 22h4"/>',panel:'<rect width="18" height="18" x="3" y="3" rx="3"/><path d="M3 9h18M3 15h18M9 3v18M15 3v18"/>',corridor:'<path d="M4 3h16v18H4V3Zm2 2v14h5V5H6Zm7 0v14h5V5h-5Z"/>',workshop:'<path d="M3 7l9-5 9 5v14H3V7Zm2 1.2V19h4v-6h6v6h4V8.2l-7-3.9-7 3.9Z"/>',power:'<path d="M12 2v10M18.4 6.6a9 9 0 1 1-12.8 0"/>',shield:'<path d="M12 3 20 6v5c0 5-3.4 8.3-8 10-4.6-1.7-8-5-8-10V6l8-3Z"/>',office:'<path d="M3 4h18v16H3V4Zm4 4h4v3H7V8Zm6 0h4v3h-4V8ZM7 13h4v3H7v-3Zm6 0h4v3h-4v-3Z"/>'},C=_=>`${new Intl.NumberFormat("es-BO",{maximumFractionDigits:0}).format(_)} W`;class te extends HTMLElement{constructor(){super(),this._hass=null,this._panel={},this._started=!1,this._renderQueued=!1,this._pending=new Map,this._errors=new Map,this._pendingAction="",this._confirmAction="",this._toast="",this._toastTimer=null,this.attachShadow({mode:"open"}),this.shadowRoot.addEventListener("click",e=>this._handleClick(e))}set hass(e){var t;this._hass=e,this._started||(this._started=!0),(t=this.shadowRoot)!=null&&t.querySelector(".operations-shell")?this._updatePresentation():this._render()}get hass(){return this._hass}set panel(e){this._panel=e&&typeof e=="object"?e:{},this._render()}get panel(){return this._panel}connectedCallback(){this._hass&&this._render()}disconnectedCallback(){this._toastTimer&&window.clearTimeout(this._toastTimer)}_kind(){return String(this._panel.panel_kind||this._panel.panelKind||"offices").toLowerCase()}_state(e){var t,i;return(i=(t=this._hass)==null?void 0:t.states)==null?void 0:i[e]}_isOn(e){var t;return((t=this._state(e))==null?void 0:t.state)==="on"||this._pending.get(e)==="on"}_unavailable(e){var i;const t=(i=this._state(e))==null?void 0:i.state;return!t||t==="unknown"||t==="unavailable"}_escape(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}_icon(e){return`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${V[e]||V.bulb}</svg>`}_devices(){const e=this._kind(),t=this._panel.power_watts||this._panel.powerWatts||this._panel.device_watts||{},i=a=>({...a,watts:a.watts??(Number(t[a.entity]||0)||void 0)});return e==="offices"?(this._panel.areas||[]).flatMap(a=>(a.devices||[]).map(i)):e==="recording"?(this._panel.switches||[]).map(i):(this._panel.zones||[]).flatMap(a=>(a.devices||(a.entities||[]).map(r=>({entity:r,name:r}))).map(i))}_powerTotal(e=this._devices()){return e.reduce((t,i)=>t+Number(i.watts||0),0)}_powerActive(e=this._devices()){return e.filter(t=>this._isOn(t.entity)).reduce((t,i)=>t+Number(i.watts||0),0)}_weather(){const e=this._state(this._panel.weather||"weather.forecast_casa");return{temperature:((e==null?void 0:e.attributes)||{}).temperature??"—",condition:ee[String((e==null?void 0:e.state)||"")]||String((e==null?void 0:e.state)||"Sin datos")}}_queueRender(){this._renderQueued||(this._renderQueued=!0,requestAnimationFrame(()=>{this._renderQueued=!1,this._render()}))}_render(){if(!this.shadowRoot)return;const e=this._weather(),t=this._devices(),i=this._panel.title||(this._kind()==="recording"?"Sala de grabación":this._kind()==="control"?"Control general":"Oficinas"),a=this._panel.subtitle||"Control operativo";this.setAttribute("data-kind",this._kind()),this.shadowRoot.innerHTML=`
      <style>
        :host{display:block;min-height:100dvh;color:var(--wit-text-primary,#f5f6f4);background:linear-gradient(155deg,#040a0f,#071118 62%,#10191e);font-family:Manrope,system-ui,sans-serif;font-variant-numeric:tabular-nums}
      ...
      <div class="operations-shell">
        <header class="topbar"><button class="menu" data-action="toggle-menu" aria-label="Abrir menú de Home Assistant"><span></span></button><div class="brand"><span class="eyebrow">WTX · MDTC</span><h1>${this._escape(i)}</h1></div><div class="top-meta"><span class="weather"><strong>${this._escape(e.temperature)}°</strong>${this._escape(e.condition)}</span></div></header>
        <main class="dashboard">
          <section class="hero"><div><span class="eyebrow">${this._escape(a)}</span><h2>${this._escape(i)}</h2><p>${this._escape(this._panel.description||"Estados y controles conectados a Home Assistant")}</p></div><div class="metrics"><span class="metric"><strong data-total-on>${t.filter(r=>this._isOn(r.entity)).length}</strong> activos</span><span class="metric"><strong data-active-power>${C(this._powerActive(t))}</strong> activos</span><span class="metric"><strong data-installed-power>${C(this._powerTotal(t))}</strong> instalados</span></div></section>
          ${this._kind()==="offices"?this._renderOffices():this._kind()==="recording"?this._renderRecording():this._renderControl()}
        </main>
        ${this._toast?`<div class="toast" role="status">${this._escape(this._toast)}</div>`:""}
      </div>
    `}_renderOffices(){return`<section class="surface section"><div class="section-head"><div><span class="eyebrow">Zonas operativas</span><h3>Oficinas</h3></div><small>Potencia configurada</small></div>${(this._panel.areas||[]).map(e=>{var n,o;const t=e.devices||[],i=e.environment||{},a=i.temperature?(n=this._state(i.temperature))==null?void 0:n.state:"",r=i.humidity?(o=this._state(i.humidity))==null?void 0:o.state:"";return`<article class="area"><div class="area-head"><div><strong>${this._escape(e.name)}</strong><small>${this._escape(e.subtitle||e.descriptor||"Área de trabajo")}</small></div><div class="env">${a?`<span>${this._escape(a)} °C</span>`:""}${r?`<span>${this._escape(r)} % HR</span>`:""}</div></div><div class="grid">${t.map(s=>this._renderDevice(s)).join("")}</div></article>`}).join("")}</section>`}_renderRecording(){const e=this._panel.switches||[];return`<section class="surface section"><div class="section-head"><div><span class="eyebrow">Cuatro circuitos</span><h3>Sala de grabación</h3></div><button class="action danger" data-action="run-action" data-action-id="recording-off">Apagar todo</button></div><div class="grid">${e.map(t=>this._renderDevice(t)).join("")}</div><div class="section-head" style="margin-top:18px;margin-bottom:0"><small>Estimación instalada: ${C(this._powerTotal(e))}. El valor representa potencia nominal, no consumo medido.</small></div></section>`}_renderControl(){return`<section class="surface section"><div class="section-head"><div><span class="eyebrow">Escenas y rutinas</span><h3>Control general</h3></div><small>Acciones verificadas</small></div><div class="grid">${[...this._panel.main_actions||[],...this._panel.daily_actions||[],...this._panel.danger_action?[this._panel.danger_action]:[]].map(t=>`<button class="action ${t.tone==="danger"?"danger":""}" data-action="run-action" data-action-id="${this._escape(t.id)}" ${this._pendingAction&&this._pendingAction!==t.id?"disabled":""}><strong>${this._escape(t.name)}</strong><small>${this._escape(t.subtitle||"Rutina operativa")}</small><span class="action-state">${this._pendingAction===t.id?"Aplicando…":t.tone==="danger"?"Protegida con confirmación":"Lista para ejecutar"}</span></button>`).join("")}</div></section><section class="surface section"><div class="section-head"><div><span class="eyebrow">Resumen de zonas</span><h3>Estado actual</h3></div></div>${(this._panel.zones||[]).map(t=>{const i=t.entities||[],a=i.filter(r=>this._isOn(r)).length;return`<div class="area"><div class="area-head"><div><strong>${this._escape(t.name)}</strong><small>${a} de ${i.length} circuitos activos</small></div><span class="device-state">${a?"Activo":"Apagado"}</span></div></div>`}).join("")}</section>${this._confirmAction?`<div class="toast" role="alert"><strong>¿Confirmar ${this._escape(this._confirmAction)}?</strong><button class="action" data-action="confirm-action" data-action-id="${this._escape(this._confirmAction)}">Confirmar</button><button class="action" data-action="cancel-action">Cancelar</button></div>`:""}`}_renderDevice(e){const t=this._isOn(e.entity),i=this._unavailable(e.entity),a=this._pending.has(e.entity),r=this._errors.get(e.entity),n=r||(a?t?"Encendiendo…":"Apagando…":i?"No disponible":t?"Encendido":"Apagado");return`<button class="device ${t?"is-on":""} ${r?"is-error":""}" data-action="toggle-switch" data-entity="${this._escape(e.entity)}" aria-pressed="${String(t)}" ${i||a?"disabled":""}><span class="device-icon">${this._icon(e.icon||"bulb")}</span><span class="device-copy"><strong>${this._escape(e.name)}</strong><small>${this._escape(e.subtitle||"Circuito")}${e.watts?` · ${C(e.watts)}`:""}</small></span><span class="device-state" data-device-status="${this._escape(e.entity)}">${this._escape(n)}</span></button>`}_updatePresentation(){var a,r,n;(a=this.shadowRoot)==null||a.querySelectorAll("[data-action=toggle-switch]").forEach(o=>{const s=o.dataset.entity||"",l=this._isOn(s),c=this._unavailable(s),d=this._pending.has(s),h=this._errors.get(s);o.classList.toggle("is-on",l),o.classList.toggle("is-error",!!h),o.disabled=c||d,o.setAttribute("aria-pressed",String(l));const p=o.querySelector("[data-device-status]");p&&(p.textContent=h||(d?l?"Encendiendo…":"Apagando…":c?"No disponible":l?"Encendido":"Apagado"))});const e=this._devices(),t=(r=this.shadowRoot)==null?void 0:r.querySelector("[data-total-on]"),i=(n=this.shadowRoot)==null?void 0:n.querySelector("[data-active-power]");t&&(t.textContent=String(e.filter(o=>this._isOn(o.entity)).length)),i&&(i.textContent=C(this._powerActive(e)))}_handleClick(e){const t=e.target.closest("[data-action]");if(!t||!this._hass)return;const i=t.dataset.action;if(i==="toggle-menu"){this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}));return}if(i==="toggle-switch"){this._toggleSwitch(t.dataset.entity||"");return}if(i==="run-action"){const a=t.dataset.actionId||"",r=this._findAction(a);(r==null?void 0:r.tone)==="danger"?this._confirmAction=a:this._executeAction(r),this._queueRender();return}if(i==="confirm-action"){const a=this._findAction(t.dataset.actionId||this._confirmAction);this._confirmAction="",this._executeAction(a),this._queueRender();return}i==="cancel-action"&&(this._confirmAction="",this._queueRender())}_findAction(e){const t=[...this._panel.main_actions||[],...this._panel.daily_actions||[],...this._panel.danger_action?[this._panel.danger_action]:[]];return e==="recording-off"?{id:e,name:"Apagar todo",off_entities:(this._panel.switches||[]).map(i=>i.entity)}:t.find(i=>i.id===e)||null}async _toggleSwitch(e){var i;if(!e||this._pending.has(e)||!((i=this._hass)!=null&&i.callService))return;const t=this._isOn(e)?"off":"on";this._pending.set(e,t),this._errors.delete(e),this._updatePresentation();try{const[a]=e.split(".");if(await this._hass.callService(a,t==="on"?"turn_on":"turn_off",{entity_id:e}),!await this._waitForState(e,t))throw new Error("Home Assistant no confirmó el estado solicitado")}catch(a){this._errors.set(e,a instanceof Error?a.message:"No se pudo cambiar el circuito"),this._showToast(this._errors.get(e)||"No se pudo cambiar el circuito")}finally{this._pending.delete(e),this._updatePresentation()}}async _executeAction(e){var i;if(!e||this._pendingAction||!((i=this._hass)!=null&&i.callService))return;this._pendingAction=e.id,this._queueRender();const t=new Map;(e.on_entities||[]).forEach(a=>t.set(a,"on")),(e.off_entities||[]).forEach(a=>t.set(a,"off"));try{for(const r of e.service_entities||[]){const[n]=r.split(".");await this._hass.callService(n,"turn_on",{entity_id:r})}for(const[r,n]of t){const[o]=r.split(".");await this._hass.callService(o,n==="on"?"turn_on":"turn_off",{entity_id:r})}if((await Promise.all([...t].map(([r,n])=>this._waitForState(r,n)))).some(r=>!r))throw new Error("No todos los circuitos confirmaron el cambio");this._showToast(`${e.name} aplicado.`)}catch(a){this._showToast(a instanceof Error?a.message:"No se pudo ejecutar la acción")}finally{this._pendingAction="",this._queueRender()}}async _waitForState(e,t){var i;for(let a=0;a<20;a+=1){if(((i=this._state(e))==null?void 0:i.state)===t)return!0;await new Promise(r=>window.setTimeout(r,250))}return!1}_showToast(e){this._toast=e,this._toastTimer&&window.clearTimeout(this._toastTimer),this._toastTimer=window.setTimeout(()=>{this._toast="",this._queueRender()},4200),this._queueRender()}}customElements.get("witmind-operations-panel")||customElements.define("witmind-operations-panel",te);const x=_=>String(_??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;"),D=(_,e=[])=>{if(Array.isArray(_))return _;for(const t of e)if(Array.isArray(_==null?void 0:_[t]))return _[t];return[]};class ie extends HTMLElement{constructor(){super(),this._hass=null,this._panel={},this._loaded=!1,this._loading=!1,this._error="",this._calendar=[],this._rules=[],this._targets=[],this._sensors=[],this._history=[],this.attachShadow({mode:"open"}),this.shadowRoot.addEventListener("click",e=>this._click(e)),this.shadowRoot.addEventListener("submit",e=>this._submit(e))}set hass(e){var t;this._hass=e,(t=this.shadowRoot)!=null&&t.querySelector(".admin-shell")||this._render(),e&&!this._loaded&&this._load()}get hass(){return this._hass}set panel(e){this._panel=e||{},this._loaded=!1,this._render(),this._hass&&this._load()}get panel(){return this._panel}disconnectedCallback(){var e;(e=this._unsubscribe)==null||e.call(this)}_kind(){return String(this._panel.panel_kind||this._panel.panelKind||"calendar").toLowerCase()}_title(){return this._kind()==="notifications"?"Notificaciones Witmind":"Calendario laboral"}_subtitle(){return this._kind()==="notifications"?"Centro de avisos":"Planificación operativa"}_admin(){var e,t;return((t=(e=this._hass)==null?void 0:e.user)==null?void 0:t.is_admin)!==!1}async _request(e,t={}){var a,r;const i=(r=(a=this._hass)==null?void 0:a.connection)==null?void 0:r.sendMessagePromise;if(!i)throw new Error("Conexión de Home Assistant no disponible");return i({type:e,...t})}async _load(){var e,t,i;if(!this._loading){this._loading=!0,this._error="",this._render();try{if(this._kind()==="notifications"){const[a,r,n,o]=await Promise.all([this._request("witmind_notifications/rules/list"),this._request("witmind_notifications/targets/list"),this._request("witmind_notifications/sensors/list"),this._request("witmind_notifications/history/list",{limit:150})]);this._rules=D(a,["rules"]),this._targets=D(r,["targets"]),this._sensors=D(n,["sensors"]),this._history=D(o,["history","items"]);try{this._unsubscribe=await((i=(t=(e=this._hass)==null?void 0:e.connection)==null?void 0:t.subscribeEvents)==null?void 0:i.call(t,()=>void this._load(),"witmind_notifications_updated"))}catch{}}else{const a=await this._request("calendario_laboral/get");this._calendar=D(a,["records","items","events"])}this._loaded=!0}catch(a){this._error=a instanceof Error?a.message:"No se pudieron cargar los datos"}finally{this._loading=!1,this._render()}}}_render(){if(!this.shadowRoot)return;const e=this._kind();this.shadowRoot.innerHTML=`<style>
      :host{display:block;min-height:100dvh;color:var(--wit-text-primary,#f5f6f4);background:linear-gradient(155deg,#040a0f,#071118 62%,#10191e);font-family:Manrope,system-ui,sans-serif}*{box-sizing:border-box}button,input,textarea{font:inherit;color:inherit}button:focus-visible,input:focus-visible,textarea:focus-visible{outline:2px solid #f26522;outline-offset:2px}.admin-shell{min-height:100dvh}.topbar{position:sticky;top:0;z-index:2;display:flex;align-items:center;gap:14px;min-height:66px;padding:12px clamp(16px,3vw,36px);border-bottom:1px solid rgba(255,255,255,.08);background:rgba(7,17,24,.84);backdrop-filter:blur(18px)}.menu{width:44px;height:44px;border:1px solid rgba(255,255,255,.12);border-radius:50%;background:rgba(255,255,255,.04);cursor:pointer}.menu span,.menu span:before,.menu span:after{display:block;width:18px;height:2px;margin:auto;background:currentColor;content:""}.menu span:before{transform:translateY(-6px)}.menu span:after{transform:translateY(4px)}.brand h1{margin:2px 0 0;font-size:clamp(20px,2.5vw,30px);letter-spacing:-.03em}.eyebrow{color:#f26522;font-size:10px;font-weight:800;letter-spacing:.12em;text-transform:uppercase}.dashboard{width:min(1200px,100%);margin:auto;padding:clamp(16px,3vw,34px)}.hero,.surface{border:1px solid rgba(255,255,255,.08);border-radius:22px;background:rgba(16,25,30,.84);box-shadow:0 16px 40px rgba(0,0,0,.2)}.hero{display:flex;align-items:center;justify-content:space-between;gap:18px;padding:24px;margin-bottom:16px}.hero h2{margin:5px 0 0;font-size:clamp(26px,4vw,42px);letter-spacing:-.04em}.hero p{margin:8px 0 0;color:#adb4b6}.refresh,.primary,.danger,.small{border:1px solid rgba(255,255,255,.12);border-radius:12px;padding:11px 14px;background:rgba(255,255,255,.05);cursor:pointer}.primary{background:#f26522;border-color:#f26522;color:#111}.danger{border-color:rgba(239,68,68,.5);color:#ff9b9b}.small{padding:7px 10px;font-size:11px}.surface{padding:18px}.surface+.surface{margin-top:14px}.section-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}.section-head h3{margin:4px 0 0;font-size:16px}.muted{color:#7e898d;font-size:12px}.list{display:grid;gap:9px}.row{display:grid;grid-template-columns:1fr auto;align-items:center;gap:14px;padding:13px;border:1px solid rgba(255,255,255,.08);border-radius:14px;background:rgba(27,40,46,.72)}.row strong,.row small{display:block}.row small{margin-top:4px;color:#7e898d;font-size:11px}.row-actions{display:flex;gap:7px;flex-wrap:wrap;justify-content:flex-end}.form{display:grid;grid-template-columns:repeat(3,1fr) auto;gap:9px;margin-top:14px}.form input,.form textarea{width:100%;padding:11px 12px;border:1px solid rgba(255,255,255,.12);border-radius:11px;background:rgba(7,17,24,.75)}.form textarea{min-height:42px;resize:vertical}.error{padding:12px;border:1px solid rgba(239,68,68,.5);border-radius:12px;color:#ff9b9b;background:rgba(100,20,20,.18)}.empty{padding:28px;text-align:center;color:#7e898d}@media(max-width:700px){.hero{align-items:flex-start;flex-direction:column;padding:18px}.form{grid-template-columns:1fr}.row{grid-template-columns:1fr}.row-actions{justify-content:flex-start}}
    </style><div class="admin-shell"><header class="topbar"><button class="menu" data-action="toggle-menu" aria-label="Abrir menú de Home Assistant"><span></span></button><div><span class="eyebrow">WTX · MDTC</span><h1>${x(this._title())}</h1></div></header><main class="dashboard"><section class="hero"><div><span class="eyebrow">${x(this._subtitle())}</span><h2>${x(this._title())}</h2><p>${x(this._panel.description||"Información conectada a Home Assistant")}</p></div><button class="refresh" data-action="refresh">Actualizar</button></section>${this._error?`<div class="error">${x(this._error)}</div>`:this._loading?'<section class="surface empty">Cargando datos de Home Assistant…</section>':e==="notifications"?this._renderNotifications():this._renderCalendar()}</main></div>`}_renderCalendar(){return`<section class="surface"><div class="section-head"><div><span class="eyebrow">Días laborables</span><h3>Calendario</h3></div><span class="muted">${this._calendar.length} registros</span></div>${this._calendar.length?`<div class="list">${this._calendar.map(e=>`<article class="row"><div><strong>${x(e.name||e.title||"Día laboral")}</strong><small>${x(e.date||"Sin fecha")}${e.description?` · ${x(e.description)}`:""}</small></div><div class="row-actions"><button class="small" data-action="toggle-calendar" data-id="${x(e.id??e.record_id)}">${e.active===!1?"Activar":"Desactivar"}</button>${this._admin()?`<button class="small danger" data-action="delete-calendar" data-id="${x(e.id??e.record_id)}">Eliminar</button>`:""}</div></article>`).join("")}</div>`:'<div class="empty">No hay registros configurados.</div>'}<form class="form" data-form="calendar"><input name="date" type="date" required><input name="name" placeholder="Nombre del día" required><input name="description" placeholder="Descripción"><button class="primary" type="submit">Añadir</button></form></section>`}_renderNotifications(){return`<section class="surface"><div class="section-head"><div><span class="eyebrow">Reglas activas</span><h3>Notificaciones</h3></div><span class="muted">${this._rules.length} reglas · ${this._targets.length} destinos · ${this._sensors.length} sensores</span></div>${this._rules.length?`<div class="list">${this._rules.map(e=>{const t=e.id??e.rule_id,i=e.enabled!==!1;return`<article class="row"><div><strong>${x(e.name||e.title||e.id||"Regla")}</strong><small>${x(e.description||e.sensor||e.entity_id||(i?"Activa":"Desactivada"))}</small></div><div class="row-actions"><button class="small" data-action="toggle-rule" data-id="${x(t)}" data-enabled="${String(i)}">${i?"Desactivar":"Activar"}</button><button class="small" data-action="test-rule" data-id="${x(t)}">Probar</button>${this._admin()?`<button class="small danger" data-action="delete-rule" data-id="${x(t)}">Eliminar</button>`:""}</div></article>`}).join("")}</div>`:'<div class="empty">No hay reglas disponibles.</div>'}</section><section class="surface"><div class="section-head"><div><span class="eyebrow">Actividad reciente</span><h3>Historial</h3></div><span class="muted">${this._history.length} eventos</span></div>${this._history.length?`<div class="list">${this._history.slice(0,12).map(e=>`<div class="row"><div><strong>${x(e.title||e.message||e.rule_name||"Aviso")}</strong><small>${x(e.created_at||e.timestamp||e.date||"")}</small></div></div>`).join("")}</div>`:'<div class="empty">Sin eventos recientes.</div>'}</section>`}_click(e){const t=e.target.closest("button[data-action]");if(!t)return;const i=t.dataset.action;i==="toggle-menu"?this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0})):i==="refresh"?this._load():i==="toggle-calendar"?this._calendarAction(t.dataset.id||"",t):i==="delete-calendar"?this._calendarAction(t.dataset.id||"",t,!0):i==="toggle-rule"?this._ruleAction("toggle",t.dataset.id||"",t.dataset.enabled==="true"):i==="test-rule"?this._ruleAction("test",t.dataset.id||""):i==="delete-rule"&&this._ruleAction("delete",t.dataset.id||"")}_submit(e){const t=e.target;if(t.dataset.form!=="calendar")return;e.preventDefault();const i=new FormData(t);this._request("calendario_laboral/add",{date:i.get("date"),name:i.get("name"),description:i.get("description"),active:!0}).then(()=>this._load()).catch(a=>{this._error=a instanceof Error?a.message:"No se pudo añadir",this._render()})}async _calendarAction(e,t,i=!1){if(!(!e||!this._admin()))try{const a=this._calendar.find(r=>String(r.id??r.record_id)===e);i?await this._request("calendario_laboral/delete",{record_id:e}):await this._request("calendario_laboral/update",{record_id:e,active:(a==null?void 0:a.active)===!1}),await this._load()}catch(a){this._error=a instanceof Error?a.message:"No se pudo actualizar",this._render()}finally{t.disabled=!1}}async _ruleAction(e,t,i=!0){if(!(!t||!this._hass))try{if(e==="toggle"&&await this._request("witmind_notifications/rules/toggle",{rule_id:t,enabled:!i}),e==="test"&&await this._request("witmind_notifications/test",{recipient:{rule_id:t}}),e==="delete"){if(!this._admin())return;await this._request("witmind_notifications/rules/delete",{rule_id:t})}await this._load()}catch(a){this._error=a instanceof Error?a.message:"No se pudo ejecutar la acción",this._render()}}}customElements.get("witmind-admin-panel")||customElements.define("witmind-admin-panel",ie);const ae={panel_kind:"lobby",title:"Lobby",subtitle:"Control operativo",site_label:"WTX · MDTC",weather:"weather.forecast_casa",light_count_sensor:"sensor.lobby_luminarias_encendidas",energy_sensor:"sensor.showroom_energia_estimada",history_hours:4,chart_hours:24,show_forecast:!0,spots:[{entity:"switch.interruptor_inteligente_3_switch_1",name:"Central Colgante",subtitle:"Iluminación central",icon:"pendant"},{entity:"switch.interruptor_inteligente_3_switch_2",name:"Spots 5W Decorativos",subtitle:"Iluminación decorativa",icon:"spot"},{entity:"switch.interruptor_inteligente_3_switch_3",name:"Tira LED",subtitle:"Iluminación ambiental",icon:"strip"},{entity:"switch.interruptor_inteligente_3_switch_4",name:"Spots 10W",subtitle:"Iluminación principal",icon:"spot"}],samples:[],reflector:{entity:""},scene_control_entities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.interruptor_inteligente_3_switch_4"],scenes:[{id:"visita",name:"Visita",subtitle:"Todos los circuitos",icon:"presentation",on_entities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.interruptor_inteligente_3_switch_4"]},{id:"regular",name:"Regular",subtitle:"Solo Spots 10W",icon:"bulb",on_entities:["switch.interruptor_inteligente_3_switch_4"],off_entities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3"]}],sample_scenes:[]},re={panel_kind:"general",static_only:!0,title:"Witmind General",subtitle:"Centro de control",site_label:"WTX · MDTC",weather:"weather.forecast_casa",show_forecast:!0,spots:[],samples:[],reflector:{entity:""},scenes:[],sample_scenes:[],scene_control_entities:[]},F={panel_kind:"offices",title:"Oficinas",subtitle:"Control operativo",description:"Circuitos de oficinas con potencia nominal instalada.",weather:"weather.forecast_casa",power_watts:{"switch.oficina_gerencial_interruptor_1":48,"switch.oficina_mindtec_interruptor_1":48,"switch.oficina_grande_interruptor_1":168,"switch.oficina_grande_interruptor_2":168,"switch.b2_gang_interruptor_1":96,"switch.b2_gang_interruptor_2":117,"switch.taller_interruptor_1":144},areas:[{id:"gerencia",name:"Gerencia",devices:[{entity:"switch.oficina_gerencial_interruptor_1",name:"Witronix LED",subtitle:"4×12 W nominal",watts:48}]},{id:"mindtec",name:"Mindtec",devices:[{entity:"switch.oficina_mindtec_interruptor_1",name:"Mindtec",subtitle:"1×48 W nominal",watts:48}]},{id:"general",name:"Oficinas grandes",environment:{temperature:"sensor.t_h_sensor_2_temperature",humidity:"sensor.t_h_sensor_2_humidity"},devices:[{entity:"switch.oficina_grande_interruptor_1",name:"Oficina grande 1",subtitle:"4×42 W nominal",watts:168},{entity:"switch.oficina_grande_interruptor_2",name:"Oficina grande 2",subtitle:"4×42 W nominal",watts:168}]},{id:"pasillos",name:"Pasillos y multifuncional",devices:[{entity:"switch.b2_gang_interruptor_1",name:"Multifuncional",subtitle:"4×24 W nominal",watts:96,icon:"office"},{entity:"switch.b2_gang_interruptor_2",name:"Pasillos",subtitle:"3×24 W + 3×15 W nominal",watts:117,icon:"corridor"}]},{id:"taller",name:"Taller",devices:[{entity:"switch.taller_interruptor_1",name:"Taller",subtitle:"3×48 W nominal",watts:144,icon:"workshop"}]}]},P={panel_kind:"recording",title:"Sala de grabación",subtitle:"Control operativo",description:"Cuatro circuitos con potencia nominal configurada.",weather:"weather.forecast_casa",power_watts:{"switch.4gang_switch_sala_grabacion_interruptor_1":24,"switch.4gang_switch_sala_grabacion_interruptor_2":96,"switch.4gang_switch_sala_grabacion_interruptor_3":50,"switch.4gang_switch_sala_grabacion_interruptor_4":30},switches:[{entity:"switch.4gang_switch_sala_grabacion_interruptor_1",name:"Tira LED",subtitle:"1×24 W nominal",watts:24,icon:"strip"},{entity:"switch.4gang_switch_sala_grabacion_interruptor_2",name:"Paneles",subtitle:"2×48 W nominal",watts:96,icon:"panel"},{entity:"switch.4gang_switch_sala_grabacion_interruptor_3",name:"Spots",subtitle:"5×10 W nominal",watts:50,icon:"spot"},{entity:"switch.4gang_switch_sala_grabacion_interruptor_4",name:"Otras luces",subtitle:"3×10 W nominal",watts:30,icon:"bulb"}]},se={panel_kind:"control",title:"Control general",subtitle:"Centro de control",description:"Escenas y rutinas conectadas a Home Assistant.",weather:"weather.forecast_casa",device_watts:{...F.power_watts,...P.power_watts,"switch.interruptor_inteligente_switch_1":48,"switch.interruptor_inteligente_switch_2":48,"switch.interruptor_inteligente_switch_3":48,"switch.interruptor_inteligente_switch_4":48,"switch.interruptor_inteligente_2_switch_1":48,"switch.interruptor_inteligente_2_switch_2":48,"switch.interruptor_inteligente_2_switch_3":48,"switch.interruptor_inteligente_2_switch_4":48,"switch.smart_relay_switch_3_switch":48,"switch.smart_relay_switch_4_switch":48,"switch.interruptor_inteligente_3_switch_1":0,"switch.interruptor_inteligente_3_switch_2":0,"switch.interruptor_inteligente_3_switch_3":0,"switch.interruptor_inteligente_3_switch_4":0},zones:[{id:"showroom",name:"Showroom",entities:["switch.interruptor_inteligente_switch_1","switch.interruptor_inteligente_switch_2","switch.interruptor_inteligente_switch_3","switch.interruptor_inteligente_switch_4","switch.interruptor_inteligente_2_switch_1","switch.interruptor_inteligente_2_switch_2","switch.interruptor_inteligente_2_switch_3","switch.interruptor_inteligente_2_switch_4","switch.smart_relay_switch_4_switch","switch.smart_relay_switch_3_switch"]},{id:"lobby",name:"Lobby",entities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.interruptor_inteligente_3_switch_4"]},{id:"oficinas",name:"Oficinas",entities:Object.keys(F.power_watts)},{id:"grabacion",name:"Sala de grabación",entities:Object.keys(P.power_watts)}],main_actions:[{id:"showroom-reunion",name:"Reunión showroom",subtitle:"Escena de reunión",service_entities:["scene.reunion"],tone:"accent"},{id:"showroom-presentacion",name:"Presentación showroom",subtitle:"Escena de presentación",service_entities:["scene.presentacion"],tone:"accent"},{id:"showroom-apagado",name:"Apagar showroom",subtitle:"Apaga los circuitos del showroom",service_entities:["script.showroom_apagado_general"],tone:"danger"},{id:"lobby-regular",name:"Lobby regular",subtitle:"Solo iluminación principal",on_entities:["switch.interruptor_inteligente_3_switch_4"],off_entities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3"]},{id:"lobby-visita",name:"Lobby visita",subtitle:"Todos los circuitos",on_entities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.interruptor_inteligente_3_switch_4"]},{id:"lobby-apagado",name:"Apagar lobby",subtitle:"Apaga los cuatro circuitos",off_entities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.interruptor_inteligente_3_switch_4"]}],daily_actions:[{id:"inicio-dia",name:"Inicio del día",subtitle:"Rutina de apertura",on_entities:["switch.interruptor_inteligente_3_switch_4","switch.oficina_gerencial_interruptor_1","switch.b2_gang_interruptor_1"],off_entities:["switch.interruptor_inteligente_switch_1","switch.interruptor_inteligente_switch_2","switch.interruptor_inteligente_switch_3","switch.interruptor_inteligente_switch_4","switch.interruptor_inteligente_2_switch_1","switch.interruptor_inteligente_2_switch_2","switch.interruptor_inteligente_2_switch_3","switch.interruptor_inteligente_2_switch_4","switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.b2_gang_interruptor_2"]},{id:"fin-dia",name:"Fin del día",subtitle:"Rutina de cierre",service_entities:["script.showroom_apagado_general"],off_entities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.interruptor_inteligente_3_switch_4"]}],danger_action:{id:"apagado-total",name:"Apagado total Witmind",subtitle:"Apaga showroom, lobby, oficinas y grabación",service_entities:["script.apagado_total_witmind"],tone:"danger"}},ne={panel_kind:"calendar",title:"Calendario laboral",subtitle:"Planificación operativa",description:"Días laborales gestionados desde Home Assistant."},oe={panel_kind:"notifications",title:"Notificaciones Witmind",subtitle:"Centro de avisos",description:"Reglas, destinos e historial de notificaciones."},q=[{id:"general",label:"General",icon:"⌂"},{id:"showroom",label:"Showroom",icon:"✦"},{id:"lobby",label:"Lobby",icon:"⌂"},{id:"offices",label:"Oficinas",icon:"▦"},{id:"recording",label:"Grabación",icon:"◈"},{id:"calendar",label:"Calendario",icon:"▣"},{id:"notifications",label:"Notificaciones",icon:"◉"},{id:"control",label:"Control",icon:"⚡"}],z=_=>{const e=String(_||"").trim().toLowerCase(),i={"oficinas-control":"offices",oficinas:"offices","sala-grabacion":"recording",grabacion:"recording","calendario-laboral":"calendar",calendario:"calendar",notificaciones:"notifications","control-general":"control"}[e]||e;return q.some(a=>a.id===i)?i:"showroom"},O=_=>JSON.parse(JSON.stringify(_));class ce extends HTMLElement{constructor(){super(...arguments),this._config={},this._hass=null,this._narrow=!1,this._activeId="showroom",this._pages=[],this._track=null,this._drag=null,this._dragging=!1,this._boundResize=()=>this._snap(!1)}set config(e){this._config=e&&typeof e=="object"?e:{},this._activeId=z(this._config.panel_id||this._config.panelId||this._config.panel_kind),this.isConnected&&this._mountPages()}get config(){return this._config}set hass(e){this._hass=e,this._pages.forEach(t=>{const i=t.firstElementChild;i&&(i.hass=e||void 0)})}get hass(){return this._hass}set narrow(e){this._narrow=!!e,this.toggleAttribute("narrow",this._narrow),this._pages.forEach(t=>{const i=t.firstElementChild;i&&(i.narrow=this._narrow)})}get narrow(){return this._narrow}connectedCallback(){this.attachShadow({mode:"open"}),this._renderShell(),this._mountPages(),window.addEventListener("resize",this._boundResize,{passive:!0})}disconnectedCallback(){window.removeEventListener("resize",this._boundResize)}_renderShell(){var t;this.shadowRoot.innerHTML=`
      <style>
        :host { display:block; min-height:100dvh; overflow:hidden; background:var(--wit-canvas,#071118); }
        .workspace { position:relative; min-height:100dvh; overflow:hidden; }
        .track { display:flex; width:100%; min-height:100dvh; transition:transform 280ms cubic-bezier(.2,.8,.2,1); will-change:transform; }
        .track.is-dragging { transition:none; cursor:grabbing; }
        .page { flex:0 0 100%; min-width:100%; min-height:100dvh; overflow:visible; }
    ...
    `;const e=this.shadowRoot.querySelector("[data-track]");this._track=e,e.addEventListener("pointerdown",i=>this._onPointerDown(i)),e.addEventListener("pointermove",i=>this._onPointerMove(i)),e.addEventListener("pointerup",i=>this._onPointerUp(i)),e.addEventListener("pointercancel",i=>this._onPointerUp(i)),(t=this.shadowRoot.querySelector("[data-nav]"))==null||t.addEventListener("click",i=>this._onNavClick(i))}_panelConfigs(){const e=this._config.workspace_panels||this._config.workspacePanels,t=Array.isArray(e)?e:[],i=new Map(t.map(r=>{const n=r&&typeof r=="object"?r:{};return[z(n.id||n.panel_id||n.panelId||n.panel_kind),n]})),a=z(this._config.panel_id||this._config.panelId||this._config.panel_kind);return q.map(r=>{const n=r.id==="general"?re:r.id==="lobby"?ae:r.id==="offices"?F:r.id==="recording"?P:r.id==="calendar"?ne:r.id==="notifications"?oe:r.id==="control"?se:{},o=i.get(r.id)||{},s=r.id===a?this._config:{},l={...O(n),...O(o),...O(s)};return r.id==="lobby"&&Array.isArray(s.devices)&&!Array.isArray(s.spots)&&(l.spots=s.devices),r.id==="general"?(l.panel_kind="general",l.static_only=!0):r.id==="lobby"?l.panel_kind="lobby":["offices","recording","control","calendar","notifications"].includes(r.id)?l.panel_kind=r.id:(delete l.panel_kind,delete l.static_only),{...r,config:l}})}_mountPages(){this._track&&(this._track.innerHTML="",this._pages=[],this._panelConfigs().forEach((e,t)=>{const i=document.createElement("section");i.className="page",i.dataset.panelId=e.id,i.setAttribute("aria-label",e.label),i.setAttribute("aria-hidden",String(e.id!==this._activeId)),i.inert=e.id!==this._activeId;const a=["offices","recording","control"].includes(e.id)?"witmind-operations-panel":["calendar","notifications"].includes(e.id)?"witmind-admin-panel":"showroom-panel",r=document.createElement(a);r.panel=a==="showroom-panel"?{config:e.config}:e.config,r.narrow=this._narrow,this._hass&&(r.hass=this._hass),i.append(r),this._track.append(i),this._pages.push(i),t===0&&(i.dataset.first="true")}),this._renderNav(),this._snap(!1))}_activeIndex(){const e=this._pages.findIndex(t=>t.dataset.panelId===this._activeId);return e>=0?e:0}_renderNav(){var i;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("[data-nav]");if(!e)return;const t=this._activeIndex();e.innerHTML=`
    ...
    `}_onNavClick(e){const t=e.target.closest("button");t&&(t.dataset.panel?this._goTo(t.dataset.panel):this._goTo(this._activeIndex()+(t.dataset.direction==="next"?1:-1)))}_onPointerDown(e){var a,r;const t=e.target,i=e.composedPath().some(n=>n instanceof HTMLElement&&!!n.closest("button,a,input,textarea,select,[data-no-swipe]"))||!!t.closest("button,a,input,textarea,select,[data-no-swipe]");this._drag={pointerId:e.pointerId,x:e.clientX,y:e.clientY,time:performance.now(),ignored:i},this._dragging=!1,i||(r=(a=e.currentTarget).setPointerCapture)==null||r.call(a,e.pointerId)}_onPointerMove(e){if(!this._drag||this._drag.ignored||this._drag.pointerId!==e.pointerId||!this._track)return;const t=e.clientX-this._drag.x,i=e.clientY-this._drag.y;!this._dragging&&(Math.abs(t)<8||Math.abs(t)<=Math.abs(i)*1.15)||(this._dragging=!0,this._track.classList.add("is-dragging"),this._track.style.transform=`translate3d(calc(${this._activeIndex()*-100}% + ${t}px), 0, 0)`,e.preventDefault())}_onPointerUp(e){var n;if(!this._drag||this._drag.pointerId!==e.pointerId)return;const t=e.clientX-this._drag.x,i=Math.max(1,performance.now()-this._drag.time),a=this._dragging&&(Math.abs(t)>56||Math.abs(t/i)>.45),r=t<0?1:-1;(n=this._track)==null||n.classList.remove("is-dragging"),this._drag=null,this._dragging=!1,a?this._goTo(this._activeIndex()+r):this._snap(!0)}_goTo(e){const t=typeof e=="string"?this._pages.findIndex(i=>i.dataset.panelId===e):e;if(t<0||t>=this._pages.length){this._snap(!0);return}this._activeId=this._pages[t].dataset.panelId||this._activeId,this._pages.forEach(i=>{const a=i.dataset.panelId===this._activeId;i.setAttribute("aria-hidden",String(!a)),i.inert=!a}),this._renderNav(),this._snap(!0),this.dispatchEvent(new CustomEvent("witmind-panel-change",{detail:{panelId:this._activeId},bubbles:!0,composed:!0}))}_snap(e=!0){this._track&&(this._track.classList.toggle("is-dragging",!e),this._track.style.transform=`translate3d(${this._activeIndex()*-100}%, 0, 0)`)}}customElements.get("witmind-workspace")||customElements.define("witmind-workspace",ce);const Y=()=>{var _,e;return((e=(_=globalThis.crypto)==null?void 0:_.randomUUID)==null?void 0:e.call(_))||`${Date.now()}-${Math.random().toString(16).slice(2)}`};class le{constructor(e=window.parent){this.target=e,this.states=new Map,this.listeners=new Set,this.pending=new Map,this.subscriptions=new Map,window.addEventListener("message",t=>this.onMessage(t)),this.post({type:"WITMIND_READY"})}subscribeEntities(e,t){return this.listeners.add(t),this.post({type:"WITMIND_SUBSCRIBE_ENTITIES",entityIds:[...new Set(e)]}),t(Object.fromEntries(this.states)),()=>this.listeners.delete(t)}getEntity(e){return this.states.get(e)}callService(e,t={},i){return this.request("WITMIND_CALL_SERVICE","WITMIND_SERVICE_RESULT",{service:e,serviceData:t,target:i})}toggleMenu(){this.post({type:"WITMIND_TOGGLE_MENU"})}dbRequest(e,t={}){return this.request("WITMIND_DB_REQUEST","WITMIND_DB_RESULT",{command:e,payload:t})}haRequest(e,t={}){return this.request("WITMIND_HA_COMMAND","WITMIND_HA_RESULT",{command:e,payload:t})}haSubscribe(e,t,i){const a=Y(),r=()=>{this.subscriptions.delete(a),this.post({type:"WITMIND_HA_UNSUBSCRIBE",requestId:a})};return new Promise((n,o)=>{const s=window.setTimeout(()=>{this.pending.delete(a),o(new Error("Timeout esperando suscripción HA"))},1e4);this.pending.set(a,{resolve:()=>{window.clearTimeout(s),n(r)},reject:o,timer:s}),this.subscriptions.set(a,i),this.post({type:"WITMIND_HA_SUBSCRIBE",requestId:a,command:e,payload:t})})}post(e){this.target.postMessage({protocol:1,source:"witmind-ui",...e},"*")}request(e,t,i){const a=Y();return new Promise((r,n)=>{const o=window.setTimeout(()=>{this.pending.delete(a),n(new Error(`Timeout esperando ${t}`))},1e4);this.pending.set(a,{resolve:r,reject:n,timer:o}),this.post({type:e,requestId:a,...i})})}onMessage(e){var a,r,n;if(e.source!==this.target||((a=e.data)==null?void 0:a.protocol)!==1||((r=e.data)==null?void 0:r.source)!=="witmind-ha")return;const t=e.data;if(t.type==="WITMIND_HA_EVENT"){(n=this.subscriptions.get(t.requestId))==null||n(t.result);return}if(t.type==="WITMIND_ENTITY_UPDATE"){Object.entries(t.states||{}).forEach(([s,l])=>this.states.set(s,l)),(t.removed||[]).forEach(s=>this.states.delete(s));const o=Object.fromEntries(this.states);this.listeners.forEach(s=>s(o));return}const i=this.pending.get(t.requestId);i&&(this.pending.delete(t.requestId),window.clearTimeout(i.timer),t.ok?i.resolve(t.result):i.reject(new Error(String(t.error||"Witmind request failed"))))}}const G=["weather.forecast_casa","media_player.showroom_1","sensor.showroom_luminarias_encendidas","sensor.showroom_energia_estimada","sensor.21051182g_battery_level","switch.interruptor_inteligente_switch_1","switch.interruptor_inteligente_switch_2","switch.interruptor_inteligente_switch_3","switch.interruptor_inteligente_switch_4","switch.interruptor_inteligente_2_switch_1","switch.interruptor_inteligente_2_switch_2","switch.interruptor_inteligente_2_switch_3","switch.interruptor_inteligente_2_switch_4","switch.smart_relay_switch_3_switch","switch.smart_relay_switch_4_switch","switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.interruptor_inteligente_3_switch_4","scene.presentacion","scene.reunion","scene.visita","scene.regular","script.showroom_encendido_general","script.showroom_apagado_general","script.apagado_total_witmind","switch.oficina_gerencial_interruptor_1","switch.oficina_mindtec_interruptor_1","switch.oficina_grande_interruptor_1","switch.oficina_grande_interruptor_2","switch.b2_gang_interruptor_1","switch.b2_gang_interruptor_2","switch.taller_interruptor_1","sensor.t_h_sensor_temperature","sensor.t_h_sensor_humidity","sensor.t_h_sensor_2_temperature","sensor.t_h_sensor_2_humidity","switch.4gang_switch_sala_grabacion_interruptor_1","switch.4gang_switch_sala_grabacion_interruptor_2","switch.4gang_switch_sala_grabacion_interruptor_3","switch.4gang_switch_sala_grabacion_interruptor_4"],W=(_,e=new Set)=>(typeof _=="string"&&/^[a-z_]+\.[a-z0-9_]+$/i.test(_)?e.add(_):Array.isArray(_)?_.forEach(t=>W(t,e)):_&&typeof _=="object"&&Object.values(_).forEach(t=>W(t,e)),[...e]);class de extends HTMLElement{constructor(){super(...arguments),this.states={},this.previousStates={},this.eventListeners=new Set,this.panelConfig={},this.messageHandler=e=>{var i,a;if(e.source!==window.parent||((i=e.data)==null?void 0:i.protocol)!==1||((a=e.data)==null?void 0:a.source)!=="witmind-ha")return;e.data.type==="WITMIND_INIT"&&e.data.panelConfig&&(this.panelConfig=e.data.panelConfig,this.applyPanelConfig(),this.resubscribeWithConfig());const t=e.data.theme;(t==="light"||t==="dark")&&this.panel&&this.panel.setAttribute("theme",t)}}connectedCallback(){this.attachShadow({mode:"open"}),window.addEventListener("message",this.messageHandler),this.shadowRoot.innerHTML="<style>:host{display:block;min-height:100dvh;background:var(--wit-surface,#071118)} witmind-workspace{display:block;min-height:100dvh}</style><witmind-workspace></witmind-workspace>",this.panel=this.shadowRoot.querySelector("witmind-workspace"),this.panel.addEventListener("hass-toggle-menu",()=>{var e;return(e=this.client)==null?void 0:e.toggleMenu()}),this.client=new le(window.parent),this.applyPanelConfig(),this.subscribe(G),this.panel.hass=this.createHassAdapter()}subscribe(e){var t;(t=this.unsubscribe)==null||t.call(this),this.unsubscribe=this.client.subscribeEntities(e,i=>{this.previousStates=this.states,this.states=i,this.panel.hass=this.createHassAdapter(),this.emitStateChanges()})}resubscribeWithConfig(){const e=[...new Set([...G,...W(this.panelConfig)])];this.subscribe(e)}applyPanelConfig(){this.panel&&(this.panel.config=this.panelConfig)}disconnectedCallback(){var e;(e=this.unsubscribe)==null||e.call(this),window.removeEventListener("message",this.messageHandler)}createHassAdapter(){const e=this.client;return{states:this.states,language:"es",user:{is_admin:!0},selectedTheme:null,callService:(i,a,r={},n)=>e.callService(`${i}.${a}`,r,n),callWS:async i=>i.type==="get_states"?Object.values(this.states):e.haRequest(String(i.type||""),i),callApi:async(i,a)=>[],connection:{subscribeEvents:async(i,a)=>{const r=n=>{(!a||a==="state_changed")&&i(n)};return this.eventListeners.add(r),()=>this.eventListeners.delete(r)},sendMessagePromise:i=>e.haRequest(String(i.type||""),i),subscribeMessage:(i,a)=>e.haSubscribe(String(a.type||""),a,i)}}}emitStateChanges(){Object.entries(this.states).forEach(([e,t])=>{this.previousStates[e]!==t&&this.eventListeners.forEach(i=>i({event_type:"state_changed",data:{entity_id:e,new_state:t,old_state:this.previousStates[e]||null}}))})}}customElements.define("witmind-ui-app",de);
