...
`;class _t extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._hass=null,this._panel=null,this._narrow=!1,this._started=!1,this._renderQueued=!1,this._forecast=[],this._history=[],this._historyError="",this._liveStates=new Map,this._pendingSwitches=new Map,this._switchErrors=new Map,this._switchTimers=new Map,this._pendingAction="",this._confirmAction="",this._toast=null,this._toastTimer=null,this._clockTimer=null,this._historyTimer=null,this._unsubscribeStates=null,this._unsubscribeForecast=null,this._forecastEntity="",this._energyRange="day",this._energyDayOffset=0,this._energyData=[],this._energyLoading=!1,this._energyError=null,this._energyMonthTotal=null,this._energyRequestId=0,this._energyRefreshTimer=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._themeStorageKey="witmind-showroom-panel-theme",this._theme=this._loadTheme(),this._activeView="home",this.shadowRoot.addEventListener("click",e=>this._handleClick(e)),this.shadowRoot.addEventListener("scroll",e=>this._handleEnergyScroll(e),!0)}set hass(e){var o,n,c,d;const t=this._hass,i=this._config(),a=this._relevantHassChanged(t,e),r=!t||((o=t.states)==null?void 0:o[i.energySensor])!==((n=e==null?void 0:e.states)==null?void 0:n[i.energySensor]),s=!((c=t==null?void 0:t.states)!=null&&c[i.energySensor])&&!!((d=e==null?void 0:e.states)!=null&&d[i.energySensor]);this._hass=e,a&&this._syncStatesFromHass(),this.isConnected&&(this._started?r&&(s?this._loadEnergyStatistics():this._scheduleEnergyRefresh()):(this._started=!0,this._start()),a&&this._updateStatePresentation())}get hass(){return this._hass}set panel(e){const t=this._config().weather;this._panel=e;const i=this._config().weather;this._config().panelKind==="general"&&this._activeView==="home"&&(this._activeView="lights"),this._started&&t!==i&&(this._resetForecastSubscription(),this._subscribeWeather()),this._hass&&(this._syncStatesFromHass(),this._loadEnergyStatistics(),this._updateStatePresentation())}get panel(){return this._panel}set narrow(e){this._narrow=!!e,this.toggleAttribute("narrow",this._narrow)}get narrow(){return this._narrow}connectedCallback(){this._hass&&(this._started||(this._started=!0,this._start()),this._updateStatePresentation(),this._scheduleEnergyRefresh(!0))}disconnectedCallback(){clearInterval(this._clockTimer),clearInterval(this._historyTimer),clearTimeout(this._toastTimer),clearTimeout(this._energyRefreshTimer),this._energyRequestId+=1;for(const e of this._switchTimers.values())clearTimeout(e);this._switchTimers.clear(),this._resetForecastSubscription(),this._unsubscribeStates&&(this._unsubscribeStates(),this._unsubscribeStates=null),this._started=!1}_requestRender(){this._renderQueued||!this._hass||!this.shadowRoot||(this._renderQueued=!0,requestAnimationFrame(()=>{this._renderQueued=!1,this.render()}))}_updateStatePresentation(){var o;if(!((o=this.shadowRoot)!=null&&o.querySelector(".app-shell"))){this._requestRender();return}const e=n=>{var _;const c=n.dataset.entity;if(!c)return;const d=this._state(c),h=this._visibleSwitchState(c),p=h==="on",g=!d||["unknown","unavailable"].includes(d.state),u=this._pendingSwitches.has(c),f=this._switchErrors.get(c),b=f||(u?h==="on"?"Encendiendo…":"Apagando…":g?"No disponible":p?"Encendido":"Apagado");n.classList.toggle("is-on",p),n.classList.toggle("is-pending",u),n.classList.toggle("is-error",!!f),n.disabled=g,n.setAttribute("aria-pressed",String(p));const $=((_=n.querySelector(".device-copy strong"))==null?void 0:_.textContent)||c;n.setAttribute("aria-label",`${$}: ${b}`);const E=n.querySelector(".device-copy small");E&&(E.textContent=b)};this.shadowRoot.querySelectorAll('[data-action="toggle-switch"]').forEach(e),this.shadowRoot.querySelectorAll('[data-action="run-scene"]').forEach(n=>{const c=this._allScenes().find(u=>u.key===n.dataset.sceneKey);if(!c)return;const d=this._sceneStatus(c),h=this._pendingAction===c.key,p=h?"Aplicando...":d.active?"Activo":d.unavailable?"Sin datos":"Inactivo";n.classList.toggle("is-pending",h),n.classList.toggle("is-active",d.active),n.classList.toggle("is-unavailable",d.unavailable),n.disabled=!!(this._pendingAction&&!h),n.setAttribute("aria-pressed",String(d.active));const g=n.querySelector(".scene-state");g&&(g.textContent=p)});const t=this._config(),i=[...t.spots,...t.samples,...t.reflector?[t.reflector]:[]],a=i.filter(n=>this._visibleSwitchState(n.entity)==="on").length,r=this.shadowRoot.querySelector("[data-lights-summary]");r&&(r.textContent=`${a} de ${i.length}`);const s=this.shadowRoot.querySelector("[data-energy-summary]");s&&(s.textContent=this._energyMonthTotal===null?"Sin datos":`${this._formatEnergy(this._energyMonthTotal)} kWh`)}_handleClick(e){const t=e.target.closest("[data-action]");if(!t||!this._hass)return;const i=t.dataset.action;if(i==="toggle-menu"){this._toggleHomeAssistantMenu();return}if(i==="toggle-theme"){this._toggleTheme();return}if(i==="set-view"){const a=t.dataset.view;["home","lights","energy","system"].includes(a)&&(this._activeView=a,this._requestRender());return}if(i==="toggle-switch"){this._toggleSwitch(t.dataset.entity);return}if(i==="run-scene"){this._runScene(t.dataset.sceneKey||t.dataset.entity,t.dataset.label);return}if(i==="open-power-on"){this._pendingAction||(this._confirmAction="on",this._requestRender());return}if(i==="open-power-off"){this._pendingAction||(this._confirmAction="off",this._requestRender());return}if(i==="general-off"){const a=this._config().generalOffScript;a?this._hass.callService("script","turn_on",{entity_id:a}).catch(r=>{this._notify("No se pudo ejecutar Apagar todo Witmind.","error"),console.error("Error ejecutando el apagado general de Witmind:",r)}):this._notify("El apagado general aún no tiene una entidad configurada.","error");return}if(i==="cancel-power-confirm"){const a=e.target.closest("[data-dialog-card]");if(t.classList.contains("dialog-backdrop")&&a)return;this._pendingAction||(this._confirmAction="",this._requestRender());return}if(i==="confirm-power"){this._confirmGeneralPower();return}if(i==="clear-scene"){this._clearScene();return}if(i==="media"){this._mediaAction(t.dataset.service);return}if(i==="energy-range"){this._setEnergyRange(t.dataset.range);return}if(i==="energy-day-prev"){this._shiftEnergyDay(-1);return}if(i==="energy-day-next"){this._shiftEnergyDay(1);return}if(i==="energy-day-today"){this._resetEnergyDay();return}i==="refresh-energy"&&(this._energyLastLoadedAt=0,this._loadEnergyStatistics())}_toggleHomeAssistantMenu(){this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}))}_loadTheme(){try{return localStorage.getItem(this._themeStorageKey)==="light"?"light":"dark"}catch{return"dark"}}_saveTheme(){try{localStorage.setItem(this._themeStorageKey,this._theme)}catch(e){console.warn("No se pudo guardar el tema del showroom:",e)}}_toggleTheme(){this._theme=this._theme==="dark"?"light":"dark",this.setAttribute("data-theme",this._theme),this._saveTheme(),this.dispatchEvent(new CustomEvent("witmind-theme-change",{detail:{theme:this._theme},bubbles:!0,composed:!0})),this._requestRender()}set theme(e){e!=="dark"&&e!=="light"||(this._theme=e,this.setAttribute("data-theme",e),this._saveTheme())}get theme(){return this._theme}_config(){var u;const e=((u=this._panel)==null?void 0:u.config)||{},t=e.panel_kind==="lobby"||e.panel_kind==="general"||e.static_only===!0||e.staticOnly===!0,i=f=>Array.isArray(f)?[...new Set(f.filter(Boolean).map(b=>String(b)))]:[],a=(f,b)=>(Array.isArray(f)&&(f.length||t)?f:b).filter(E=>E==null?void 0:E.entity).map((E,_)=>({entity:String(E.entity),name:E.name||`Dispositivo ${_+1}`,subtitle:E.subtitle||"Iluminación",icon:E.icon||"bulb"})),r=a(e.spots,A.spots),s=a(e.samples||e.muestras,A.samples),o=[...r,...s].map(f=>f.entity),n=i(e.scene_control_entities||e.sceneControlEntities),c=n.length?n:o,d=(f,b,$)=>(Array.isArray(f)&&(f.length||t)?f:b).filter(_=>(_==null?void 0:_.entity)||(_==null?void 0:_.id)||(_==null?void 0:_.key)).map((_,v)=>{const k=_.entity?String(_.entity):"",C=String(_.id||_.key||k||`${$}-${v+1}`),x=b.find(I=>{const Te=I.entity?String(I.entity):"",ut=String(I.id||I.key||Te||"");return k&&Te===k||ut===C}),z=k||(x!=null&&x.entity?String(x.entity):""),N=String(_.id||_.key||(x==null?void 0:x.id)||z||`${$}-${v+1}`),T=z||`${$}:${N}`,M=Array.isArray(_.on_entities)||Array.isArray(_.onEntities),ie=Array.isArray(_.off_entities)||Array.isArray(_.offEntities),ce=i(M?_.on_entities||_.onEntities:x==null?void 0:x.onEntities),ht=i(ie?_.off_entities||_.offEntities:[]),gt=ie?ht.filter(I=>!ce.includes(I)):c.filter(I=>!ce.includes(I));return{key:T,id:N,entity:z,name:_.name||(x==null?void 0:x.name)||`Escena ${v+1}`,subtitle:_.subtitle||(x==null?void 0:x.subtitle)||"Escena del showroom",icon:_.icon||(x==null?void 0:x.icon)||"presentation",directOnly:_.direct_only??_.directOnly??(x==null?void 0:x.directOnly)??!1,onEntities:ce,offEntities:gt}}),h=e.reflector||A.reflector,p=Number(e.history_hours??e.historyHours),g=Number(e.chart_hours??e.chartHours);return{title:e.title||A.title,subtitle:e.subtitle||A.subtitle,siteLabel:e.site_label||e.siteLabel||A.siteLabel,logo:e.logo||A.logo,weather:e.weather||A.weather,mediaPlayer:e.media_player||e.mediaPlayer||A.mediaPlayer,lightCountSensor:e.light_count_sensor||e.lightCountSensor||A.lightCountSensor,energySensor:e.energy_sensor||e.energySensor||A.energySensor,batteryLevel:e.battery_level||e.batteryLevel||A.batteryLevel,powerOnScript:e.power_on_script||e.powerOnScript||A.powerOnScript,powerOffScript:e.power_off_script||e.powerOffScript||A.powerOffScript,historyHours:Number.isFinite(p)&&p>0?Math.min(24,p):A.historyHours,chartHours:Number.isFinite(g)&&g>0?Math.min(72,g):A.chartHours,showForecast:e.show_forecast??e.showForecast??A.showForecast,panelKind:e.panel_kind||e.panelKind||"showroom",staticOnly:e.static_only??e.staticOnly??!1,generalOffScript:e.general_off_script||e.generalOffScript||"",spots:r,samples:s,sceneControlEntities:c,reflector:h!=null&&h.entity?{entity:String(h.entity),name:h.name||A.reflector.name,subtitle:h.subtitle||A.reflector.subtitle,icon:h.icon||A.reflector.icon}:null,scenes:d(e.scenes,A.scenes,"scene"),sampleScenes:d(e.sample_scenes||e.sampleScenes,A.sampleScenes,"sample")}}_allDevices(){const e=this._config();return[...e.spots,...e.samples,...e.reflector?[e.reflector]:[]]}_allScenes(e=this._config()){return[...e.scenes,...e.sampleScenes]}_trackedEntities(){const e=this._config();return new Set([...this._allDevices().map(t=>t.entity),...e.sceneControlEntities,...this._allScenes(e).flatMap(t=>[t.entity,...t.onEntities,...t.offEntities]),e.weather,e.mediaPlayer,e.lightCountSensor,e.energySensor,e.batteryLevel,e.powerOnScript,e.powerOffScript].filter(Boolean))}_relevantHassChanged(e,t){var i,a;if(!e||!t)return!0;for(const r of this._trackedEntities())if(((i=e.states)==null?void 0:i[r])!==((a=t.states)==null?void 0:a[r]))return!0;return!1}async _start(){this._clockTimer=setInterval(()=>this._updateClock(),3e4),await Promise.allSettled([this._fetchCurrentStates(),this._subscribeStateChanges(),this._subscribeWeather(),this._loadEnergyStatistics()])}_syncStatesFromHass(){var e;if((e=this._hass)!=null&&e.states)for(const t of this._trackedEntities()){const i=this._hass.states[t];i&&this._applyLiveState(t,i)}}_applyLiveState(e,t){if(!t){this._liveStates.delete(e);return}this._liveStates.set(e,t);const i=this._pendingSwitches.get(e);if(i&&t.state===i.desired){this._pendingSwitches.delete(e),this._switchErrors.delete(e);const a=this._switchTimers.get(e);a&&clearTimeout(a),this._switchTimers.delete(e)}}async _fetchCurrentStates(){var e;if((e=this._hass)!=null&&e.callWS)try{const t=await this._hass.callWS({type:"get_states"}),i=this._trackedEntities();for(const a of t||[])i.has(a.entity_id)&&this._applyLiveState(a.entity_id,a);this._updateStatePresentation()}catch(t){console.error("No se pudieron sincronizar los estados del showroom:",t)}}async _subscribeStateChanges(){var e;if(!(!((e=this._hass)!=null&&e.connection)||this._unsubscribeStates))try{this._unsubscribeStates=await this._hass.connection.subscribeEvents(t=>{var a;const i=(a=t==null?void 0:t.data)==null?void 0:a.entity_id;!i||!this._trackedEntities().has(i)||(this._applyLiveState(i,t.data.new_state),i===this._config().energySensor&&this._scheduleEnergyRefresh(),this._updateStatePresentation())},"state_changed")}catch(t){console.error("No se pudo suscribir a state_changed:",t)}}_resetForecastSubscription(){this._unsubscribeForecast&&(this._unsubscribeForecast(),this._unsubscribeForecast=null),this._forecastEntity=""}async _subscribeWeather(){var t;const e=this._config();if(!(!((t=this._hass)!=null&&t.connection)||!e.weather)&&!(this._unsubscribeForecast&&this._forecastEntity===e.weather)){this._resetForecastSubscription();try{this._forecastEntity=e.weather,this._unsubscribeForecast=await this._hass.connection.subscribeMessage(i=>{this._forecast=Array.isArray(i==null?void 0:i.forecast)?i.forecast:[],this._requestRender()},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e.weather})}catch(i){this._forecastEntity="",console.error("No se pudo cargar el pronóstico:",i)}}}_energyRefreshInterval(){return this._energyRange==="day"?3e4:this._energyRange==="month"?12e4:3e5}_scheduleEnergyRefresh(e=!1){if(!this._hass||!this.isConnected||(clearTimeout(this._energyRefreshTimer),this._energyRange==="day"&&this._energyDayOffset!==0))return;const t=this._energyRefreshInterval(),i=this._energyLastLoadedAt?Date.now()-this._energyLastLoadedAt:0,a=e?0:this._energyLastLoadedAt?Math.max(1e3,t-i):t;this._energyRefreshTimer=setTimeout(()=>this._loadEnergyStatistics(),a)}_energyRangeDefinition(e=this._energyRange){const t=new Date;let i,a=t,r,s,o,n=!1;if(e==="year")i=new Date(t.getFullYear(),0,1,0,0,0,0),r="month",s=`Año ${t.getFullYear()}`,o="mes";else if(e==="month")i=new Date(t.getFullYear(),t.getMonth(),1,0,0,0,0),r="day",s=t.toLocaleDateString("es-BO",{month:"long",year:"numeric"}),o="día";else{const c=new Date(t.getFullYear(),t.getMonth(),t.getDate(),0,0,0,0);i=new Date(c.getFullYear(),c.getMonth(),c.getDate()+Math.min(0,Number(this._energyDayOffset)||0),0,0,0,0),n=i.getTime()===c.getTime(),a=n?t:new Date(i.getFullYear(),i.getMonth(),i.getDate()+1,0,0,0,0),r="hour",s=i.toLocaleDateString("es-BO",{weekday:"long",day:"numeric",month:"long"}),o="hora"}return{start:i,end:a,period:r,title:s,intervalLabel:o,isToday:n}}_energyValueToKWh(e,t){const i=Number(e);if(!Number.isFinite(i))return null;const a=String(t||"kWh").trim().toLowerCase().replaceAll(" ","");return a==="kwh"?i:a==="wh"?i/1e3:a==="mwh"?i*1e3:null}_deriveEnergyStateDeltas(e,t,i){const a=Number(t instanceof Date?t.getTime():t),r=Number(i instanceof Date?i.getTime():i),s=e.filter(c=>Number.isFinite(Number(c.start))&&Number.isFinite(Number(c.state))).sort((c,d)=>Number(c.start)-Number(d.start)),o=[];let n=null;for(const c of s){const d=Number(c.start),h=Number(c.state);if(d<a){n=h;continue}if(d>=r)break;let p=0;if(Number.isFinite(n)){const g=h-n;p=g>=0?g:Math.max(0,h)}o.push({...c,change:p}),n=h}return o}_aggregateEnergyDayRows(e,t,i){var c;const a=new Date(t.start),r=new Date(t.end),s=t.isToday?new Date(r.getFullYear(),r.getMonth(),r.getDate(),r.getHours(),0,0,0):new Date(a.getFullYear(),a.getMonth(),a.getDate(),23,0,0,0),o=new Map;for(let d=new Date(a);d<=s;d.setHours(d.getHours()+1)){const h=d.getTime();o.set(h,{start:h,end:new Date(d.getFullYear(),d.getMonth(),d.getDate(),d.getHours()+1,0,0,0).getTime(),change:0,samples:0,partial:t.isToday&&h===s.getTime(),live:!1})}let n=null;for(const d of e){const h=new Date(Number(d.start));if(!Number.isFinite(h.getTime()))continue;const p=new Date(h.getFullYear(),h.getMonth(),h.getDate(),h.getHours(),0,0,0).getTime(),g=o.get(p);g&&(g.change+=Math.max(0,Number(d.change)||0),g.samples+=1,Number.isFinite(d.state)&&(!n||Number(d.end||d.start)>Number(n.end||n.start))&&(n=d))}if(t.isToday){const d=this._energyValueToKWh(i==null?void 0:i.state,(c=i==null?void 0:i.attributes)==null?void 0:c.unit_of_measurement),h=n==null?void 0:n.state,p=Number((n==null?void 0:n.end)||(n==null?void 0:n.start)),g=o.get(s.getTime());if(g&&Number.isFinite(d)&&Number.isFinite(h)&&Number.isFinite(p)&&p>=s.getTime()&&r.getTime()-p>=0&&r.getTime()-p<=900*1e3){const u=d-h;Number.isFinite(u)&&u>=0&&(g.change+=u,g.live=u>0)}}return[...o.values()].filter(d=>d.samples>0||d.live)}_calculateCurrentMonthEnergy(e,t,i){var p;const a=new Date(t),r=new Date(a.getFullYear(),a.getMonth(),1,0,0,0,0).getTime(),s=e.filter(g=>Number.isFinite(Number(g.start))&&Number(g.start)>=r).sort((g,u)=>Number(g.start)-Number(u.start));let o=s.reduce((g,u)=>g+Math.max(0,Number(u.change)||0),0),n=null;for(const g of s)Number.isFinite(Number(g.state))&&(!n||Number(g.end||g.start)>Number(n.end||n.start))&&(n=g);const c=this._energyValueToKWh(i==null?void 0:i.state,(p=i==null?void 0:i.attributes)==null?void 0:p.unit_of_measurement),d=Number(n==null?void 0:n.state),h=Number((n==null?void 0:n.end)||(n==null?void 0:n.start));if(Number.isFinite(c)&&Number.isFinite(d)&&Number.isFinite(h)&&h>=r&&h<=a.getTime()&&a.getTime()-h<=7200*1e3){const g=c-d;Number.isFinite(g)&&g>=0&&(o+=g)}return s.length||Number.isFinite(d)?o:null}_aggregateEnergyCalendarRows(e,t,i,a){var h;if(!["month","year"].includes(a))return[];const r=new Map;let s=null;for(const p of e){const g=Number(p.start);if(!Number.isFinite(g))continue;const u=new Date(g),f=a==="month"?new Date(u.getFullYear(),u.getMonth(),u.getDate(),0,0,0,0).getTime():new Date(u.getFullYear(),u.getMonth(),1,0,0,0,0).getTime(),b=r.get(f)||{start:f,change:0,samples:0,partial:!1,live:!1};b.change+=Math.max(0,Number(p.change)||0),b.samples+=1,r.set(f,b),Number.isFinite(Number(p.state))&&(!s||g>Number(s.start))&&(s=p)}const o=this._energyValueToKWh(i==null?void 0:i.state,(h=i==null?void 0:i.attributes)==null?void 0:h.unit_of_measurement),n=Number(s==null?void 0:s.state),c=Number(s==null?void 0:s.start),d=new Date(t.end);if(Number.isFinite(o)&&Number.isFinite(n)&&Number.isFinite(c)&&c<=d.getTime()&&d.getTime()-c<=7200*1e3){const p=o-n;if(Number.isFinite(p)&&p>=0){const g=a==="month"?new Date(d.getFullYear(),d.getMonth(),d.getDate(),0,0,0,0).getTime():new Date(d.getFullYear(),d.getMonth(),1,0,0,0,0).getTime(),u=r.get(g)||{start:g,change:0,samples:0,partial:!1,live:!1};u.change+=p,u.live=p>0,r.set(g,u)}}return[...r.values()].sort((p,g)=>Number(p.start)-Number(g.start))}_energyViewSignature(){return JSON.stringify([this._energyRange,this._energyDayOffset,this._energyMonthTotal,this._energyError||"",this._energyData.map(e=>[Number(e.start),Number(e.change)||0,Number(e.samples)||0,!!e.partial,!!e.live])])}async _loadEnergyStatistics(){var g;if(!((g=this._hass)!=null&&g.connection))return;clearTimeout(this._energyRefreshTimer);const e=this._config(),t=this._state(e.energySensor),i=Number(t==null?void 0:t.state);if(!t){this._energyData=[],this._energyMonthTotal=null,this._energyError=`No existe ${e.energySensor} en Home Assistant.`,this._energyLoading=!1,this._requestRender();return}if(!Number.isFinite(i)){this._energyData=[],this._energyMonthTotal=null,this._energyError=`${e.energySensor} no entrega un valor numérico.`,this._energyLoading=!1,this._requestRender();return}const a=++this._energyRequestId,r=this._energyViewSignature(),s=this._energyData.length>0,o=this._energyRangeDefinition(),n=new Date,c=new Date(n.getFullYear(),n.getMonth(),1,0,0,0,0),d=new Date(o.start.getTime()-3600*1e3),h=this._energyRange==="year"?"hour":"5minute",p=new Date(c.getTime()-3600*1e3);this._energyLoading=!0,this._energyError=null,s||this._requestRender();try{const u=await this._hass.connection.sendMessagePromise({type:"recorder/get_statistics_metadata",statistic_ids:[e.energySensor]});if(a!==this._energyRequestId)return;const b=(Array.isArray(u)?u:[]).find(T=>(T==null?void 0:T.statistic_id)===e.energySensor)||null;if(!b||!b.has_sum)throw new Error("La entidad no dispone de estadísticas acumulables. Verifica device_class: energy y state_class total/total_increasing.");const $=this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:d.toISOString(),end_time:o.end.toISOString(),statistic_ids:[e.energySensor],period:h,units:{energy:"kWh"},types:["state"]}),E=this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:p.toISOString(),end_time:n.toISOString(),statistic_ids:[e.energySensor],period:"hour",units:{energy:"kWh"},types:["state"]}),[_,v]=await Promise.all([$,E]);if(a!==this._energyRequestId)return;const k=T=>(Array.isArray(T==null?void 0:T[e.energySensor])?T[e.energySensor]:[]).map(M=>({start:Number(M.start),end:Number(M.end),change:M.change===void 0||M.change===null?null:Math.max(0,Number(M.change)||0),state:M.state===void 0||M.state===null?null:Number(M.state)})).filter(M=>Number.isFinite(M.start)&&(Number.isFinite(M.state)||Number.isFinite(M.change))),C=k(_),x=this._deriveEnergyStateDeltas(C,o.start,o.end);this._energyData=this._energyRange==="day"?this._aggregateEnergyDayRows(x,o,t):this._aggregateEnergyCalendarRows(x,o,t,this._energyRange);const z=k(v),N=this._deriveEnergyStateDeltas(z,c,n);if(this._energyMonthTotal=this._calculateCurrentMonthEnergy(N,n,t),this._energyRange==="month"&&this._energyData.length)this._energyMonthTotal=this._energyData.reduce((T,M)=>T+Math.max(0,Number(M.change)||0),0);else if(this._energyRange==="year"&&Number.isFinite(this._energyMonthTotal)){const T=new Date(n.getFullYear(),n.getMonth(),1,0,0,0,0).getTime(),M=this._energyData.find(ie=>Number(ie.start)===T);M&&(M.change=this._energyMonthTotal)}this._energyLastLoadedAt=Date.now(),this._energyError=null}catch(u){if(a!==this._energyRequestId)return;this._energyData=[],this._energyMonthTotal=null,this._energyError=(u==null?void 0:u.message)||"No se pudieron consultar las estadísticas energéticas.",console.error("Error cargando estadísticas de energía del showroom:",u)}finally{if(a===this._energyRequestId){this._energyLoading=!1;const u=r!==this._energyViewSignature();!s||u&&this._activeView==="energy"?this._requestRender():this._updateStatePresentation(),this._scheduleEnergyRefresh()}}}_setEnergyRange(e){!["day","month","year"].includes(e)||e===this._energyRange||(this._energyRange=e,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_shiftEnergyDay(e){if(this._energyRange!=="day")return;const t=Number(e);if(!Number.isFinite(t)||t===0)return;const i=Math.min(0,this._energyDayOffset+t);i!==this._energyDayOffset&&(this._energyDayOffset=i,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_resetEnergyDay(){this._energyRange!=="day"||this._energyDayOffset===0||(this._energyDayOffset=0,this._energyData=[],this._energyError=null,this._energyLastLoadedAt=0,this._energyAutoFollow=!0,this._energyScrollLeft=null,this._loadEnergyStatistics())}_formatEnergy(e,t=2){const i=Number(e);return Number.isFinite(i)?i.toLocaleString("es-BO",{minimumFractionDigits:t,maximumFractionDigits:t}):"--"}_energyLabel(e,t=this._energyRange){const i=new Date(Number(e));return Number.isFinite(i.getTime())?t==="year"?i.toLocaleDateString("es-BO",{month:"short"}).replace(".",""):t==="month"?String(i.getDate()):i.toLocaleTimeString("es-BO",{hour:"2-digit",minute:"2-digit",hour12:!1}):"--"}_captureEnergyChartScroll(){var i;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("[data-energy-scroll]");if(!e)return;const t=Math.max(0,e.scrollWidth-e.clientWidth);this._energyScrollLeft=e.scrollLeft,this._energyAutoFollow=t<=0||t-e.scrollLeft<=8}_handleEnergyScroll(e){var a,r;const t=(r=(a=e.target)==null?void 0:a.closest)==null?void 0:r.call(a,"[data-energy-scroll]");if(!t)return;const i=Math.max(0,t.scrollWidth-t.clientWidth);this._energyScrollLeft=t.scrollLeft,this._energyAutoFollow=i<=0||i-t.scrollLeft<=8}_restoreEnergyChartScroll(){var i;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("[data-energy-scroll]");if(!e)return;const t=Math.max(0,e.scrollWidth-e.clientWidth);if(this._energyAutoFollow||this._energyScrollLeft===null){e.scrollLeft=t,this._energyScrollLeft=e.scrollLeft;return}e.scrollLeft=Math.max(0,Math.min(this._energyScrollLeft,t))}_energyChart(){const e=this._energyData;if(this._energyLoading&&!e.length)return'<div class="energy-empty"><span class="energy-spinner"></span>Consultando estadísticas de Home Assistant…</div>';if(this._energyError)return`<div class="energy-empty error">${this._icon("status")}<span>${this._escape(this._energyError)}</span></div>`;if(!e.length)return'<div class="energy-empty">No hay estadísticas de consumo disponibles para este período.</div>';const t=280,i=14,a=16,r=22,s=42,o=this._energyRange==="day"?64:this._energyRange==="month"?36:58,n=Math.max(620,e.length*o+i+a),c=t-r-s,d=n-i-a,h=Math.max(...e.map(_=>_.change),.001),p=this._energyRange==="day"?10:e.length>24?4:7,g=Math.max(6,(d-p*Math.max(0,e.length-1))/e.length),u=this._energyRange==="month"?Math.max(1,Math.ceil(e.length/10)):this._energyRange==="day"?2:1,f=[0,.25,.5,.75,1],b=f.map(_=>{const v=r+c*(1-_);return`<line x1="${i}" y1="${v.toFixed(1)}" x2="${n-a}" y2="${v.toFixed(1)}" class="energy-grid-line"/>`}).join(""),$=f.map(_=>{const v=r+c*(1-_),k=this._formatEnergy(h*_,h<1?2:1);return`<span class="energy-y-tick" style="top:${v.toFixed(1)}px">${this._escape(k)}</span>`}).join(""),E=e.map((_,v)=>{const k=i+v*(g+p),C=_.change>0?Math.max(2,_.change/h*c):1,x=r+c-C,z=v%u===0||v===e.length-1,N=this._energyLabel(_.start),T=_.partial?" · en curso":"",M=_.partial?`<text x="${(k+g/2).toFixed(1)}" y="${(r+10).toFixed(1)}" text-anchor="middle" class="energy-current-label">ahora</text>`:"";return`<g class="energy-bar-group ${_.partial?"is-current":""}"><rect x="${k.toFixed(1)}" y="${x.toFixed(1)}" width="${g.toFixed(1)}" height="${C.toFixed(1)}" rx="${Math.min(4,g/2).toFixed(1)}" class="energy-bar ${_.partial?"is-partial":""}"><title>${this._escape(N)} · ${this._formatEnergy(_.change)} kWh${T}</title></rect>${M}${z?`<text x="${(k+g/2).toFixed(1)}" y="${t-14}" text-anchor="middle" class="energy-axis-text">${this._escape(N)}</text>`:""}</g>`}).join("");return`<div class="energy-chart-layout"><div class="energy-y-axis" aria-hidden="true"><span class="energy-y-unit">kWh</span>${$}</div><div class="energy-chart-wrap" data-energy-scroll><svg class="energy-chart" width="${n}" height="${t}" viewBox="0 0 ${n} ${t}" role="img" aria-label="Gráfica de consumo energético estimado en kWh">${b}${E}</svg></div></div>`}async _loadHistory(){var o;const e=this._config();if(!((o=this._hass)!=null&&o.callApi))return;const t=Math.max(e.historyHours,e.chartHours),i=new Date(Date.now()-t*60*60*1e3).toISOString(),a=new Date().toISOString(),r=[e.lightCountSensor,...e.spots.map(n=>n.entity),...e.samples.map(n=>n.entity)].filter(Boolean).join(",");if(!r)return;const s=`history/period/${encodeURIComponent(i)}?filter_entity_id=${encodeURIComponent(r)}&end_time=${encodeURIComponent(a)}&minimal_response&no_attributes`;try{this._history=await this._hass.callApi("GET",s),this._historyError=""}catch(n){this._history=[],this._historyError="No se pudo cargar el historial.",console.error("No se pudo cargar el historial del showroom:",n)}this._requestRender()}_state(e){var t,i;return this._liveStates.get(e)||((i=(t=this._hass)==null?void 0:t.states)==null?void 0:i[e])}_isUnavailable(e){var i;const t=(i=this._state(e))==null?void 0:i.state;return!t||t==="unknown"||t==="unavailable"}_visibleSwitchState(e){var t,i;return((t=this._pendingSwitches.get(e))==null?void 0:t.desired)||((i=this._state(e))==null?void 0:i.state)||"unavailable"}async _toggleSwitch(e){if(!e||!this._hass)return;const t=this._state(e);if(!t||["unknown","unavailable"].includes(t.state)){this._switchErrors.set(e,"No disponible"),this._updateStatePresentation();return}const a=this._visibleSwitchState(e)==="on"?"off":"on",r=a==="on"?"turn_on":"turn_off",s=e.split(".")[0]||"switch";this._pendingSwitches.set(e,{desired:a,startedAt:Date.now()}),this._switchErrors.delete(e),this._updateStatePresentation();try{await this._hass.callService(s,r,{entity_id:e});const o=this._switchTimers.get(e);o&&clearTimeout(o);const n=setTimeout(()=>this._verifySwitchState(e,a),6e3);this._switchTimers.set(e,n)}catch(o){this._pendingSwitches.delete(e),this._switchErrors.set(e,"La acción falló"),this._updateStatePresentation(),console.error(`Error ejecutando ${r} en ${e}:`,o)}}async _verifySwitchState(e,t){var a;await this._fetchCurrentStates();const i=((a=this._state(e))==null?void 0:a.state)===t;this._pendingSwitches.delete(e),this._switchTimers.delete(e),i?this._switchErrors.delete(e):this._switchErrors.set(e,"Sin confirmación"),this._updateStatePresentation()}_sceneStatus(e){const t=[...e.onEntities.map(r=>({entityId:r,desired:"on"})),...e.offEntities.map(r=>({entityId:r,desired:"off"}))];if(!t.length)return{active:!1,unavailable:!1,mismatches:[]};const i=t.some(({entityId:r})=>this._isUnavailable(r)),a=t.filter(({entityId:r,desired:s})=>{var o;return((o=this._state(r))==null?void 0:o.state)!==s});return{active:!i&&a.length===0,unavailable:i,mismatches:a}}_sceneExpectations(e){return[...e.offEntities.map(t=>({entityId:t,desired:"off"})),...e.onEntities.map(t=>({entityId:t,desired:"on"}))]}_markExpectedStates(e){const t=Date.now();for(const{entityId:i,desired:a}of e)this._pendingSwitches.set(i,{desired:a,startedAt:t}),this._switchErrors.delete(i)}_clearExpectedStates(e){for(const{entityId:t}of e){this._pendingSwitches.delete(t);const i=this._switchTimers.get(t);i&&clearTimeout(i),this._switchTimers.delete(t)}}async _setEntitiesState(e,t){const i=[...new Set((e||[]).filter(Boolean))];if(!i.length)return;const a=new Map;for(const s of i){const o=s.split(".")[0];o&&(a.has(o)||a.set(o,[]),a.get(o).push(s))}const r=t==="on"?"turn_on":"turn_off";for(const[s,o]of a)await this._hass.callService(s,r,{entity_id:o})}async _waitForExpectedStates(e,t=7e3){const i=Date.now()+t;let a=e;for(;Date.now()<i;){if(await this._fetchCurrentStates(),a=e.filter(({entityId:r,desired:s})=>{var o;return((o=this._state(r))==null?void 0:o.state)!==s}),!a.length)return{ok:!0,mismatches:[]};await new Promise(r=>setTimeout(r,450))}return{ok:!1,mismatches:a}}async _runScene(e,t){var o;if(!e||this._pendingAction)return;const i=this._config(),a=this._allScenes(i).find(n=>n.key===e||n.entity===e);if(!a){this._notify("La escena no está configurada.","error");return}const r=this._sceneExpectations(a);this._pendingAction=a.key,this._markExpectedStates(r),this._updateStatePresentation();let s=null;try{if(a.entity&&!a.directOnly)try{await this._hass.callService("scene","turn_on",{entity_id:a.entity})}catch(d){s=d,console.warn(`La escena ${a.entity} no respondió; se aplicará el perfil directo.`,d)}await this._setEntitiesState(a.offEntities,"off"),await this._setEntitiesState(a.onEntities,"on");const n=await this._waitForExpectedStates(r);if(!n.ok){const d=n.mismatches.map(h=>h.entityId).join(", ");throw new Error(`No se confirmaron los estados de: ${d}`)}const c=s?`${t||"Modo"} aplicado mediante control directo.`:`${t||"Modo"} activo.`;this._notify(c,"success")}catch(n){for(const{entityId:c,desired:d}of r)((o=this._state(c))==null?void 0:o.state)!==d&&this._switchErrors.set(c,"No confirmó el modo");this._notify("No se pudo aplicar completamente el modo seleccionado.","error"),console.error("Error aplicando modo del showroom:",n)}finally{this._clearExpectedStates(r),this._pendingAction="",await this._fetchCurrentStates(),this._updateStatePresentation()}}async _executeGeneralPower(e,t={}){var c;if(!this._hass||this._pendingAction||!["on","off"].includes(e))return!1;const i=this._config(),a=e==="on"?i.powerOnScript:i.powerOffScript,r=i.sceneControlEntities.map(d=>({entityId:d,desired:e})),s=t.successMessage||(e==="on"?"Iluminación general encendida.":"Iluminación general apagada."),o=t.errorMessage||(e==="on"?"No se pudo encender toda la iluminación.":"No se pudo apagar toda la iluminación.");this._pendingAction=a||`direct-power-${e}`,this._markExpectedStates(r),this._updateStatePresentation();let n=null;try{if(a)try{await this._hass.callService("script","turn_on",{entity_id:a})}catch(h){n=h,console.warn(`El script ${a} no respondió; se aplicará el control directo.`,h)}await this._setEntitiesState(i.sceneControlEntities,e);const d=await this._waitForExpectedStates(r);if(!d.ok){const h=d.mismatches.map(p=>p.entityId).join(", ");throw new Error(`No se confirmaron los estados de: ${h}`)}return this._confirmAction="",this._notify(s,"success"),!0}catch(d){for(const{entityId:h,desired:p}of r)((c=this._state(h))==null?void 0:c.state)!==p&&this._switchErrors.set(h,"Sin confirmación");return this._notify(o,"error"),console.error("Error ejecutando el control general del showroom:",{error:d,scriptError:n,desired:e}),!1}finally{this._clearExpectedStates(r),this._pendingAction="",await this._fetchCurrentStates(),this._updateStatePresentation()}}async _confirmGeneralPower(){const e=this._confirmAction;["on","off"].includes(e)&&await this._executeGeneralPower(e,{successMessage:e==="on"?"Toda la iluminación del showroom está encendida.":"Toda la iluminación del showroom está apagada."})}async _clearScene(){this._pendingAction||await this._executeGeneralPower("off",{successMessage:"Escena apagada. La iluminación del showroom quedó apagada.",errorMessage:"No se pudo apagar completamente la escena."})}async _mediaAction(e){const t=this._config().mediaPlayer;if(!(!t||!e||this._isUnavailable(t)))try{await this._hass.callService("media_player",e,{entity_id:t})}catch(i){this._notify("No se pudo controlar el reproductor.","error"),console.error(`Error ejecutando media_player.${e}:`,i)}}_updateToastPresentation(){if(!this.shadowRoot)return;const e=this.shadowRoot.querySelector("[data-toast]");if(!this._toast){e==null||e.remove();return}if(e){e.className=`toast ${this._escape(this._toast.type)}`,e.textContent=this._toast.message;return}const t=document.createElement("div");t.dataset.toast="",t.className=`toast ${this._escape(this._toast.type)}`,t.setAttribute("role","status"),t.textContent=this._toast.message,this.shadowRoot.append(t)}_notify(e,t="success"){var i;clearTimeout(this._toastTimer),this._toast={message:e,type:t},(i=this.shadowRoot)!=null&&i.querySelector(".app-shell")?this._updateToastPresentation():this._requestRender(),this._toastTimer=setTimeout(()=>{this._toast=null,this._updateToastPresentation()},4200)}_historyMap(){var t;const e=new Map;for(const i of this._history||[]){const a=(t=i==null?void 0:i[0])==null?void 0:t.entity_id;a&&e.set(a,i)}return e}_historySegments(e,t,i){if(!Array.isArray(e)||!e.length)return[];const a=e.map(s=>({state:s.state,time:new Date(s.last_changed||s.last_updated).getTime()})).filter(s=>Number.isFinite(s.time)).sort((s,o)=>s.time-o.time);if(!a.length)return[];const r=[];for(let s=0;s<a.length;s+=1){const o=a[s],n=a[s+1],c=Math.max(t,o.time),d=Math.min(i,(n==null?void 0:n.time)??i);d<=c||r.push({state:o.state,left:(c-t)/(i-t)*100,width:(d-c)/(i-t)*100})}return r}_sparkline(e,t){var u;const i=this._historyMap().get(e)||[],a=Date.now(),r=a-t*60*60*1e3,s=i.map(f=>({value:Number(f.state),time:new Date(f.last_changed||f.last_updated).getTime()})).filter(f=>Number.isFinite(f.value)&&Number.isFinite(f.time)&&f.time>=r).sort((f,b)=>f.time-b.time),o=Number((u=this._state(e))==null?void 0:u.state);if(Number.isFinite(o)&&s.push({value:o,time:a}),!s.length)return{path:"",min:"--",max:"--",avg:"--"};const n=s.map(f=>f.value),c=Math.min(...n),d=Math.max(...n),h=n.reduce((f,b)=>f+b,0)/n.length,p=d-c||1;return{path:s.map((f,b)=>{const $=(f.time-r)/(a-r)*300,E=66-(f.value-c)/p*52;return`${b?"L":"M"}${Math.max(0,Math.min(300,$)).toFixed(1)},${E.toFixed(1)}`}).join(" "),min:this._formatNumber(c),max:this._formatNumber(d),avg:this._formatNumber(h)}}_formatNumber(e){return Number.isFinite(e)?new Intl.NumberFormat("es-BO",{maximumFractionDigits:1}).format(e):"--"}_updateClock(){var o,n,c;if(!this.shadowRoot)return;const e=new Date,t=new Intl.DateTimeFormat("es-BO",{hour:"numeric",minute:"2-digit",hour12:!0}).formatToParts(e),i=((o=t.find(d=>d.type==="hour"))==null?void 0:o.value)||"--",a=((n=t.find(d=>d.type==="minute"))==null?void 0:n.value)||"--",r=(((c=t.find(d=>d.type==="dayPeriod"))==null?void 0:c.value)||"").replaceAll(".","").replaceAll(" ","").toUpperCase();for(const d of this.shadowRoot.querySelectorAll("[data-clock-time]"))d.textContent=`${i}:${a}`;for(const d of this.shadowRoot.querySelectorAll("[data-clock-period]"))d.textContent=r||"";const s=this.shadowRoot.querySelector("[data-current-time]");s&&(s.dateTime=e.toISOString(),s.setAttribute("aria-label",`${i}:${a} ${r}`.trim()))}_icon(e,t=""){const i=ze[e]||ze.bulb;return`<svg class="icon ${this._escape(t)}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${i}</svg>`}_escape(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}_renderDevice(e){const t=this._state(e.entity),i=this._visibleSwitchState(e.entity),a=i==="on",r=!t||["unknown","unavailable"].includes(t.state),s=this._pendingSwitches.has(e.entity),o=this._switchErrors.get(e.entity),n=o||(s?i==="on"?"Encendiendo…":"Apagando…":r?"No disponible":a?"Encendido":"Apagado");return`
    ...
    `}_renderWeather(){const e=this._config(),t=this._state(e.weather);if(!t)return`
      ...
      <section class="surface weather-card">
        <div class="weather-main">
          <div class="weather-symbol">${this._escape(de[a]||"·")}</div>
          <div class="weather-copy">
            <span class="eyebrow">Clima · Casa</span>
            <h2>${this._escape(Ce[a]||a)}</h2>
          ...
          <div class="forecast-row">
            ${r.length?r.map(s=>{const o=new Date(s.datetime),n=new Intl.DateTimeFormat("es-BO",{weekday:"short"}).format(o);return`
                <div class="forecast-item">
                  ...
                  <b>${this._escape(de[s.condition]||"·")}</b>
      ...
      <div class="app-shell">
        <header class="topbar">
          ...
          <div class="topbar-meta">
            ...
            <div class="header-weather" aria-label="Clima actual: ${this._escape(Ce[r]||r||"Sin datos")}, ${this._escape(a.temperature??"Sin datos")}${this._escape(a.temperature_unit??"°")}">
              <span aria-hidden="true">${this._escape(de[r]||"·")}</span>
              <strong>${this._escape(a.temperature??"--")}${this._escape(a.temperature_unit??"°")}</strong>
            </div>
            <button class="theme-button" data-action="toggle-theme" aria-label="Cambiar a tema ${s}" title="Cambiar a tema ${s}">${ft}</button>
          </div>
        </header>
    ...
    `,this._updateClock(),requestAnimationFrame(()=>this._restoreEnergyChartScroll())}}customElements.get("showroom-panel")||customElements.define("showroom-panel",_t);const bt={"clear-night":"Noche despejada",cloudy:"Nublado",exceptional:"Condición excepcional",fog:"Niebla",hail:"Granizo",lightning:"Tormenta eléctrica","lightning-rainy":"Tormenta y lluvia",partlycloudy:"Parcialmente nublado",pouring:"Lluvia intensa",rainy:"Lluvia",snowy:"Nieve","snowy-rainy":"Aguanieve",sunny:"Soleado",windy:"Ventoso","windy-variant":"Viento y nubes"},yt={"clear-night":"☾",cloudy:"☁",exceptional:"!",fog:"≋",hail:"◆",lightning:"ϟ","lightning-rainy":"ϟ",partlycloudy:"◒",pouring:"☂",rainy:"☂",snowy:"❄","snowy-rainy":"❄",sunny:"☀",windy:"≈","windy-variant":"≈"},vt='<svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><line x1="3" x2="21" y1="6" y2="6"></line><line x1="3" x2="21" y1="12" y2="12"></line><line x1="3" x2="21" y1="18" y2="18"></line></svg>',xt='<svg class="theme-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><g class="theme-icon-sun"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"></path></g><path class="theme-icon-moon" d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"></path></svg>',Ne={bulb:'<path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5M9 18h6M10 22h4"/>',panel:'<rect width="18" height="18" x="3" y="3" rx="3"/><path d="M3 9h18M3 15h18M9 3v18M15 3v18"/>',corridor:'<path d="M4 3h16v18H4V3Zm2 2v14h5V5H6Zm7 0v14h5V5h-5Z"/>',workshop:'<path d="M3 7l9-5 9 5v14H3V7Zm2 1.2V19h4v-6h6v6h4V8.2l-7-3.9-7 3.9Z"/>',power:'<path d="M12 2v10M18.4 6.6a9 9 0 1 1-12.8 0"/>',energy:'<path d="M13 2 5 13h6l-1 9 8-11h-6l1-9Z"/>',shield:'<path d="M12 3 20 6v5c0 5-3.4 8.3-8 10-4.6-1.7-8-5-8-10V6l8-3Z"/>',office:'<path d="M3 4h18v16H3V4Zm4 4h4v3H7V8Zm6 0h4v3h-4V8ZM7 13h4v3H7v-3Zm6 0h4v3h-4v-3Z"/>'},W=l=>`${new Intl.NumberFormat("es-BO",{maximumFractionDigits:0}).format(l)} W`;class wt extends HTMLElement{constructor(){super(),this._hass=null,this._panel={},this._started=!1,this._renderQueued=!1,this._pending=new Map,this._errors=new Map,this._pendingAction="",this._confirmAction="",this._toast="",this._toastTimer=null,this._theme=this._loadTheme(),this.attachShadow({mode:"open"}),this.shadowRoot.addEventListener("click",e=>this._handleClick(e))}set hass(e){var t;this._hass=e,this._started||(this._started=!0),this.isConnected&&((t=this.shadowRoot)!=null&&t.querySelector(".operations-shell")?this._updatePresentation():this._render())}get hass(){return this._hass}set panel(e){this._panel=e&&typeof e=="object"?e:{},this.isConnected&&this._render()}get panel(){return this._panel}set theme(e){if(e==="dark"||e==="light"){const t=this._theme!==e;this._theme=e,this.setAttribute("data-theme",e),this._saveTheme(),t&&this.isConnected&&this._queueRender()}}get theme(){return this._theme}connectedCallback(){this.setAttribute("data-theme",this._theme),this._hass&&this._render()}disconnectedCallback(){this._toastTimer&&window.clearTimeout(this._toastTimer)}_kind(){return String(this._panel.panel_kind||this._panel.panelKind||"offices").toLowerCase()}_loadTheme(){try{return localStorage.getItem("witmind-showroom-panel-theme")==="light"?"light":"dark"}catch{return"dark"}}_saveTheme(){try{localStorage.setItem("witmind-showroom-panel-theme",this._theme)}catch{}}_toggleTheme(){this.theme=this._theme==="dark"?"light":"dark",this.dispatchEvent(new CustomEvent("witmind-theme-change",{detail:{theme:this._theme},bubbles:!0,composed:!0}))}_state(e){var t,i;return(i=(t=this._hass)==null?void 0:t.states)==null?void 0:i[e]}_isOn(e){var t;return((t=this._state(e))==null?void 0:t.state)==="on"||this._pending.get(e)==="on"}_unavailable(e){var i;const t=(i=this._state(e))==null?void 0:i.state;return!t||t==="unknown"||t==="unavailable"}_escape(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}_icon(e){return`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${Ne[e]||Ne.bulb}</svg>`}_devices(){const e=this._kind(),t=this._panel.power_watts||this._panel.powerWatts||this._panel.device_watts||{},i=a=>({...a,watts:a.watts??(Number(t[a.entity]||0)||void 0)});return e==="offices"?(this._panel.areas||[]).flatMap(a=>(a.devices||[]).map(i)):e==="recording"?(this._panel.switches||[]).map(i):(this._panel.zones||[]).flatMap(a=>(a.devices||(a.entities||[]).map(r=>({entity:r,name:r}))).map(i))}_powerTotal(e=this._devices()){return e.reduce((t,i)=>t+Number(i.watts||0),0)}_powerActive(e=this._devices()){return e.filter(t=>this._isOn(t.entity)).reduce((t,i)=>t+Number(i.watts||0),0)}_weather(){const e=this._state(this._panel.weather||"weather.forecast_casa");return{temperature:((e==null?void 0:e.attributes)||{}).temperature??"—",condition:bt[String((e==null?void 0:e.state)||"")]||String((e==null?void 0:e.state)||"Sin datos")}}_queueRender(){this._renderQueued||(this._renderQueued=!0,requestAnimationFrame(()=>{this._renderQueued=!1,this._render()}))}_render(){var p;if(!this.shadowRoot)return;const e=this._weather(),t=this._devices(),i=this._kind(),a=this._panel.title||(i==="recording"?"Sala de grabación":i==="control"?"Control general":"Oficinas"),r=this._panel.subtitle||"Control operativo",s=t.filter(g=>this._isOn(g.entity)).length,o=this._powerActive(t),n=this._powerTotal(t),c=new Date,d=new Intl.DateTimeFormat("es-BO",{hour:"numeric",minute:"2-digit"}).format(c);this.setAttribute("data-kind",this._kind()),this.setAttribute("data-theme",this._theme),this.shadowRoot.innerHTML=`
      <style>
      ...
      <div class="operations-shell">
        <header class="topbar">
          <div class="topbar-start">
            <button class="menu-button" data-action="toggle-menu" aria-label="Abrir menú de navegación de Home Assistant" title="Abrir menú">${vt}</button>
          ...
          <div class="topbar-meta">
            ...
            <div class="header-weather" aria-label="Clima actual: ${this._escape(e.condition)}, ${this._escape(e.temperature)}°"><span aria-hidden="true">${this._escape(yt[String(((p=this._state(this._panel.weather||"weather.forecast_casa"))==null?void 0:p.state)||"")]||"·")}</span><strong>${this._escape(e.temperature)}°</strong></div>
            <button class="theme-button" data-action="toggle-theme" aria-label="Cambiar tema" title="Cambiar tema">${xt}</button>
          </div>
        </header>
        <main class="dashboard">
    ...
    `,s=a?this._notificationLoading&&!this._notificationLoaded:this._loading&&!this._calendar.length;this.shadowRoot.innerHTML=`
      ...
      <div class="admin-shell">
        ...
        <main class="dashboard">
          ${r}
          ${this._error?`<div class="error">${m(this._error)}</div>`:""}
        ...
        ${this._notificationToast?`
          <div class="toast-banner ${this._notificationToast.type}">
            <span>${m(this._notificationToast.message)}</span>
          </div>
        `:""}
      </div>
    `,this._updatePendingCountdowns()}_renderNotifications(){const e=this._rules.filter(o=>o.enabled!==!1).length,t=this._rules.filter(o=>{var n;return o.enabled!==!1&&((n=o.runtime)==null?void 0:n.active)}).length,i=this._targets.filter(o=>o.available).length,a=this._targets.length,r=this._history.find(o=>o.status==="sent"),s=r?`${this._formatHistoryDate(r.timestamp)} (${r.recipient||r.target||"Destino"})`:"Sin envíos recientes";return`
      ...
      <section class="hero-status-grid">
        ...
        <div class="status-card">
          ...
          <div class="status-value" style="font-size:16px;line-height:1.3;margin-top:8px;">${m(s)}</div>
    ...
    `}_renderRulesTab(){return this._rules.length?`
      <div class="rule-list">
        ${this._rules.map(e=>{var d,h,p,g,u;const t=m(e.id),i=this._findSensor((d=e.source)==null?void 0:d.entity_id),a=this._liveSensorValue(i),r=At(e),s=this._notificationBusy===`toggle:${e.id}`;let o="";r.countdownType==="retry"&&r.countdownValue?o=` · reintento <span class="runtime-countdown" data-retry-at="${m(r.countdownValue)}"></span>`:r.countdownType==="reminder"&&r.countdownValue?o=` · recordatorio <span class="runtime-countdown" data-reminder-at="${m(r.countdownValue)}"></span>`:r.countdownType==="pending"&&r.countdownValue&&(o=` <span class="runtime-countdown" data-pending-until="${m(r.countdownValue)}"></span>`);const n=(e.recipients||[]).some(f=>f.status==="stale_identity"||f.available===!1),c=(e.recipients||[]).map(f=>f.custom_name||f.name||f.notify_entity_id||f.legacy_service).join(" · ");return`
            <article class="surface rule-card ${r.status}">
              <div class="rule-card-head">
                <div class="rule-icon">${he}</div>
                <div class="rule-title">
                  ...
                  <p>${m(((h=e.source)==null?void 0:h.display_name)||((p=e.source)==null?void 0:p.entity_id))}</p>
                </div>
                <button
              ...
              <div class="rule-metrics">
                <div>
                  ...
                  <strong>${m(St(e.condition))}</strong>
                </div>
                <div>
                  <small>Actual</small>
                  <strong>${a.available?`${Number(a.value).toFixed(1)} ${m(a.unit)}`:"—"}</strong>
                </div>
                <div>
                  <small>Avisos</small>
                  <strong>${m(Et(e.behavior))}</strong>
              ...
              <div class="rule-footer">
                <span class="recipient-line ${n?"stale-warning":""}">
                  ${ae} ${n?"<strong>[Acción Requerida]</strong> ":""}${m(c||"Sin destinatarios asignados")}
                </span>
                <div class="card-actions">
                  ${this._admin()?`
                    <button class="small secondary" data-action="edit-rule" data-id="${t}" title="Editar regla">${Le} Editar</button>
                    <button class="small danger" data-action="delete-rule" data-id="${t}" title="Eliminar regla">${Nt}</button>
                  `:""}
                </div>
              </div>
              ...
              ${(u=e.runtime)!=null&&u.last_error?`
                <div class="inline-error">
                  ${Ie}
                  <span>${m(e.runtime.last_error)}</span>
                </div>
              `:""}
            </article>
          `}).join("")}
        ...
        ${this._targets.map(e=>{const t=this._notificationBusy===`test:${e.key}`,i=[e.manufacturer,e.model].filter(Boolean).join(" · ")||"Aplicación móvil",a=e.sw_version?`Firmware ${e.sw_version}`:"Firmware no informado",r=e.notify_entity_id||e.legacy_service||"Sin endpoint";return`
            <article class="surface device-card">
              <div class="device-card-head">
                <div class="device-icon">${ae}</div>
                <div class="device-title">
                  <h3>${m(e.name)}</h3>
                  ${e.custom_name?`<small>Home Assistant: ${m(e.ha_name||"—")}</small>`:""}
                  <span class="availability-badge ${e.available?"ok":"bad"}">
                    ${e.available?"Disponible":"No disponible"}
                  </span>
                </div>
                ${this._admin()?`
                  <button class="icon-button device-rename" data-action="rename-target" data-key="${m(e.target_id||e.key)}" title="Cambiar nombre amigable">
                    ${Le}
                  </button>
                `:""}
              </div>
              ...
              <dl class="device-data">
                <div><dt>Hardware</dt><dd>${m(i)}</dd></div>
                <div><dt>Software</dt><dd>${m(a)}</dd></div>
                ${e.area_name?`<div><dt>Área</dt><dd>${m(e.area_name)}</dd></div>`:""}
                <div><dt>Notificador</dt><dd><code>${m(r)}</code></dd></div>
                ${e.legacy_service&&e.notify_entity_id?`<div><dt>Compatibilidad</dt><dd><code>${m(e.legacy_service)}</code></dd></div>`:""}
              </dl>
              ...
              <button
                ...
                ${t?"disabled":""}
              >
                ${Dt} ${t?"Enviando prueba…":"Enviar prueba individual"}
              </button>
            </article>
          `}).join("")}
      </div>
                ...
                <div class="history-row">
                  ...
                  <div class="history-main">
                    <div class="history-header-line">
                      <strong>${m(s.rule_name||n)}</strong>
                      <span class="history-tag ${s.event_type}">${m(n)}</span>
                      <span class="history-status-tag ${o?"ok":"bad"}">${o?"Enviado":"Error"}</span>
                    </div>
                    <small>Destinatario: ${m(s.recipient||s.target||"Destino")}</small>
                    ${s.error?`<div class="history-error-code">${m(s.error)}</div>`:""}
                  </div>
                  <div class="history-aside">
                    ${s.value!=null?`<strong>${Number(s.value).toFixed(1)} °C</strong>`:""}
                    <time>${m(this._formatHistoryDate(s.timestamp))}</time>
                  </div>
                </div>
              `}).join("")}
          </div>
    ...
    `}_formatHistoryDate(e){if(!e)return"—";try{return new Intl.DateTimeFormat("es-BO",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",timeZone:"America/La_Paz"}).format(new Date(e))}catch{return String(e)}}_renderNotificationEditor(){var o;if(!this._notificationEditorOpen||!this._ruleDraft)return"";const e=this._ruleDraft,t=this._notificationEditorStep,i=!!this._editingRuleId,a=this._findSensor((o=e.source)==null?void 0:o.entity_id),r=this._liveSensorValue(a),s=["1. Sensor","2. Condición","3. Destinatarios","4. Mensaje"];return`
        ...
        <div class="modal-card wizard-card" data-editor-card>
          <div class="modal-head">
            <div>
              ...
              <h3>${i?m(e.name):"Configurar regla"}</h3>
            </div>
          ...
          ${this._editorError?`<div class="error" data-editor-error style="margin-bottom:14px;">${m(this._editorError)}</div>`:""}
            ...
            <div style="display:flex;gap:10px;">
              ...
              ${t<4?'<button type="button" class="primary" data-action="editor-next">Siguiente</button>':`
                <button type="button" class="primary" data-action="save-rule" ${this._notificationBusy==="save"?"disabled":""}>
                  ${Re} ${this._notificationBusy==="save"?"Guardando…":i?"Guardar cambios":"Crear regla"}
                </button>
              `}
            </div>
          </div>
      ...
      <div class="editor-section">
        ...
        <select class="field-control" data-field="sensor">
          ...
          ${this._preferredSensors().map(r=>`
            <option value="${m(r.entity_id)}" ${r.entity_id===e.source.entity_id?"selected":""}>
              ${r.preferred?"★ ":""}${m(r.display_name||r.name)} (${m(r.entity_id)})
            </option>
          `).join("")}
        </select>
        ...
        ${t?`
          <div class="sensor-preview-box">
            <div class="sensor-preview-icon">${zt}</div>
            <div class="sensor-preview-copy">
              <small>${m(t.area_name||t.device_name||"Área no asignada")}</small>
              <strong>${m(t.display_name||t.name)}</strong>
              <code>${m(t.entity_id)}</code>
            </div>
            <div class="sensor-live-pill">
              <small>Valor en vivo</small>
              <strong>${i.available?`${Number(i.value).toFixed(1)} ${m(i.unit)}`:"—"}</strong>
            </div>
          </div>
        `:`
      ...
      <div class="editor-section">
        <div class="field-grid two">
          ...
          ${i?`
            <label>
              ...
              <input type="number" step="0.1" class="field-control" data-field="threshold" value="${m(t.threshold)}" />
            </label>
          `:`
            <div class="field-grid two nested">
              <label>
                <span class="field-label">Límite Mín (°C)</span>
                <input type="number" step="0.1" class="field-control" data-field="lower" value="${m(t.lower)}" />
              </label>
              <label>
                <span class="field-label">Límite Máx (°C)</span>
                <input type="number" step="0.1" class="field-control" data-field="upper" value="${m(t.upper)}" />
              </label>
            </div>
          `}
        </div>
        ...
        <div class="field-grid two" style="margin-top:10px;">
          <div class="field-block">
            ...
            <input type="number" min="0" step="1" class="field-control" data-field="for-minutes" value="${m(s)}" />
          </div>
          ...
          <div class="field-block">
            ...
            <input type="number" min="0" max="50" step="0.1" class="field-control" data-field="hysteresis" value="${m(t.hysteresis)}" />
          </div>
        </div>
        ...
        <div class="field-grid ${a==="repeat"?"two":"one"}" style="margin-top:8px;">
          ...
          ${a==="repeat"?`
            <label>
              ...
              <input type="number" min="1" step="1" class="field-control" data-field="reminder-minutes" value="${m(r)}" />
            </label>
          `:""}
        </div>
        ...
        <div class="logic-preview-box">
          ...
          <span data-logic-preview-text>${m(De(e))}</span>
        </div>
      </div>
        ...
        <div class="target-picker">
          ${this._targets.map(t=>{const i=this._isRecipientSelected(t),a=t.notify_entity_id||t.legacy_service,r=e.recipients.some(s=>s.device_id===t.device_id&&s.status==="stale_identity");return`
              <label class="target-option ${i?"selected":""}">
                <input type="checkbox" data-field="recipient" value="${m(t.key)}" ${i?"checked":""} />
                <span class="target-option-icon">${ae}</span>
                <span class="target-option-copy">
                  <strong>${m(t.name)}</strong>
                  <small>${m(t.custom_name?`HA: ${t.ha_name||"—"}`:t.model||"Mobile App")}</small>
                  <code>${m(a)}</code>
    ...
    `:`
      ...
      <div class="editor-section">
        <div class="form-group">
          ...
          <input type="text" class="field-control" data-field="rule-name" value="${m(e.name)}" maxlength="120" required />
        </div>

        <div class="form-group" style="margin-top:10px;">
          <label>Título de la notificación push</label>
          <input type="text" class="field-control" data-field="message-title" value="${m(e.message.title)}" maxlength="240" />
        </div>

        <div class="form-group" style="margin-top:10px;">
          <label>Cuerpo del mensaje</label>
          <textarea class="field-control textarea" data-field="message-body" maxlength="2000" rows="3">${m(e.message.body)}</textarea>
        </div>
        ...
        <div class="message-preview-card">
          ...
          <strong data-message-preview-title>${m(e.message.title||e.name||"Alerta")}</strong>
          <p data-message-preview-body>${m(a)}</p>
        </div>
          ...
          ${this._recoveryAccordionOpen?`
            <div class="accordion-body">
              <div class="form-group">
                ...
                <input type="text" class="field-control" data-field="recovery-title" value="${m(e.message.recovery_title||"")}" placeholder="ej. Temperatura normalizada" maxlength="240" />
              </div>
              <div class="form-group" style="margin-top:8px;">
                <label>Mensaje al normalizarse</label>
                <textarea class="field-control textarea" data-field="recovery-body" rows="2" placeholder="ej. {sensor} regresó a valor seguro ({value} {unit})." maxlength="2000">${m(e.message.recovery_body||"")}</textarea>
              </div>
            </div>
          `:""}
        </div>
      ...
      <div class="modal-backdrop" data-action="cancel-delete-rule">
        <div class="modal-card dialog-card" data-delete-card>
          ...
          <p style="color:var(--wit-muted,#adb4b6);font-size:14px;line-height:1.5;">
            Se eliminará la regla <strong>"${m(e.name)}"</strong>. Esta acción detendrá de inmediato su monitoreo y eliminará sus estados runtime en Home Assistant.
          </p>
          ${this._deleteError?`<div class="error" data-delete-error>${m(this._deleteError)}</div>`:""}
    ...
    `:""}_renderRenameTargetModal(){return this._findTarget(this._renameTargetId||"")?`
      <div class="modal-backdrop" data-action="close-rename-backdrop">
        <div class="modal-card dialog-card" data-rename-card>
          ...
          ${this._renameError?`<div class="error" data-rename-error style="margin-bottom:12px;">${m(this._renameError)}</div>`:""}
          <div class="form-group">
            <label>Nombre amigable (máx 80 caracteres)</label>
            <input type="text" class="field-control" data-field="device-alias" value="${m(this._renameValue)}" maxlength="80" required />
          </div>
    ...
    `:""}_renderHelpModal(){if(!this._helpTopic)return"";const e=Mt(this._helpTopic);return e?`
    ...
    `:""}_years(){var i;const e=(i=this._todayPayload)==null?void 0:i.years;if(Array.isArray(e)&&e.length)return e;const t=new Set;return this._calendar.forEach(a=>{const r=parseInt(String(a.date||"").slice(0,4),10);Number.isNaN(r)||t.add(r)}),Array.from(t).sort()}_filteredHolidays(){return this._year==="all"?this._calendar:this._calendar.filter(e=>String(e.date||"").startsWith(`${this._year}-`))}_formatDate(e){const t=String(e||""),i=/^\d{4}-\d{2}-\d{2}$/.test(t)?new Date(`${t}T12:00:00`):new Date(t);return Number.isNaN(i.getTime())?t||"Sin fecha":new Intl.DateTimeFormat("es-BO",{day:"2-digit",month:"short",year:"numeric",timeZone:"America/La_Paz"}).format(i)}_renderCalendar(){var h,p,g,u;const e=this._todayPayload||{},t=!!e.is_non_working_day,i=String(e.reason||(t?"No laborable":"Día laboral")),a=e.next_holiday,r=((h=this._hass)==null?void 0:h.states)||{},s=((p=r["automation.taller_ciclo_10s"])==null?void 0:p.state)||"inactivo",o=((g=r["automation.witmind_bloqueo_laboral_apagado_seguro"])==null?void 0:g.state)||"activo",n=((u=r["binary_sensor.bloqueo_automatizaciones_laborales"])==null?void 0:u.state)||(t?"on":"off"),c=this._years(),d=this._filteredHolidays();return`
      ...
      <section class="hero-status-grid">
        <div class="status-card">
          ...
          <div class="status-value">${m(i)}</div>
          <div class="status-sub">Fecha evaluada: ${m(e.today||new Date().toISOString().slice(0,10))}</div>
        </div>
        ...
        <div class="status-card">
          <div class="status-card-header">
            ...
            <span class="status-badge ${a?"is-blocked":"is-muted"}">
              ${a?m(this._formatDate(a.date)):"Ninguno"}
            </span>
          </div>
          <div class="status-value">${a?m(a.name):"Sin feriados activos"}</div>
          <div class="status-sub">${a!=null&&a.description?m(a.description):"Pausará automatizaciones laborales"}</div>
        </div>
        ...
        <div class="status-card">
          ...
          <div class="status-sub" style="font-size: 11px; line-height: 1.6; margin-top: 4px;">
            • Taller (ciclo 10s): <strong>${m(s)}</strong><br>
            • Apagado seguro: <strong>${m(o)}</strong><br>
      ...
      <section class="surface">
        <div class="section-head">
          ...
          <div class="filter-group">
            ...
            ${c.map(f=>`<button class="filter-btn ${this._year===String(f)?"active":""}" data-action="filter-year" data-year="${f}">${f}</button>`).join("")}
          </div>
        </div>

        ${d.length?`
          <div class="list">
            ${d.map(f=>{const b=m(f.id??f.record_id),$=f.active!==!1;return`
                <article class="row">
                  <div class="row-details">
                    <strong>${m(f.name||"Feriado")}</strong>
                    <small>${m(this._formatDate(f.date))}${f.description?` · ${m(f.description)}`:""}</small>
                  </div>
                  <div class="row-actions">
                    <span class="status-badge ${$?"is-blocked":"is-muted"}" style="font-size: 10px; padding: 3px 8px;">
                      ${$?"Bloquea":"Inactivo"}
                    </span>
                    ${this._admin()?`
                      <button class="small ${$?"is-muted":"is-active"}" data-action="toggle-calendar" data-id="${b}">
                        ${$?"Desactivar":"Activar"}
                      </button>
                      <button class="small secondary" data-action="open-edit-modal" data-id="${b}">Editar</button>
                      <button class="small danger" data-action="delete-calendar" data-id="${b}">Eliminar</button>
                    `:""}
                  </div>
                </article>
              `}).join("")}
    ...
    `}_renderCalendarModal(){if(!this._modal)return"";const e=this._modal,t=e.mode==="add";return`
      <div class="modal-backdrop" data-action="close-modal-backdrop">
        <div class="modal-card">
          ...
          ${e.error?`<div class="error" style="margin-bottom: 12px;">${m(e.error)}</div>`:""}
          <form class="modal-form" data-form="modal-calendar">
            <div class="form-group">
              <label>Fecha (YYYY-MM-DD)</label>
              <input type="date" name="date" value="${m(e.date)}" required />
            </div>
            <div class="form-group">
              <label>Nombre del día festivo</label>
              <input type="text" name="name" value="${m(e.name)}" placeholder="ej. Día del Trabajo" required maxlength="120" />
            </div>
            <div class="form-group">
              <label>Descripción o alcance</label>
              <textarea name="description" placeholder="Opcional: información adicional" maxlength="500">${m(e.description)}</textarea>
            </div>
    ...
    `}_input(e){const t=e.target,i=t.dataset.field;if(!i)return;const a=t.value??"";if(i==="history-search"){this._historySearch=a,this._render();return}if(i==="device-alias"){this._renameValue=a,this._renameError="";return}this._ruleDraft&&(i==="rule-name"&&(this._ruleDraft.name=a),i==="threshold"&&(this._ruleDraft.condition.threshold=a),i==="lower"&&(this._ruleDraft.condition.lower=a),i==="upper"&&(this._ruleDraft.condition.upper=a),i==="for-minutes"&&(this._ruleDraft.condition.for_seconds=Math.max(0,Number(a||0)*60)),i==="hysteresis"&&(this._ruleDraft.condition.hysteresis=a),i==="reminder-minutes"&&(this._ruleDraft.behavior.reminder_interval_seconds=Math.max(0,Number(a||0)*60)),i==="message-title"&&(this._ruleDraft.message.title=a),i==="message-body"&&(this._ruleDraft.message.body=a),i==="recovery-title"&&(this._ruleDraft.message.recovery_title=a),i==="recovery-body"&&(this._ruleDraft.message.recovery_body=a),this._editorError="",this._syncEditorPreviewsInPlace())}_change(e){var a;const t=e.target,i=t.dataset.field;if(!(!i||!this._ruleDraft))if(this._editorError="",i==="sensor"){const r=this._findSensor(t.value);this._ruleDraft.source={entity_id:(r==null?void 0:r.entity_id)||t.value,display_name:(r==null?void 0:r.display_name)||(r==null?void 0:r.name)||t.value,area_name:(r==null?void 0:r.area_name)||null},!this._editingRuleId&&r&&(this._ruleDraft.name=`Temperatura · ${r.display_name||r.name}`),this._render()}else if(i==="condition-type")this._ruleDraft.condition.type=t.value,this._render();else if(i==="recipient"){const r=t,s=this._findTarget(r.value);if(!s)return;const o=s.target_id||s.key,n=this._ruleDraft.recipients.findIndex(c=>c.target_id&&c.target_id===o||c.device_id&&s.device_id&&c.device_id===s.device_id||c.notify_entity_id&&s.notify_entity_id&&c.notify_entity_id===s.notify_entity_id||c.legacy_service&&s.legacy_service&&c.legacy_service===s.legacy_service);r.checked&&n===-1?this._ruleDraft.recipients.push({target_id:s.target_id||s.key,identity_keys:Array.isArray(s.identity_keys)?[...s.identity_keys]:[],device_id:s.device_id,notify_entity_id:s.notify_entity_id,legacy_service:s.legacy_service,name:s.name,custom_name:s.custom_name||null}):!r.checked&&n!==-1&&this._ruleDraft.recipients.splice(n,1),(a=r.closest(".target-option"))==null||a.classList.toggle("selected",r.checked)}else i==="notification-mode"?(this._ruleDraft.behavior.notification_mode=["once","repeat","daily"].includes(t.value)?t.value:"once",this._ruleDraft.behavior.notification_mode==="repeat"&&Number(this._ruleDraft.behavior.reminder_interval_seconds||0)<=0&&(this._ruleDraft.behavior.reminder_interval_seconds=1800),this._render()):i==="notify-recovery"?(this._ruleDraft.behavior.notify_recovery=t.checked,this._syncEditorPreviewsInPlace()):i==="rule-enabled"&&(this._ruleDraft.enabled=t.checked)}_syncEditorPreviewsInPlace(){var a;if(!this._ruleDraft||!this.shadowRoot)return;const e=this.shadowRoot.querySelector("[data-logic-preview-text]");e&&(e.textContent=De(this._ruleDraft));const t=this.shadowRoot.querySelector("[data-message-preview-title]"),i=this.shadowRoot.querySelector("[data-message-preview-body]");if(t&&(t.textContent=this._ruleDraft.message.title||this._ruleDraft.name||"Alerta"),i){const r=this._findSensor((a=this._ruleDraft.source)==null?void 0:a.entity_id),s=this._liveSensorValue(r),o=s.available?Number(s.value).toFixed(1):"28.5";i.textContent=(this._ruleDraft.message.body||"").replaceAll("{sensor}",this._ruleDraft.source.display_name||"Sensor Rack").replaceAll("{value}",o).replaceAll("{unit}",s.unit||"°C").replaceAll("{threshold}",String(this._ruleDraft.condition.threshold??`${this._ruleDraft.condition.lower}–${this._ruleDraft.condition.upper}`)).replaceAll("{area}",this._ruleDraft.source.area_name||"Sistemas").replaceAll("{time}","14:30")}}_click(e){const t=e.target;if(t.dataset.action==="close-modal-backdrop"){this._modal=null,this._render();return}if(t.dataset.action==="close-editor-backdrop"){if(this._notificationBusy)return;this._notificationEditorOpen=!1,this._ruleDraft=null,this._editingRuleId=null,this._render();return}if(t.dataset.action==="cancel-delete-rule"){this._deleteRuleId=null,this._render();return}if(t.dataset.action==="close-rename-backdrop"||t.dataset.action==="close-rename-target"){this._renameTargetId=null,this._renameValue="",this._renameError="",this._render();return}if(t.dataset.action==="close-help"){this._helpTopic=null,this._render();return}const i=t.closest("button[data-action]");if(!i)return;const a=i.dataset.action;if(a==="toggle-menu")this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}));else if(a==="toggle-theme")this._toggleTheme();else if(a==="refresh")this._load();else if(a==="tab")this._notificationTab=i.dataset.tab||"rules",this._render();else if(a==="new-rule")this._editingRuleId=null,this._ruleDraft=this._newDraft(),this._notificationEditorStep=1,this._notificationEditorOpen=!0,this._editorError="",this._recoveryAccordionOpen=!1,this._render();else if(a==="edit-rule"){const r=i.dataset.id,s=this._rules.find(o=>o.id===r);s&&(this._editingRuleId=r||null,this._ruleDraft=this._draftFromRule(s),this._notificationEditorStep=1,this._notificationEditorOpen=!0,this._editorError="",this._recoveryAccordionOpen=!!(this._ruleDraft.message.recovery_title||this._ruleDraft.message.recovery_body),this._render())}else if(a==="close-editor"){if(this._notificationBusy)return;this._notificationEditorOpen=!1,this._ruleDraft=null,this._editingRuleId=null,this._render()}else if(a==="editor-back")this._notificationEditorStep=Math.max(1,this._notificationEditorStep-1),this._editorError="",this._render();else if(a==="editor-next"){const r=st(this._notificationEditorStep,this._ruleDraft);if(r){this._editorError=r,this._render();return}this._notificationEditorStep=Math.min(4,this._notificationEditorStep+1),this._editorError="",this._render()}else if(a==="save-rule")this._saveNotificationRule();else if(a==="toggle-rule")this._toggleNotificationRule(i.dataset.id||"",i.dataset.enabled!=="true");else if(a==="delete-rule")this._deleteRuleId=i.dataset.id||null,this._deleteError="",this._render();else if(a==="confirm-delete-rule")this._deleteNotificationRule();else if(a==="test-target")this._testNotificationTarget(i.dataset.key||"");else if(a==="rename-target"){const r=this._findTarget(i.dataset.key);r&&(this._renameTargetId=r.target_id||r.key,this._renameValue=r.custom_name||"",this._renameError="",this._render())}else if(a==="save-target-alias")this._saveTargetAlias(!1);else if(a==="clear-target-alias")this._saveTargetAlias(!0);else if(a==="open-help")this._helpTopic=i.dataset.help||null,this._render();else if(a==="toggle-recovery-accordion")this._recoveryAccordionOpen=!this._recoveryAccordionOpen,this._render();else if(a==="filter-history-type")this._historyTypeFilter=i.dataset.type||"all",this._render();else if(a==="filter-history-status")this._historyStatusFilter=i.dataset.status||"all",this._render();else if(a==="load-more-history")this._historyLimit+=50,this._render();else if(a==="filter-year")this._year=i.dataset.year||"all",this._render();else if(a==="open-add-modal")this._modal={mode:"add",date:new Date().toISOString().slice(0,10),name:"",description:"",active:!0},this._render();else if(a==="open-edit-modal"){const r=i.dataset.id,s=this._calendar.find(o=>String(o.id??o.record_id)===r);s&&(this._modal={mode:"edit",record_id:r,date:s.date,name:s.name,description:s.description||"",active:s.active!==!1},this._render())}else a==="close-modal"?(this._modal=null,this._render()):a==="toggle-calendar"?this._toggleCalendar(i.dataset.id||"",i):a==="delete-calendar"?this._deleteCalendar(i.dataset.id||""):a==="undo-delete"&&this._undoDelete()}async _saveNotificationRule(){if(!this._ruleDraft||this._notificationBusy)return;const e=$t(this._ruleDraft);if(!e.valid){this._notificationEditorStep=e.step,this._editorError=e.error,this._render();return}this._notificationBusy="save",this._editorError="",this._render();try{const t=kt(this._ruleDraft);this._editingRuleId?(await this._request("witmind_notifications/rules/update",{rule_id:this._editingRuleId,rule:t}),this._showNotificationToast(`Regla actualizada: ${t.name}`)):(await this._request("witmind_notifications/rules/create",{rule:t}),this._showNotificationToast(`Regla creada: ${t.name}`)),this._notificationEditorOpen=!1,this._ruleDraft=null,this._editingRuleId=null,await this._loadNotifications()}catch(t){this._editorError=t.message||"No se pudo guardar la regla",this._render()}finally{this._notificationBusy="",this._render()}}async _toggleNotificationRule(e,t){if(!(!e||this._notificationBusy)){this._notificationBusy=`toggle:${e}`,this._render();try{await this._request("witmind_notifications/rules/toggle",{rule_id:e,enabled:t}),await this._loadNotifications()}catch(i){this._showNotificationToast(i.message||"No se pudo cambiar el estado de la regla","error")}finally{this._notificationBusy="",this._render()}}}async _deleteNotificationRule(){if(!(!this._deleteRuleId||this._notificationBusy)){this._notificationBusy="delete",this._deleteError="",this._render();try{await this._request("witmind_notifications/rules/delete",{rule_id:this._deleteRuleId}),this._showNotificationToast("Regla eliminada exitosamente."),this._deleteRuleId=null,await this._loadNotifications()}catch(e){this._deleteError=e.message||"No se pudo eliminar la regla"}finally{this._notificationBusy="",this._render()}}}async _testNotificationTarget(e){const t=this._findTarget(e);if(!(!t||this._notificationBusy)){this._notificationBusy=`test:${t.key}`,this._render();try{await this._request("witmind_notifications/test",{recipient:{device_id:t.device_id,notify_entity_id:t.notify_entity_id,legacy_service:t.legacy_service,name:t.name},title:"Prueba Witmind",message:`Notificación de prueba enviada a ${t.name}.`}),this._showNotificationToast(`Prueba enviada a ${t.name}.`),await this._refreshNotificationRuntime()}catch(i){this._showNotificationToast(i.message||`Falló la prueba para ${t.name}`,"error")}finally{this._notificationBusy="",this._render()}}}async _saveTargetAlias(e=!1){const t=this._findTarget(this._renameTargetId||"");if(!t||this._notificationBusy.startsWith("alias:"))return;const i=e?"":String(this._renameValue||"").trim().replace(/\s+/g," ");if(!e&&!i){this._renameError="Escribe un nombre o usa 'Restaurar nombre original'.",this._render();return}if(i.length>80){this._renameError="El nombre puede tener como máximo 80 caracteres.",this._render();return}this._notificationBusy=`alias:${t.target_id||t.key}`,this._render();try{await this._request("witmind_notifications/targets/alias/set",{target_id:t.target_id||t.key,alias:i}),this._renameTargetId=null,this._renameValue="",this._renameError="",this._showNotificationToast(e?"Nombre de Home Assistant restaurado.":"Nombre amigable guardado."),await this._loadNotifications()}catch(a){this._renameError=a.message||"No se pudo guardar el alias"}finally{this._notificationBusy="",this._render()}}async _submit(e){const t=e.target;if(t.dataset.form!=="modal-calendar"||!this._modal||this._busy)return;e.preventDefault();const i=new FormData(t),a=String(i.get("date")||"").trim(),r=String(i.get("name")||"").trim(),s=String(i.get("description")||"").trim(),o=i.get("active")==="on";if(!a||!r){this._modal&&(this._modal.error="Fecha y nombre son obligatorios"),this._render();return}this._busy=!0;const n=this._backendType;try{this._modal.mode==="add"?(await this._request(`${n}/add`,{date:a,name:r,description:s,active:o}),this._showToast(`Feriado añadido: ${r}`)):(await this._request(`${n}/update`,{record_id:this._modal.record_id,date:a,name:r,description:s,active:o}),this._showToast(`Feriado actualizado: ${r}`)),this._modal=null,await this._loadCalendar()}catch(c){this._modal&&(this._modal.error=c.message||"Error al guardar el feriado"),this._render()}finally{this._busy=!1}}async _toggleCalendar(e,t){if(!e||!this._admin()||this._busy)return;const i=this._calendar.find(s=>String(s.id??s.record_id)===e);if(!i)return;this._busy=!0,t.disabled=!0;const a=i.active===!1,r=this._backendType;try{await this._request(`${r}/update`,{record_id:e,active:a,date:i.date,name:i.name,description:i.description||""}),this._showToast(a?`Feriado activado: ${i.name}`:`Feriado pausado: ${i.name}`),await this._loadCalendar()}catch(s){this._showToast(s.message||"No se pudo actualizar")}finally{this._busy=!1,t.disabled=!1}}async _deleteCalendar(e){if(!e||!this._admin()||this._busy)return;const t=this._calendar.find(a=>String(a.id??a.record_id)===e);if(!t||!confirm(`¿Eliminar definitivamente el feriado "${t.name}" (${this._formatDate(t.date)})?`))return;this._busy=!0;const i=this._backendType;try{await this._request(`${i}/delete`,{record_id:e}),this._undoDeletedRecord=t,this._showToast(`Eliminado: ${t.name}`,"undo"),await this._loadCalendar()}catch(a){this._showToast(a.message||"No se pudo eliminar")}finally{this._busy=!1}}async _undoDelete(){if(!this._undoDeletedRecord||this._busy)return;const e=this._undoDeletedRecord;this._busy=!0;const t=this._backendType;try{await this._request(`${t}/add`,{date:e.date,name:e.name,description:e.description||"",active:e.active!==!1}),this._undoDeletedRecord=null,this._showToast(`Feriado restaurado: ${e.name}`),await this._loadCalendar()}catch(i){this._showToast(i.message||"No se pudo restaurar")}finally{this._busy=!1}}_styles(){return`
      ...
      * { box-sizing: border-box; }
      ...
      .recipient-line.stale-warning { color: #f87171; }
      ...
      .icon-btn { width: 34px; height: 34px; padding: 0; display: grid; place-items: center; border-radius: 50%; }
      ...
      .wizard-body { display: grid; gap: 14px; min-height: 280px; }
      .wizard-actions {
        display: flex;
        align-items: center;
        justify-content: space-between;
      ...
      :host([data-theme=light]) .status-card, :host([data-theme=light]) .surface, :host([data-theme=light]) .rule-card, :host([data-theme=light]) .device-card { background: rgba(255, 255, 255, 0.9); border-color: rgba(23, 33, 41, 0.12); color: #172129; }
      ...
      :host([data-theme=light]) .row-details small, :host([data-theme=light]) .status-sub, :host([data-theme=light]) .admin-heading p, :host([data-theme=light]) .rule-title p { color: #5f6b70; }
      :host([data-theme=light]) .filter-btn, :host([data-theme=light]) .tab-btn { border-color: rgba(23, 33, 41, 0.14); background: rgba(247, 250, 250, 0.96); color: #5f6b70; }
      ...
      :host([data-theme=light]) .modal-card { background: #ffffff; border-color: rgba(23, 33, 41, 0.16); color: #172129; }
      :host([data-theme=light]) .field-control, :host([data-theme=light]) .modal-form input, :host([data-theme=light]) .modal-form textarea { background: #f7fafa; border-color: rgba(23, 33, 41, 0.16); color: #172129; }
      :host([data-theme=light]) .toast-banner { background: #ffffff; color: #172129; border-color: rgba(242, 101, 34, 0.4); }
      :host([data-theme=light]) .rule-metrics, :host([data-theme=light]) .device-data, :host([data-theme=light]) .target-option { background: rgba(240, 244, 244, 0.8); }
    ...
    </style><div class="energy-panel"><header class="topbar"><div class="topbar-start"><button class="menu-button" data-action="toggle-menu" aria-label="Abrir menú de Home Assistant">${Ht}</button><div class="brand"><strong>WITMIND</strong><span>WTX · MDTC</span></div></div><div class="status-strip"><div class="status-pill">${re}<span><strong data-live-active>${this._activeCount()} de ${this._circuits().length}</strong><small>Circuitos activos</small></span></div><div class="status-pill">${re}<span><strong data-live-power>${this._formatPower(this._currentPower())}</strong><small>Potencia actual</small></span></div><div class="status-pill">${re}<span><strong>${this._formatPower(this._installedPower())}</strong><small>Potencia conocida</small></span></div></div><div class="topbar-end"><time class="clock">${this._escape(t)}</time><button class="theme-button" data-action="toggle-theme" aria-label="Cambiar tema">${qt}</button></div></header><main class="dashboard"><section class="workspace-heading"><div><span class="eyebrow">Analítica del edificio</span><h1>Gestión de energía</h1><p>Consumo estimado, horas de uso y escenarios de ahorro para Showroom, Lobby, Oficinas y Sala de grabación.</p></div><div class="toolbar"><div class="range-tabs" role="tablist" aria-label="Período de análisis">${["day","week","month"].map(a=>`<button data-action="range" data-range="${a}" class="${this._range===a?"is-active":""}" role="tab" aria-selected="${this._range===a}">${a==="day"?"24 h":a==="week"?"7 días":"30 días"}</button>`).join("")}</div><button class="icon-button" data-action="refresh" aria-label="Actualizar historial" title="Actualizar">${re}</button></div></section>${this._loading?`<section class="surface state-card"><div><div class="loader"></div><strong>Cargando historial energético</strong><span>Consultando ${this._circuits().length} circuitos para ${this._escape(e.title.toLowerCase())}.</span></div></section>`:this._error?`<section class="surface state-card"><div><strong>No se pudo cargar el historial</strong><span>${this._escape(this._error)}. Usa Actualizar para volver a intentarlo.</span></div></section>`:i?this._renderReport(i):'<section class="surface state-card"><div><strong>Sin datos disponibles</strong><span>Home Assistant todavía no devolvió historial para este período.</span></div></section>'}</main></div>`}}customElements.get("witmind-energy-panel")||customElements.define("witmind-energy-panel",jt);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const se=globalThis,Se=se.ShadowRoot&&(se.ShadyCSS===void 0||se.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ee=Symbol(),Fe=new WeakMap;let nt=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==Ee)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Se&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=Fe.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&Fe.set(t,e))}return e}toString(){return this.cssText}};const Wt=l=>new nt(typeof l=="string"?l:l+"",void 0,Ee),Bt=(l,...e)=>{const t=l.length===1?l[0]:e.reduce((i,a,r)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+l[r+1],l[0]);return new nt(t,l,Ee)},Ut=(l,e)=>{if(Se)l.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of e){const i=document.createElement("style"),a=se.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,l.appendChild(i)}},He=Se?l=>l:l=>l instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Wt(t)})(l):l;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Vt,defineProperty:Xt,getOwnPropertyDescriptor:Yt,getOwnPropertyNames:Gt,getOwnPropertySymbols:Zt,getPrototypeOf:Kt}=Object,P=globalThis,qe=P.trustedTypes,Qt=qe?qe.emptyScript:"",ge=P.reactiveElementPolyfillSupport,G=(l,e)=>l,ye={toAttribute(l,e){switch(e){case Boolean:l=l?Qt:null;break;case Object:case Array:l=l==null?l:JSON.stringify(l)}return l},fromAttribute(l,e){let t=l;switch(e){case Boolean:t=l!==null;break;case Number:t=l===null?null:Number(l);break;case Object:case Array:try{t=JSON.parse(l)}catch{t=null}}return t}},ot=(l,e)=>!Vt(l,e),je={attribute:!0,type:String,converter:ye,reflect:!1,useDefault:!1,hasChanged:ot};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),P.litPropertyMetadata??(P.litPropertyMetadata=new WeakMap);let B=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=je){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const i=Symbol(),a=this.getPropertyDescriptor(e,i,t);a!==void 0&&Xt(this.prototype,e,a)}}static getPropertyDescriptor(e,t,i){const{get:a,set:r}=Yt(this.prototype,e)??{get(){return this[t]},set(s){this[t]=s}};return{get:a,set(s){const o=a==null?void 0:a.call(this);r==null||r.call(this,s),this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??je}static _$Ei(){if(this.hasOwnProperty(G("elementProperties")))return;const e=Kt(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(G("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(G("properties"))){const t=this.properties,i=[...Gt(t),...Zt(t)];for(const a of i)this.createProperty(a,t[a])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[i,a]of t)this.elementProperties.set(i,a)}this._$Eh=new Map;for(const[t,i]of this.elementProperties){const a=this._$Eu(t,i);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const a of i)t.unshift(He(a))}else e!==void 0&&t.push(He(e));return t}static _$Eu(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(t=>t(this))}addController(e){var t;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((t=e.hostConnected)==null||t.call(e))}removeController(e){var t;(t=this._$EO)==null||t.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ut(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(t=>{var i;return(i=t.hostConnected)==null?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(t=>{var i;return(i=t.hostDisconnected)==null?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){var r;const i=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,i);if(a!==void 0&&i.reflect===!0){const s=(((r=i.converter)==null?void 0:r.toAttribute)!==void 0?i.converter:ye).toAttribute(t,i.type);this._$Em=e,s==null?this.removeAttribute(a):this.setAttribute(a,s),this._$Em=null}}_$AK(e,t){var r,s;const i=this.constructor,a=i._$Eh.get(e);if(a!==void 0&&this._$Em!==a){const o=i.getPropertyOptions(a),n=typeof o.converter=="function"?{fromAttribute:o.converter}:((r=o.converter)==null?void 0:r.fromAttribute)!==void 0?o.converter:ye;this._$Em=a;const c=n.fromAttribute(t,o.type);this[a]=c??((s=this._$Ej)==null?void 0:s.get(a))??c,this._$Em=null}}requestUpdate(e,t,i,a=!1,r){var s;if(e!==void 0){const o=this.constructor;if(a===!1&&(r=this[e]),i??(i=o.getPropertyOptions(e)),!((i.hasChanged??ot)(r,t)||i.useDefault&&i.reflect&&r===((s=this._$Ej)==null?void 0:s.get(e))&&!this.hasAttribute(o._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:a,wrapped:r},s){i&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,s??t??this[e]),r!==!0||s!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var i;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[r,s]of this._$Ep)this[r]=s;this._$Ep=void 0}const a=this.constructor.elementProperties;if(a.size>0)for(const[r,s]of a){const{wrapped:o}=s,n=this[r];o!==!0||this._$AL.has(r)||n===void 0||this.C(r,void 0,s,n)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),(i=this._$EO)==null||i.forEach(a=>{var r;return(r=a.hostUpdate)==null?void 0:r.call(a)}),this.update(t)):this._$EM()}catch(a){throw e=!1,this._$EM(),a}e&&this._$AE(t)}willUpdate(e){}_$AE(e){var t;(t=this._$EO)==null||t.forEach(i=>{var a;return(a=i.hostUpdated)==null?void 0:a.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(t=>this._$ET(t,this[t]))),this._$EM()}updated(e){}firstUpdated(e){}};B.elementStyles=[],B.shadowRootOptions={mode:"open"},B[G("elementProperties")]=new Map,B[G("finalized")]=new Map,ge==null||ge({ReactiveElement:B}),(P.reactiveElementVersions??(P.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Z=globalThis,We=l=>l,oe=Z.trustedTypes,Be=oe?oe.createPolicy("lit-html",{createHTML:l=>l}):void 0,lt="$lit$",R=`lit$${Math.random().toFixed(9).slice(2)}$`,ct="?"+R,Jt=`<${ct}>`,j=document,Q=()=>j.createComment(""),J=l=>l===null||typeof l!="object"&&typeof l!="function",Ae=Array.isArray,ei=l=>Ae(l)||typeof(l==null?void 0:l[Symbol.iterator])=="function",ue=`[ 	
\f\r]`,Y=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ue=/-->/g,Ve=/>/g,F=RegExp(`>|${ue}(?:([^\\s"'>=/]+)(${ue}*=${ue}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Xe=/'/g,Ye=/"/g,dt=/^(?:script|style|textarea|title)$/i,ti=l=>(e,...t)=>({_$litType$:l,strings:e,values:t}),S=ti(1),V=Symbol.for("lit-noChange"),w=Symbol.for("lit-nothing"),Ge=new WeakMap,H=j.createTreeWalker(j,129);function pt(l,e){if(!Ae(l)||!l.hasOwnProperty("raw"))throw Error("invalid template strings array");return Be!==void 0?Be.createHTML(e):e}const ii=(l,e)=>{const t=l.length-1,i=[];let a,r=e===2?"<svg>":e===3?"<math>":"",s=Y;for(let o=0;o<t;o++){const n=l[o];let c,d,h=-1,p=0;for(;p<n.length&&(s.lastIndex=p,d=s.exec(n),d!==null);)p=s.lastIndex,s===Y?d[1]==="!--"?s=Ue:d[1]!==void 0?s=Ve:d[2]!==void 0?(dt.test(d[2])&&(a=RegExp("</"+d[2],"g")),s=F):d[3]!==void 0&&(s=F):s===F?d[0]===">"?(s=a??Y,h=-1):d[1]===void 0?h=-2:(h=s.lastIndex-d[2].length,c=d[1],s=d[3]===void 0?F:d[3]==='"'?Ye:Xe):s===Ye||s===Xe?s=F:s===Ue||s===Ve?s=Y:(s=F,a=void 0);const g=s===F&&l[o+1].startsWith("/>")?" ":"";r+=s===Y?n+Jt:h>=0?(i.push(c),n.slice(0,h)+lt+n.slice(h)+R+g):n+R+(h===-2?o:g)}return[pt(l,r+(l[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class ee{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let r=0,s=0;const o=e.length-1,n=this.parts,[c,d]=ii(e,t);if(this.el=ee.createElement(c,i),H.currentNode=this.el.content,t===2||t===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(a=H.nextNode())!==null&&n.length<o;){if(a.nodeType===1){if(a.hasAttributes())for(const h of a.getAttributeNames())if(h.endsWith(lt)){const p=d[s++],g=a.getAttribute(h).split(R),u=/([.?@])?(.*)/.exec(p);n.push({type:1,index:r,name:u[2],strings:g,ctor:u[1]==="."?ri:u[1]==="?"?si:u[1]==="@"?ni:le}),a.removeAttribute(h)}else h.startsWith(R)&&(n.push({type:6,index:r}),a.removeAttribute(h));if(dt.test(a.tagName)){const h=a.textContent.split(R),p=h.length-1;if(p>0){a.textContent=oe?oe.emptyScript:"";for(let g=0;g<p;g++)a.append(h[g],Q()),H.nextNode(),n.push({type:2,index:++r});a.append(h[p],Q())}}}else if(a.nodeType===8)if(a.data===ct)n.push({type:2,index:r});else{let h=-1;for(;(h=a.data.indexOf(R,h+1))!==-1;)n.push({type:7,index:r}),h+=R.length-1}r++}}static createElement(e,t){const i=j.createElement("template");return i.innerHTML=e,i}}function X(l,e,t=l,i){var s,o;if(e===V)return e;let a=i!==void 0?(s=t._$Co)==null?void 0:s[i]:t._$Cl;const r=J(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==r&&((o=a==null?void 0:a._$AO)==null||o.call(a,!1),r===void 0?a=void 0:(a=new r(l),a._$AT(l,t,i)),i!==void 0?(t._$Co??(t._$Co=[]))[i]=a:t._$Cl=a),a!==void 0&&(e=X(l,a._$AS(l,e.values),a,i)),e}class ai{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,a=((e==null?void 0:e.creationScope)??j).importNode(t,!0);H.currentNode=a;let r=H.nextNode(),s=0,o=0,n=i[0];for(;n!==void 0;){if(s===n.index){let c;n.type===2?c=new te(r,r.nextSibling,this,e):n.type===1?c=new n.ctor(r,n.name,n.strings,this,e):n.type===6&&(c=new oi(r,this,e)),this._$AV.push(c),n=i[++o]}s!==(n==null?void 0:n.index)&&(r=H.nextNode(),s++)}return H.currentNode=j,a}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class te{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,i,a){this.type=2,this._$AH=w,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cv=(a==null?void 0:a.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=X(this,e,t),J(e)?e===w||e==null||e===""?(this._$AH!==w&&this._$AR(),this._$AH=w):e!==this._$AH&&e!==V&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ei(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==w&&J(this._$AH)?this._$AA.nextSibling.data=e:this.T(j.createTextNode(e)),this._$AH=e}$(e){var r;const{values:t,_$litType$:i}=e,a=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=ee.createElement(pt(i.h,i.h[0]),this.options)),i);if(((r=this._$AH)==null?void 0:r._$AD)===a)this._$AH.p(t);else{const s=new ai(a,this),o=s.u(this.options);s.p(t),this.T(o),this._$AH=s}}_$AC(e){let t=Ge.get(e.strings);return t===void 0&&Ge.set(e.strings,t=new ee(e)),t}k(e){Ae(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const r of e)a===t.length?t.push(i=new te(this.O(Q()),this.O(Q()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,t);e!==this._$AB;){const a=We(e).nextSibling;We(e).remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}}class le{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,a,r){this.type=1,this._$AH=w,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=w}_$AI(e,t=this,i,a){const r=this.strings;let s=!1;if(r===void 0)e=X(this,e,t,0),s=!J(e)||e!==this._$AH&&e!==V,s&&(this._$AH=e);else{const o=e;let n,c;for(e=r[0],n=0;n<r.length-1;n++)c=X(this,o[i+n],t,n),c===V&&(c=this._$AH[n]),s||(s=!J(c)||c!==this._$AH[n]),c===w?e=w:e!==w&&(e+=(c??"")+r[n+1]),this._$AH[n]=c}s&&!a&&this.j(e)}j(e){e===w?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ri extends le{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===w?void 0:e}}class si extends le{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==w)}}class ni extends le{constructor(e,t,i,a,r){super(e,t,i,a,r),this.type=5}_$AI(e,t=this){if((e=X(this,e,t,0)??w)===V)return;const i=this._$AH,a=e===w&&i!==w||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==w&&(i===w||a);a&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}}class oi{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){X(this,e)}}const me=Z.litHtmlPolyfillSupport;me==null||me(ee,te),(Z.litHtmlVersions??(Z.litHtmlVersions=[])).push("3.3.3");const li=(l,e,t)=>{const i=(t==null?void 0:t.renderBefore)??e;let a=i._$litPart$;if(a===void 0){const r=(t==null?void 0:t.renderBefore)??null;i._$litPart$=a=new te(e.insertBefore(Q(),r),r,void 0,t??{})}return a._$AI(l),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const q=globalThis;class K extends B{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t;const e=super.createRenderRoot();return(t=this.renderOptions).renderBefore??(t.renderBefore=e.firstChild),e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=li(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return V}}var rt;K._$litElement$=!0,K.finalized=!0,(rt=q.litElementHydrateSupport)==null||rt.call(q,{LitElement:K});const fe=q.litElementPolyfillSupport;fe==null||fe({LitElement:K});(q.litElementVersions??(q.litElementVersions=[])).push("4.2.2");/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ci=[["path",{d:"M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const di=[["path",{d:"m7 7 10 10"}],["path",{d:"M17 7v10H7"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pi=[["path",{d:"M7 7h10v10"}],["path",{d:"M7 17 17 7"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gi=[["path",{d:"m6 9 6 6 6-6"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ui=[["path",{d:"m9 18 6-6-6-6"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mi=[["path",{d:"m18 15-6-6-6 6"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fi=[["circle",{cx:"12",cy:"12",r:"10"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _i=[["circle",{cx:"12",cy:"12",r:"10"}],["polyline",{points:"12 6 12 12 16 14"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bi=[["rect",{width:"16",height:"16",x:"4",y:"4",rx:"2"}],["rect",{width:"6",height:"6",x:"9",y:"9",rx:"1"}],["path",{d:"M15 2v2"}],["path",{d:"M15 20v2"}],["path",{d:"M2 15h2"}],["path",{d:"M2 9h2"}],["path",{d:"M20 15h2"}],["path",{d:"M20 9h2"}],["path",{d:"M9 2v2"}],["path",{d:"M9 20v2"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vi=[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"}],["circle",{cx:"12",cy:"12",r:"3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xi=[["path",{d:"M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wi=[["path",{d:"m12 14 4-4"}],["path",{d:"M3.34 19a10 10 0 1 1 17.32 0"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ki=[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Si=[["circle",{cx:"12",cy:"12",r:"10"}],["path",{d:"M12 16v-4"}],["path",{d:"M12 8h.01"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ei=[["path",{d:"M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"}],["path",{d:"M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"}],["path",{d:"M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Mi=[["polyline",{points:"15 3 21 3 21 9"}],["polyline",{points:"9 21 3 21 3 15"}],["line",{x1:"21",x2:"14",y1:"3",y2:"10"}],["line",{x1:"3",x2:"10",y1:"21",y2:"14"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ti=[["polyline",{points:"4 14 10 14 10 20"}],["polyline",{points:"20 10 14 10 14 4"}],["line",{x1:"14",x2:"21",y1:"10",y2:"3"}],["line",{x1:"3",x2:"10",y1:"21",y2:"14"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ci=[["path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zi=[["path",{d:"M9 18V5l12-2v13"}],["circle",{cx:"6",cy:"18",r:"3"}],["circle",{cx:"18",cy:"16",r:"3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Di=[["polygon",{points:"6 3 20 12 6 21 6 3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ii=[["path",{d:"M4.9 19.1C1 15.2 1 8.8 4.9 4.9"}],["path",{d:"M7.8 16.2c-2.3-2.3-2.3-6.1 0-8.5"}],["circle",{cx:"12",cy:"12",r:"2"}],["path",{d:"M16.2 7.8c2.3 2.3 2.3 6.1 0 8.5"}],["path",{d:"M19.1 4.9C23 8.8 23 15.1 19.1 19"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ri=[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"}],["path",{d:"M21 3v5h-5"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"}],["path",{d:"M8 16H3v5"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Pi=[["path",{d:"M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"}],["circle",{cx:"12",cy:"12",r:"3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oi=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fi=[["polygon",{points:"19 20 9 12 19 4 19 20"}],["line",{x1:"5",x2:"5",y1:"19",y2:"5"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Hi=[["polygon",{points:"5 4 15 12 5 20 5 4"}],["line",{x1:"19",x2:"19",y1:"5",y2:"19"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qi=[["line",{x1:"4",x2:"4",y1:"21",y2:"14"}],["line",{x1:"4",x2:"4",y1:"10",y2:"3"}],["line",{x1:"12",x2:"12",y1:"21",y2:"12"}],["line",{x1:"12",x2:"12",y1:"8",y2:"3"}],["line",{x1:"20",x2:"20",y1:"21",y2:"16"}],["line",{x1:"20",x2:"20",y1:"12",y2:"3"}],["line",{x1:"2",x2:"6",y1:"14",y2:"14"}],["line",{x1:"10",x2:"14",y1:"8",y2:"8"}],["line",{x1:"18",x2:"22",y1:"16",y2:"16"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ji=[["path",{d:"M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"}],["path",{d:"M20 3v4"}],["path",{d:"M22 5h-4"}],["path",{d:"M4 17v2"}],["path",{d:"M5 18H3"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wi=[["circle",{cx:"12",cy:"12",r:"4"}],["path",{d:"M12 2v2"}],["path",{d:"M12 20v2"}],["path",{d:"m4.93 4.93 1.41 1.41"}],["path",{d:"m17.66 17.66 1.41 1.41"}],["path",{d:"M2 12h2"}],["path",{d:"M20 12h2"}],["path",{d:"m6.34 17.66-1.41 1.41"}],["path",{d:"m19.07 4.93-1.41 1.41"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bi=[["path",{d:"M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ui=[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17"}],["polyline",{points:"16 7 22 7 22 13"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vi=[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"}],["path",{d:"M12 9v4"}],["path",{d:"M12 17h.01"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xi=[["rect",{width:"20",height:"15",x:"2",y:"7",rx:"2",ry:"2"}],["polyline",{points:"17 2 12 7 7 2"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Yi=[["path",{d:"M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z"}],["path",{d:"M16 9a5 5 0 0 1 0 6"}],["path",{d:"M19.364 18.364a9 9 0 0 0 0-12.728"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Gi=[["path",{d:"M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z"}],["line",{x1:"22",x2:"16",y1:"9",y2:"15"}],["line",{x1:"16",x2:"22",y1:"9",y2:"15"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Zi=[["path",{d:"M12 20h.01"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0"}],["path",{d:"M5 12.859a10 10 0 0 1 5.17-2.69"}],["path",{d:"M19 12.859a10 10 0 0 0-2.007-1.523"}],["path",{d:"M2 8.82a15 15 0 0 1 4.177-2.643"}],["path",{d:"M22 8.82a15 15 0 0 0-11.288-3.764"}],["path",{d:"m2 2 20 20"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ki=[["path",{d:"M12 20h.01"}],["path",{d:"M2 8.82a15 15 0 0 1 20 0"}],["path",{d:"M5 12.859a10 10 0 0 1 14 0"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qi=[["path",{d:"M12.8 19.6A2 2 0 1 0 14 16H2"}],["path",{d:"M17.5 8a2.5 2.5 0 1 1 2 4H2"}],["path",{d:"M9.8 4.4A2 2 0 1 1 11 8H2"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ji=[["path",{d:"M18 6 6 18"}],["path",{d:"m6 6 12 12"}]];/**
 * @license lucide v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ea=[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"}]],ta={home:ki,lightbulb:Ai,sun:Wi,moon:Ci,zap:ea,music:zi,sliders:qi,activity:ci,shield:Oi,power:Li,"chevron-right":ui,"chevron-down":gi,"chevron-up":mi,x:Ji,check:hi,"alert-triangle":Vi,"alert-circle":fi,clock:_i,thermometer:Bi,droplets:yi,wind:Qi,sparkles:ji,play:Di,pause:Ni,"skip-forward":Hi,"skip-back":Fi,"volume-2":Yi,"volume-x":Gi,"arrow-up-right":pi,"arrow-down-right":di,layers:Ei,tv:Xi,cpu:bi,"refresh-cw":Ri,eye:vi,settings:Pi,flame:xi,radio:Ii,wifi:Ki,"wifi-off":Zi,maximize:Mi,minimize:Ti,gauge:wi,"trending-up":Ui,grid:$i,info:Si};function y(l,e={}){const t=e.size||22,i=e.strokeWidth||1.8,a=e.color||"currentColor",r=e.className||"",s=ta[l.toLowerCase()];return s?S`
    <svg
      ...
      class="wit-icon ${r}"
    >
      ${s.map(([o,n])=>o==="path"?S`<path d="${n.d}"></path>`:o==="circle"?S`<circle cx="${n.cx}" cy="${n.cy}" r="${n.r}"></circle>`:o==="line"?S`<line x1="${n.x1}" y1="${n.y1}" x2="${n.x2}" y2="${n.y2}"></line>`:o==="rect"?S`<rect width="${n.width}" height="${n.height}" x="${n.x}" y="${n.y}" rx="${n.rx||0}"></rect>`:o==="polygon"?S`<polygon points="${n.points}"></polygon>`:o==="polyline"?S`<polyline points="${n.points}"></polyline>`:null)}
    </svg>
  `:S`
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    `}const ia=(l,e)=>{if(!Number.isFinite(l))return null;const t=String(e||"W").trim().toLowerCase();return t==="kw"?l*1e3:t==="mw"?l*1e6:t==="w"?l:null},L={weather:"weather.forecast_casa",showroomPower:"sensor.showroom_potencia_activa",showroomEnergy:"sensor.showroom_energia_activa",lobbyPower:"sensor.sensor_de_potencia_showroom_p"},ne=[{id:"ground.showroom",floor:"ground",label:"Showroom",power:L.showroomPower,circuits:[{entity:"switch.interruptor_inteligente_switch_1",label:"Spots ventana",watts:100},{entity:"switch.interruptor_inteligente_switch_2",label:"Spots 2x3",watts:120},{entity:"switch.interruptor_inteligente_switch_3",label:"Spots 3x3",watts:180},{entity:"switch.interruptor_inteligente_switch_4",label:"Spots TV",watts:25},{entity:"switch.interruptor_inteligente_2_switch_1",label:"Paneles 3k/6k",watts:96},{entity:"switch.interruptor_inteligente_2_switch_2",label:"Colgantes",watts:10},{entity:"switch.interruptor_inteligente_2_switch_3",label:"Slims",watts:432},{entity:"switch.interruptor_inteligente_2_switch_4",label:"Downlights",watts:144},{entity:"switch.smart_relay_switch_4_switch",label:"Paneles",watts:288},{entity:"switch.smart_relay_switch_3_switch",label:"Reflector exterior"}],action:{label:"Modo reunión",serviceEntity:"scene.reunion",onEntities:["switch.interruptor_inteligente_switch_1","switch.interruptor_inteligente_switch_2"],offEntities:["switch.interruptor_inteligente_switch_3","switch.interruptor_inteligente_switch_4","switch.interruptor_inteligente_2_switch_1","switch.interruptor_inteligente_2_switch_2","switch.interruptor_inteligente_2_switch_3","switch.interruptor_inteligente_2_switch_4","switch.smart_relay_switch_4_switch","switch.smart_relay_switch_3_switch"]}},{id:"ground.witronix_admin",floor:"ground",label:"Witronix Admin",temperature:"sensor.t_h_sensor_temperature",humidity:"sensor.t_h_sensor_humidity",showInTable:!1,circuits:[]},{id:"ground.lobby",floor:"ground",label:"Lobby",power:L.lobbyPower,circuits:[{entity:"switch.interruptor_inteligente_3_switch_1",label:"Central colgante"},{entity:"switch.interruptor_inteligente_3_switch_2",label:"Spots decorativos"},{entity:"switch.interruptor_inteligente_3_switch_3",label:"Tira LED"},{entity:"switch.interruptor_inteligente_3_switch_4",label:"Spots principales"}],action:{label:"Modo invitados",onEntities:["switch.interruptor_inteligente_3_switch_1","switch.interruptor_inteligente_3_switch_2","switch.interruptor_inteligente_3_switch_3","switch.interruptor_inteligente_3_switch_4"],offEntities:[]}},{id:"ground.grabacion",floor:"ground",label:"Grabación",circuits:[{entity:"switch.4gang_switch_sala_grabacion_interruptor_1",label:"Tira LED",watts:24},{entity:"switch.4gang_switch_sala_grabacion_interruptor_2",label:"Paneles",watts:96},{entity:"switch.4gang_switch_sala_grabacion_interruptor_3",label:"Spots",watts:50},{entity:"switch.4gang_switch_sala_grabacion_interruptor_4",label:"Otras luces",watts:30}],action:{label:"Iluminación completa",onEntities:["switch.4gang_switch_sala_grabacion_interruptor_1","switch.4gang_switch_sala_grabacion_interruptor_2","switch.4gang_switch_sala_grabacion_interruptor_3","switch.4gang_switch_sala_grabacion_interruptor_4"],offEntities:[]}},{id:"upper.witronix",floor:"upper",label:"Witronix",circuits:[{entity:"switch.oficina_gerencial_interruptor_1",label:"Witronix LED",watts:48}]},{id:"upper.mindtec",floor:"upper",label:"Mindtec",circuits:[{entity:"switch.oficina_mindtec_interruptor_1",label:"Iluminación Mindtec",watts:48}]},{id:"upper.office_large",floor:"upper",label:"Oficina grande",temperature:"sensor.t_h_sensor_2_temperature",humidity:"sensor.t_h_sensor_2_humidity",circuits:[{entity:"switch.oficina_grande_interruptor_1",label:"Oficina grande 1",watts:168},{entity:"switch.oficina_grande_interruptor_2",label:"Oficina grande 2",watts:168}]},{id:"upper.sala_multiuso",floor:"upper",label:"Sala multiuso",circuits:[{entity:"switch.b2_gang_interruptor_1",label:"Multifuncional",watts:96},{entity:"switch.b2_gang_interruptor_2",label:"Pasillos",watts:117}]},{id:"upper.taller",floor:"upper",label:"Taller",circuits:[{entity:"switch.taller_interruptor_1",label:"Iluminación Taller",watts:144}]}],aa={ground:[{zoneId:"ground.witronix_admin",left:8,top:13,width:22},{zoneId:"ground.showroom",left:8,top:47,width:22},{zoneId:"ground.lobby",left:38,top:51,width:21},{zoneId:"ground.grabacion",left:65,top:52,width:15}],upper:[{zoneId:"upper.mindtec",left:8,top:14,width:20},{zoneId:"upper.witronix",left:8,top:50,width:20},{zoneId:"upper.taller",left:41,top:16,width:16},{zoneId:"upper.sala_multiuso",left:38,top:50,width:18},{zoneId:"upper.office_large",left:62,top:50,width:20}]},ra=[...new Set([L.weather,L.showroomPower,L.showroomEnergy,...ne.flatMap(l=>{var e,t,i;return[l.temperature,l.humidity,l.power,(e=l.action)==null?void 0:e.serviceEntity,...((t=l.action)==null?void 0:t.onEntities)||[],...((i=l.action)==null?void 0:i.offEntities)||[],...l.circuits.map(a=>a.entity)]})].filter(l=>!!l))],sa={ground:{label:"Planta Baja",context:"Showroom",image:"./building/planta-baja.png"},upper:{label:"Planta Alta",context:"Taller",image:"./building/planta-alta.png"}},na={"clear-night":"Despejado de noche",cloudy:"Nublado",exceptional:"Condición excepcional",fog:"Niebla",hail:"Granizo",lightning:"Tormenta eléctrica","lightning-rainy":"Tormenta y lluvia",partlycloudy:"Parcialmente nublado",pouring:"Lluvia intensa",rainy:"Lluvioso",snowy:"Nevado","snowy-rainy":"Aguanieve",sunny:"Soleado",windy:"Ventoso","windy-variant":"Viento y nubes"},D=l=>!l||l.state==="unknown"||l.state==="unavailable",U=(l,e)=>{var a;if(D(l))return null;const t=e?(a=l==null?void 0:l.attributes)==null?void 0:a[e]:l==null?void 0:l.state,i=Number(t);return Number.isFinite(i)?i:null},Ze=l=>{var t;const e=U(l);return e===null?null:ia(e,String(((t=l==null?void 0:l.attributes)==null?void 0:t.unit_of_measurement)||"W"))},Me=class Me extends K{constructor(){super(...arguments),this._hass=null,this._panel={},this._theme="dark",this._activeFloor="ground",this._actionState="idle",this._actionMessage="",this._clock=new Date,this._history=[],this._historyTrend=null,this._historyState="idle",this._historyRequested=!1,this._touchStartX=null,this._touchLastX=null,this._mouseStartX=null,this._mouseLastX=null,this._onTouchMove=e=>{if(this._touchStartX===null)return;const t=e.touches[0];t&&(this._touchLastX=t.clientX,Math.abs(t.clientX-this._touchStartX)>12&&e.preventDefault())},this._onTouchEnd=()=>{this._touchStartX!==null&&this._touchLastX!==null&&this._finishFloorSwipe(this._touchLastX-this._touchStartX),this._touchStartX=null,this._touchLastX=null},this._onTouchCancel=()=>{this._touchStartX=null,this._touchLastX=null},this._onPointerMove=e=>{this._mouseStartX!==null&&(this._mouseLastX=e.clientX)},this._onPointerUp=()=>{this._mouseStartX!==null&&this._mouseLastX!==null&&this._finishFloorSwipe(this._mouseLastX-this._mouseStartX),this._mouseStartX=null,this._mouseLastX=null},this._onPointerCancel=()=>{this._mouseStartX=null,this._mouseLastX=null}}set hass(e){const t=this._hass;this._hass=e,this.requestUpdate("hass",t),this.isConnected&&!this._historyRequested&&this._loadHistory()}get hass(){return this._hass}set panel(e){const t=this._panel;this._panel=e&&typeof e=="object"?e:{},this.requestUpdate("panel",t)}get panel(){return this._panel}set theme(e){if(e!=="dark"&&e!=="light")return;const t=this._theme;this._theme=e,this.setAttribute("data-theme",e),this.requestUpdate("theme",t)}get theme(){return this._theme}connectedCallback(){super.connectedCallback(),this.setAttribute("data-theme",this._theme),this._clockTimer=window.setInterval(()=>{this._clock=new Date,this.requestUpdate()},3e4),window.addEventListener("touchmove",this._onTouchMove,{passive:!1}),window.addEventListener("touchend",this._onTouchEnd,{passive:!0}),window.addEventListener("touchcancel",this._onTouchCancel,{passive:!0}),window.addEventListener("pointermove",this._onPointerMove),window.addEventListener("pointerup",this._onPointerUp),window.addEventListener("pointercancel",this._onPointerCancel),this._historyRequested||this._loadHistory()}disconnectedCallback(){super.disconnectedCallback(),this._clockTimer&&window.clearInterval(this._clockTimer),window.removeEventListener("touchmove",this._onTouchMove),window.removeEventListener("touchend",this._onTouchEnd),window.removeEventListener("touchcancel",this._onTouchCancel),window.removeEventListener("pointermove",this._onPointerMove),window.removeEventListener("pointerup",this._onPointerUp),window.removeEventListener("pointercancel",this._onPointerCancel)}updated(e){e.has("theme")&&this.setAttribute("data-theme",this._theme)}_state(e){var t,i;return(i=(t=this._hass)==null?void 0:t.states)==null?void 0:i[e]}_zones(){return ne.filter(e=>e.floor===this._activeFloor)}_availableCircuits(e){return e.circuits.filter(t=>!D(this._state(t.entity)))}_onCircuits(e){return this._availableCircuits(e).filter(t=>{var i;return((i=this._state(t.entity))==null?void 0:i.state)==="on"})}_profileActive(e){return e.action?[...e.action.onEntities,...e.action.offEntities].some(i=>D(this._state(i)))?!1:e.action.onEntities.every(i=>{var a;return((a=this._state(i))==null?void 0:a.state)==="on"})&&e.action.offEntities.every(i=>{var a;return((a=this._state(i))==null?void 0:a.state)==="off"}):this._onCircuits(e).length>0}_zonePower(e){const t=e.power?Ze(this._state(e.power)):null;if(t!==null)return{value:t,measured:!0};const i=this._onCircuits(e).filter(a=>typeof a.watts=="number");return i.length?{value:i.reduce((a,r)=>a+Number(r.watts),0),measured:!1}:null}_format(e,t,i=0){return e===null?"No disponible":`${new Intl.NumberFormat("es-BO",{maximumFractionDigits:i}).format(e)} ${t}`}_weather(){const e=this._state(L.weather);return{available:!D(e),temperature:U(e,"temperature"),condition:na[String((e==null?void 0:e.state)||"")]||(D(e)?"No disponible":String(e==null?void 0:e.state))}}_environment(){const e=this._zones().map(a=>a.temperature&&U(this._state(a.temperature))).filter(a=>typeof a=="number"),t=this._zones().map(a=>a.humidity&&U(this._state(a.humidity))).filter(a=>typeof a=="number"),i=a=>a.length?a.reduce((r,s)=>r+s,0)/a.length:null;return{temperature:i(e),humidity:i(t)}}_activePower(){const e=Ze(this._state(L.showroomPower));return e===null?null:e}async _loadHistory(){var i,a;const e=(a=(i=this._hass)==null?void 0:i.connection)==null?void 0:a.sendMessagePromise;if(!e||D(this._state(L.showroomPower))){this._historyState="unavailable",this.requestUpdate();return}this._historyRequested=!0,this._historyState="loading",this.requestUpdate();const t=Date.now();try{const r=await e({type:"history/history_during_period",start_time:new Date(t-1728e5).toISOString(),end_time:new Date(t).toISOString(),entity_ids:[L.showroomPower],minimal_response:!0,no_attributes:!0,significant_changes_only:!1}),s=Array.isArray(r)?Array.isArray(r[0])?r[0]:r:Object.values(r||{})[0],o=(Array.isArray(s)?s:[]).map(p=>({value:Number((p==null?void 0:p.state)??(p==null?void 0:p.s)),time:Date.parse(String((p==null?void 0:p.last_changed)??(p==null?void 0:p.last_updated)??(p==null?void 0:p.lu)??(p==null?void 0:p.lc)??""))})).filter(p=>Number.isFinite(p.value)&&Number.isFinite(p.time)),n=new Map;o.forEach(p=>n.set(Math.floor(p.time/36e5),p.value));const c=Math.floor(t/36e5),d=Array.from({length:24},(p,g)=>n.get(c-23+g)).filter(p=>typeof p=="number"),h=Array.from({length:24},(p,g)=>n.get(c-47+g)).filter(p=>typeof p=="number");if(this._history=d,d.length&&h.length){const p=d.reduce((u,f)=>u+f,0)/d.length,g=h.reduce((u,f)=>u+f,0)/h.length;this._historyTrend=g>0?(p-g)/g*100:null}this._historyState=d.length?"ready":"unavailable"}catch{this._historyState="error"}this.requestUpdate()}_setFloor(e){e!==this._activeFloor&&(this._activeFloor=e,this.requestUpdate())}_onTouchStart(e){const t=e.changedTouches[0]||e.touches[0];t&&(this._touchStartX=t.clientX,this._touchLastX=t.clientX)}_onPointerDown(e){e.pointerType==="touch"||e.button!==0||(this._mouseStartX=e.clientX,this._mouseLastX=e.clientX)}_finishFloorSwipe(e){Math.abs(e)<54||this._setFloor(e<0?"upper":"ground")}async _toggleZone(e){var a;if(!((a=this._hass)!=null&&a.callService)||this._actionState==="loading")return;const t=this._availableCircuits(e);if(!t.length)return;const i=e.action?!this._profileActive(e):this._onCircuits(e).length!==t.length;this._actionState="loading",this._actionMessage=`${i?"Encendiendo":"Apagando"} ${e.label}`,this.requestUpdate();try{if(e.action)if(!i)await this._hass.callService("switch","turn_off",{entity_id:t.map(r=>r.entity)});else{e.action.serviceEntity&&!D(this._state(e.action.serviceEntity))&&await this._hass.callService("scene","turn_on",{entity_id:e.action.serviceEntity});const r=e.action.offEntities.filter(o=>!D(this._state(o))),s=e.action.onEntities.filter(o=>!D(this._state(o)));r.length&&await this._hass.callService("switch","turn_off",{entity_id:r}),s.length&&await this._hass.callService("switch","turn_on",{entity_id:s})}else await this._hass.callService("switch",i?"turn_on":"turn_off",{entity_id:t.map(r=>r.entity)});this._actionState="idle",this._actionMessage=i&&e.action?`${e.action.label} aplicado en ${e.label}`:`Orden enviada a ${e.label}`}catch(r){this._actionState="error",this._actionMessage=r instanceof Error?r.message:"No se pudo ejecutar la acción"}this.requestUpdate()}async _setAll(e){var i;if(!((i=this._hass)!=null&&i.callService)||this._actionState==="loading")return;const t=ne.flatMap(a=>this._availableCircuits(a).map(r=>r.entity));if(t.length){this._actionState="loading",this._actionMessage=e?"Encendiendo circuitos disponibles":"Apagando circuitos disponibles",this.requestUpdate();try{await this._hass.callService("switch",e?"turn_on":"turn_off",{entity_id:t}),this._actionState="idle",this._actionMessage="Orden enviada. Esperando confirmación de Home Assistant"}catch(a){this._actionState="error",this._actionMessage=a instanceof Error?a.message:"No se pudo ejecutar la acción"}this.requestUpdate()}}_scrollTo(e){var t;(t=this.renderRoot.querySelector(`#${e}`))==null||t.scrollIntoView({behavior:"smooth",block:"start"})}_toggleMenu(){this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}))}_renderZoneRow(e){var c;const t=this._availableCircuits(e),i=this._onCircuits(e),a=e.circuits.length-t.length,r=this._zonePower(e),s=this._profileActive(e),o=t.length?a?"warning":i.length?"normal":"off":"unavailable",n=o==="unavailable"?"No disponible":o==="warning"?"Parcial":o==="normal"?"Normal":"Apagada";return S`
      <div class="circuit-row" role="row">
        ...
        <div role="cell" class="numeric">${r?this._format(r.value,"W"):"No disponible"}${r&&!r.measured?S`<small>nominal</small>`:w}</div>
      ...
      </div>`}_renderFloorOverlays(){return aa[this._activeFloor].map(e=>{const t=ne.find(c=>c.id===e.zoneId);if(!t)return w;const i=this._availableCircuits(t),a=this._onCircuits(t),r=this._zonePower(t),s=t.temperature?U(this._state(t.temperature)):null,o=t.humidity?U(this._state(t.humidity)):null;return i.length||r||s!==null||o!==null?S`
        <div class="zone-overlay ${a.length?"is-active":""}" style="left:${e.left}%;top:${e.top}%;width:${e.width||21}%">
          <strong>${t.label}</strong>
          <div class="overlay-metrics">
            ${i.length?S`<span>${y("lightbulb",{size:12})}${a.length}/${i.length}</span>`:w}
            ${r?S`<span>${y("zap",{size:12})}${this._format(r.value,"W")}</span>`:w}
            ${s!==null?S`<span>${y("thermometer",{size:12})}${this._format(s,"°C",1)}</span>`:w}
            ${o!==null?S`<span>${y("droplets",{size:12})}${this._format(o,"%",0)}</span>`:w}
          </div>
        </div>`:w})}render(){var h;const e=sa[this._activeFloor],t=this._weather(),i=this._environment(),a=this._activePower(),r=this._history.length?Math.max(...this._history,1):1,o=(Array.isArray(this._panel.alarm_entities)?this._panel.alarm_entities:[]).map(p=>this._state(p)).filter(p=>p&&!D(p)&&p.state!=="off"),n=!!((h=this._hass)!=null&&h.states&&Object.keys(this._hass.states).length),c=new Intl.DateTimeFormat("es-BO",{hour:"2-digit",minute:"2-digit",hour12:!1}).format(this._clock),d=new Intl.DateTimeFormat("es-BO",{day:"2-digit",month:"short",year:"numeric"}).format(this._clock);return S`
      <div class="bms-shell">
        <header class="topbar">
          ...
          <div class="header-status"><div class="clock"><strong>${c}</strong><span>${d}</span></div><div class="weather-chip">${y("sun",{size:22})}<span><strong>${this._format(t.temperature,"°C",1)}</strong>${t.condition}</span></div><div class="mode-chip ${n?"ok":"warn"}">${y(n?"check":"alert-circle",{size:18})}<span><small>Estado</small><strong>${n?"Supervisión activa":"Conexión pendiente"}</strong></span></div></div>
        </header>
        ...
        <main class="dashboard-grid">
          <section class="main-column">
            <article id="floor-plan" class="panel floor-card">
              ...
              <div class="floor-viewport" data-no-swipe @touchstart=${this._onTouchStart} @pointerdown=${this._onPointerDown} aria-label="${e.label}: ${e.context}">
                <div class="floor-stage">
                  <img src=${e.image} alt="Plano arquitectónico real de ${e.label}" draggable="false" />
            ...
            <article id="circuits" class="panel circuits-card">
              ...
              <div class="circuit-table" role="table" aria-label="Circuitos por zona">
                ...
                ${this._zones().filter(p=>p.showInTable!==!1&&p.circuits.length).map(p=>this._renderZoneRow(p))}
              </div>
            </article>
          </section>
          ...
          <section class="side-column">
            <article id="alerts" class="panel side-card alerts-card">
              <div class="panel-head"><div class="panel-title warning-icon">${y("alert-triangle",{size:19})}<h2>ALARMAS / EVENTOS</h2></div><span class="head-meta">${o.length} activas</span></div>
              ${o.length?S`<div class="alert-list">${o.map(p=>{var g;return S`<div class="alert-row">${y("alert-triangle",{size:20})}<div><strong>${String(((g=p==null?void 0:p.attributes)==null?void 0:g.friendly_name)||(p==null?void 0:p.entity_id))}</strong><span>${String(p==null?void 0:p.state)}</span></div></div>`})}</div>`:S`<div class="empty-state">${y("shield",{size:26})}<div><strong>Sin alarmas configuradas</strong><span>Conecta entidades en <code>alarm_entities</code> para habilitar esta sección.</span></div></div>`}
            </article>
            ...
            <article id="environment" class="panel side-card">
              ...
              <div class="environment-grid"><div>${y("thermometer",{size:27})}<strong>${this._format(i.temperature,"°C",1)}</strong><span>Interior promedio</span></div><div>${y("droplets",{size:27})}<strong>${this._format(i.humidity,"%",0)}</strong><span>Humedad promedio</span></div><div>${y("sun",{size:27})}<strong>${this._format(t.temperature,"°C",1)}</strong><span>Exterior</span></div><div>${y("activity",{size:27})}<strong class="condition">${t.condition}</strong><span>WTX - MDTC</span></div></div>
            </article>
            ...
            <article id="consumption" class="panel side-card consumption-card">
              ...
              <div class="power-reading">${y("zap",{size:43})}<div><strong>${this._format(a,"W")}</strong><span>${a===null?"Medición no disponible":"Showroom - potencia activa"}</span></div>${this._historyTrend!==null?S`<b class=${this._historyTrend<=0?"trend good":"trend bad"}>${this._historyTrend>0?"+":""}${this._historyTrend.toFixed(0)} %<small>vs. 24 h previas</small></b>`:w}</div>
              ${this._historyState==="ready"?S`<div class="history-bars" aria-label="Histórico real de potencia de las últimas 24 horas">${this._history.map(p=>S`<i style="height:${Math.max(4,p/r*100)}%" title="${this._format(p,"W")}"></i>`)}</div>`:S`<div class="history-empty"><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><p>${this._historyState==="loading"?"Cargando histórico real de Home Assistant":this._historyState==="error"?"No se pudo cargar el histórico":"Histórico no disponible para esta medición"}.</p></div>`}
            </article>
