...
const LOBBY_CONFIG: PanelConfig = {
  ...
  show_forecast: true,
  spots: [
    { entity: "switch.interruptor_inteligente_3_switch_1", name: "Central Colgante", subtitle: "Iluminación central · 100 W", icon: "pendant" },
    { entity: "switch.interruptor_inteligente_3_switch_2", name: "Spots 5W Decorativos", subtitle: "Iluminación decorativa · 40 W", icon: "spot" },
    { entity: "switch.interruptor_inteligente_3_switch_3", name: "Tira LED", subtitle: "Iluminación ambiental · 168 W", icon: "strip" },
    { entity: "switch.interruptor_inteligente_3_switch_4", name: "Spots 10W", subtitle: "Iluminación principal · 205 W", icon: "spot" },
  ],
  samples: [],
  reflector: { entity: "" },
...
const GENERAL_CONFIG: PanelConfig = {
  ...
  show_forecast: true,
  spots: [
    { entity: "switch.oficina_gerencial_interruptor_1", name: "Witronix LED", subtitle: "Gerencia · 48 W nominal", icon: "bulb" },
    { entity: "switch.oficina_mindtec_interruptor_1", name: "Mindtec", subtitle: "Mindtec · 48 W nominal", icon: "bulb" },
    { entity: "switch.oficina_grande_interruptor_1", name: "Oficina grande 1", subtitle: "Oficinas grandes · 4×48 W nominal (192 W)", icon: "office" },
    { entity: "switch.oficina_grande_interruptor_2", name: "Oficina grande 2", subtitle: "Oficinas grandes · 4×48 W nominal (192 W)", icon: "office" },
    { entity: "switch.b2_gang_interruptor_1", name: "Multifuncional", subtitle: "Pasillos y multifuncional · 4×24 W nominal (96 W)", icon: "office" },
    { entity: "switch.b2_gang_interruptor_2", name: "Pasillos", subtitle: "Pasillos · 3×24 W + 3×15 W nominal (117 W)", icon: "corridor" },
    { entity: "switch.taller_interruptor_1", name: "Taller", subtitle: "Taller · 3×48 W nominal (144 W)", icon: "workshop" },
  ],
  samples: [],
  reflector: { entity: "" },
  scenes: [],
...
const OFFICES_CONFIG: PanelConfig = {
  ...
  power_watts: {
    ...
    "switch.oficina_grande_interruptor_1": 192, "switch.oficina_grande_interruptor_2": 192,
    "switch.b2_gang_interruptor_1": 96, "switch.b2_gang_interruptor_2": 117, "switch.taller_interruptor_1": 144,
  },
  areas: [
    { id: "gerencia", name: "Gerencia", environment: { temperature: "sensor.t_h_sensor_temperature", humidity: "sensor.t_h_sensor_humidity" }, devices: [{ entity: "switch.oficina_gerencial_interruptor_1", name: "Witronix LED", subtitle: "48 W nominal", watts: 48 }] },
    { id: "mindtec", name: "Mindtec", devices: [{ entity: "switch.oficina_mindtec_interruptor_1", name: "Mindtec", subtitle: "48 W nominal", watts: 48 }] },
    { id: "general", name: "Oficinas grandes", environment: { temperature: "sensor.t_h_sensor_2_temperature", humidity: "sensor.t_h_sensor_2_humidity" }, devices: [
      { entity: "switch.oficina_grande_interruptor_1", name: "Oficina grande 1", subtitle: "4×48 W nominal (192 W)", watts: 192 },
      { entity: "switch.oficina_grande_interruptor_2", name: "Oficina grande 2", subtitle: "4×48 W nominal (192 W)", watts: 192 },
    ] },
    { id: "pasillos", name: "Pasillos y multifuncional", devices: [
      { entity: "switch.b2_gang_interruptor_1", name: "Multifuncional", subtitle: "4×24 W nominal (96 W)", watts: 96, icon: "office" },
      { entity: "switch.b2_gang_interruptor_2", name: "Pasillos", subtitle: "3×24 W + 3×15 W nominal (117 W)", watts: 117, icon: "corridor" },
    ] },
    { id: "taller", name: "Taller", devices: [{ entity: "switch.taller_interruptor_1", name: "Taller", subtitle: "3×48 W nominal (144 W)", watts: 144, icon: "workshop" }] },
  ],
};
...
const RECORDING_CONFIG: PanelConfig = {
  ...
  power_watts: {
    "switch.4gang_switch_sala_grabacion_interruptor_1": 42, "switch.4gang_switch_sala_grabacion_interruptor_2": 96,
    "switch.4gang_switch_sala_grabacion_interruptor_3": 45, "switch.4gang_switch_sala_grabacion_interruptor_4": 20,
  },
  switches: [
    { entity: "switch.4gang_switch_sala_grabacion_interruptor_1", name: "Tiras LED", subtitle: "3×14 W nominal (42 W)", watts: 42, icon: "strip" },
    { entity: "switch.4gang_switch_sala_grabacion_interruptor_2", name: "Paneles", subtitle: "2×48 W nominal (96 W)", watts: 96, icon: "panel" },
    { entity: "switch.4gang_switch_sala_grabacion_interruptor_3", name: "Tracklight", subtitle: "3×15 W nominal (45 W)", watts: 45, icon: "spot" },
    { entity: "switch.4gang_switch_sala_grabacion_interruptor_4", name: "Spots", subtitle: "4×5 W nominal (20 W)", watts: 20, icon: "bulb" },
  ],
};
...
const CONTROL_CONFIG: PanelConfig = {
  ...
  device_watts: { ...(OFFICES_CONFIG.power_watts as Record<string, number>), ...(RECORDING_CONFIG.power_watts as Record<string, number>),
    "switch.interruptor_inteligente_switch_1": 100, "switch.interruptor_inteligente_switch_2": 120, "switch.interruptor_inteligente_switch_3": 180, "switch.interruptor_inteligente_switch_4": 25,
    "switch.interruptor_inteligente_2_switch_1": 96, "switch.interruptor_inteligente_2_switch_2": 10, "switch.interruptor_inteligente_2_switch_3": 432, "switch.interruptor_inteligente_2_switch_4": 144,
    "switch.smart_relay_switch_3_switch": 100, "switch.smart_relay_switch_4_switch": 288,
    "switch.interruptor_inteligente_3_switch_1": 100, "switch.interruptor_inteligente_3_switch_2": 40, "switch.interruptor_inteligente_3_switch_3": 168, "switch.interruptor_inteligente_3_switch_4": 205,
  },
  zones: [
