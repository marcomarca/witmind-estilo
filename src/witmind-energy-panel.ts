...
const CIRCUITS: EnergyCircuit[] = [
  ...
  { entity: "switch.smart_relay_switch_4_switch", name: "Paneles (relé)", zone: "showroom", zoneLabel: "Showroom", watts: 288 },
  { entity: "switch.smart_relay_switch_3_switch", name: "Reflector exterior", zone: "showroom", zoneLabel: "Showroom", watts: 100 },
  { entity: "switch.interruptor_inteligente_3_switch_1", name: "Central Colgante", zone: "lobby", zoneLabel: "Lobby", watts: 100 },
  { entity: "switch.interruptor_inteligente_3_switch_2", name: "Spots 5W Decorativos", zone: "lobby", zoneLabel: "Lobby", watts: 40 },
  { entity: "switch.interruptor_inteligente_3_switch_3", name: "Tira LED", zone: "lobby", zoneLabel: "Lobby", watts: 168 },
  { entity: "switch.interruptor_inteligente_3_switch_4", name: "Spots 10W", zone: "lobby", zoneLabel: "Lobby", watts: 205 },
  ...
  { entity: "switch.oficina_grande_interruptor_1", name: "Oficina grande 1", zone: "offices", zoneLabel: "Oficinas", watts: 192 },
  { entity: "switch.oficina_grande_interruptor_2", name: "Oficina grande 2", zone: "offices", zoneLabel: "Oficinas", watts: 192 },
  ...
  { entity: "switch.4gang_switch_sala_grabacion_interruptor_1", name: "Tiras LED", zone: "recording", zoneLabel: "Grabación", watts: 42 },
  { entity: "switch.4gang_switch_sala_grabacion_interruptor_2", name: "Paneles", zone: "recording", zoneLabel: "Grabación", watts: 96 },
  { entity: "switch.4gang_switch_sala_grabacion_interruptor_3", name: "Tracklight", zone: "recording", zoneLabel: "Grabación", watts: 45 },
  { entity: "switch.4gang_switch_sala_grabacion_interruptor_4", name: "Spots", zone: "recording", zoneLabel: "Grabación", watts: 20 },
];
...
class WitmindEnergyPanel extends HTMLElement {
  ...
  private _updateLiveMetrics() {
    ...
    const onCount = this._activeCount();
    const offCount = this._circuits().length - onCount;
    if (active) active.textContent = `${onCount} enc. · ${offCount} apag.`;
